...
public class SexSlotSitting {
	...
	public static final SexSlot SITTING = new SexSlot(
			"Sitting",
			"sitting down",
            "With a small thrust of [npc.her] [npc.hips], [npc.name] let out [npc.a_moan+] as [npc.she] reach [npc.her] climax.",
			false,
			SexSlotTag.SITTING);
	...
	public static final SexSlot SITTING_IN_LAP = new SexSlot(
			"Sitting in lap",
			"sitting in lap",
            "With trembling [npc.legs], [npc.name] sink down into [npc2.namePos] lap, and with [npc.a_moan+], [npc.she] prepare to reach [npc.her] climax.",
			false,
	...
	public static final SexSlot SITTING_BETWEEN_LEGS = new SexSlot(
			"Between legs",
			"between legs",
            "Leaning down into [npc2.name], [npc.name] let out [npc.a_moan+] as [npc.she] prepare to reach [npc.her] climax.",
			false,
	...
	public static final SexSlot SITTING_TAUR_PRESENTING_ORAL = new SexSlot(
			"Presenting for oral",
			"presenting for oral",
            "With trembling [npc.legs], [npc.name] push [npc.her] groin back against [npc2.namePos] face, and with [npc.a_moan+], [npc.she] prepare to reach [npc.her] climax.",
			false,
