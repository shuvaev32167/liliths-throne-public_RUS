...
public class ClitClit {
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "With a slow thrust of [npc.her] [npc.hips+], [npc.name] press [npc.her] [npc.clit+] against [npc2.namePos] [npc2.pussy+], before starting to rhythmically grind up and down against [npc2.her] [npc2.labia+].",
                            "With [npc.a_moan+], [npc.name] slowly press [npc.her] groin in between [npc2.namePos] [npc2.legs], before starting to grind [npc.her] [npc.clit+] up and down over [npc2.her] [npc2.pussy+]."));
					break;
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "With a rough buck of [npc.her] [npc.hips+], [npc.name] slam [npc.her] [npc.clit+] against [npc2.namePos] [npc2.pussy+], before starting to forcefully grind up and down against [npc2.her] [npc2.labia+].",
                            "With [npc.a_moan+], [npc.name] roughly slam [npc.her] groin in between [npc2.namePos] [npc2.legs], before starting to forcefully grind [npc.her] [npc.clit+] up and down over [npc2.her] [npc2.pussy+]."));
					break;
				case DOM_NORMAL:
				case SUB_EAGER:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "With an eager thrust of [npc.her] [npc.hips+], [npc.name] bump [npc.her] [npc.clit+] against [npc2.namePos] [npc2.pussy+], before starting to enthusiastically grind up and down against [npc2.her] [npc2.labia+].",
                            "With [npc.a_moan+], [npc.name] eagerly press [npc.her] groin in between [npc2.namePos] [npc2.legs], before starting to frantically grind [npc.her] [npc.clit+] up and down over [npc2.her] [npc2.pussy+]."));
					break;
				case SUB_NORMAL:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "With a thrust of [npc.her] [npc.hips+], [npc.name] bump [npc.her] [npc.clit+] against [npc2.namePos] [npc2.pussy+], before starting to grind up and down against [npc2.her] [npc2.labia+].",
                            "With [npc.a_moan+], [npc.name] press [npc.her] groin in between [npc2.namePos] [npc2.legs], before starting to grind [npc.her] [npc.clit+] up and down over [npc2.her] [npc2.pussy+]."));
					break;
				case SUB_RESISTING:
					break;
			}
					...
					case SUB_NORMAL:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								" Bucking [npc2.her] own [npc2.hips] in response,"
                                        + " [npc2.name] [npc2.verb(let)] out [npc2.a_moan+] as [npc2.she] [npc2.verb(mirror)] the movements of [npc.name] и [npc2.verb(rub)] [npc2.her] [npc2.clit+] against [npc.her] [npc.pussy+].",
	...
	public static final SexAction TRIBBING_DOM_GENTLE = new SexAction(
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                    "Letting out a little [npc.moan] with every thrust of [npc.her] [npc.hips], [npc.name] gently rub [npc.her] [npc.clit+] up and down over [npc2.namePos] [npc2.vagina+].",
                    "[npc.Name] let out a series of soft sighs as [npc.she] gently rub [npc.her] [npc.clit+] up and down over [npc2.namePos] [npc2.vagina+].",
                    "Sliding [npc.her] [npc.clit+] over [npc2.namePos] [npc2.vagina+], [npc.name] let out a little [npc.moan] with each pump of [npc.her] [npc.hips]."));
	...
	public static final SexAction TRIBBING_DOM_NORMAL = new SexAction(
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                    "Letting out [npc.a_moan+] with each eager thrust of [npc.her] [npc.hips], [npc.name] passionately rub [npc.her] [npc.clit+] up and down over [npc2.namePos] [npc2.vagina+].",
                    "[npc.Name] let out a series of lewd [npc.moans] as [npc.she] desperately grind [npc.her] [npc.clit+] up and down over [npc2.namePos] [npc2.vagina+].",
                    "Eagerly grinding [npc.her] [npc.clit+] over [npc2.namePos] [npc2.vagina+], [npc.name] let out [npc.a_moan+] with each frantic pump of [npc.her] [npc.hips]."));
	...
	public static final SexAction TRIBBING_DOM_ROUGH = new SexAction(
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                    "Letting out [npc.a_moan+] with each forceful thrust of [npc.her] [npc.hips], [npc.name] roughly grind [npc.her] [npc.clit+] up and down over [npc2.namePos] [npc2.vagina+].",
                    "[npc.Name] let out a series of lewd [npc.moans] as [npc.she] roughly grind [npc.her] [npc.clit+] up and down over [npc2.namePos] [npc2.vagina+].",
                    "Violently grinding [npc.her] [npc.clit+] over [npc2.namePos] [npc2.vagina+], [npc.name] let out [npc.a_moan+] with each forceful pump of [npc.her] [npc.hips]."));
	...
	public static final SexAction TRIBBING_SUB_NORMAL = new SexAction(
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                    "Letting out [npc.a_moan+] with each thrust of [npc.her] [npc.hips], [npc.name] continue to rub [npc.her] [npc.clit+] up and down over [npc2.namePos] [npc2.vagina+].",
                    "[npc.Name] let out a series of lewd [npc.moans] as [npc.she] rub [npc.her] [npc.clit+] up and down over [npc2.namePos] [npc2.vagina+].",
                    "Rubbing [npc.her] [npc.clit+] over [npc2.namePos] [npc2.vagina+], [npc.name] let out [npc.a_moan+] with each pump of [npc.her] [npc.hips]."));
		...
		public String getDescription() {
			...
			if(!isTargetedCharacterInanimate()) {
				switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(this))) {
					case DOM_GENTLE:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                "[npc.Name] try to pull [npc.her] groin away from [npc2.nameHers],"
                                ...
                                "With [npc.a_sob+], [npc.name] try to pull [npc.her] [npc.pussy] away from [npc2.nameHers],"
                                ...
                                "Tears start to well up in [npc.namePos] [npc.eyes], and with [npc.a_sob+], [npc.she] try to pull [npc.her] [npc.pussy] away from [npc2.nameHers],"
	...
	public static final SexAction TRIBBING_STOP = new SexAction(
		...
		public String getDescription() {
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "With one last rough thrust, [npc.name] pull [npc.her] groin away from [npc2.namePos] [npc2.pussy+], putting an end to the tribbing.",
                            "Roughly grinding [npc.her] [npc.clit+] over [npc2.namePos] [npc2.pussy] one last time, [npc.name] then pull back, putting an end to the rough tribbing."));
					break;
				default:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "With one last buck of [npc.her] [npc.hips], [npc.name] pull [npc.her] groin away from [npc2.namePos] [npc2.pussy+], putting an end to the tribbing.",
                            "Rubbing [npc.her] [npc.clit+] over [npc2.namePos] [npc2.pussy] one last time, [npc.name] then pull back, putting an end to the tribbing."));
					break;
			}
			...
			if(!isTargetedCharacterInanimate()) {
				switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(this))) {
					...
					default:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                " [npc2.Name] [npc2.verb(let)] out [npc2.a_moan+] as [npc.name] pull back, signalling [npc2.her] desire for more attention.",
	...
	public static final SexAction PUSSY_CONTROL = new SexAction(
		...
		public String getDescription() {
			return UtilText.returnStringAtRandom(
                    "Letting out [npc.a_moan+], [npc.name] concentrate on using the prehensility of [npc.her] [npc.clit] to rub at [npc2.namePos] [npc2.pussy+], before moving up to massage and squeeze down on [npc2.her] own [npc2.clit+].",
					isTargetedCharacterInanimate()
						?null
                            : "[npc.Name] let out [npc.a_moan+] as [npc.she] focus on controlling [npc.her] prehensile [npc.clit]."
                            + " Rubbing and stroking [npc2.namePos] [npc2.labia+], [npc.name] grin as [npc.she] then move up to massage [npc2.her] own [npc2.clit+], causing [npc2.herHim] to let out [npc2.a_moan+].",
                    "[npc.Name] grin in delight as [npc.she] use [npc.her] prehensile clit to massage and stroke [npc2.namePos] [npc2.labia+], before moving up to squeeze and rub at [npc2.her] own [npc2.clit+].",
                    "With [npc.a_moan+], [npc.name] focus on controlling [npc.her] prehensile [npc.clit], pressing down and massaging [npc2.namePos] [npc2.labia+], before moving up to rub at [npc2.her] [npc2.clit+].");
		}
	};
}
