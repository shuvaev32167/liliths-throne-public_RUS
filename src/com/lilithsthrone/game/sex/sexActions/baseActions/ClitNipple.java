...
public class ClitNipple {
		...
		public String getDescription() {
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Guiding [npc.her] [npc.clit+] up to [npc2.namePos] [npc2.breasts+],"
                                    + " [npc.name] start slowly teasing the [npc.clitTip+] up and down over ones of [npc2.her] [npc2.nipples+], ready to penetrate [npc2.herHim] at any moment.",

                            "With a soft [npc.moan], [npc.name] guide [npc.her] [npc.clit+] up to [npc2.namePos] [npc2.breasts+],"
				...
				case SUB_EAGER:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Guiding [npc.her] [npc.clit+] up to [npc2.namePos] [npc2.breasts+],"
                                    + " [npc.name] start eagerly sliding the [npc.clitTip+] up and down over one of [npc2.her] [npc2.nipples+], ready to penetrate [npc2.herHim] at any moment.",

                            "With [npc.a_moan+], [npc.name] guide [npc.her] [npc.clit+] up to [npc2.namePos] [npc2.breasts+],"
				...
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Grinding [npc.her] [npc.clit+] up against [npc2.namePos] [npc2.breasts+],"
                                    + " [npc.name] pull back a little before starting to slide the [npc.clitTip+] up and down over one of [npc2.her] [npc2.nipples+], ready to start fucking [npc2.herHim] at any moment.",

                            "With [npc.a_moan+], [npc.name] line [npc.her] [npc.clit+] up to [npc2.namePos] [npc2.breasts+],"
				...
				case SUB_NORMAL:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Guiding [npc.her] [npc.clit+] up to [npc2.namePos] [npc2.breasts+],"
                                    + " [npc.name] start sliding the [npc.clitTip+] up and down over one of [npc2.her] [npc2.nipples+], ready to penetrate [npc2.herHim] at any moment.",

                            "With [npc.a_moan+], [npc.name] guide [npc.her] [npc.clit+] up to [npc2.namePos] [npc2.breasts+], before starting to slide the [npc.clitTip] up and down over one of [npc2.her] [npc2.nipples+].",
	...
	public static final SexAction FORCE_CLIT_OVER_NIPPLE = new SexAction(
		...
		public String getDescription() {
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "[npc.Name] grab [npc2.namePos] [npc2.clit+], before guiding it up to [npc.her] [npc.breasts+]."
                                    + " Slowly pushing the [npc2.clitTip+] up and down over [npc.her] [npc.nipple+], [npc.she] tease [npc2.name] with the promise of penetration at any moment.",

                            "With a soft [npc.moan], [npc.name] grab [npc2.namePos] [npc2.clit+] и guide it up to [npc.her] [npc.breasts+],"
									+ " before starting to gently slide the [npc2.clitTip] up and down over [npc.her] [npc.nipple+].",

                            "Grabbing [npc2.namePos] [npc2.clit+], [npc.name] gently slide the [npc2.clitTip+] over [npc.her] [npc.nipple+],"
				...
				case SUB_EAGER:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "[npc.Name] grab [npc2.namePos] [npc2.clit+], before guiding it up to [npc.her] [npc.breasts+]."
                                    + " Eagerly pushing the [npc2.clitTip+] up and down over [npc.her] [npc.nipple+], [npc.she] tease [npc2.name] with the promise of penetration at any moment.",

                            "With [npc.a_moan+], [npc.name] grab [npc2.namePos] [npc2.clit+] и guide it up to [npc.her] [npc.breasts+],"
									+ " before starting to eagerly slide the [npc2.clitTip] up and down over [npc.her] [npc.nipple+].",

                            "Grabbing [npc2.namePos] [npc2.clit+], [npc.name] eagerly slide the [npc2.clitTip+] over [npc.her] [npc.nipple+],"
                                    + " letting out [npc.a_moan+] as [npc.she] tease [npc2.herHim] with the promise of penetration."));
					break;
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "[npc.Name] grab [npc2.namePos] [npc2.clit+], before yanking it up to [npc.her] [npc.breasts+]."
                                    + " Roughly forcing the [npc2.clitTip+] up and down over [npc.her] [npc.nipple+], [npc.she] tease [npc2.name] with the promise of penetration at any moment.",

                            "With [npc.a_moan+], [npc.name] grab [npc2.namePos] [npc2.clit+] and yank it up to [npc.her] [npc.breasts+],"
                                    + " before starting to roughly force the [npc2.clitTip] up and down over [npc.her] [npc.nipple+].",

                            "Grabbing [npc2.namePos] [npc2.clit+], [npc.name] roughly grind the [npc2.clitTip+] over [npc.her] [npc.nipple+],"
                                    + " letting out [npc.a_moan+] as [npc.she] tease [npc2.herHim] with the promise of penetration."));
					break;
				case SUB_NORMAL:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "[npc.Name] grab [npc2.namePos] [npc2.clit+], before guiding it up to [npc.her] [npc.breasts+]."
                                    + " Pushing the [npc2.clitTip+] up and down over [npc.her] [npc.nipple+], [npc.she] tease [npc2.name] with the promise of penetration at any moment.",

                            "With [npc.a_moan+], [npc.name] grab [npc2.namePos] [npc2.clit+] и guide it up to [npc.her] [npc.breasts+],"
									+ " before starting to slide the [npc2.clitTip] up and down over [npc.her] [npc.nipple+].",

                            "Grabbing [npc2.namePos] [npc2.clit+], [npc.name] slide the [npc2.clitTip+] over [npc.her] [npc.nipple+],"
                                    + " letting out [npc.a_moan+] as [npc.she] tease [npc2.herHim] with the promise of penetration."));
					break;
				default:
					break;
				...
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Slowly teasing the [npc.clitTip+] of [npc.her] [npc.clit] over [npc2.namePos] [npc2.breasts+],"
                                    + " [npc.name] let out a little [npc.moan] before slowly pushing forwards, sinking [npc.her] [npc.clit+] into [npc2.her] [npc2.nipple+].",

                            "[npc.Name] position the [npc.clitTip+] of [npc.her] [npc.clit] over [npc2.namePos] [npc2.breasts+],"
				...
				case DOM_NORMAL:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Eagerly teasing the [npc.clitTip+] of [npc.her] [npc.clit] over [npc2.namePos] [npc2.breasts+],"
                                    + " [npc.name] let out [npc.a_moan+] before thrusting forwards, greedily sinking [npc.her] [npc.clit+] into [npc2.her] [npc2.nipple+].",
				...
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Roughly grinding the [npc.clitTip+] of [npc.her] [npc.clit] over [npc2.namePos] [npc2.breasts+],"
                                    + " [npc.name] let out [npc.a_moan+] before violently slamming forwards, forcing [npc.her] [npc.clit+] deep into [npc2.her] [npc2.nipple+].",
				...
				case SUB_NORMAL:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Teasing the [npc.clitTip+] of [npc.her] [npc.clit] over [npc2.namePos] [npc2.breasts+],"
                                    + " [npc.name] let out [npc.a_moan+] before thrusting forwards, sinking [npc.her] [npc.clit+] into [npc2.her] [npc2.nipple+].",
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
					"Gently sinking [npc.her] [npc.clit+] deep into [npc2.namePos] [npc2.nipple+],"
                            + " [npc.name] start rocking [npc.her] [npc.hips] back and forth, letting out a little [npc.moan] with every thrust as [npc.she] slowly fuck [npc2.her] [npc2.breasts].",

					"Slowly pushing [npc.her] [npc.clit+] into [npc2.namePos] [npc2.nipple+],"
                            + " [npc.name] softly thrust [npc.her] [npc.hips] forwards, letting out a little [npc.moan] as [npc.she] gently fuck [npc2.her] [npc2.breasts].",

                    "Sliding [npc.her] [npc.clit+] into [npc2.namePos] [npc2.nipple+], [npc.name] let out a little [npc.moan] as [npc.she] start to gently pump [npc.her] [npc.hips] back and forth,"
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
					"Eagerly sinking [npc.her] [npc.clit+] deep into [npc2.namePos] [npc2.nipple+],"
                            + " [npc.name] start enthusiastically rocking [npc.her] [npc.hips] back and forth, letting out [npc.a_moan+] with every thrust as [npc.she] happily fuck [npc2.her] [npc2.breasts].",

					"Enthusiastically pushing [npc.her] [npc.clit+] deep into [npc2.namePos] [npc2.nipple+],"
                            + " [npc.name] frantically thrust [npc.her] [npc.hips] forwards, letting out [npc.a_moan+] as [npc.she] greedily fuck [npc2.her] [npc2.breasts].",

                    "Thrusting [npc.her] [npc.clit+] deep into [npc2.namePos] [npc2.nipple+], [npc.name] let out [npc.a_moan+] as [npc.she] start to eagerly pump [npc.her] [npc.hips] back and forth,"
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
					"Roughly slamming [npc.her] [npc.clit+] deep into [npc2.namePos] [npc2.nipple+],"
                            + " [npc.name] start roughly slamming [npc.her] [npc.hips] back and forth, letting out [npc.a_moan+] with every thrust as [npc.she] brutally fuck [npc2.her] [npc2.breasts].",

					"Violently thrusting [npc.her] [npc.clit+] deep into [npc2.namePos] [npc2.nipple+],"
                            + " [npc.name] start roughly slamming [npc.her] [npc.hips] forwards, letting out [npc.a_moan+] as [npc.she] forcefully fuck [npc2.her] [npc2.breasts].",

                    "Forcefully driving [npc.her] [npc.clit+] deep into [npc2.namePos] [npc2.nipple+], [npc.name] let out [npc.a_moan+] as [npc.she] start to roughly slam [npc.her] [npc.hips] back and forth,"
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
					"Sinking [npc.her] [npc.clit+] deep into [npc2.namePos] [npc2.nipple+],"
                            + " [npc.name] start rocking [npc.her] [npc.hips] back and forth, letting out [npc.a_moan+] with every thrust as [npc.she] happily fuck [npc2.her] [npc2.breasts].",

					"Pushing [npc.her] [npc.clit+] deep into [npc2.namePos] [npc2.nipple+],"
                            + " [npc.name] start thrusting [npc.her] [npc.hips] forwards, letting out [npc.a_moan+] as [npc.she] eagerly fuck [npc2.her] [npc2.breasts].",

                    "Thrusting [npc.her] [npc.clit+] deep into [npc2.namePos] [npc2.nipple+], [npc.name] let out [npc.a_moan+] as [npc.she] start to pump [npc.her] [npc.hips] back and forth,"
	...
	public static final SexAction CLIT_FUCKING_SUB_EAGER = new SexAction(
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
					"Eagerly sinking [npc.her] [npc.clit+] deep into [npc2.namePos] [npc2.nipple+],"
                            + " [npc.name] start enthusiastically rocking [npc.her] [npc.hips] back and forth, letting out [npc.a_moan+] with every thrust as [npc.she] happily fuck [npc2.namePos] [npc2.breasts].",
		...
		public String getDescription() {
			...
			if(!isTargetedCharacterInanimate()) {
				switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(this))) {
					case DOM_GENTLE:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                "[npc.Name] try to pull [npc.her] [npc.clit] out of [npc2.namePos] [npc2.nipple(true)],"
                                ...
                                "With [npc.a_sob+], [npc.name] try to pull [npc.her] [npc.clit] away from [npc2.name], but [npc2.she] quickly [npc2.verb(grab)] it, before gently forcing it back inside [npc2.her] [npc2.nipple+].",

                                "Tears start to well up in [npc.namePos] [npc.eyes], and with [npc.a_sob+], [npc.she] try to pull [npc.her] [npc.clit] away from [npc2.namePos] [npc2.nipple+],"
					...
					case DOM_ROUGH:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                ...
                                "With [npc.a_sob+], [npc.name] try to pull [npc.her] [npc.clit] away from [npc2.name], but [npc2.she] quickly [npc2.verb(grab)] it, before roughly forcing it back inside [npc2.her] [npc2.nipple+].",
					...
					default: // DOM_NORMAL and in case anything goes wrong:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                ...
                                "With [npc.a_sob+], [npc.name] try to pull [npc.her] [npc.clit] away from [npc2.name], but [npc2.she] quickly [npc2.verb(grab)] it, before eagerly forcing it back inside [npc2.her] [npc2.nipple+].",
				...
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                        ...
                        "With [npc.a_sob+], [npc.name] try to pull [npc.her] [npc.clit] away from [npc2.name], but [npc2.she] quickly [npc2.verb(move)] forwards, keeping it thrust inside [npc2.her] [npc2.nipple+].",
		...
		public String getDescription() {
				...
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Roughly yanking [npc.her] [npc.clit+] out of [npc2.namePos] [npc2.nipple+],"
                                    + " [npc.name] dominantly slide the [npc.clitTip+] up and down over one of [npc2.her] [npc2.breasts+] one last time before pulling back.",

                            "Thrusting deep inside of [npc2.name] one last time, [npc.name] then yank [npc.her] [npc.clit+] back out of [npc2.her] [npc2.nipple+], putting an end to the rough fucking."));
					break;
				default:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Sliding [npc.her] [npc.clit] out of [npc2.namePos] [npc2.nipple+], [npc.name] rub the [npc.clitTip] up and down over one of [npc2.her] [npc2.breasts+] one last time before pulling back.",

                            "Pushing deep inside of [npc2.name] one last time, [npc.name] then slide [npc.her] [npc.clit+] back out of [npc2.her] [npc2.nipple+], putting an end to the fucking."));
					break;
			}
			...
			if(!isTargetedCharacterInanimate()) {
				switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(this))) {
					...
					default:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                " [npc2.Name] [npc2.verb(let)] out [npc2.a_moan+] as [npc.name] pull [npc.her] [npc.clit+] out of [npc2.her] [npc2.nipple+], eager for more of [npc.her] attention.",
	...
	public static final SexAction USING_CLIT_START = new SexAction(
		...
		public String getDescription() {
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Grabbing [npc2.namePos] [npc2.clit], [npc.name] slowly guide it up to [npc.her] [npc.breasts+],"
                            ...
                            "Grabbing [npc2.namePos] [npc2.clit], [npc.name] line it up to [npc.her] [npc.nipple+],"
                                    + " before slowly pushing [npc.her] [npc.breasts] forwards and letting out a soft [npc.moan] as [npc.she] penetrate [npc.herself] on [npc2.her] [npc2.clit+]."));
					break;
				case DOM_NORMAL:
				case SUB_EAGER:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Grabbing [npc2.namePos] [npc2.clit], [npc.name] eagerly guide it up to [npc.her] [npc.breasts+],"
                            ...
                            "Grabbing [npc2.namePos] [npc2.clit], [npc.name] line it up to [npc.her] [npc.nipple+],"
                                    + " before eagerly pushing [npc.her] [npc.breasts] forwards and letting out [npc.a_moan+] as [npc.she] penetrate [npc.herself] on [npc2.her] [npc2.clit+]."));
					break;
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            ...
                            "Grabbing [npc2.namePos] [npc2.clit], [npc.name] line it up to [npc.her] [npc.nipple+],"
                                    + " before dominantly pushing [npc.her] [npc.breasts] forwards and letting out [npc.a_moan+] as [npc.she] penetrate [npc.herself] on [npc2.her] [npc2.clit+]."));
					break;
				case SUB_NORMAL:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Grabbing [npc2.namePos] [npc2.clit], [npc.name] guide it up to [npc.her] [npc.breasts+],"
									+ " letting out [npc.a_moan+] before pushing out [npc.her] chest and forcing [npc2.herHim] to penetrate [npc.her] [npc.nipple+].",

                            "Grabbing [npc2.namePos] [npc2.clit], [npc.name] line it up to [npc.her] [npc.nipple+],"
                                    + " before pushing [npc.her] [npc.breasts] forwards and letting out [npc.a_moan+] as [npc.she] penetrate [npc.herself] on [npc2.her] [npc2.clit+]."));
					break;
				default:
					break;
			}
				...
				switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(this))) {
					...
					case SUB_RESISTING:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                ...
                                " With [npc2.a_sob+], [npc2.name] [npc2.verb(struggle)] against [npc.name] as [npc.she] force [npc2.her] [npc2.clit] deep into [npc.her] [npc.nipple+]."));
						break;
					default:
						break;
				}
	...
	public static final SexAction RIDING_CLIT_DOM_GENTLE = new SexAction(
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                    "With a gentle forwards thrust of [npc.her] chest, [npc.name] let out a soft [npc.moan] as [npc.she] help to sink [npc2.namePos] [npc2.clit+] deep into [npc.her] [npc.nipple+].",

                    "With a soft [npc.moan], [npc.name] gently push [npc.her] chest forwards, forcing [npc2.namePos] [npc2.clit+] ever deeper into [npc.her] [npc.nipple+].",
	...
	public static final SexAction RIDING_CLIT_DOM_NORMAL = new SexAction(
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                    "With an eager forwards thrust of [npc.her] chest, [npc.name] let out [npc.a_moan+] as [npc.she] help to sink [npc2.namePos] [npc2.clit+] deep into [npc.her] [npc.nipple+].",

                    "With [npc.a_moan+], [npc.name] enthusiastically push [npc.her] chest forwards, forcing [npc2.namePos] [npc2.clit+] ever deeper into [npc.her] [npc.nipple+].",
	...
	public static final SexAction RIDING_CLIT_DOM_ROUGH = new SexAction(
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                    "With a violent forwards thrust of [npc.her] chest, [npc.name] let out [npc.a_moan+] as [npc.she] force [npc2.namePos] [npc2.clit+] deep into [npc.her] [npc.nipple+].",

                    "With [npc.a_moan+], [npc.name] roughly thrust [npc.her] chest forwards, forcing [npc2.namePos] [npc2.clit+] ever deeper into [npc.her] [npc.nipple+].",
	...
	public static final SexAction RIDING_CLIT_SUB_NORMAL = new SexAction(
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                    "With a quick forwards thrust of [npc.her] chest, [npc.name] let out [npc.a_moan+] as [npc.she] help to sink [npc2.namePos] [npc2.clit+] deep into [npc.her] [npc.nipple+].",

                    "With [npc.a_moan+], [npc.name] push [npc.her] chest forwards, forcing [npc2.namePos] [npc2.clit+] ever deeper into [npc.her] [npc.nipple+].",
	...
	public static final SexAction FUCKED_STOP = new SexAction(
		...
		public String getDescription() {
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Yanking [npc2.namePos] [npc2.clit] out of [npc.her] [npc.nipple+], [npc.name] let out a menacing growl as [npc.she] command [npc2.name] to stop fucking [npc.herHim].",

                            "[npc.Name] lean into [npc2.name], inhaling [npc2.her] [npc2.scent] before yanking [npc2.her] [npc2.clit] out of [npc.her] [npc.nipple+]."));
					break;
				default:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Sliding [npc2.namePos] [npc2.clit] out of [npc.her] [npc.nipple+], [npc.name] let out [npc.a_moan+] as [npc.she] tell [npc2.name] to stop fucking [npc.herHim].",

                            "[npc.Name] lean into [npc2.name], inhaling [npc2.her] [npc2.scent] before sliding [npc2.her] [npc2.clit] out of [npc.her] [npc.nipple+]."));
					break;
			}
	...
	public static final SexAction NIPPLE_CONTROL = new SexAction(
		...
		public String getDescription() {
			return UtilText.returnStringAtRandom(
                    "Letting out [npc.a_moan+], [npc.name] concentrate on squeezing the extra internal muscles within [npc.her] [npc.nipple(true)] down around [npc2.namePos] [npc2.clit+].",
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(action))) {
				...
				case SUB_RESISTING:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							...
							" [npc2.A_sob+] bursts out from between [npc2.namePos] [npc2.lips] as [npc2.she] weakly [npc2.verb(try)] to push [npc.name] away,"
                                    + " squirming and protesting as [npc.name] continue to force [npc2.her] [npc2.clit+] deep into [npc.her] [npc.nipple+].",
