...
public class PenisAnus {
			...
			if(!getOngoingCharacters(Main.sex.getCharacterTargetedForSexAction(this)).isEmpty()) {
				switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
					case DOM_GENTLE:
						UtilText.nodeContentSB.append(UtilText.parse(Util.newArrayListOfValues(Main.sex.getCharacterPerformingAction(), Main.sex.getCharacterTargetedForSexAction(this), getPrimaryDPPerformer(Main.sex.getCharacterTargetedForSexAction(this))),
								...
								"Not deterred by the fact that [npc3.namePos] [npc3.cock] is already deep in [npc2.namePos] [npc2.asshole+],"
                                        + " [npc.name] start slowly teasing the [npc.cockTip+] of [npc.her] own [npc.cock+] up against [npc2.her] [npc2.assCloaca+], threatening to start double-penetrating [npc.herHim] at any moment.",
                                        "With a soft [npc.moan], [npc.name] gently guide the [npc.cockTip+] of [npc.her] [npc.cock] over the exposed parts of [npc2.namePos] [npc2.assCloaca+],"
					...
					case DOM_ROUGH:
						UtilText.nodeContentSB.append(UtilText.parse(Util.newArrayListOfValues(Main.sex.getCharacterPerformingAction(), Main.sex.getCharacterTargetedForSexAction(this), getPrimaryDPPerformer(Main.sex.getCharacterTargetedForSexAction(this))),
								UtilText.returnStringAtRandom(
								"Not deterred by the fact that [npc3.namePos] [npc3.cock] is already deep in [npc2.namePos] [npc2.asshole+],"
                                        + " [npc.name] start roughly grinding the [npc.cockTip+] of [npc.her] own [npc.cock+] up against [npc2.her] [npc2.assCloaca+], threatening to start double-penetrating [npc.herHim] at any moment.",
                                        "With [npc.a_moan+], [npc.name] forcefully rub the [npc.cockTip+] of [npc.her] [npc.cock] over the exposed parts of [npc2.namePos] [npc2.assCloaca+],"
										+ " indicating that [npc.she] might join [npc3.name] and start double-penetrating [npc2.her] [npc2.asshole+].",
					...
					case SUB_NORMAL:
						UtilText.nodeContentSB.append(UtilText.parse(Util.newArrayListOfValues(Main.sex.getCharacterPerformingAction(), Main.sex.getCharacterTargetedForSexAction(this), getPrimaryDPPerformer(Main.sex.getCharacterTargetedForSexAction(this))),
								UtilText.returnStringAtRandom(
								"Not deterred by the fact that [npc3.namePos] [npc3.cock] is already deep in [npc2.namePos] [npc2.asshole+],"
                                        + " [npc.name] start grinding the [npc.cockTip+] of [npc.her] own [npc.cock+] up against [npc2.her] [npc2.assCloaca+], threatening to start double-penetrating [npc.herHim] at any moment.",
                                        "With [npc.a_moan+], [npc.name] rub the [npc.cockTip+] of [npc.her] [npc.cock] over the exposed parts of [npc2.namePos] [npc2.assCloaca+],"
										+ " indicating that [npc.she] might join [npc3.name] and start double-penetrating [npc2.her] [npc2.asshole+].",
					...
					default:
						UtilText.nodeContentSB.append(UtilText.parse(Util.newArrayListOfValues(Main.sex.getCharacterPerformingAction(), Main.sex.getCharacterTargetedForSexAction(this), getPrimaryDPPerformer(Main.sex.getCharacterTargetedForSexAction(this))),
								UtilText.returnStringAtRandom(
								"Not deterred by the fact that [npc3.namePos] [npc3.cock] is already deep in [npc2.namePos] [npc2.asshole+],"
                                        + " [npc.name] start eagerly grinding the [npc.cockTip+] of [npc.her] own [npc.cock+] up against [npc2.her] [npc2.assCloaca+], threatening to start double-penetrating [npc.herHim] at any moment.",
                                        "With [npc.a_moan+], [npc.name] enthusiastically rub the [npc.cockTip+] of [npc.her] [npc.cock] over the exposed parts of [npc2.namePos] [npc2.assCloaca+],"
										+ " indicating that [npc.she] might join [npc3.name] and start double-penetrating [npc2.her] [npc2.asshole+].",
				...
				switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
					case DOM_GENTLE:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								"Guiding [npc.her] [npc.cock+] up to [npc2.namePos] [npc2.asshole+],"
                                        + " [npc.name] start slowly teasing the [npc.cockTip+] up and down over [npc2.her] [npc2.assCloaca+], ready to penetrate [npc2.herHim] at any moment.",
                                "With a soft [npc.moan], [npc.name] guide [npc.her] [npc.cock+] up to [npc2.namePos] [npc2.asshole+], before starting to gently slide the [npc.cockTip] up and down over [npc2.her] [npc2.assCloaca+].",
					...
					case DOM_ROUGH:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								"Grinding [npc.her] [npc.cock+] up against [npc2.namePos] [npc2.asshole+],"
                                        + " [npc.name] pull back a little before starting to slide the [npc.cockTip+] up and down over [npc2.her] [npc2.assCloaca+], ready to start fucking [npc2.herHim] at any moment.",
                                "With [npc.a_moan+], [npc.name] line [npc.her] [npc.cock+] up to [npc2.namePos] [npc2.asshole+],"
					...
					case SUB_NORMAL:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								"Guiding [npc.her] [npc.cock+] up to [npc2.namePos] [npc2.asshole+],"
                                        + " [npc.name] start sliding the [npc.cockTip+] up and down over [npc2.her] [npc2.assCloaca+], ready to penetrate [npc2.herHim] at any moment.",
                                "With [npc.a_moan+], [npc.name] guide [npc.her] [npc.cock+] up to [npc2.namePos] [npc2.asshole+], before starting to slide the [npc.cockTip] up and down over [npc2.her] [npc2.assCloaca+].",
					...
					default:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								"Guiding [npc.her] [npc.cock+] up to [npc2.namePos] [npc2.asshole+],"
                                        + " [npc.name] start eagerly sliding the [npc.cockTip+] up and down over [npc2.her] [npc2.assCloaca+], ready to penetrate [npc2.herHim] at any moment.",
                                "With [npc.a_moan+], [npc.name] guide [npc.her] [npc.cock+] up to [npc2.namePos] [npc2.asshole+], before starting to eagerly slide the [npc.cockTip] up and down over [npc2.her] [npc2.assCloaca+].",
		...
		public String getDescription() {
			...
			if(!getOngoingCharacters(Main.sex.getCharacterPerformingAction()).isEmpty()) {
					...
					case DOM_GENTLE:
						UtilText.nodeContentSB.append(UtilText.parse(Util.newArrayListOfValues(Main.sex.getCharacterPerformingAction(), Main.sex.getCharacterTargetedForSexAction(this), getPrimaryDPPerformer(Main.sex.getCharacterTargetedForSexAction(this))),
								...
								"Wanting more than just [npc3.namePos] [npc3.cock+] stuffed in [npc.her] [npc.asshole+],"
                                        + " [npc.name] gently take hold of [npc2.namePos] [npc2.cock+], before starting to slide the [npc2.cockTip] up and down over an exposed part of [npc.her] [npc.assCloaca+].",
								"With [npc3.namePos] [npc3.cock+] still thrusting in and out of [npc.her] [npc.asshole+],"
                                        + " [npc.name] grab [npc2.namePos] [npc2.cock+], before gently sliding the [npc2.cockTip+] over an exposed part of [npc.her] [npc.assCloaca+].")));
						break;
					case DOM_ROUGH:
						UtilText.nodeContentSB.append(UtilText.parse(Util.newArrayListOfValues(Main.sex.getCharacterPerformingAction(), Main.sex.getCharacterTargetedForSexAction(this), getPrimaryDPPerformer(Main.sex.getCharacterTargetedForSexAction(this))),
								UtilText.returnStringAtRandom(
								...
								"Wanting more than just [npc3.namePos] [npc3.cock+] stuffed in [npc.her] [npc.asshole+],"
                                        + " [npc.name] roughly seize hold of [npc2.namePos] [npc2.cock+], before starting to forcefully rub the [npc2.cockTip] up and down over an exposed part of [npc.her] [npc.assCloaca+].",
								"With [npc3.namePos] [npc3.cock+] still thrusting in and out of [npc.her] [npc.asshole+],"
                                        + " [npc.name] forcefully grab [npc2.namePos] [npc2.cock+], before roughly rubbing the [npc2.cockTip+] over an exposed part of [npc.her] [npc.assCloaca+].")));
						break;
					case SUB_NORMAL:
						UtilText.nodeContentSB.append(UtilText.parse(Util.newArrayListOfValues(Main.sex.getCharacterPerformingAction(), Main.sex.getCharacterTargetedForSexAction(this), getPrimaryDPPerformer(Main.sex.getCharacterTargetedForSexAction(this))),
								UtilText.returnStringAtRandom(
								...
								"Wanting more than just [npc3.namePos] [npc3.cock+] stuffed in [npc.her] [npc.asshole+],"
                                        + " [npc.name] take hold of [npc2.namePos] [npc2.cock+], before starting to rub the [npc2.cockTip] up and down over an exposed part of [npc.her] [npc.assCloaca+].",
								"With [npc3.namePos] [npc3.cock+] still thrusting in and out of [npc.her] [npc.asshole+],"
                                        + " [npc.name] grab [npc2.namePos] [npc2.cock+], before rubbing the [npc2.cockTip+] over an exposed part of [npc.her] [npc.assCloaca+].")));
						break;
					default:
						UtilText.nodeContentSB.append(UtilText.parse(Util.newArrayListOfValues(Main.sex.getCharacterPerformingAction(), Main.sex.getCharacterTargetedForSexAction(this), getPrimaryDPPerformer(Main.sex.getCharacterTargetedForSexAction(this))),
								UtilText.returnStringAtRandom(
								...
								"Wanting more than just [npc3.namePos] [npc3.cock+] stuffed in [npc.her] [npc.asshole+],"
                                        + " [npc.name] desperately seize hold of [npc2.namePos] [npc2.cock+], before starting to energetically rub the [npc2.cockTip] up and down over an exposed part of [npc.her] [npc.assCloaca+].",
								"With [npc3.namePos] [npc3.cock+] still thrusting in and out of [npc.her] [npc.asshole+],"
                                        + " [npc.name] eagerly grab [npc2.namePos] [npc2.cock+], before happily rubbing the [npc2.cockTip+] over an exposed part of [npc.her] [npc.assCloaca+].")));
						break;
				}
				...
				switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
					case DOM_GENTLE:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                "[npc.Name] grab [npc2.namePos] [npc2.cock+], before guiding it up to [npc.her] [npc.asshole+]."
                                        + " Slowly pushing the [npc2.cockTip+] up and down over [npc.her] [npc.assCloaca+], [npc.she] tease [npc2.name] with the promise of penetration at any moment.",
                                "With a soft [npc.moan], [npc.name] grab [npc2.namePos] [npc2.cock+] и guide it up to [npc.her] [npc.asshole+],"
										+ " before starting to gently slide the [npc2.cockTip] up and down over [npc.her] [npc.assCloaca+].",
                                "Grabbing [npc2.namePos] [npc2.cock+], [npc.name] gently slide the [npc2.cockTip+] over [npc.her] [npc.asshole+],"
                                        + " letting out a soft [npc.moan] as [npc.she] tease [npc2.herHim] with the promise of penetration."));
						break;
					case DOM_ROUGH:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                "[npc.Name] grab [npc2.namePos] [npc2.cock+], before yanking it up to [npc.her] [npc.asshole+]."
                                        + " Roughly forcing the [npc2.cockTip+] up and down over [npc.her] [npc.assCloaca+], [npc.she] tease [npc2.name] with the promise of penetration at any moment.",
                                "With [npc.a_moan+], [npc.name] grab [npc2.namePos] [npc2.cock+] and yank it up to [npc.her] [npc.asshole+],"
                                        + " before starting to roughly force the [npc2.cockTip] up and down over [npc.her] [npc.assCloaca+].",
                                "Grabbing [npc2.namePos] [npc2.cock+], [npc.name] roughly grind the [npc2.cockTip+] over [npc.her] [npc.asshole+],"
                                        + " letting out [npc.a_moan+] as [npc.she] tease [npc2.herHim] with the promise of penetration."));
						break;
					case SUB_NORMAL:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                "[npc.Name] grab [npc2.namePos] [npc2.cock+], before guiding it up to [npc.her] [npc.asshole+]."
                                        + " Pushing the [npc2.cockTip+] up and down over [npc.her] [npc.assCloaca+], [npc.she] tease [npc2.name] with the promise of penetration at any moment.",
                                "With [npc.a_moan+], [npc.name] grab [npc2.namePos] [npc2.cock+] и guide it up to [npc.her] [npc.asshole+],"
										+ " before starting to slide the [npc2.cockTip] up and down over [npc.her] [npc.assCloaca+].",
                                "Grabbing [npc2.namePos] [npc2.cock+], [npc.name] slide the [npc2.cockTip+] over [npc.her] [npc.asshole+],"
                                        + " letting out [npc.a_moan+] as [npc.she] tease [npc2.herHim] with the promise of penetration."));
						break;
					default:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                "[npc.Name] grab [npc2.namePos] [npc2.cock+], before guiding it up to [npc.her] [npc.asshole+]."
                                        + " Eagerly pushing the [npc2.cockTip+] up and down over [npc.her] [npc.assCloaca+], [npc.she] tease [npc2.name] with the promise of penetration at any moment.",
                                "With [npc.a_moan+], [npc.name] grab [npc2.namePos] [npc2.cock+] и guide it up to [npc.her] [npc.asshole+],"
										+ " before starting to eagerly slide the [npc2.cockTip] up and down over [npc.her] [npc.assCloaca+].",
                                "Grabbing [npc2.namePos] [npc2.cock+], [npc.name] eagerly slide the [npc2.cockTip+] over [npc.her] [npc.asshole+],"
                                        + " letting out [npc.a_moan+] as [npc.she] tease [npc2.herHim] with the promise of penetration."));
						break;
				}
			}
		...
		public String getDescription() {
			if(PenisAnus.getOngoingCharacters(Main.sex.getCharacterPerformingAction()).size()>1) {
				return UtilText.parse(PenisAnus.getCharactersForParsing(Main.sex.getCharacterPerformingAction()), UtilText.returnStringAtRandom(
                        "Letting out [npc.a_moan+], [npc.name] concentrate on squeezing the extra internal muscles within [npc.her] [npc.asshole] down around"
						...
						(!isTargetedCharacterInanimate()
                                ? "[npc.Name] let out [npc.a_moan+] as [npc.she] focus on controlling the extra muscles lining the insides of [npc.her] [npc.asshole]."
                        ...
                        "With [npc.a_moan+], [npc.name] focus on controlling the extra muscles deep within [npc.her] [npc.asshole],"
				...
				return UtilText.returnStringAtRandom(
                        "Letting out [npc.a_moan+], [npc.name] concentrate on squeezing the extra internal muscles within [npc.her] [npc.asshole] down around [npc2.namePos] [npc2.cock+].",
						(!isTargetedCharacterInanimate()
                                ? "[npc.Name] let out [npc.a_moan+] as [npc.she] focus on controlling the extra muscles lining the insides of [npc.her] [npc.asshole]."
				...
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Slowly teasing the [npc.cockTip+] of [npc.her] [npc.cock] over [npc2.namePos] [npc2.assCloaca+],"
                                    + " [npc.name] let out a little [npc.moan] before slowly pushing forwards, sinking [npc.her] [npc.cock+] into [npc2.her] [npc2.asshole+].",

                            "[npc.Name] position the [npc.cockTip+] of [npc.her] [npc.cock] " + assTargeting + ","
                                    + " and with a slow, steady pressure, [npc.she] gently sink it deep into [npc2.her] [npc2.asshole+]."));
					break;
				case DOM_NORMAL:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Eagerly teasing the [npc.cockTip+] of [npc.her] [npc.cock] over [npc2.namePos] [npc2.assCloaca+],"
                                    + " [npc.name] let out [npc.a_moan+] before thrusting forwards, greedily sinking [npc.her] [npc.cock+] into [npc2.her] [npc2.asshole+].",

                            "[npc.Name] position the [npc.cockTip+] of [npc.her] [npc.cock] " + assTargeting + ", "
                                    + "and with a determined thrust, [npc.she] eagerly sink it deep into [npc2.her] [npc2.asshole+]."));
					break;
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Roughly grinding the [npc.cockTip+] of [npc.her] [npc.cock] over [npc2.namePos] [npc2.assCloaca+],"
                                    + " [npc.name] let out [npc.a_moan+] before violently slamming forwards, forcing [npc.her] [npc.cock+] deep into [npc2.her] [npc2.asshole+].",

                            "[npc.Name] position the [npc.cockTip+] of [npc.her] [npc.cock] " + assTargeting + ","
                                    + " and with a forceful thrust, [npc.she] roughly slam it deep into [npc2.her] [npc2.asshole+]."));
					break;
				case SUB_EAGER:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Eagerly teasing the [npc.cockTip+] of [npc.her] [npc.cock] over [npc2.namePos] [npc2.assCloaca+],"
				...
				case SUB_NORMAL:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Teasing the [npc.cockTip+] of [npc.her] [npc.cock] over [npc2.namePos] [npc2.assCloaca+],"
                                    + " [npc.name] let out [npc.a_moan+] before thrusting forwards, sinking [npc.her] [npc.cock+] into [npc2.her] [npc2.asshole+].",

                            "[npc.Name] position the [npc.cockTip+] of [npc.her] [npc.cock] " + assTargeting + ","
                                    + " and with a little thrust, [npc.she] sink it deep into [npc2.her] [npc2.asshole+]."));
					break;
				default:
					break;
			}
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(UtilText.parse(getCharactersForParsing(),
                            "Wanting to join in on the fun, [npc.name] bring the [npc.cockHead+] of [npc.her] [npc.cock] up to [npc2.namePos] [npc2.asshole+], and the next time [npc3.name] [npc3.verb(pull)] back,"
		...
		public String getDescription() {
			...
			if(PenisAnus.getOngoingCharacters(Main.sex.getCharacterTargetedForSexAction(this)).size()>1) {
				UtilText.nodeContentSB.append(UtilText.parse(PenisAnus.getCharactersForParsing(Main.sex.getCharacterTargetedForSexAction(this)), UtilText.returnStringAtRandom(
                        "With [npc.her] [npc.cock+] rubbing up against [npc3.nameHers], [npc.name] gently thrust deep inside of [npc2.namePos] [npc2.asshole+],"
                                + " letting out a little [npc.moan] with every buck of [npc.her] [npc.hips] as [npc.she] slowly fuck [npc2.herHim].",
                        "Joining [npc3.name] in double-penetrating [npc2.namePos] [npc2.asshole+], [npc.name] softly thrust [npc.her] [npc.hips] forwards, letting out a little [npc.moan] as [npc.she] gently fuck [npc2.herHim].",
                        "With both [npc.her] и [npc3.namePos] [npc.cocks(true)] stuffed deep in [npc2.namePos] [npc2.asshole+],"
				...
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                        ...
                        "Sliding [npc.her] [npc.cock+] into [npc2.namePos] [npc2.asshole+], [npc.name] let out a little [npc.moan] as [npc.she] start to gently pump [npc.her] [npc.hips] back and forth,"
	...
	public static final SexAction PENIS_FUCKING_DOM_NORMAL = new SexAction(
		...
		public String getDescription() {
			...
			if(PenisAnus.getOngoingCharacters(Main.sex.getCharacterTargetedForSexAction(this)).size()>1) {
				UtilText.nodeContentSB.append(UtilText.parse(PenisAnus.getCharactersForParsing(Main.sex.getCharacterTargetedForSexAction(this)), UtilText.returnStringAtRandom(
                        "With [npc.her] [npc.cock+] rubbing up against [npc3.nameHers], [npc.name] eagerly thrust deep inside of [npc2.namePos] [npc2.asshole+],"
                                + " letting out [npc.a_moan+] with every energetic buck of [npc.her] [npc.hips] as [npc.she] frantically fuck [npc2.herHim].",
                        "Joining [npc3.name] in double-penetrating [npc2.namePos] [npc2.asshole+], [npc.name] enthusiastically thrust [npc.her] [npc.hips] forwards, letting out [npc.a_moan+] as [npc.she] eagerly fuck [npc2.herHim].",
                        "With both [npc.her] и [npc3.namePos] [npc.cocks(true)] stuffed deep in [npc2.namePos] [npc2.asshole+],"
				...
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                        ...
                        "Thrusting [npc.her] [npc.cock+] deep into [npc2.namePos] [npc2.asshole+], [npc.name] let out [npc.a_moan+] as [npc.she] start to eagerly pump [npc.her] [npc.hips] back and forth,"
	...
	public static final SexAction PENIS_FUCKING_DOM_ROUGH = new SexAction(
		...
		public String getDescription() {
			...
			if(PenisAnus.getOngoingCharacters(Main.sex.getCharacterTargetedForSexAction(this)).size()>1) {
				UtilText.nodeContentSB.append(UtilText.parse(PenisAnus.getCharactersForParsing(Main.sex.getCharacterTargetedForSexAction(this)), UtilText.returnStringAtRandom(
                        "With [npc.her] [npc.cock+] rubbing up against [npc3.nameHers], [npc.name] roughly thrust deep inside of [npc2.namePos] [npc2.asshole+],"
                                + " letting out [npc.a_moan+] with every violent slam of [npc.her] [npc.hips] as [npc.she] forcefully fuck [npc2.herHim].",
                        "Joining [npc3.name] in double-penetrating [npc2.namePos] [npc2.asshole+], [npc.name] roughly slam [npc.her] [npc.hips] forwards, letting out [npc.a_moan+] as [npc.she] forcefully fuck [npc2.herHim].",
                        "With both [npc.her] и [npc3.namePos] [npc.cocks(true)] stuffed deep in [npc2.namePos] [npc2.asshole+],"
				...
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                        ...
                        "Forcefully driving [npc.her] [npc.cock+] deep into [npc2.namePos] [npc2.asshole+], [npc.name] let out [npc.a_moan+] as [npc.she] start to roughly slam [npc.her] [npc.hips] back and forth,"
	...
	public static final SexAction PENIS_FUCKING_SUB_NORMAL = new SexAction(
		...
		public String getDescription() {
			...
			if(PenisAnus.getOngoingCharacters(Main.sex.getCharacterTargetedForSexAction(this)).size()>1) {
				UtilText.nodeContentSB.append(UtilText.parse(PenisAnus.getCharactersForParsing(Main.sex.getCharacterTargetedForSexAction(this)), UtilText.returnStringAtRandom(
                        "With [npc.her] [npc.cock+] rubbing up against [npc3.nameHers], [npc.name] thrust deep inside of [npc2.namePos] [npc2.asshole+],"
                                + " letting out [npc.a_moan+] with every buck of [npc.her] [npc.hips] as [npc.she] happily fuck [npc2.herHim].",
                        "Joining [npc3.name] in double-penetrating [npc2.namePos] [npc2.asshole+], [npc.name] thrust [npc.her] [npc.hips] forwards, letting out [npc.a_moan+] as [npc.she] fuck [npc2.herHim].",
                        "With both [npc.her] и [npc3.namePos] [npc.cocks(true)] stuffed deep in [npc2.namePos] [npc2.asshole+],"
				...
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                        ...
                        "Thrusting [npc.her] [npc.cock+] deep into [npc2.namePos] [npc2.asshole+], [npc.name] let out [npc.a_moan+] as [npc.she] start to pump [npc.her] [npc.hips] back and forth,"
		...
		public String getDescription() {
			...
			if(!Main.sex.getCharacterPerformingAction().isTaur()) {
				switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
					case DOM_GENTLE:
						UtilText.nodeContentSB.append(UtilText.parse(getCharactersForParsing(), UtilText.returnStringAtRandom(
                                "Not satisfied with having just [npc3.name] fucking [npc.her] [npc.asshole+], [npc.name] gently take hold of [npc2.namePos] [npc2.cock], before slowly guiding it up to [npc.her] [npc.assCloaca+]."
                                        + " Letting out a little [npc.moan], [npc.she] then gently buck [npc.her] [npc.hips] и force [npc2.herHim] to join [npc3.name] in double-penetrating [npc.her] [npc.asshole+].",
                                "Wanting more than just [npc3.namePos] [npc3.cock] in [npc.her] [npc.asshole], [npc.name] take hold of [npc2.namePos] [npc2.cock], before gently lining it up " + assTargeting + "."
                                        + " Slowly pushing [npc.her] [npc.hips] back, [npc.she] let out a soft [npc.moan] as [npc.she] feel [npc2.namePos] [npc2.cock+] push in alongside [npc3.namePos] into [npc.her] [npc.asshole+].")));
						break;
					case DOM_ROUGH:
						UtilText.nodeContentSB.append(UtilText.parse(getCharactersForParsing(), UtilText.returnStringAtRandom(
                                "Not satisfied with having just [npc3.name] fucking [npc.her] [npc.asshole+], [npc.name] roughly grab [npc2.namePos] [npc2.cock], before forcefully moving it up to [npc.her] [npc.assCloaca+]."
                                        + " Letting out [npc.a_moan+], [npc.she] then violently buck [npc.her] [npc.hips] и force [npc2.herHim] to join [npc3.name] in double-penetrating [npc.her] [npc.asshole+].",
                                "Wanting more than just [npc3.namePos] [npc3.cock] in [npc.her] [npc.asshole], [npc.name] forcefully grab [npc2.namePos] [npc2.cock], before quickly lining it up " + assTargeting + "."
                                        + " Roughly slamming [npc.her] [npc.hips] back, [npc.she] let out [npc.a_moan+] as [npc.she] feel [npc2.namePos] [npc2.cock+] push in alongside [npc3.namePos] into [npc.her] [npc.asshole+].")));
						break;
					case SUB_NORMAL:
						UtilText.nodeContentSB.append(UtilText.parse(getCharactersForParsing(), UtilText.returnStringAtRandom(
                                "Not satisfied with having just [npc3.name] fucking [npc.her] [npc.asshole+], [npc.name] grab [npc2.namePos] [npc2.cock], before moving it up to [npc.her] [npc.assCloaca+]."
                                        + " Letting out [npc.a_moan+], [npc.she] then buck [npc.her] [npc.hips] и force [npc2.herHim] to join [npc3.name] in double-penetrating [npc.her] [npc.asshole+].",
                                "Wanting more than just [npc3.namePos] [npc3.cock] in [npc.her] [npc.asshole], [npc.name] grab [npc2.namePos] [npc2.cock], before lining it up " + assTargeting + "."
                                        + " Bucking [npc.her] [npc.hips] back, [npc.she] let out [npc.a_moan+] as [npc.she] feel [npc2.namePos] [npc2.cock+] push in alongside [npc3.namePos] into [npc.her] [npc.asshole+].")));
						break;
					default:
						UtilText.nodeContentSB.append(UtilText.parse(getCharactersForParsing(), UtilText.returnStringAtRandom(
                                "Not satisfied with having just [npc3.name] fucking [npc.her] [npc.asshole+], [npc.name] impatiently grab [npc2.namePos] [npc2.cock], before eagerly moving it up to [npc.her] [npc.assCloaca+]."
                                        + " Letting out [npc.a_moan+], [npc.she] then desperately buck [npc.her] [npc.hips] и force [npc2.herHim] to join [npc3.name] in double-penetrating [npc.her] [npc.asshole+].",
                                "Wanting more than just [npc3.namePos] [npc3.cock] in [npc.her] [npc.asshole], [npc.name] greedily grab [npc2.namePos] [npc2.cock], before quickly lining it up " + assTargeting + "."
                                        + " Impatiently bucking [npc.her] [npc.hips] back, [npc.she] let out [npc.a_moan+] as [npc.she] feel [npc2.namePos] [npc2.cock+] push in alongside [npc3.namePos] into [npc.her] [npc.asshole+].")));
						break;
				}
				...
				switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
					case DOM_GENTLE:
						UtilText.nodeContentSB.append(UtilText.parse(getCharactersForParsing(), UtilText.returnStringAtRandom(
                                "Not satisfied with having just [npc3.name] fucking [npc.her] [npc.asshole+], [npc.name] slowly move [npc.her] [npc.hips] until [npc2.namePos] [npc2.cock+] is pressed up to [npc.her] [npc.assCloaca+],"
                                        + " and then with a little [npc.moan], [npc.she] gently buck back and force [npc2.herHim] to join [npc3.name] in double-penetrating [npc.her] [npc.asshole+].",
                                "Wanting to be fucked by more than just [npc3.name], [npc.name] push back against [npc2.namePos] [npc2.cock], making sure to line the [npc2.cockHead] up " + assTargeting + " before slowly moving back and forcing [npc2.herHim] to join [npc3.name] in double-penetrating [npc.her] [npc.asshole+].")));
						break;
					case DOM_ROUGH:
						UtilText.nodeContentSB.append(UtilText.parse(getCharactersForParsing(), UtilText.returnStringAtRandom(
                                "Not satisfied with having just [npc3.name] fucking [npc.her] [npc.asshole+], [npc.name] forcefully push [npc.her] [npc.hips] back until [npc2.namePos] [npc2.cock+] is pressed up to [npc.her] [npc.assCloaca+],"
                                        + " and then with [npc.a_moan+], [npc.she] violently slam back and force [npc2.herHim] to join [npc3.name] in double-penetrating [npc.her] [npc.asshole+].",
                                "Wanting to be fucked by more than just [npc3.name], [npc.name] roughly push back against [npc2.namePos] [npc2.cock], making sure to line the [npc2.cockHead] up " + assTargeting + " before dominantly moving back and forcing [npc2.herHim] to join [npc3.name] in double-penetrating [npc.her] [npc.asshole+].")));
						break;
					case SUB_NORMAL:
						UtilText.nodeContentSB.append(UtilText.parse(getCharactersForParsing(), UtilText.returnStringAtRandom(
                                "Not satisfied with having just [npc3.name] fucking [npc.her] [npc.asshole+], [npc.name] push [npc.her] [npc.hips] back until [npc2.namePos] [npc2.cock+] is pressed up to [npc.her] [npc.assCloaca+],"
                                        + " and then with [npc.a_moan+], [npc.she] buck back and force [npc2.herHim] to join [npc3.name] in double-penetrating [npc.her] [npc.asshole+].",
                                "Wanting to be fucked by more than just [npc3.name], [npc.name] push back against [npc2.namePos] [npc2.cock], making sure to line the [npc2.cockHead] up " + assTargeting + " before moving back and forcing [npc2.herHim] to join [npc3.name] in double-penetrating [npc.her] [npc.asshole+].")));
						break;
					default:
						UtilText.nodeContentSB.append(UtilText.parse(getCharactersForParsing(), UtilText.returnStringAtRandom(
                                "Not satisfied with having just [npc3.name] fucking [npc.her] [npc.asshole+], [npc.name] eagerly push [npc.her] [npc.hips] back until [npc2.namePos] [npc2.cock+] is pressed up to [npc.her] [npc.assCloaca+],"
                                        + " and then with [npc.a_moan+], [npc.she] greedily buck back and force [npc2.herHim] to join [npc3.name] in double-penetrating [npc.her] [npc.asshole+].",
                                "Wanting to be fucked by more than just [npc3.name], [npc.name] desperately push back against [npc2.namePos] [npc2.cock], making sure to line the [npc2.cockHead] up " + assTargeting + " before eagerly moving back and forcing [npc2.herHim] to join [npc3.name] in double-penetrating [npc.her] [npc.asshole+].")));
						break;
				}
			}
				...
				switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(this))) {
					...
					case SUB_RESISTING:
						UtilText.nodeContentSB.append(UtilText.parse(getCharactersForParsing(), UtilText.returnStringAtRandom(
                                ...
                                " With [npc2.a_sob+], [npc2.name] [npc2.verb(struggle)] against [npc.name] as [npc.she] force [npc2.her] [npc2.cock] deep into [npc.her] [npc.asshole+].")));
						break;
					default:
						UtilText.nodeContentSB.append(UtilText.parse(getCharactersForParsing(), UtilText.returnStringAtRandom(
								" [npc2.Name] [npc2.verb(let)] out [npc2.a_moan+] as [npc2.she] [npc2.verb(enter)] [npc.herHim],"
		...
		public String getDescription() {
			...
			if(PenisAnus.getOngoingCharacters(Main.sex.getCharacterTargetedForSexAction(this)).size()>1) {
				switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(this))) {
					case DOM_GENTLE:
						UtilText.nodeContentSB.append(UtilText.parse(PenisAnus.getCharactersForParsing(Main.sex.getCharacterTargetedForSexAction(this)), UtilText.returnStringAtRandom(
                                "[npc.Name] try to pull [npc.her] [npc.cock] out of [npc2.namePos] [npc2.asshole],"
                                ...
                                "Tears start to well up in [npc.namePos] [npc.eyes], and with [npc.a_sob+], [npc.she] try to pull [npc.her] [npc.cock] away from [npc2.namePos] [npc2.asshole+],"
				...
				switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(this))) {
					case DOM_GENTLE:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                ...
                                "With [npc.a_sob+], [npc.name] try to pull [npc.her] [npc.cock] away from [npc2.name], but [npc2.she] quickly [npc2.verb(grab)] it, before gently forcing it back inside [npc2.her] [npc2.asshole+].",
                                "Tears start to well up in [npc.namePos] [npc.eyes], and with [npc.a_sob+], [npc.she] try to pull [npc.her] [npc.cock] away from [npc2.namePos] [npc2.asshole+],"
										+ " but [npc2.name] quickly [npc2.verb(shift)] position, ignoring [npc.her] protests as [npc2.she] gently [npc2.verb(force)] [npc2.her] [npc2.asshole+] down onto [npc.her] [npc.cock+]."));
						break;
					case DOM_ROUGH:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                ...
                                "With [npc.a_sob+], [npc.name] try to pull [npc.her] [npc.cock] away from [npc2.name], but [npc2.she] quickly [npc2.verb(grab)] it, before roughly forcing it back inside [npc2.her] [npc2.asshole+].",
                                "Tears start to well up in [npc.namePos] [npc.eyes], and with [npc.a_sob+], [npc.she] try to pull [npc.her] [npc.cock] away from [npc2.namePos] [npc2.asshole+],"
										+ " but [npc2.name] quickly [npc2.verb(shift)] position, ignoring [npc.her] protests as [npc2.she] roughly [npc2.verb(force)] [npc2.her] [npc2.asshole+] down onto [npc.her] [npc.cock+]."));
						break;
					default: // DOM_NORMAL and in case anything goes wrong:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                ...
                                "With [npc.a_sob+], [npc.name] try to pull [npc.her] [npc.cock] away from [npc2.name], but [npc2.she] quickly [npc2.verb(grab)] it, before eagerly forcing it back inside [npc2.her] [npc2.asshole+].",
                                "Tears start to well up in [npc.namePos] [npc.eyes], and with [npc.a_sob+], [npc.she] try to pull [npc.her] [npc.cock] away from [npc2.namePos] [npc2.asshole+],"
										+ " but [npc2.name] quickly [npc2.verb(shift)] position, ignoring [npc.her] protests as [npc2.she] [npc2.verb(force)] [npc2.her] [npc2.asshole+] down onto [npc.her] [npc.cock+]."));
						break;
				}
			...
			if(PenisAnus.getOngoingCharacters(Main.sex.getCharacterTargetedForSexAction(this)).size()>1) {
					...
					case DOM_ROUGH:
						UtilText.nodeContentSB.append(UtilText.parse(PenisAnus.getCharactersForParsing(Main.sex.getCharacterTargetedForSexAction(this)), UtilText.returnStringAtRandom(
								"Roughly yanking [npc.her] [npc.cock+] out of [npc2.namePos] [npc2.asshole+],"
                                        + " [npc.name] dominantly slide the [npc.cockTip+] up and down over [npc2.her] [npc2.assCloaca+] one last time before pulling back and leaving [npc3.name] to continue fucking [npc2.herHim].",
                                "Thrusting deep inside of [npc2.name] one last time, [npc.name] then yank [npc.her] [npc.cock+] back out of [npc2.her] [npc2.asshole+], putting an end to the rough double-penetration.")));
						break;
					default:
						UtilText.nodeContentSB.append(UtilText.parse(PenisAnus.getCharactersForParsing(Main.sex.getCharacterTargetedForSexAction(this)), UtilText.returnStringAtRandom(
								"Sliding [npc.her] [npc.cock] out of [npc2.namePos] [npc2.asshole+],"
                                        + " [npc.name] rub the [npc.cockTip] up and down over [npc2.her] [npc2.assCloaca+] one last time before pulling back and leaving [npc3.name] to continue fucking [npc2.herHim].",
                                "Pushing deep inside of [npc2.name] one last time, [npc.name] then slide [npc.her] [npc.cock+] back out of [npc2.her] [npc2.asshole+], putting an end to the double-penetration.")));
						break;
				}
				...
				if(!isTargetedCharacterInanimate()) {
					switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(this))) {
						case SUB_RESISTING:
							UtilText.nodeContentSB.append(UtilText.parse(PenisAnus.getCharactersForParsing(Main.sex.getCharacterTargetedForSexAction(this)), UtilText.returnStringAtRandom(
                                    " [npc2.Name] can't [npc2.verb(help)] but [npc2.verb(let)] out [npc2.sob+] as [npc.name] pull out of [npc2.her] [npc2.asshole],"
						...
						default:
							UtilText.nodeContentSB.append(UtilText.parse(PenisAnus.getCharactersForParsing(Main.sex.getCharacterTargetedForSexAction(this)), UtilText.returnStringAtRandom(
                                    " [npc2.Name] [npc2.verb(let)] out [npc2.a_moan+] as [npc.name] pull [npc.her] [npc.cock+] out of [npc2.her] [npc2.asshole+], eager for more of [npc.her] attention.",
				...
				switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
					case DOM_ROUGH:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								"Roughly yanking [npc.her] [npc.cock+] out of [npc2.namePos] [npc2.asshole+],"
                                        + " [npc.name] dominantly slide the [npc.cockTip+] up and down over [npc2.her] [npc2.assCloaca+] one last time before pulling back.",
                                "Thrusting deep inside of [npc2.name] one last time, [npc.name] then yank [npc.her] [npc.cock+] back out of [npc2.her] [npc2.asshole+], putting an end to the rough fucking."));
						break;
					default:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                "Sliding [npc.her] [npc.cock] out of [npc2.namePos] [npc2.asshole+], [npc.name] rub the [npc.cockTip] up and down over [npc2.her] [npc2.assCloaca+] one last time before pulling back.",
                                "Pushing deep inside of [npc2.name] one last time, [npc.name] then slide [npc.her] [npc.cock+] back out of [npc2.her] [npc2.asshole+], putting an end to the fucking."));
						break;
				}
		...
		public String getDescription() {
			...
			if(!Main.sex.getCharacterPerformingAction().isTaur()) {
				switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
					case DOM_GENTLE:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                "Grabbing [npc2.namePos] [npc2.cock], [npc.name] slowly guide it up " + assTargeting + ","
                                ...
                                "Grabbing [npc2.namePos] [npc2.cock], [npc.name] line it up to [npc.her] [npc.asshole+],"
					...
					case SUB_NORMAL:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                "Grabbing [npc2.namePos] [npc2.cock], [npc.name] guide it up " + assTargeting + ","
					...
					default:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                "Grabbing [npc2.namePos] [npc2.cock], [npc.name] eagerly guide it up " + assTargeting + ","
				...
				switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
					case DOM_GENTLE:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                "[npc.Name] slowly move [npc.her] [npc.hips] until [npc2.namePos] [npc2.cock+] is pressed up " + assTargeting + ","
                                        + " and then with a little [npc.moan], [npc.she] gently buck back and force [npc2.herHim] to penetrate [npc.her] [npc.asshole+].",
                                "Pushing [npc.her] [npc.asshole+] back against [npc2.namePos] [npc2.cock], [npc.name] line it up over [npc.her] [npc.assCloaca+],"
                                        + " before slowly moving back and letting out a soft [npc.moan] as [npc.she] force [npc2.herHim] to penetrate [npc.herHim]."));
						break;
					case DOM_ROUGH:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                "[npc.Name] forcefully push [npc.her] [npc.hips] back until [npc2.namePos] [npc2.cock+] is pressed up " + assTargeting + ","
                                        + " and then with [npc.a_moan+], [npc.she] violently slam back and force [npc2.herHim] to penetrate [npc.her] [npc.asshole+].",
                                "Roughly pushing [npc.her] [npc.asshole+] back against [npc2.namePos] [npc2.cock], [npc.name] line it up over [npc.her] [npc.assCloaca+],"
                                        + " before dominantly moving back and letting out [npc.a_moan+] as [npc.she] force [npc2.herHim] to penetrate [npc.herHim]."));
						break;
					case SUB_NORMAL:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                "[npc.Name] push [npc.her] [npc.hips] back until [npc2.namePos] [npc2.cock+] is pressed up " + assTargeting + ","
                                        + " and then with [npc.a_moan+], [npc.she] buck back and force [npc2.herHim] to penetrate [npc.her] [npc.asshole+].",
                                "Pushing [npc.her] [npc.asshole+] back against [npc2.namePos] [npc2.cock], [npc.name] line it up over [npc.her] [npc.assCloaca+],"
                                        + " before moving back and letting out [npc.a_moan+] as [npc.she] force [npc2.herHim] to penetrate [npc.herHim]."));
						break;
					default:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                "[npc.Name] eagerly push [npc.her] [npc.hips] back until [npc2.namePos] [npc2.cock+] is pressed up " + assTargeting + ","
                                        + " and then with [npc.a_moan+], [npc.she] greedily buck back and force [npc2.herHim] to penetrate [npc.her] [npc.asshole+].",
                                "Desperately pushing [npc.her] [npc.asshole+] back against [npc2.namePos] [npc2.cock], [npc.name] line it up over [npc.her] [npc.assCloaca+],"
		...
		public String getDescription() {
			...
			if(PenisAnus.getOngoingCharacters(Main.sex.getCharacterPerformingAction()).size()>1) {
				UtilText.nodeContentSB.append(UtilText.parse(PenisAnus.getCharactersForParsing(Main.sex.getCharacterPerformingAction()), UtilText.returnStringAtRandom(
                        "With a gentle thrust of [npc.her] [npc.hips], [npc.name] let out a soft [npc.moan] as [npc.she] help to sink the two [npc2.cocks(true)] penetrating [npc.herHim] ever deeper into [npc.her] [npc.asshole+].",
                        "With a soft [npc.moan], [npc.name] gently start bucking [npc.her] [npc.hips], forcing #IF(npc3.isPlayer())[npc3.namePos] и [npc2.namePos]#ELSE[npc2.namePos] и [npc3.namePos]#ENDIF [npc2.cocks+(true)] ever deeper into [npc.her] [npc.asshole+].",
				...
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                        "With a gentle thrust of [npc.her] [npc.hips], [npc.name] let out a soft [npc.moan] as [npc.she] help to sink [npc2.namePos] [npc2.cock+] deep into [npc.her] [npc.asshole+].",
                        "With a soft [npc.moan], [npc.name] gently start bucking [npc.her] [npc.hips], forcing [npc2.namePos] [npc2.cock+] ever deeper into [npc.her] [npc.asshole+].",
	...
	public static final SexAction RIDING_PENIS_DOM_NORMAL = new SexAction(
		...
		public String getDescription() {
			...
			if(PenisAnus.getOngoingCharacters(Main.sex.getCharacterPerformingAction()).size()>1) {
				UtilText.nodeContentSB.append(UtilText.parse(PenisAnus.getCharactersForParsing(Main.sex.getCharacterPerformingAction()), UtilText.returnStringAtRandom(
                        "With an eager bucking of [npc.her] [npc.hips], [npc.name] let out [npc.a_moan+] as [npc.she] help to sink the two [npc2.cocks(true)] penetrating [npc.herHim] ever deeper into [npc.her] [npc.asshole+].",
                        "With [npc.a_moan+], [npc.name] enthusiastically start bucking [npc.her] [npc.hips], forcing #IF(npc3.isPlayer())[npc3.namePos] и [npc2.namePos]#ELSE[npc2.namePos] и [npc3.namePos]#ENDIF [npc2.cocks+(true)] ever deeper into [npc.her] [npc.asshole+].",
				...
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                        "With an eager bucking of [npc.her] [npc.hips], [npc.name] let out [npc.a_moan+] as [npc.she] help to sink [npc2.namePos] [npc2.cock+] deep into [npc.her] [npc.asshole+].",
                        "With [npc.a_moan+], [npc.name] enthusiastically start bucking [npc.her] [npc.hips], forcing [npc2.namePos] [npc2.cock+] ever deeper into [npc.her] [npc.asshole+].",
	...
	public static final SexAction RIDING_PENIS_DOM_ROUGH = new SexAction(
		...
		public String getDescription() {
			...
			if(PenisAnus.getOngoingCharacters(Main.sex.getCharacterPerformingAction()).size()>1) {
				UtilText.nodeContentSB.append(UtilText.parse(PenisAnus.getCharactersForParsing(Main.sex.getCharacterPerformingAction()), UtilText.returnStringAtRandom(
                        "With a violent slamming of [npc.her] [npc.hips], [npc.name] let out [npc.a_moan+] as [npc.she] force the two [npc2.cocks(true)] penetrating [npc.herHim] ever deeper into [npc.her] [npc.asshole+].",
                        "With [npc.a_moan+], [npc.name] roughly start bucking [npc.her] [npc.hips], forcing #IF(npc3.isPlayer())[npc3.namePos] и [npc2.namePos]#ELSE[npc2.namePos] и [npc3.namePos]#ENDIF [npc2.cocks+(true)] ever deeper into [npc.her] [npc.asshole+].",
				...
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                        "With a violent slam of [npc.her] [npc.hips], [npc.name] let out [npc.a_moan+] as [npc.she] force [npc2.namePos] [npc2.cock+] deep into [npc.her] [npc.asshole+].",
                        "With [npc.a_moan+], [npc.name] roughly start bucking [npc.her] [npc.hips], forcing [npc2.namePos] [npc2.cock+] ever deeper into [npc.her] [npc.asshole+].",
	...
	public static final SexAction RIDING_PENIS_SUB_NORMAL = new SexAction(
		...
		public String getDescription() {
			...
			if(PenisAnus.getOngoingCharacters(Main.sex.getCharacterPerformingAction()).size()>1) {
				UtilText.nodeContentSB.append(UtilText.parse(PenisAnus.getCharactersForParsing(Main.sex.getCharacterPerformingAction()), UtilText.returnStringAtRandom(
                        "With a quick buck of [npc.her] [npc.hips], [npc.name] let out [npc.a_moan+] as [npc.she] force the two [npc2.cocks(true)] penetrating [npc.herHim] ever deeper into [npc.her] [npc.asshole+].",
                        "With [npc.a_moan+], [npc.name] start bucking [npc.her] [npc.hips], forcing #IF(npc3.isPlayer())[npc3.namePos] и [npc2.namePos]#ELSE[npc2.namePos] и [npc3.namePos]#ENDIF [npc2.cocks+(true)] ever deeper into [npc.her] [npc.asshole+].",
				...
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                        "With a quick buck of [npc.her] [npc.hips], [npc.name] let out [npc.a_moan+] as [npc.she] help to sink [npc2.namePos] [npc2.cock+] deep into [npc.her] [npc.asshole+].",
                        "With [npc.a_moan+], [npc.name] start bucking [npc.her] [npc.hips], forcing [npc2.namePos] [npc2.cock+] ever deeper into [npc.her] [npc.asshole+].",
					...
					case DOM_GENTLE:
						UtilText.nodeContentSB.append(UtilText.parse(PenisAnus.getCharactersForParsing(Main.sex.getCharacterPerformingAction()), UtilText.returnStringAtRandom(
                                "[npc.Name] feel tears start to well up in [npc.her] [npc.eyes], and, not being able to hold back any longer, [npc.she] suddenly let out [npc.a_sob+],"
                                        + " before weakly trying to pull both #IF(npc3.isPlayer())[npc3.namePos] и [npc2.namePos]#ELSE[npc2.namePos] и [npc3.namePos]#ENDIF [npc2.cocks(true)] out of [npc.her] [npc.asshole+].",
                                "[npc.A_sob+] bursts out from [npc.namePos] mouth as [npc.she] frantically try to pull [npc.her] [npc.asshole] away from the unwanted double-penetration,"
		...
		public String getDescription() {
			...
			if(PenisAnus.getOngoingCharacters(Main.sex.getCharacterPerformingAction()).size()>1) {
				switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
					case DOM_ROUGH:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                "Yanking [npc2.namePos] [npc2.cock] out of [npc.her] [npc.asshole+], [npc.name] let out a menacing growl as [npc.she] command [npc2.name] to stop fucking [npc.herHim].",
                                "[npc.Name] lean into [npc2.name], inhaling [npc2.her] [npc2.scent] before yanking [npc2.her] [npc2.cock] out of [npc.her] [npc.asshole+]."));
						break;
					default:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                "Sliding [npc2.namePos] [npc2.cock] out of [npc.her] [npc.asshole+], [npc.name] let out [npc.a_moan+] as [npc.she] tell [npc2.name] to stop fucking [npc.herHim].",
                                "[npc.Name] lean into [npc2.name], inhaling [npc2.her] [npc2.scent] before sliding [npc2.her] [npc2.cock] out of [npc.her] [npc.asshole+]."));
						break;
				}
				...
				if(!isTargetedCharacterInanimate()) {
					switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(this))) {
						...
						default:
							UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                    " [npc2.Name] [npc2.verb(let)] out [npc2.a_moan+] as [npc.name] stop [npc2.herHim] from fucking [npc.her] [npc.asshole+].",
					...
					case SUB_RESISTING:
						return (UtilText.parse(PenisAnus.getCharactersForParsing(Main.sex.getCharacterTargetedForSexAction(action)), UtilText.returnStringAtRandom(
								" Desperately trying, and failing, to pull away from the two [npc.cocks(true)] inside of [npc2.herHim],"
                                        + " [npc2.name] [npc2.verb(let)] out [npc2.a_sob+], tears streaming down [npc2.her] [npc2.face] as [npc2.she] weakly [npc2.verb(beg)] for [npc.name] и [npc3.name] to pull out of [npc2.her] [npc2.asshole+].",
								...
								" [npc2.Sobbing] in distress, and with tears running down [npc2.her] [npc2.face],"
                                        + " [npc2.name] weakly [npc2.verb(struggle)] in a vain attempt to dislodge the [npc.cocks(true)] thrusting into [npc2.her] [npc2.asshole+], pleading and crying for [npc.name] и [npc3.name] to leave [npc2.herHim] alone.")));
					case SUB_NORMAL:
						return (UtilText.parse(PenisAnus.getCharactersForParsing(Main.sex.getCharacterTargetedForSexAction(action)), UtilText.returnStringAtRandom(
				...
				switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(action))) {
					case SUB_RESISTING:
						return UtilText.parse(PenisAnus.getCharactersForParsing(Main.sex.getCharacterPerformingAction()), UtilText.returnStringAtRandom(
								...
								" [npc2.A_sob+] bursts out from between [npc2.namePos] [npc2.lips] as [npc2.she] weakly [npc2.verb(try)] to push [npc.name] away,"
                                        + " squirming and protesting as [npc.name] continue to force both [npc2.her] и [npc3.namePos] [npc2.cock+] deep into [npc.her] [npc.asshole+].",
					...
					case SUB_RESISTING:
						return (UtilText.returnStringAtRandom(
								" Failing to pull [npc2.her] [npc2.cock] away from [npc.namePos] [npc.asshole],"
										+ " [npc2.name] [npc2.verb(let)] out [npc2.a_sob+] as [npc2.she] weakly [npc2.verb(try)] to struggle free.",
								" [npc2.A_sob+] bursts out from between [npc2.namePos] [npc2.lips] as [npc2.she] weakly [npc2.verb(try)] to push [npc.name] away,"
                                        + " squirming and protesting as [npc.name] continue to force [npc2.her] [npc2.cock+] deep into [npc.her] [npc.asshole+].",
								" [npc2.Sobbing] in distress, [npc2.name] [npc2.verb(try)], in vain, to pull [npc2.her] [npc2.cock] away from [npc.namePos] [npc.asshole+]."));
					case DOM_GENTLE:
						return (UtilText.returnStringAtRandom(
								" [npc2.Name] gently [npc2.verb(slide)] [npc2.her] [npc2.cock+] deep into [npc.namePos] [npc.asshole+],"
