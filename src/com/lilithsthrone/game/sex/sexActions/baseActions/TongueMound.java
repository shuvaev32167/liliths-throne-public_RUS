...
public class TongueMound {
	...
	public static final SexAction MOUND_SNOG = new SexAction(
		...
		public String getDescription() {
			return UtilText.returnStringAtRandom(
                    "[npc.Name] roughly grind [npc.her] [npc.lips+] down against [npc2.namePos] doll-like mound,"
								+ " forcefully kissing and licking at [npc2.her] sensitive crotch"+getDescriptionFinisher(this, 0),

                    "Dropping [npc.her] head down into [npc2.namePos] crotch, [npc.name] roughly grind [npc.her] mouth against [npc2.her] genderless crotch,"
								+ " kissing and licking [npc2.her] sensitive mound"+getDescriptionFinisher(this, 1),

                    "Pushing [npc.her] face down into [npc2.namePos] groin, [npc.name] start grinding [npc.her] [npc.lips+] against [npc2.her] genderless mound,"
	...
	public static final SexAction MOUND_KISSING = new SexAction(
		...
		public String getDescription() {
			return UtilText.returnStringAtRandom(
                    "[npc.Name] eagerly press [npc.her] [npc.lips+] down against [npc2.namePos] doll-like mound,"
							+ " passionately kissing and licking at [npc2.her] sensitive crotch"+getDescriptionFinisher(this, 0),

                    "Dropping [npc.her] head down into [npc2.namePos] crotch, [npc.name] passionately press [npc.her] mouth against [npc2.her] genderless crotch,"
							+ " kissing and licking [npc2.her] sensitive mound"+getDescriptionFinisher(this, 1),

                    "Pushing [npc.her] face down into [npc2.namePos] groin, [npc.name] start pressing [npc.her] [npc.lips+] against [npc2.her] genderless mound,"
	...
	public static final SexAction GENTLE_MOUND_KISSING = new SexAction(
		...
		public String getDescription() {
			return UtilText.returnStringAtRandom(
                    "[npc.Name] gently press [npc.her] [npc.lips+] down against [npc2.namePos] doll-like mound,"
							+ " planting delicate kisses on [npc2.her] sensitive crotch"+getDescriptionFinisher(this, 0),

                    "Dropping [npc.her] head down into [npc2.namePos] crotch, [npc.name] gently press [npc.her] mouth against [npc2.her] genderless crotch,"
							+ " kissing and licking [npc2.her] sensitive mound"+getDescriptionFinisher(this, 1),

                    "Pushing [npc.her] face down into [npc2.namePos] groin, [npc.name] start softly pressing [npc.her] [npc.lips+] against [npc2.her] genderless mound,"
	...
	public static final SexAction MOUND_KISSING_SUB_NORMAL = new SexAction(
		...
		public String getDescription() {
			return UtilText.returnStringAtRandom(
                    "[npc.Name] press [npc.her] [npc.lips+] down against [npc2.namePos] doll-like mound,"
							+ " kissing and licking at [npc2.her] sensitive crotch"+getDescriptionFinisher(this, 0),

                    "Dropping [npc.her] head down into [npc2.namePos] crotch, [npc.name] press [npc.her] mouth against [npc2.her] genderless crotch,"
							+ " kissing and licking [npc2.her] sensitive mound"+getDescriptionFinisher(this, 1),
