...
public class PenisVagina {
			...
			if(!getOngoingCharacters(Main.sex.getCharacterTargetedForSexAction(this)).isEmpty()) {
				switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
					case DOM_GENTLE:
						UtilText.nodeContentSB.append(UtilText.parse(Util.newArrayListOfValues(Main.sex.getCharacterPerformingAction(), Main.sex.getCharacterTargetedForSexAction(this), getPrimaryDPPerformer(Main.sex.getCharacterTargetedForSexAction(this))),
								...
								"Not deterred by the fact that [npc3.namePos] [npc3.cock] is already deep in [npc2.namePos] [npc2.pussy+],"
                                        + " [npc.name] start slowly teasing the [npc.cockTip+] of [npc.her] own [npc.cock+] up against [npc2.her] [npc2.labia+], threatening to start double-penetrating [npc.herHim] at any moment.",
                                        "With a soft [npc.moan], [npc.name] gently guide the [npc.cockTip+] of [npc.her] [npc.cock] over the exposed parts of [npc2.namePos] [npc2.labia+],"
					...
					case DOM_ROUGH:
						UtilText.nodeContentSB.append(UtilText.parse(Util.newArrayListOfValues(Main.sex.getCharacterPerformingAction(), Main.sex.getCharacterTargetedForSexAction(this), getPrimaryDPPerformer(Main.sex.getCharacterTargetedForSexAction(this))),
								UtilText.returnStringAtRandom(
								"Not deterred by the fact that [npc3.namePos] [npc3.cock] is already deep in [npc2.namePos] [npc2.pussy+],"
                                        + " [npc.name] start roughly grinding the [npc.cockTip+] of [npc.her] own [npc.cock+] up against [npc2.her] [npc2.labia+], threatening to start double-penetrating [npc.herHim] at any moment.",
                                        "With [npc.a_moan+], [npc.name] forcefully rub the [npc.cockTip+] of [npc.her] [npc.cock] over the exposed parts of [npc2.namePos] [npc2.labia+],"
										+ " indicating that [npc.she] might join [npc3.name] and start double-penetrating [npc2.her] [npc2.pussy+].",
					...
					case SUB_NORMAL:
						UtilText.nodeContentSB.append(UtilText.parse(Util.newArrayListOfValues(Main.sex.getCharacterPerformingAction(), Main.sex.getCharacterTargetedForSexAction(this), getPrimaryDPPerformer(Main.sex.getCharacterTargetedForSexAction(this))),
								UtilText.returnStringAtRandom(
								"Not deterred by the fact that [npc3.namePos] [npc3.cock] is already deep in [npc2.namePos] [npc2.pussy+],"
                                        + " [npc.name] start grinding the [npc.cockTip+] of [npc.her] own [npc.cock+] up against [npc2.her] [npc2.labia+], threatening to start double-penetrating [npc.herHim] at any moment.",
                                        "With [npc.a_moan+], [npc.name] rub the [npc.cockTip+] of [npc.her] [npc.cock] over the exposed parts of [npc2.namePos] [npc2.labia+],"
										+ " indicating that [npc.she] might join [npc3.name] and start double-penetrating [npc2.her] [npc2.pussy+].",
					...
					default:
						UtilText.nodeContentSB.append(UtilText.parse(Util.newArrayListOfValues(Main.sex.getCharacterPerformingAction(), Main.sex.getCharacterTargetedForSexAction(this), getPrimaryDPPerformer(Main.sex.getCharacterTargetedForSexAction(this))),
								UtilText.returnStringAtRandom(
								"Not deterred by the fact that [npc3.namePos] [npc3.cock] is already deep in [npc2.namePos] [npc2.pussy+],"
                                        + " [npc.name] start eagerly grinding the [npc.cockTip+] of [npc.her] own [npc.cock+] up against [npc2.her] [npc2.labia+], threatening to start double-penetrating [npc.herHim] at any moment.",
                                        "With [npc.a_moan+], [npc.name] enthusiastically rub the [npc.cockTip+] of [npc.her] [npc.cock] over the exposed parts of [npc2.namePos] [npc2.labia+],"
										+ " indicating that [npc.she] might join [npc3.name] and start double-penetrating [npc2.her] [npc2.pussy+].",
				...
				switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
					case DOM_GENTLE:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								"Guiding [npc.her] [npc.cock+] up to [npc2.namePos] [npc2.pussy+],"
                                        + " [npc.name] start slowly teasing the [npc.cockTip+] up and down between [npc2.her] [npc2.labia+], ready to penetrate [npc2.herHim] at any moment.",
                                "With a soft [npc.moan], [npc.name] guide [npc.her] [npc.cock+] up to [npc2.namePos] [npc2.pussy+], before starting to gently slide the [npc.cockTip] up and down between [npc2.her] [npc2.labia+].",
					...
					case DOM_ROUGH:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								"Grinding [npc.her] [npc.cock+] up against [npc2.namePos] [npc2.pussy+],"
                                        + " [npc.name] pull back a little before starting to slide the [npc.cockTip+] up and down between [npc2.her] [npc2.labia+], ready to start fucking [npc2.herHim] at any moment.",
                                "With [npc.a_moan+], [npc.name] line [npc.her] [npc.cock+] up to [npc2.namePos] [npc2.pussy+],"
					...
					case SUB_NORMAL:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								"Guiding [npc.her] [npc.cock+] up to [npc2.namePos] [npc2.pussy+],"
                                        + " [npc.name] start sliding the [npc.cockTip+] up and down between [npc2.her] [npc2.labia+], ready to penetrate [npc2.herHim] at any moment.",
                                "With [npc.a_moan+], [npc.name] guide [npc.her] [npc.cock+] up to [npc2.namePos] [npc2.pussy+], before starting to slide the [npc.cockTip] up and down between [npc2.her] [npc2.labia+].",
					...
					default:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								"Guiding [npc.her] [npc.cock+] up to [npc2.namePos] [npc2.pussy+],"
                                        + " [npc.name] start eagerly sliding the [npc.cockTip+] up and down between [npc2.her] [npc2.labia+], ready to penetrate [npc2.herHim] at any moment.",
                                "With [npc.a_moan+], [npc.name] guide [npc.her] [npc.cock+] up to [npc2.namePos] [npc2.pussy+], before starting to eagerly slide the [npc.cockTip] up and down between [npc2.her] [npc2.labia+].",
		...
		public String getDescription() {
			...
			if(!getOngoingCharacters(Main.sex.getCharacterPerformingAction()).isEmpty()) {
					...
					case DOM_GENTLE:
						UtilText.nodeContentSB.append(
								...
								"Wanting more than just [npc3.namePos] [npc3.cock+] stuffed in [npc.her] [npc.pussy+],"
                                        + " [npc.name] gently take hold of [npc2.namePos] [npc2.cock+], before starting to slide the [npc2.cockTip] up and down between an exposed part of [npc.her] [npc.labia+].",
								"With [npc3.namePos] [npc3.cock+] still thrusting in and out of [npc.her] [npc.pussy+],"
                                        + " [npc.name] grab [npc2.namePos] [npc2.cock+], before gently sliding the [npc2.cockTip+] over an exposed part of [npc.her] [npc.labia+].")));
						break;
					case DOM_ROUGH:
						UtilText.nodeContentSB.append
						(UtilText.parse(Util.newArrayListOfValues(Main.sex.getCharacterPerformingAction(), Main.sex.getCharacterTargetedForSexAction(this), getPrimaryDPPerformer(Main.sex.getCharacterTargetedForSexAction(this))),
								...
								"Wanting more than just [npc3.namePos] [npc3.cock+] stuffed in [npc.her] [npc.pussy+],"
                                        + " [npc.name] roughly seize hold of [npc2.namePos] [npc2.cock+], before starting to forcefully rub the [npc2.cockTip] up and down between an exposed part of [npc.her] [npc.labia+].",
								"With [npc3.namePos] [npc3.cock+] still thrusting in and out of [npc.her] [npc.pussy+],"
                                        + " [npc.name] forcefully grab [npc2.namePos] [npc2.cock+], before roughly rubbing the [npc2.cockTip+] over an exposed part of [npc.her] [npc.labia+].")));
						break;
					case SUB_NORMAL:
						UtilText.nodeContentSB.append(
								UtilText.parse(Util.newArrayListOfValues(Main.sex.getCharacterPerformingAction(), Main.sex.getCharacterTargetedForSexAction(this), getPrimaryDPPerformer(Main.sex.getCharacterTargetedForSexAction(this))),
								...
								"Wanting more than just [npc3.namePos] [npc3.cock+] stuffed in [npc.her] [npc.pussy+],"
                                        + " [npc.name] take hold of [npc2.namePos] [npc2.cock+], before starting to rub the [npc2.cockTip] up and down between an exposed part of [npc.her] [npc.labia+].",
								"With [npc3.namePos] [npc3.cock+] still thrusting in and out of [npc.her] [npc.pussy+],"
                                        + " [npc.name] grab [npc2.namePos] [npc2.cock+], before rubbing the [npc2.cockTip+] over an exposed part of [npc.her] [npc.labia+].")));
						break;
					default:
						UtilText.nodeContentSB.append(
								UtilText.parse(Util.newArrayListOfValues(Main.sex.getCharacterPerformingAction(), Main.sex.getCharacterTargetedForSexAction(this), getPrimaryDPPerformer(Main.sex.getCharacterTargetedForSexAction(this))),
								...
								"Wanting more than just [npc3.namePos] [npc3.cock+] stuffed in [npc.her] [npc.pussy+],"
                                        + " [npc.name] desperately seize hold of [npc2.namePos] [npc2.cock+], before starting to energetically rub the [npc2.cockTip] up and down between an exposed part of [npc.her] [npc.labia+].",
								"With [npc3.namePos] [npc3.cock+] still thrusting in and out of [npc.her] [npc.pussy+],"
                                        + " [npc.name] eagerly grab [npc2.namePos] [npc2.cock+], before happily rubbing the [npc2.cockTip+] over an exposed part of [npc.her] [npc.labia+].")));
						break;
				}
				...
				switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
					case DOM_GENTLE:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                "[npc.Name] grab [npc2.namePos] [npc2.cock+], before guiding it up to [npc.her] [npc.pussy+]."
                                        + " Slowly pushing the [npc2.cockTip+] up and down between [npc.her] [npc.labia+], [npc.she] tease [npc2.name] with the promise of penetration at any moment.",
                                "With a soft [npc.moan], [npc.name] grab [npc2.namePos] [npc2.cock+] и guide it up to [npc.her] [npc.pussy+],"
										+ " before starting to gently slide the [npc2.cockTip] up and down between [npc.her] [npc.labia+].",
                                "Grabbing [npc2.namePos] [npc2.cock+], [npc.name] gently slide the [npc2.cockTip+] over [npc.her] [npc.pussy+],"
                                        + " letting out a soft [npc.moan] as [npc.she] tease [npc2.herHim] with the promise of penetration."));
						break;
					case DOM_ROUGH:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                "[npc.Name] grab [npc2.namePos] [npc2.cock+], before yanking it up to [npc.her] [npc.pussy+]."
                                        + " Roughly forcing the [npc2.cockTip+] up and down between [npc.her] [npc.labia+], [npc.she] tease [npc2.name] with the promise of penetration at any moment.",
                                "With [npc.a_moan+], [npc.name] grab [npc2.namePos] [npc2.cock+] and yank it up to [npc.her] [npc.pussy+],"
                                        + " before starting to roughly force the [npc2.cockTip] up and down between [npc.her] [npc.labia+].",
                                "Grabbing [npc2.namePos] [npc2.cock+], [npc.name] roughly grind the [npc2.cockTip+] over [npc.her] [npc.pussy+],"
                                        + " letting out [npc.a_moan+] as [npc.she] tease [npc2.herHim] with the promise of penetration."));
						break;
					case SUB_NORMAL:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                "[npc.Name] grab [npc2.namePos] [npc2.cock+], before guiding it up to [npc.her] [npc.pussy+]."
                                        + " Pushing the [npc2.cockTip+] up and down between [npc.her] [npc.labia+], [npc.she] tease [npc2.name] with the promise of penetration at any moment.",
                                "With [npc.a_moan+], [npc.name] grab [npc2.namePos] [npc2.cock+] и guide it up to [npc.her] [npc.pussy+],"
										+ " before starting to slide the [npc2.cockTip] up and down between [npc.her] [npc.labia+].",
                                "Grabbing [npc2.namePos] [npc2.cock+], [npc.name] slide the [npc2.cockTip+] over [npc.her] [npc.pussy+],"
                                        + " letting out [npc.a_moan+] as [npc.she] tease [npc2.herHim] with the promise of penetration."));
						break;
					default:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                "[npc.Name] grab [npc2.namePos] [npc2.cock+], before guiding it up to [npc.her] [npc.pussy+]."
                                        + " Eagerly pushing the [npc2.cockTip+] up and down between [npc.her] [npc.labia+], [npc.she] tease [npc2.name] with the promise of penetration at any moment.",
                                "With [npc.a_moan+], [npc.name] grab [npc2.namePos] [npc2.cock+] и guide it up to [npc.her] [npc.pussy+],"
										+ " before starting to eagerly slide the [npc2.cockTip] up and down between [npc.her] [npc.labia+].",
                                "Grabbing [npc2.namePos] [npc2.cock+], [npc.name] eagerly slide the [npc2.cockTip+] over [npc.her] [npc.pussy+],"
                                        + " letting out [npc.a_moan+] as [npc.she] tease [npc2.herHim] with the promise of penetration."));
						break;
				}
			}
			...
			if(!isTargetedCharacterInanimate()) {
				...
				if((Main.sex.getCharacterPerformingAction().isVaginaVirgin() || Main.sex.getCharacterPerformingAction().hasHymen()) && Main.sex.getCharacterPerformingAction().hasFetish(Fetish.FETISH_PURE_VIRGIN)) {
					if(Main.sex.getCharacterPerformingAction().isMute()) {
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                " Treasuring [npc.her] virginity above all else, [npc.name] then quickly pull [npc.her] [npc.pussy] away from [npc2.namePos] [npc2.cock+].",
                                " Not at all ready to lose [npc.her] precious virginity, [npc.name] then quickly pull [npc.her] [npc.pussy] away from [npc2.namePos] [npc2.cock+].",
                                " As [npc.she] treasure [npc.her] precious virginity above all else,"
                                        + " [npc.name] make it clear that [npc.she] [npc.do]n't actually want to be penetrated by pulling [npc.her] [npc.pussy] away from [npc2.namePos] [npc2.cock+]."));
		...
		public String getDescription() {
			if(PenisVagina.getOngoingCharacters(Main.sex.getCharacterPerformingAction()).size()>1) {
				return UtilText.parse(PenisVagina.getCharactersForParsing(Main.sex.getCharacterPerformingAction()), UtilText.returnStringAtRandom(
                        "Letting out [npc.a_moan+], [npc.name] concentrate on squeezing the extra internal muscles within [npc.her] [npc.pussy] down around #IF(npc3.isPlayer())[npc3.namePos] и [npc2.namePos]#ELSE[npc2.namePos] и [npc3.namePos]#ENDIF [npc2.cocks+(true)].",
				...
				return UtilText.returnStringAtRandom(
                        "Letting out [npc.a_moan+], [npc.name] concentrate on squeezing the extra internal muscles within [npc.her] [npc.pussy] down around [npc2.namePos] [npc2.cock+].",
						(!isTargetedCharacterInanimate()
                                ? "[npc.Name] let out [npc.a_moan+] as [npc.she] focus on controlling the extra muscles lining the insides of [npc.her] [npc.pussy]."
				...
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Slowly teasing the [npc.cockTip+] of [npc.her] [npc.cock] between [npc2.namePos] [npc2.labia+],"
                                    + " [npc.name] let out a little [npc.moan] before slowly pushing forwards, sinking [npc.her] [npc.cock+] into [npc2.her] [npc2.pussy+].",

                            "[npc.Name] position the [npc.cockTip+] of [npc.her] [npc.cock] between [npc2.namePos] [npc2.labia+],"
                                    + " and with a slow, steady pressure, [npc.she] gently sink it deep into [npc2.her] [npc2.pussy+]."));
					break;
				case DOM_NORMAL:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Eagerly teasing the [npc.cockTip+] of [npc.her] [npc.cock] between [npc2.namePos] [npc2.labia+],"
                                    + " [npc.name] let out [npc.a_moan+] before thrusting forwards, greedily sinking [npc.her] [npc.cock+] into [npc2.her] [npc2.pussy+].",

                            "[npc.Name] position the [npc.cockTip+] of [npc.her] [npc.cock] between [npc2.namePos] [npc2.labia+], "
                                    + "and with a determined thrust, [npc.she] eagerly sink it deep into [npc2.her] [npc2.pussy+]."));
					break;
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Roughly grinding the [npc.cockTip+] of [npc.her] [npc.cock] between [npc2.namePos] [npc2.labia+],"
                                    + " [npc.name] let out [npc.a_moan+] before violently slamming forwards, forcing [npc.her] [npc.cock+] deep into [npc2.her] [npc2.pussy+].",

                            "[npc.Name] position the [npc.cockTip+] of [npc.her] [npc.cock] between [npc2.namePos] [npc2.labia+],"
                                    + " and with a forceful thrust, [npc.she] roughly slam it deep into [npc2.her] [npc2.pussy+]."));
					break;
				case SUB_EAGER:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Eagerly teasing the [npc.cockTip+] of [npc.her] [npc.cock] between [npc2.namePos] [npc2.labia+],"
				...
				case SUB_NORMAL:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Teasing the [npc.cockTip+] of [npc.her] [npc.cock] between [npc2.namePos] [npc2.labia+],"
                                    + " [npc.name] let out [npc.a_moan+] before thrusting forwards, sinking [npc.her] [npc.cock+] into [npc2.her] [npc2.pussy+].",

                            "[npc.Name] position the [npc.cockTip+] of [npc.her] [npc.cock] between [npc2.namePos] [npc2.labia+],"
                                    + " and with a little thrust, [npc.she] sink it deep into [npc2.her] [npc2.pussy+]."));
					break;
				default:
					break;
			}
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(UtilText.parse(getCharactersForParsing(),
                            "Wanting to join in on the fun, [npc.name] bring the [npc.cockHead+] of [npc.her] [npc.cock] up to [npc2.namePos] [npc2.pussy+], and the next time [npc3.name] [npc3.verb(pull)] back,"
		...
		public String getDescription() {
			...
			if(PenisVagina.getOngoingCharacters(Main.sex.getCharacterTargetedForSexAction(this)).size()>1) {
				UtilText.nodeContentSB.append(UtilText.parse(PenisVagina.getCharactersForParsing(Main.sex.getCharacterTargetedForSexAction(this)), UtilText.returnStringAtRandom(
                        "With [npc.her] [npc.cock+] rubbing up against [npc3.nameHers], [npc.name] gently thrust deep inside of [npc2.namePos] [npc2.pussy+],"
                                + " letting out a little [npc.moan] with every buck of [npc.her] [npc.hips] as [npc.she] slowly fuck [npc2.herHim].",
                        "Joining [npc3.name] in double-penetrating [npc2.namePos] [npc2.pussy+], [npc.name] softly thrust [npc.her] [npc.hips] forwards, letting out a little [npc.moan] as [npc.she] gently fuck [npc2.herHim].",
                        "With both [npc.her] и [npc3.namePos] [npc.cocks(true)] stuffed deep in [npc2.namePos] [npc2.pussy+],"
				...
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                        ...
                        "Sliding [npc.her] [npc.cock+] into [npc2.namePos] [npc2.pussy+], [npc.name] let out a little [npc.moan] as [npc.she] start to gently pump [npc.her] [npc.hips] back and forth,"
	...
	public static final SexAction PENIS_FUCKING_DOM_NORMAL = new SexAction(
		...
		public String getDescription() {
			...
			if(PenisVagina.getOngoingCharacters(Main.sex.getCharacterTargetedForSexAction(this)).size()>1) {
				UtilText.nodeContentSB.append(UtilText.parse(PenisVagina.getCharactersForParsing(Main.sex.getCharacterTargetedForSexAction(this)), UtilText.returnStringAtRandom(
                        "With [npc.her] [npc.cock+] rubbing up against [npc3.nameHers], [npc.name] eagerly thrust deep inside of [npc2.namePos] [npc2.pussy+],"
                                + " letting out [npc.a_moan+] with every energetic buck of [npc.her] [npc.hips] as [npc.she] frantically fuck [npc2.herHim].",
                        "Joining [npc3.name] in double-penetrating [npc2.namePos] [npc2.pussy+], [npc.name] enthusiastically thrust [npc.her] [npc.hips] forwards, letting out [npc.a_moan+] as [npc.she] eagerly fuck [npc2.herHim].",
                        "With both [npc.her] и [npc3.namePos] [npc.cocks(true)] stuffed deep in [npc2.namePos] [npc2.pussy+],"
				...
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                        ...
                        "Thrusting [npc.her] [npc.cock+] deep into [npc2.namePos] [npc2.pussy+], [npc.name] let out [npc.a_moan+] as [npc.she] start to eagerly pump [npc.her] [npc.hips] back and forth,"
	...
	public static final SexAction PENIS_FUCKING_DOM_ROUGH = new SexAction(
		...
		public String getDescription() {
			...
			if(PenisVagina.getOngoingCharacters(Main.sex.getCharacterTargetedForSexAction(this)).size()>1) {
				UtilText.nodeContentSB.append(UtilText.parse(PenisVagina.getCharactersForParsing(Main.sex.getCharacterTargetedForSexAction(this)), UtilText.returnStringAtRandom(
                        "With [npc.her] [npc.cock+] rubbing up against [npc3.nameHers], [npc.name] roughly thrust deep inside of [npc2.namePos] [npc2.pussy+],"
                                + " letting out [npc.a_moan+] with every violent slam of [npc.her] [npc.hips] as [npc.she] forcefully fuck [npc2.herHim].",
                        "Joining [npc3.name] in double-penetrating [npc2.namePos] [npc2.pussy+], [npc.name] roughly slam [npc.her] [npc.hips] forwards, letting out [npc.a_moan+] as [npc.she] forcefully fuck [npc2.herHim].",
                        "With both [npc.her] и [npc3.namePos] [npc.cocks(true)] stuffed deep in [npc2.namePos] [npc2.pussy+],"
				...
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                        ...
                        "Forcefully driving [npc.her] [npc.cock+] deep into [npc2.namePos] [npc2.pussy+], [npc.name] let out [npc.a_moan+] as [npc.she] start to roughly slam [npc.her] [npc.hips] back and forth,"
	...
	public static final SexAction PENIS_FUCKING_SUB_NORMAL = new SexAction(
		...
		public String getDescription() {
			...
			if(PenisVagina.getOngoingCharacters(Main.sex.getCharacterTargetedForSexAction(this)).size()>1) {
				UtilText.nodeContentSB.append(UtilText.parse(PenisVagina.getCharactersForParsing(Main.sex.getCharacterTargetedForSexAction(this)), UtilText.returnStringAtRandom(
                        "With [npc.her] [npc.cock+] rubbing up against [npc3.nameHers], [npc.name] thrust deep inside of [npc2.namePos] [npc2.pussy+],"
                                + " letting out [npc.a_moan+] with every buck of [npc.her] [npc.hips] as [npc.she] happily fuck [npc2.herHim].",
                        "Joining [npc3.name] in double-penetrating [npc2.namePos] [npc2.pussy+], [npc.name] thrust [npc.her] [npc.hips] forwards, letting out [npc.a_moan+] as [npc.she] fuck [npc2.herHim].",
                        "With both [npc.her] и [npc3.namePos] [npc.cocks(true)] stuffed deep in [npc2.namePos] [npc2.pussy+],"
				...
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                        ...
                        "Thrusting [npc.her] [npc.cock+] deep into [npc2.namePos] [npc2.pussy+], [npc.name] let out [npc.a_moan+] as [npc.she] start to pump [npc.her] [npc.hips] back and forth,"
		...
		public String getDescription() {
			...
			if(!Main.sex.getCharacterPerformingAction().isTaur()) {
				switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
					case DOM_GENTLE:
						UtilText.nodeContentSB.append(UtilText.parse(getCharactersForParsing(), UtilText.returnStringAtRandom(
                                "Not satisfied with having just [npc3.name] fucking [npc.her] [npc.pussy+], [npc.name] gently take hold of [npc2.namePos] [npc2.cock], before slowly guiding it up to [npc.her] [npc.labia+]."
                                        + " Letting out a little [npc.moan], [npc.she] then gently buck [npc.her] [npc.hips] и force [npc2.herHim] to join [npc3.name] in double-penetrating [npc.her] [npc.pussy+].",
                                "Wanting more than just [npc3.namePos] [npc3.cock] in [npc.her] [npc.pussy], [npc.name] take hold of [npc2.namePos] [npc2.cock], before gently lining it up to [npc.her] [npc.labia+]."
                                        + " Slowly pushing [npc.her] [npc.hips] back, [npc.she] let out a soft [npc.moan] as [npc.she] feel [npc2.namePos] [npc2.cock+] push in alongside [npc3.namePos] into [npc.her] [npc.pussy+].")));
						break;
					case DOM_ROUGH:
						UtilText.nodeContentSB.append(UtilText.parse(getCharactersForParsing(), UtilText.returnStringAtRandom(
                                "Not satisfied with having just [npc3.name] fucking [npc.her] [npc.pussy+], [npc.name] roughly grab [npc2.namePos] [npc2.cock], before forcefully moving it up to [npc.her] [npc.labia+]."
                                        + " Letting out [npc.a_moan+], [npc.she] then violently buck [npc.her] [npc.hips] и force [npc2.herHim] to join [npc3.name] in double-penetrating [npc.her] [npc.pussy+].",
                                "Wanting more than just [npc3.namePos] [npc3.cock] in [npc.her] [npc.pussy], [npc.name] forcefully grab [npc2.namePos] [npc2.cock], before quickly lining it up to [npc.her] [npc.labia+]."
                                        + " Roughly slamming [npc.her] [npc.hips] back, [npc.she] let out [npc.a_moan+] as [npc.she] feel [npc2.namePos] [npc2.cock+] push in alongside [npc3.namePos] into [npc.her] [npc.pussy+].")));
						break;
					case SUB_NORMAL:
						UtilText.nodeContentSB.append(UtilText.parse(getCharactersForParsing(), UtilText.returnStringAtRandom(
                                "Not satisfied with having just [npc3.name] fucking [npc.her] [npc.pussy+], [npc.name] grab [npc2.namePos] [npc2.cock], before moving it up to [npc.her] [npc.labia+]."
                                        + " Letting out [npc.a_moan+], [npc.she] then buck [npc.her] [npc.hips] и force [npc2.herHim] to join [npc3.name] in double-penetrating [npc.her] [npc.pussy+].",
                                "Wanting more than just [npc3.namePos] [npc3.cock] in [npc.her] [npc.pussy], [npc.name] grab [npc2.namePos] [npc2.cock], before lining it up to [npc.her] [npc.labia+]."
                                        + " Bucking [npc.her] [npc.hips] back, [npc.she] let out [npc.a_moan+] as [npc.she] feel [npc2.namePos] [npc2.cock+] push in alongside [npc3.namePos] into [npc.her] [npc.pussy+].")));
						break;
					default:
						UtilText.nodeContentSB.append(UtilText.parse(getCharactersForParsing(), UtilText.returnStringAtRandom(
                                "Not satisfied with having just [npc3.name] fucking [npc.her] [npc.pussy+], [npc.name] impatiently grab [npc2.namePos] [npc2.cock], before eagerly moving it up to [npc.her] [npc.labia+]."
                                        + " Letting out [npc.a_moan+], [npc.she] then desperately buck [npc.her] [npc.hips] и force [npc2.herHim] to join [npc3.name] in double-penetrating [npc.her] [npc.pussy+].",
                                "Wanting more than just [npc3.namePos] [npc3.cock] in [npc.her] [npc.pussy], [npc.name] greedily grab [npc2.namePos] [npc2.cock], before quickly lining it up to [npc.her] [npc.labia+]."
                                        + " Impatiently bucking [npc.her] [npc.hips] back, [npc.she] let out [npc.a_moan+] as [npc.she] feel [npc2.namePos] [npc2.cock+] push in alongside [npc3.namePos] into [npc.her] [npc.pussy+].")));
						break;
				}
				...
				switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
					case DOM_GENTLE:
						UtilText.nodeContentSB.append(UtilText.parse(getCharactersForParsing(), UtilText.returnStringAtRandom(
                                "Not satisfied with having just [npc3.name] fucking [npc.her] [npc.pussy+], [npc.name] slowly move [npc.her] [npc.hips] until [npc2.namePos] [npc2.cock+] is pressed up to [npc.her] [npc.labia+],"
                                        + " and then with a little [npc.moan], [npc.she] gently buck back and force [npc2.herHim] to join [npc3.name] in double-penetrating [npc.her] [npc.pussy+].",
                                "Wanting to be fucked by more than just [npc3.name], [npc.name] push back against [npc2.namePos] [npc2.cock], making sure to line the [npc2.cockHead] up between [npc.her] [npc.labia+]"
										+ " before slowly moving back and forcing [npc2.herHim] to join [npc3.name] in double-penetrating [npc.her] [npc.pussy+].")));
						break;
					case DOM_ROUGH:
						UtilText.nodeContentSB.append(UtilText.parse(getCharactersForParsing(), UtilText.returnStringAtRandom(
                                "Not satisfied with having just [npc3.name] fucking [npc.her] [npc.pussy+], [npc.name] forcefully push [npc.her] [npc.hips] back until [npc2.namePos] [npc2.cock+] is pressed up to [npc.her] [npc.labia+],"
                                        + " and then with [npc.a_moan+], [npc.she] violently slam back and force [npc2.herHim] to join [npc3.name] in double-penetrating [npc.her] [npc.pussy+].",
                                "Wanting to be fucked by more than just [npc3.name], [npc.name] roughly push back against [npc2.namePos] [npc2.cock], making sure to line the [npc2.cockHead] up between [npc.her] [npc.labia+]"
										+ " before dominantly moving back and forcing [npc2.herHim] to join [npc3.name] in double-penetrating [npc.her] [npc.pussy+].")));
						break;
					case SUB_NORMAL:
						UtilText.nodeContentSB.append(UtilText.parse(getCharactersForParsing(), UtilText.returnStringAtRandom(
                                "Not satisfied with having just [npc3.name] fucking [npc.her] [npc.pussy+], [npc.name] push [npc.her] [npc.hips] back until [npc2.namePos] [npc2.cock+] is pressed up to [npc.her] [npc.labia+],"
                                        + " and then with [npc.a_moan+], [npc.she] buck back and force [npc2.herHim] to join [npc3.name] in double-penetrating [npc.her] [npc.pussy+].",
                                "Wanting to be fucked by more than just [npc3.name], [npc.name] push back against [npc2.namePos] [npc2.cock], making sure to line the [npc2.cockHead] up between [npc.her] [npc.labia+]"
										+ " before moving back and forcing [npc2.herHim] to join [npc3.name] in double-penetrating [npc.her] [npc.pussy+].")));
						break;
					default:
						UtilText.nodeContentSB.append(UtilText.parse(getCharactersForParsing(), UtilText.returnStringAtRandom(
                                "Not satisfied with having just [npc3.name] fucking [npc.her] [npc.pussy+], [npc.name] eagerly push [npc.her] [npc.hips] back until [npc2.namePos] [npc2.cock+] is pressed up to [npc.her] [npc.labia+],"
                                        + " and then with [npc.a_moan+], [npc.she] greedily buck back and force [npc2.herHim] to join [npc3.name] in double-penetrating [npc.her] [npc.pussy+].",
                                "Wanting to be fucked by more than just [npc3.name], [npc.name] desperately push back against [npc2.namePos] [npc2.cock], making sure to line the [npc2.cockHead] up between [npc.her] [npc.labia+]"
				...
				switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(this))) {
					...
					case SUB_RESISTING:
						UtilText.nodeContentSB.append(UtilText.parse(getCharactersForParsing(), UtilText.returnStringAtRandom(
                                ...
                                " With [npc2.a_sob+], [npc2.name] [npc2.verb(struggle)] against [npc.name] as [npc.she] force [npc2.her] [npc2.cock] deep into [npc.her] [npc.pussy+].")));
						break;
					default:
						UtilText.nodeContentSB.append(UtilText.parse(getCharactersForParsing(), UtilText.returnStringAtRandom(
								" [npc2.Name] [npc2.verb(let)] out [npc2.a_moan+] as [npc2.she] [npc2.verb(enter)] [npc.herHim],"
		...
		public String getDescription() {
			...
			if(PenisVagina.getOngoingCharacters(Main.sex.getCharacterTargetedForSexAction(this)).size()>1) {
				switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(this))) {
					case DOM_GENTLE:
						UtilText.nodeContentSB.append(UtilText.parse(PenisVagina.getCharactersForParsing(Main.sex.getCharacterTargetedForSexAction(this)), UtilText.returnStringAtRandom(
                                "[npc.Name] try to pull [npc.her] [npc.cock] out of [npc2.namePos] [npc2.pussy],"
                                ...
                                "Tears start to well up in [npc.namePos] [npc.eyes], and with [npc.a_sob+], [npc.she] try to pull [npc.her] [npc.cock] away from [npc2.namePos] [npc2.pussy+],"
				...
				switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(this))) {
					case DOM_GENTLE:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                ...
                                "With [npc.a_sob+], [npc.name] try to pull [npc.her] [npc.cock] away from [npc2.name], but [npc2.she] quickly [npc2.verb(grab)] it, before gently forcing it back inside [npc2.her] [npc2.pussy+].",
                                "Tears start to well up in [npc.namePos] [npc.eyes], and with [npc.a_sob+], [npc.she] try to pull [npc.her] [npc.cock] away from [npc2.namePos] [npc2.pussy+],"
										+ " but [npc2.name] quickly [npc2.verb(shift)] position, ignoring [npc.her] protests as [npc2.she] gently [npc2.verb(force)] [npc2.her] [npc2.pussy+] down onto [npc.her] [npc.cock+]."));
						break;
					case DOM_ROUGH:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                ...
                                "With [npc.a_sob+], [npc.name] try to pull [npc.her] [npc.cock] away from [npc2.name], but [npc2.she] quickly [npc2.verb(grab)] it, before roughly forcing it back inside [npc2.her] [npc2.pussy+].",
                                "Tears start to well up in [npc.namePos] [npc.eyes], and with [npc.a_sob+], [npc.she] try to pull [npc.her] [npc.cock] away from [npc2.namePos] [npc2.pussy+],"
										+ " but [npc2.name] quickly [npc2.verb(shift)] position, ignoring [npc.her] protests as [npc2.she] roughly [npc2.verb(force)] [npc2.her] [npc2.pussy+] down onto [npc.her] [npc.cock+]."));
						break;
					default: // DOM_NORMAL and in case anything goes wrong:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                ...
                                "With [npc.a_sob+], [npc.name] try to pull [npc.her] [npc.cock] away from [npc2.name], but [npc2.she] quickly [npc2.verb(grab)] it, before eagerly forcing it back inside [npc2.her] [npc2.pussy+].",
                                "Tears start to well up in [npc.namePos] [npc.eyes], and with [npc.a_sob+], [npc.she] try to pull [npc.her] [npc.cock] away from [npc2.namePos] [npc2.pussy+],"
										+ " but [npc2.name] quickly [npc2.verb(shift)] position, ignoring [npc.her] protests as [npc2.she] [npc2.verb(force)] [npc2.her] [npc2.pussy+] down onto [npc.her] [npc.cock+]."));
						break;
				}
			...
			if(PenisVagina.getOngoingCharacters(Main.sex.getCharacterTargetedForSexAction(this)).size()>1) {
					...
					case DOM_ROUGH:
						UtilText.nodeContentSB.append(UtilText.parse(PenisVagina.getCharactersForParsing(Main.sex.getCharacterTargetedForSexAction(this)), UtilText.returnStringAtRandom(
								"Roughly yanking [npc.her] [npc.cock+] out of [npc2.namePos] [npc2.pussy+],"
                                        + " [npc.name] dominantly slide the [npc.cockTip+] up and down over [npc2.her] [npc2.labia+] one last time before pulling back and leaving [npc3.name] to continue fucking [npc2.herHim].",
                                "Thrusting deep inside of [npc2.name] one last time, [npc.name] then yank [npc.her] [npc.cock+] back out of [npc2.her] [npc2.pussy+], putting an end to the rough double-penetration.")));
						break;
					default:
						UtilText.nodeContentSB.append(UtilText.parse(PenisVagina.getCharactersForParsing(Main.sex.getCharacterTargetedForSexAction(this)), UtilText.returnStringAtRandom(
								"Sliding [npc.her] [npc.cock] out of [npc2.namePos] [npc2.pussy+],"
                                        + " [npc.name] rub the [npc.cockTip] up and down over [npc2.her] [npc2.labia+] one last time before pulling back and leaving [npc3.name] to continue fucking [npc2.herHim].",
                                "Pushing deep inside of [npc2.name] one last time, [npc.name] then slide [npc.her] [npc.cock+] back out of [npc2.her] [npc2.pussy+], putting an end to the double-penetration.")));
						break;
				}
				...
				if(!isTargetedCharacterInanimate()) {
					switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(this))) {
						case SUB_RESISTING:
							UtilText.nodeContentSB.append(UtilText.parse(PenisVagina.getCharactersForParsing(Main.sex.getCharacterTargetedForSexAction(this)), UtilText.returnStringAtRandom(
                                    " [npc2.Name] can't [npc2.verb(help)] but [npc2.verb(let)] out [npc2.sob+] as [npc.name] pull out of [npc2.her] [npc2.pussy],"
						...
						default:
							UtilText.nodeContentSB.append(UtilText.parse(PenisVagina.getCharactersForParsing(Main.sex.getCharacterTargetedForSexAction(this)), UtilText.returnStringAtRandom(
                                    " [npc2.Name] [npc2.verb(let)] out [npc2.a_moan+] as [npc.name] pull [npc.her] [npc.cock+] out of [npc2.her] [npc2.pussy+], eager for more of [npc.her] attention.",
				...
				switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
					case DOM_ROUGH:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								"Roughly yanking [npc.her] [npc.cock+] out of [npc2.namePos] [npc2.pussy+],"
                                        + " [npc.name] dominantly slide the [npc.cockTip+] up and down over [npc2.her] [npc2.labia+] one last time before pulling back.",
                                "Thrusting deep inside of [npc2.name] one last time, [npc.name] then yank [npc.her] [npc.cock+] back out of [npc2.her] [npc2.pussy+], putting an end to the rough fucking."));
						break;
					default:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                "Sliding [npc.her] [npc.cock] out of [npc2.namePos] [npc2.pussy+], [npc.name] rub the [npc.cockTip] up and down over [npc2.her] [npc2.labia+] one last time before pulling back.",
                                "Pushing deep inside of [npc2.name] one last time, [npc.name] then slide [npc.her] [npc.cock+] back out of [npc2.her] [npc2.pussy+], putting an end to the fucking."));
						break;
				}
		...
		public String getDescription() {
			...
			if(!Main.sex.getCharacterPerformingAction().isTaur()) {
				switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
					case DOM_GENTLE:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                "Grabbing [npc2.namePos] [npc2.cock], [npc.name] slowly guide it up to [npc.her] [npc.labia+],"
                                ...
                                "Grabbing [npc2.namePos] [npc2.cock], [npc.name] line it up to [npc.her] [npc.pussy+],"
					...
					case SUB_NORMAL:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                "Grabbing [npc2.namePos] [npc2.cock], [npc.name] guide it up to [npc.her] [npc.labia+],"
					...
					default:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                "Grabbing [npc2.namePos] [npc2.cock], [npc.name] eagerly guide it up to [npc.her] [npc.labia+],"
				...
				switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
					case DOM_GENTLE:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                "[npc.Name] slowly move [npc.her] [npc.hips] until [npc2.namePos] [npc2.cock+] is pressed up to [npc.her] [npc.labia+],"
                                        + " and then with a little [npc.moan], [npc.she] gently buck back and force [npc2.herHim] to penetrate [npc.her] [npc.pussy+].",
                                "Pushing [npc.her] [npc.pussy+] back against [npc2.namePos] [npc2.cock], [npc.name] line it up between [npc.her] [npc.labia+],"
                                        + " before slowly moving back and letting out a soft [npc.moan] as [npc.she] force [npc2.herHim] to penetrate [npc.herHim]."));
						break;
					case DOM_ROUGH:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                "[npc.Name] forcefully push [npc.her] [npc.hips] back until [npc2.namePos] [npc2.cock+] is pressed up to [npc.her] [npc.labia+],"
                                        + " and then with [npc.a_moan+], [npc.she] violently slam back and force [npc2.herHim] to penetrate [npc.her] [npc.pussy+].",
                                "Roughly pushing [npc.her] [npc.pussy+] back against [npc2.namePos] [npc2.cock], [npc.name] line it up between [npc.her] [npc.labia+],"
                                        + " before dominantly moving back and letting out [npc.a_moan+] as [npc.she] force [npc2.herHim] to penetrate [npc.herHim]."));
						break;
					case SUB_NORMAL:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                "[npc.Name] push [npc.her] [npc.hips] back until [npc2.namePos] [npc2.cock+] is pressed up to [npc.her] [npc.labia+],"
                                        + " and then with [npc.a_moan+], [npc.she] buck back and force [npc2.herHim] to penetrate [npc.her] [npc.pussy+].",
                                "Pushing [npc.her] [npc.pussy+] back against [npc2.namePos] [npc2.cock], [npc.name] line it up between [npc.her] [npc.labia+],"
                                        + " before moving back and letting out [npc.a_moan+] as [npc.she] force [npc2.herHim] to penetrate [npc.herHim]."));
						break;
					default:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                "[npc.Name] eagerly push [npc.her] [npc.hips] back until [npc2.namePos] [npc2.cock+] is pressed up to [npc.her] [npc.labia+],"
                                        + " and then with [npc.a_moan+], [npc.she] greedily buck back and force [npc2.herHim] to penetrate [npc.her] [npc.pussy+].",
                                "Desperately pushing [npc.her] [npc.pussy+] back against [npc2.namePos] [npc2.cock], [npc.name] line it up between [npc.her] [npc.labia+],"
		...
		public String getDescription() {
			...
			if(PenisVagina.getOngoingCharacters(Main.sex.getCharacterPerformingAction()).size()>1) {
				UtilText.nodeContentSB.append(UtilText.parse(PenisVagina.getCharactersForParsing(Main.sex.getCharacterPerformingAction()), UtilText.returnStringAtRandom(
                        "With a gentle thrust of [npc.her] [npc.hips], [npc.name] let out a soft [npc.moan] as [npc.she] help to sink the two [npc2.cocks(true)] penetrating [npc.herHim] ever deeper into [npc.her] [npc.pussy+].",
                        "With a soft [npc.moan], [npc.name] gently start bucking [npc.her] [npc.hips], forcing #IF(npc3.isPlayer())[npc3.namePos] и [npc2.namePos]#ELSE[npc2.namePos] и [npc3.namePos]#ENDIF [npc2.cocks+(true)] ever deeper into [npc.her] [npc.pussy+].",
				...
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                        "With a gentle thrust of [npc.her] [npc.hips], [npc.name] let out a soft [npc.moan] as [npc.she] help to sink [npc2.namePos] [npc2.cock+] deep into [npc.her] [npc.pussy+].",
                        "With a soft [npc.moan], [npc.name] gently start bucking [npc.her] [npc.hips], forcing [npc2.namePos] [npc2.cock+] ever deeper into [npc.her] [npc.pussy+].",
	...
	public static final SexAction RIDING_PENIS_DOM_NORMAL = new SexAction(
		...
		public String getDescription() {
			...
			if(PenisVagina.getOngoingCharacters(Main.sex.getCharacterPerformingAction()).size()>1) {
				UtilText.nodeContentSB.append(UtilText.parse(PenisVagina.getCharactersForParsing(Main.sex.getCharacterPerformingAction()), UtilText.returnStringAtRandom(
                        "With an eager bucking of [npc.her] [npc.hips], [npc.name] let out [npc.a_moan+] as [npc.she] help to sink the two [npc2.cocks(true)] penetrating [npc.herHim] ever deeper into [npc.her] [npc.pussy+].",
                        "With [npc.a_moan+], [npc.name] enthusiastically start bucking [npc.her] [npc.hips], forcing #IF(npc3.isPlayer())[npc3.namePos] и [npc2.namePos]#ELSE[npc2.namePos] и [npc3.namePos]#ENDIF [npc2.cocks+(true)] ever deeper into [npc.her] [npc.pussy+].",
				...
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                        "With an eager bucking of [npc.her] [npc.hips], [npc.name] let out [npc.a_moan+] as [npc.she] help to sink [npc2.namePos] [npc2.cock+] deep into [npc.her] [npc.pussy+].",
                        "With [npc.a_moan+], [npc.name] enthusiastically start bucking [npc.her] [npc.hips], forcing [npc2.namePos] [npc2.cock+] ever deeper into [npc.her] [npc.pussy+].",
	...
	public static final SexAction RIDING_PENIS_DOM_ROUGH = new SexAction(
		...
		public String getDescription() {
			...
			if(PenisVagina.getOngoingCharacters(Main.sex.getCharacterPerformingAction()).size()>1) {
				UtilText.nodeContentSB.append(UtilText.parse(PenisVagina.getCharactersForParsing(Main.sex.getCharacterPerformingAction()), UtilText.returnStringAtRandom(
                        "With a violent slamming of [npc.her] [npc.hips], [npc.name] let out [npc.a_moan+] as [npc.she] force the two [npc2.cocks(true)] penetrating [npc.herHim] ever deeper into [npc.her] [npc.pussy+].",
                        "With [npc.a_moan+], [npc.name] roughly start bucking [npc.her] [npc.hips], forcing #IF(npc3.isPlayer())[npc3.namePos] и [npc2.namePos]#ELSE[npc2.namePos] и [npc3.namePos]#ENDIF [npc2.cocks+(true)] ever deeper into [npc.her] [npc.pussy+].",
				...
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                        "With a violent slam of [npc.her] [npc.hips], [npc.name] let out [npc.a_moan+] as [npc.she] force [npc2.namePos] [npc2.cock+] deep into [npc.her] [npc.pussy+].",
                        "With [npc.a_moan+], [npc.name] roughly start bucking [npc.her] [npc.hips], forcing [npc2.namePos] [npc2.cock+] ever deeper into [npc.her] [npc.pussy+].",
	...
	public static final SexAction RIDING_PENIS_SUB_NORMAL = new SexAction(
		...
		public String getDescription() {
			...
			if(PenisVagina.getOngoingCharacters(Main.sex.getCharacterPerformingAction()).size()>1) {
				UtilText.nodeContentSB.append(UtilText.parse(PenisVagina.getCharactersForParsing(Main.sex.getCharacterPerformingAction()), UtilText.returnStringAtRandom(
                        "With a quick buck of [npc.her] [npc.hips], [npc.name] let out [npc.a_moan+] as [npc.she] force the two [npc2.cocks(true)] penetrating [npc.herHim] ever deeper into [npc.her] [npc.pussy+].",
                        "With [npc.a_moan+], [npc.name] start bucking [npc.her] [npc.hips], forcing #IF(npc3.isPlayer())[npc3.namePos] и [npc2.namePos]#ELSE[npc2.namePos] и [npc3.namePos]#ENDIF [npc2.cocks+(true)] ever deeper into [npc.her] [npc.pussy+].",
				...
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                        "With a quick buck of [npc.her] [npc.hips], [npc.name] let out [npc.a_moan+] as [npc.she] help to sink [npc2.namePos] [npc2.cock+] deep into [npc.her] [npc.pussy+].",
                        "With [npc.a_moan+], [npc.name] start bucking [npc.her] [npc.hips], forcing [npc2.namePos] [npc2.cock+] ever deeper into [npc.her] [npc.pussy+].",
					...
					case DOM_GENTLE:
						UtilText.nodeContentSB.append(UtilText.parse(PenisVagina.getCharactersForParsing(Main.sex.getCharacterPerformingAction()), UtilText.returnStringAtRandom(
                                "[npc.Name] feel tears start to well up in [npc.her] [npc.eyes], and, not being able to hold back any longer, [npc.she] suddenly let out [npc.a_sob+],"
                                        + " before weakly trying to pull both #IF(npc3.isPlayer())[npc3.namePos] и [npc2.namePos]#ELSE[npc2.namePos] и [npc3.namePos]#ENDIF [npc2.cocks(true)] out of [npc.her] [npc.pussy+].",
                                "[npc.A_sob+] bursts out from [npc.namePos] mouth as [npc.she] frantically try to pull [npc.her] [npc.pussy] away from the unwanted double-penetration,"
		...
		public String getDescription() {
			...
			if(PenisVagina.getOngoingCharacters(Main.sex.getCharacterPerformingAction()).size()>1) {
				switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
					case DOM_ROUGH:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                "Yanking [npc2.namePos] [npc2.cock] out of [npc.her] [npc.pussy+], [npc.name] let out a menacing growl as [npc.she] command [npc2.name] to stop fucking [npc.herHim].",
                                "[npc.Name] lean into [npc2.name], inhaling [npc2.her] [npc2.scent] before yanking [npc2.her] [npc2.cock] out of [npc.her] [npc.pussy+]."));
						break;
					default:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                "Sliding [npc2.namePos] [npc2.cock] out of [npc.her] [npc.pussy+], [npc.name] let out [npc.a_moan+] as [npc.she] tell [npc2.name] to stop fucking [npc.herHim].",
                                "[npc.Name] lean into [npc2.name], inhaling [npc2.her] [npc2.scent] before sliding [npc2.her] [npc2.cock] out of [npc.her] [npc.pussy+]."));
						break;
				}
				...
				if(!isTargetedCharacterInanimate()) {
					switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(this))) {
						...
						default:
							UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                    " [npc2.Name] [npc2.verb(let)] out [npc2.a_moan+] as [npc.name] stop [npc2.herHim] from fucking [npc.her] [npc.pussy+].",
					...
					case SUB_RESISTING:
						return (UtilText.parse(PenisVagina.getCharactersForParsing(Main.sex.getCharacterTargetedForSexAction(action)), UtilText.returnStringAtRandom(
								" Desperately trying, and failing, to pull away from the two [npc.cocks(true)] inside of [npc2.herHim],"
                                        + " [npc2.name] [npc2.verb(let)] out [npc2.a_sob+], tears streaming down [npc2.her] [npc2.face] as [npc2.she] weakly [npc2.verb(beg)] for [npc.name] и [npc3.name] to pull out of [npc2.her] [npc2.pussy+].",
								...
								" [npc2.Sobbing] in distress, and with tears running down [npc2.her] [npc2.face],"
                                        + " [npc2.name] weakly [npc2.verb(struggle)] in a vain attempt to dislodge the [npc.cocks(true)] thrusting into [npc2.her] [npc2.pussy+], pleading and crying for [npc.name] и [npc3.name] to leave [npc2.herHim] alone.")));
					case SUB_NORMAL:
						return (UtilText.parse(PenisVagina.getCharactersForParsing(Main.sex.getCharacterTargetedForSexAction(action)), UtilText.returnStringAtRandom(
				...
				switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(action))) {
					case SUB_RESISTING:
						return UtilText.parse(PenisVagina.getCharactersForParsing(Main.sex.getCharacterPerformingAction()), UtilText.returnStringAtRandom(
								...
								" [npc2.A_sob+] bursts out from between [npc2.namePos] [npc2.lips] as [npc2.she] weakly [npc2.verb(try)] to push [npc.name] away,"
                                        + " squirming and protesting as [npc.name] continue to force both [npc2.her] и [npc3.namePos] [npc2.cock+] deep into [npc.her] [npc.pussy+].",
					...
					case SUB_RESISTING:
						return (UtilText.returnStringAtRandom(
								" Failing to pull [npc2.her] [npc2.cock] away from [npc.namePos] [npc.pussy],"
										+ " [npc2.name] [npc2.verb(let)] out [npc2.a_sob+] as [npc2.she] weakly [npc2.verb(try)] to struggle free.",
								" [npc2.A_sob+] bursts out from between [npc2.namePos] [npc2.lips] as [npc2.she] weakly [npc2.verb(try)] to push [npc.name] away,"
                                        + " squirming and protesting as [npc.name] continue to force [npc2.her] [npc2.cock+] deep into [npc.her] [npc.pussy+].",
								" [npc2.Sobbing] in distress, [npc2.name] [npc2.verb(try)], in vain, to pull [npc2.her] [npc2.cock] away from [npc.namePos] [npc.pussy+]."));
					case DOM_GENTLE:
						return (UtilText.returnStringAtRandom(
								" [npc2.Name] gently [npc2.verb(slide)] [npc2.her] [npc2.cock+] deep into [npc.namePos] [npc.pussy+],"
