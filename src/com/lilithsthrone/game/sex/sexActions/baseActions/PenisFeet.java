...
public class PenisFeet {
		...
		public String getDescription() {
			...
			if(Main.sex.getCharacterTargetedForSexAction(this).getLegType().getFootType().equals(FootType.HOOFS)) {
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                        "[npc.Eagerly(bringing)] [npc2.namePos] hard hoofs up to the sides of [npc.her] [npc.cock+], [npc.name] carefully press the soles up against [npc.her] genitals,"
										+ " before thrusting [npc.her] [npc.hips] forwards and starting to receive a hoofjob.",

                        "[npc.Name] rub the [npc.cockHead+] of [npc.her] [npc.cock] up against [npc2.namePos] hard hoofs,"
				...
				if(!isTargetedCharacterInanimate()) {
					switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(this))) {
						case SUB_RESISTING:
							UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                    " [npc2.Name] [npc2.verb(let)] out [npc2.a_sob+] as [npc.name] start using [npc2.her] [npc2.feet], and,"
						...
						default:
							UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                    " [npc2.Name] [npc2.verb(let)] out [npc2.a_moan+] as [npc.name] start using [npc2.her] [npc2.feet],"
				...
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                        "[npc.Eagerly(curling)] [npc2.namePos] bird-like feet around [npc.her] [npc.cock+], [npc.name] make sure that [npc2.her] sharp talons are pointing away from [npc.her] genitals,"
										+ " before thrusting [npc.her] [npc.hips] forwards and starting to receive a [npc2.footjob].",

                        "[npc.Name] rub the [npc.cockHead+] of [npc.her] [npc.cock] up against [npc2.namePos] soles,"
				...
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                        "[npc.Eagerly(pushing)] [npc2.namePos] [npc2.feet+] together, [npc.name] press the [npc.cockHead+] of [npc.her] [npc.cock+] up against them,"
										+ " before [npc.eagerly] thrusting [npc.her] [npc.hips] forwards and starting to fuck the crevice that's formed.",

                        "[npc.Name] rub the [npc.cockHead+] of [npc.her] [npc.cock] up against [npc2.namePos] [npc2.feet+],"
				...
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                        "[npc.Eagerly(pushing)] [npc2.namePos] [npc2.feet+] together, [npc.name] press the [npc.cockHead+] of [npc.her] [npc.cock+] up against [npc2.namePos] soles,"
										+ " before [npc.eagerly] thrusting [npc.her] [npc.hips] forwards and starting to fuck the crevice that's formed.",
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
					"Gently sliding [npc.her] [npc.cock+] between [npc2.namePos] [npc2.feet],"
                            + " [npc.name] start steadily bucking [npc.her] [npc.hips] back and forth, letting out a little [npc.moan] with every thrust as [npc.she] slowly receive [npc2.a_footjob].",

					"Gently slipping [npc.her] [npc.cock+] between [npc2.namePos] [npc2.feet+],"
                            + " [npc.name] start softly thrusting [npc.her] [npc.hips] forwards, letting out a little [npc.moan] as [npc.she] gently receive [npc2.a_footjob].",

                    "Softly pushing [npc2.namePos] [npc2.feet+] together, [npc.name] let out a little [npc.moan] as [npc.she] start to gently pump [npc.her] [npc.hips] back and forth,"
                            + " breathing in [npc2.her] [npc2.scent] as [npc.she] slowly receive [npc2.a_footjob]."));
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
					"Eagerly pushing [npc.her] [npc.cock+] between [npc2.namePos] [npc2.feet],"
                            + " [npc.name] start energetically bucking [npc.her] [npc.hips] back and forth, letting out [npc.a_moan+] with every thrust as [npc.she] greedily receive [npc2.a_footjob].",

					"Desperately pushing [npc.her] [npc.cock+] between [npc2.namePos] [npc2.feet+],"
                            + " [npc.name] start frantically thrusting [npc.her] [npc.hips] forwards, letting out [npc.a_moan+] as [npc.she] greedily receive [npc2.a_footjob].",

                    "Greedily pushing [npc2.namePos] [npc2.feet+] together, [npc.name] let out [npc.a_moan+] as [npc.she] start to desperately pump [npc.her] [npc.hips] back and forth,"
                            + " breathing in [npc2.her] [npc2.scent] as [npc.she] energetically receive [npc2.a_footjob]."));
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
					"Roughly thrusting [npc.her] [npc.cock+] between [npc2.namePos] [npc2.feet],"
                            + " [npc.name] start dominantly pumping [npc.her] [npc.hips] back and forth, letting out [npc.a_moan+] with every thrust as [npc.she] forcefully receive [npc2.a_footjob].",

					"Forcefully pushing [npc.her] [npc.cock+] between [npc2.namePos] [npc2.feet+],"
                            + " [npc.name] start violently thrusting [npc.her] [npc.hips] forwards, letting out [npc.a_moan+] as [npc.she] roughly receive [npc2.a_footjob].",

                    "Dominantly pushing [npc2.namePos] [npc2.feet+] together, [npc.name] let out [npc.a_moan+] as [npc.she] start to slam [npc.her] [npc.hips] back and forth,"
                            + " breathing in [npc2.her] [npc2.scent] as [npc.she] roughly receive [npc2.a_footjob]."));
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
					"Pushing [npc.her] [npc.cock+] between [npc2.namePos] [npc2.feet],"
                            + " [npc.name] start bucking [npc.her] [npc.hips] back and forth, letting out [npc.a_moan+] with every thrust as [npc.she] greedily receive [npc2.a_footjob].",

					"Pushing [npc.her] [npc.cock+] between [npc2.namePos] [npc2.feet+],"
                            + " [npc.name] start thrusting [npc.her] [npc.hips] forwards, letting out [npc.a_moan+] as [npc.she] happily receive [npc2.a_footjob].",

                    "Pushing [npc2.namePos] [npc2.feet+] together, [npc.name] let out [npc.a_moan+] as [npc.she] start to pump [npc.her] [npc.hips] back and forth,"
                            + " breathing in [npc2.her] [npc2.scent] as [npc.she] receive [npc2.a_footjob]."));
		...
		public String getDescription() {
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(this))) {
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Desperately trying, and failing, to pull [npc.her] [npc.cock+] away from [npc2.name], [npc.name] let out [npc.a_sob+] as, ignoring [npc.her] protests,"
                                    + " [npc2.she] slowly [npc2.verb(thrust)] [npc2.her] [npc2.feet] back against [npc.herHim] и [npc2.verb(continue)] gently forcing [npc.herHim] to receive [npc2.a_footjob].",
				...
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Desperately trying, and failing, to pull [npc.her] [npc.cock+] away from [npc2.name], [npc.name] let out [npc.a_sob+] as, ignoring [npc.her] protests,"
                                    + " [npc2.she] violently [npc2.verb(thrust)] [npc2.her] [npc2.feet] back against [npc.herHim] и [npc2.verb(continue)] roughly forcing [npc.herHim] to receive [npc2.a_footjob].",
				...
				default: // DOM_NORMAL and in case anything goes wrong:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Desperately trying, and failing, to pull [npc.her] [npc.cock+] away from [npc2.name], [npc.name] let out [npc.a_sob+] as, ignoring [npc.her] protests,"
                                    + " [npc2.she] eagerly [npc2.verb(thrust)] [npc2.her] [npc2.feet] back against [npc.herHim] и [npc2.verb(continue)] rapidly forcing [npc.herHim] to receive [npc2.a_footjob].",
				...
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Roughly yanking [npc.her] [npc.cock+] out from between [npc2.namePos] [npc2.feet+],"
                                    + " [npc.name] dominantly slide the [npc.cockHead] of [npc.her] [npc.cock] up and down over [npc2.her] [npc2.toes+] one last time before pulling [npc.her] [npc.hips] back.",
	...
	public static final SexAction FOOT_JOB_DOUBLE_GIVING_START = new SexAction(
		...
		public String getDescription() {
			...
			if(Main.sex.getCharacterPerformingAction().getLegType().getFootType().equals(FootType.HOOFS)) {
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                        "With [npc.a_moan+], [npc.name] [npc.eagerly] slide [npc2.namePos] [npc2.cock+] over [npc.her] hard hoofs,"
								+ " before carefully pressing them against the sides of [npc2.her] [npc2.cock] and starting to give [npc2.herHim] [npc.a_footjob].",

                        "Rubbing [npc.her] hard hoofs against [npc2.namePos] [npc2.cock+], [npc.name] carefully press them together,"
                                + " [npc.moaning+] as [npc.she] start to give [npc2.herHim] [npc.a_footjob]."));

				if(!isTargetedCharacterInanimate()) {
					switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(this))) {
						case SUB_RESISTING:
							UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                    " [npc2.Name] [npc2.verb(let)] out [npc2.a_sob+] as [npc.name] force [npc2.her] [npc2.cock] in between [npc.her] [npc.feet+],"
											+ " and, struggling against [npc.herHim], [npc2.she] desperately [npc2.verb(try)] to pull away.",

                                    " With [npc2.a_sob+], [npc2.name] [npc2.verb(struggle)] against [npc.name] as [npc.she] force [npc2.her] [npc2.cock] deep between [npc.her] [npc.feet]."));
							break;
						default:
							UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
				...
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                        "With [npc.a_moan+], [npc.name] [npc.eagerly] slide [npc2.namePos] [npc2.cock+] over the soles of [npc.her] bird-like claws,"
								+ " before carefully wrapping them around [npc2.her] [npc2.cock] and starting to give [npc2.herHim] [npc.a_footjob].",

                        "Rubbing [npc.her] bird-like claws against [npc2.namePos] [npc2.cock+], [npc.name] carefully wrap them around [npc2.her] shaft,"
                                + " [npc.moaning+] as [npc.she] start to give [npc2.herHim] [npc.a_footjob]."));
				...
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                        "With [npc.a_moan+], [npc.name] [npc.eagerly] slide [npc2.namePos] [npc2.cock+] over [npc.her] [npc.feet+],"
								+ " before [npc.eagerly] wrapping them around [npc2.her] [npc2.cock] and starting to give [npc2.herHim] [npc.a_footjob].",

                        "Rubbing [npc.her] [npc.feet+] against [npc2.namePos] [npc2.cock+], [npc.name] [npc.eagerly] press them together,"
                                + " [npc.moaning+] as [npc.she] start to give [npc2.herHim] [npc.a_footjob]."));
				...
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                        "With [npc.a_moan+], [npc.name] [npc.eagerly] slide [npc2.namePos] [npc2.cock+] over the soles of [npc.her] [npc.feet+],"
	...
	public static final SexAction FOOT_JOB_DOUBLE_GIVING_DOM_GENTLE = new SexAction(
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                    "Gently sliding [npc.her] [npc.feet] up and down around [npc2.namePos] [npc2.cock+], [npc.name] let out a soft [npc.moan] as [npc.she] give [npc2.herHim] [npc.a_footjob].",

                    "With a soft [npc.moan], [npc.name] gently start sliding [npc.her] [npc.feet+] up and down around [npc2.namePos] [npc2.cock+].",

                    "Slowly pressing [npc.her] [npc.feet+] together around [npc2.namePos] [npc2.cock+], [npc.name] let out [npc.a_moan+] as [npc.she] give [npc2.herHim] [npc.a_footjob]."));
	...
	public static final SexAction FOOT_JOB_DOUBLE_GIVING_DOM_NORMAL = new SexAction(
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                    "Eagerly sliding [npc.her] [npc.feet] up and down around [npc2.namePos] [npc2.cock+], [npc.name] let out [npc.a_moan+] as [npc.she] give [npc2.herHim] [npc.a_footjob].",

                    "With [npc.a_moan+], [npc.name] happily start sliding [npc.her] [npc.feet+] up and down around [npc2.namePos] [npc2.cock+].",

                    "Eagerly pressing [npc.her] [npc.feet+] together around [npc2.namePos] [npc2.cock+], [npc.name] let out [npc.a_moan+] as [npc.she] give [npc2.herHim] [npc.a_footjob]."));
	...
	public static final SexAction FOOT_JOB_DOUBLE_GIVING_DOM_ROUGH = new SexAction(
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                    "Roughly sliding [npc.her] [npc.feet+] up and down around [npc2.namePos] [npc2.cock+], [npc.name] let out [npc.a_moan+] as [npc.she] give [npc2.herHim] [npc.a_footjob].",
                    "With [npc.a_moan+], [npc.name] start forcefully sliding [npc.her] [npc.feet+] up and down around [npc2.namePos] [npc2.cock+].",
                    "Roughly pressing [npc.her] [npc.feet+] together around [npc2.namePos] [npc2.cock+], [npc.name] let out [npc.a_moan+] as [npc.she] give [npc2.herHim] [npc.a_footjob]."));
	...
	public static final SexAction FOOT_JOB_DOUBLE_GIVING_SUB_NORMAL = new SexAction(
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                    "Sliding [npc.her] [npc.feet] up and down around [npc2.namePos] [npc2.cock+], [npc.name] let out [npc.a_moan+] as [npc.she] give [npc2.herHim] [npc.a_footjob].",

                    "With [npc.a_moan+], [npc.name] happily start sliding [npc.her] [npc.feet+] up and down around [npc2.namePos] [npc2.cock+].",

                    "Pressing [npc.her] [npc.feet+] together around [npc2.namePos] [npc2.cock+], [npc.name] let out [npc.a_moan+] as [npc.she] give [npc2.herHim] [npc.a_footjob]."));
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(this))) {
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            ...
                            "[npc.A_sob+] bursts out from [npc.namePos] mouth as [npc.she] frantically try to pull [npc.her] [npc.feet] away from [npc2.namePos] [npc2.cock],"
	...
	public static final SexAction FOOT_JOB_DOUBLE_GIVING_STOP = new SexAction(
		...
		public String getDescription() {
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Yanking [npc2.namePos] [npc2.cock] out from between [npc.her] [npc.feet], [npc.name] let out a menacing growl as [npc.she] command [npc2.herHim] to stop.",

                            "[npc.Name] lean into [npc2.name], inhaling [npc2.her] [npc2.scent] before yanking [npc2.her] [npc2.cock] out from between [npc.her] [npc.feet]."));
					break;
				default:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Sliding [npc2.namePos] [npc2.cock] out from between [npc.her] [npc.feet], [npc.name] let out [npc.a_moan+] as [npc.she] tell [npc2.herHim] to stop.",

                            "[npc.Name] lean into [npc2.name], inhaling [npc2.her] [npc2.scent] before sliding [npc2.her] [npc2.cock] out from between [npc.her] [npc.feet]."));
					break;
			}
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(action))) {
				...
				case SUB_RESISTING:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							...
							" [npc2.A_sob+] bursts out from between [npc2.namePos] [npc2.lips] as [npc2.she] weakly [npc2.verb(try)] to push [npc.name] away,"
                                    + " squirming and protesting as [npc.name] continue to force [npc2.her] [npc2.cock+] in between [npc.her] [npc.feet+].",
