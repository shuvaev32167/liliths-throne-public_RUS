...
public class ClitMouth {
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
				case DOM_GENTLE:
					return UtilText.returnStringAtRandom(
                            "Shifting [npc.her] [npc.hips], [npc.name] reposition [npc.herself] in order to gently grind [npc.her] [npc.clit+] against [npc2.namePos] [npc2.lips+].",

                            "With a quick shift of [npc.her] [npc.hips], [npc.name] let out a soft [npc.moan] as [npc.she] gently press [npc.her] [npc.clit+] down against [npc2.namePos] [npc2.tongue+].",
							
							"Gently pressing [npc.her] [npc.pussy+] down against [npc2.namePos] mouth,"
                                    + " [npc.name] reposition [npc.herself] so that [npc.sheIs] grinding [npc.her] [npc.clit+] down against [npc2.namePos] [npc2.lips+].");

				case SUB_EAGER:
				case DOM_NORMAL:
					return UtilText.returnStringAtRandom(
                            "Shifting [npc.her] [npc.hips], [npc.name] reposition [npc.herself] in order to eagerly grind [npc.her] [npc.clit+] against [npc2.namePos] [npc2.lips+].",

                            "With a quick shift of [npc.her] [npc.hips], [npc.name] let out [npc.a_moan+] as [npc.she] greedily press [npc.her] [npc.clit+] down against [npc2.namePos] [npc2.tongue+].",
				...
				case DOM_ROUGH:
					return UtilText.returnStringAtRandom(
                            "Shifting [npc.her] [npc.hips], [npc.name] reposition [npc.herself] in order to roughly grind [npc.her] [npc.clit+] against [npc2.namePos] [npc2.lips+].",

                            "With a quick shift of [npc.her] [npc.hips], [npc.name] let out [npc.a_moan+] as [npc.she] roughly grind [npc.her] [npc.clit+] down against [npc2.namePos] [npc2.tongue+].",
							
							"Aggressively pressing [npc.her] [npc.pussy+] down against [npc2.namePos] mouth,"
                                    + " [npc.name] reposition [npc.herself] so that [npc.sheIs] roughly grinding [npc.her] [npc.clit+] down against [npc2.namePos] [npc2.lips+].");
					
				case SUB_NORMAL:
					return UtilText.returnStringAtRandom(
                            "Shifting [npc.her] [npc.hips], [npc.name] reposition [npc.herself] in order to grind [npc.her] [npc.clit+] against [npc2.namePos] [npc2.lips+].",

                            "With a quick shift of [npc.her] [npc.hips], [npc.name] let out [npc.a_moan+] as [npc.she] press [npc.her] [npc.clit+] down against [npc2.namePos] [npc2.tongue+].",
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Slowly sliding [npc.her] [npc.tongue] over [npc2.namePos] [npc2.pussy+], [npc.name] press [npc.her] [npc.lips+] against [npc2.her] [npc2.clit+], before starting to gently suck and kiss it.",

                            "With a long, slow lick, [npc.name] run [npc.her] [npc.tongue] up and over [npc2.namePos] [npc2.clit+],"
                                    + " pressing [npc.her] [npc.lips+] against it as [npc.she] gently start kissing and sucking on [npc2.her] [npc2.clit+].",

                            "Gently kissing and licking [npc2.namePos] [npc2.pussy+], [npc.name] slowly make [npc.her] way to [npc2.her] [npc2.clit+],"
                                    + " and with a series of soft licks from [npc.her] [npc.tongue+], [npc.she] start focusing on pleasuring [npc2.her] [npc2.clit+]."));
					break;
				case DOM_NORMAL:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Eagerly sliding [npc.her] [npc.tongue] over [npc2.namePos] [npc2.pussy+], [npc.name] press [npc.her] [npc.lips+] against [npc2.her] [npc2.clit+], before starting to greedily suck and kiss it.",

                            "With a long, wet lick, [npc.name] run [npc.her] [npc.tongue] up and over [npc2.namePos] [npc2.clit+],"
                                    + " pressing [npc.her] [npc.lips+] against it as [npc.she] eagerly start kissing and sucking on [npc2.her] [npc2.clit+].",

                            "Eagerly kissing and licking [npc2.namePos] [npc2.pussy+], [npc.name] make [npc.her] way to [npc2.her] [npc2.clit+],"
                                    + " and with a series of wet licks from [npc.her] [npc.tongue+], [npc.she] start focusing on pleasuring [npc2.her] [npc2.clit+]."));
					break;
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Roughly dragging [npc.her] [npc.tongue+] over [npc2.namePos] [npc2.pussy+],"
                                    + " [npc.name] forcefully press [npc.her] [npc.lips+] against [npc2.her] [npc2.clit+], before starting to dominantly suck and kiss it.",

                            "With a rough, wet lick, [npc.name] run [npc.her] [npc.tongue] up and over [npc2.namePos] [npc2.clit+],"
                                    + " pressing [npc.her] [npc.lips+] against it as [npc.she] start forcefully kissing and sucking on [npc2.her] [npc2.clit+].",

                            "Roughly kissing and licking [npc2.namePos] [npc2.pussy+], [npc.name] make [npc.her] way to [npc2.her] [npc2.clit+],"
                                    + " and with a series of greedy, wet licks from [npc.her] [npc.tongue+], [npc.she] start focusing on pleasuring [npc2.her] [npc2.clit+]."));
					break;
				case SUB_EAGER:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Eagerly sliding [npc.her] [npc.tongue] over [npc2.namePos] [npc2.pussy+], [npc.name] press [npc.her] [npc.lips+] against [npc2.her] [npc2.clit+], before starting to greedily suck and kiss it.",
				...
				case SUB_NORMAL:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Sliding [npc.her] [npc.tongue] over [npc2.namePos] [npc2.pussy+], [npc.name] press [npc.her] [npc.lips+] against [npc2.her] [npc2.clit+], before starting to suck and kiss it.",

                            "With a long, wet lick, [npc.name] run [npc.her] [npc.tongue] up and over [npc2.namePos] [npc2.clit+],"
                                    + " pressing [npc.her] [npc.lips+] against it as [npc.she] start kissing and sucking on [npc2.her] [npc2.clit+].",

                            "Kissing and licking [npc2.namePos] [npc2.pussy+], [npc.name] make [npc.her] way to [npc2.her] [npc2.clit+],"
                                    + " and with a series of wet licks from [npc.her] [npc.tongue+], [npc.she] start focusing on pleasuring [npc2.her] [npc2.clit+]."));
					break;
				default:
					break;
	...
	public static final SexAction TWINTAIL_PULL = new SexAction(
		...
		public String getDescription() {
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Taking hold of [npc2.namePos] " + style + ", [npc.name] gently pull [npc2.her] forwards, forcing [npc2.herHim] to swallow [npc.her] [npc.clit+] all the way down to the base.",
                            "Reaching down to take a gentle, but firm, grip on each of [npc2.namePos] " + style + ", [npc.name] slowly pull [npc2.herHim] into [npc.her] groin,"
                                    + " letting out [npc.a_moan+] as [npc.she] force [npc2.herHim] to deepthroat [npc.her] [npc.clit+].",
				...
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Roughly grasping [npc2.namePos] " + style + ", [npc.name] violently jerk [npc2.her] head forwards, forcing [npc2.herHim] to swallow [npc.her] [npc.clit+] all the way down to the base.",
				...
				default: // For dom normal, sub normal, and sub eager:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Taking hold of [npc2.namePos] " + style + ", [npc.name] firmly pull [npc2.her] head forwards, forcing [npc2.herHim] to swallow [npc.her] [npc.clit+] all the way down to the base.",
					...
					case DOM_GENTLE:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								" With tears welling up in [npc2.her] [npc2.eyes], [npc2.name] [npc2.verb(spend)] a moment gently caressing the underside of [npc.namePos] [npc.clit] with [npc2.her] [npc2.tongue],"
                                        + " before finally being able to gasp for air as [npc.she] momentarily withdraw [npc.her] [npc.clit+] from [npc2.her] throat.",
					...
					case SUB_RESISTING:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								" Scrunching [npc2.her] [npc2.eyes] shut, [npc2.name] [npc2.verb(beat)] against #IF(npc.isPlayer())your#ELSE[npc.her] tormentor's#ENDIF thighs in a futile gesture of resistance,"
                                        + " before finally being able to cry and gasp for air as [npc.name] momentarily withdraw [npc.her] [npc.clit+] from [npc2.her] throat.",
	...
	public static final SexAction EAR_PULL = new SexAction(
		...
		public String getDescription() {
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Taking hold of [npc2.namePos] [npc2.ears+], [npc.name] gently pull [npc2.her] forwards, forcing [npc2.herHim] to swallow [npc.her] [npc.clit+] all the way down to the base.",
				...
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Roughly grasping [npc2.namePos] [npc2.ears+], [npc.name] violently jerk [npc2.her] head forwards, forcing [npc2.herHim] to swallow [npc.her] [npc.clit+] all the way down to the base.",
				...
				default: // For dom normal, sub normal, and sub eager:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Taking hold of [npc2.namePos] [npc2.ears+], [npc.name] firmly pull [npc2.her] head forwards, forcing [npc2.herHim] to swallow [npc.her] [npc.clit+] all the way down to the base.",
	...
	public static final SexAction GRAB_HORNS = new SexAction(
		...
		public String getDescription() {
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Taking hold of [npc2.namePos] [npc2.horns+], [npc.name] gently pull [npc2.her] forwards, forcing [npc2.herHim] to swallow [npc.her] [npc.clit+] all the way down to the base.",
				...
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Roughly grasping [npc2.namePos] [npc2.horns+], [npc.name] violently jerk [npc2.her] head forwards, forcing [npc2.herHim] to swallow [npc.her] [npc.clit+] all the way down to the base.",
				...
				default: // For dom normal, sub normal, and sub eager:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Taking hold of [npc2.namePos] [npc2.horns+], [npc.name] firmly pull [npc2.her] head forwards, forcing [npc2.herHim] to swallow [npc.her] [npc.clit+] all the way down to the base.",
	...
	public static final SexAction GRAB_ANTENNAE = new SexAction(
		...
		public String getDescription() {
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Taking hold of [npc2.namePos] [npc2.antennae+], [npc.name] gently pull [npc2.her] forwards, forcing [npc2.herHim] to swallow [npc.her] [npc.clit+] all the way down to the base.",
				...
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Roughly grasping [npc2.namePos] [npc2.antennae+], [npc.name] violently jerk [npc2.her] head forwards, forcing [npc2.herHim] to swallow [npc.her] [npc.clit+] all the way down to the base.",
				...
				default: // For dom normal, sub normal, and sub eager:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Taking hold of [npc2.namePos] [npc2.antennae+], [npc.name] firmly pull [npc2.her] head forwards, forcing [npc2.herHim] to swallow [npc.her] [npc.clit+] all the way down to the base.",
		...
		public String getDescription() {
			...
			return UtilText.parse(performer, target,
					UtilText.returnStringAtRandom(
                            "Letting out a muffled [npc.moan], [npc.name] concentrate on squeezing the extra internal muscles within [npc.her] throat down around [npc2.namePos] [npc2.clit+].",
						isTargetedCharacterInanimate()
							?null
                                ...
                                + " Gripping and squeezing them down around the [npc2.clit+] in [npc.her] mouth, [npc.name] cause [npc2.name] to let out an involuntary cry of pleasure.",
                            "[npc.Name] find [npc.her] letting out a series of muffled [npc.moans] as [npc.she] concentrate on squeezing the extra muscles within [npc.her] throat down around [npc2.namePos] [npc2.clit+].",
                            "With a muffled [npc.moan], [npc.name] focus on controlling the extra muscles deep within [npc.her] throat, gripping them down and massaging [npc2.namePos] [npc2.clit+]."));
		}
	};
		...
		public String getDescription() {
			...
			if(Main.sex.getSexPositionSlot(Main.sex.getCharacterTargetedForSexAction(this)).hasTag(SexSlotTag.PERFORMING_ORAL)) {
				...
				switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
					case DOM_GENTLE:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                "Reaching down to grab [npc2.namePos] head, [npc.name] line the [npc.clitTip+] of [npc.her] [npc.clit] up to [npc2.her] [npc2.lips+],"
										+ " before gently pushing [npc.her] [npc.hips] forwards and sliding [npc.her] [npc.clit+] into [npc2.her] mouth.",

                                "Reaching down to take hold of [npc2.namePos] head, [npc.name] push the [npc.clitTip+] of [npc.her] [npc.clit] against [npc2.namePos] [npc2.lips+],"
				...
				switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
					case DOM_GENTLE:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                "Shuffling back a little, [npc.name] slowly lower [npc.her] [npc.clit+] down to [npc2.namePos] mouth,"
										+ " before gently pushing the [npc.clitTip+] past [npc2.her] [npc2.lips+] and collapsing down onto [npc2.her] [npc2.face+].",

                                "Gently lowering [npc.her] [npc.clit+] down to [npc2.namePos] mouth, [npc.name] slowly allow [npc.her] [npc.legs] to give out from under [npc.herHim]"
										+ " as [npc.she] forces the [npc.clitTip+] past [npc2.her] [npc2.lips+]."));
						break;
					case DOM_NORMAL:
					case SUB_EAGER:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                "Shuffling back a little, [npc.name] quickly drop [npc.her] [npc.clit+] down to [npc2.namePos] mouth,"
										+ " before eagerly pushing the [npc.clitTip+] past [npc2.her] [npc2.lips+] and collapsing down onto [npc2.her] [npc2.face+].",

                                "Quickly dropping [npc.her] [npc.clit+] down to [npc2.namePos] mouth, [npc.name] allow [npc.her] [npc.legs] to give out from under [npc.herHim]"
										+ " as [npc.she] eagerly forces the [npc.clitTip+] past [npc2.her] [npc2.lips+]."));
						break;
					case DOM_ROUGH:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                "Shuffling back a little, [npc.name] roughly grind [npc.her] [npc.clit+] down against [npc2.namePos] mouth,"
										+ " before forcefully pushing the [npc.clitTip+] past [npc2.her] [npc2.lips+] and collapsing down onto [npc2.her] [npc2.face+].",

                                "Roughly grinding [npc.her] [npc.clit+] down against [npc2.namePos] mouth, [npc.name] allow [npc.her] [npc.legs] to give out from under [npc.herHim]"
										+ " as [npc.she] forces the [npc.clitTip+] past [npc2.her] [npc2.lips+]."));
						break;
					case SUB_NORMAL:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
					...
					case DOM_GENTLE:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								"Lining the [npc.clitTip+] of [npc.her] [npc.clit] up to [npc2.namePos] [npc2.lips+],"
                                        + " [npc.name] gently push [npc.her] [npc.hips] forwards and slide [npc.her] [npc.clit+] into [npc2.her] mouth.",

								"Pushing the [npc.clitTip+] of [npc.her] [npc.clit] against [npc2.namePos] [npc2.lips+],"
                                        + " [npc.name] slowly push [npc.her] [npc.hips] into [npc2.her] [npc2.face], gently sliding [npc.her] [npc.clit+] into [npc2.her] mouth."));
						break;
					case DOM_NORMAL:
					case SUB_EAGER:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								"Lining the [npc.clitTip+] of [npc.her] [npc.clit] up to [npc2.namePos] [npc2.lips+],"
                                        + " [npc.name] eagerly push [npc.her] [npc.hips] forwards and slide [npc.her] [npc.clit+] into [npc2.namePos] mouth.",

								"Pushing the [npc.clitTip+] of [npc.her] [npc.clit] against [npc2.namePos] [npc2.lips+],"
                                        + " [npc.name] eagerly buck [npc.her] [npc.hips] into [npc2.her] [npc2.face], sliding [npc.her] [npc.clit+] into [npc2.her] mouth."));
						break;
					case DOM_ROUGH:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								"Lining the [npc.clitTip+] of [npc.her] [npc.clit] up to [npc2.namePos] [npc2.lips+],"
                                        + " [npc.name] roughly slams [npc.her] [npc.hips] forwards and force [npc.her] [npc.clit+] into [npc2.namePos] mouth.",

								"Grinding the [npc.clitTip+] of [npc.her] [npc.clit] against [npc2.namePos] [npc2.lips+],"
                                        + " [npc.name] roughly slam [npc.her] [npc.hips] into [npc2.her] [npc2.face], forcing [npc.her] [npc.clit+] into [npc2.her] mouth."));
						break;
					case SUB_NORMAL:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								"Lining the [npc.clitTip+] of [npc.her] [npc.clit] up to [npc2.namePos] [npc2.lips+],"
                                        + " [npc.name] push [npc.her] [npc.hips] forwards and slide [npc.her] [npc.clit+] into [npc2.her] mouth.",

								"Pushing the [npc.clitTip+] of [npc.her] [npc.clit] against [npc2.namePos] [npc2.lips+],"
                                        + " [npc.name] buck [npc.her] [npc.hips] into [npc2.her] [npc2.face], sliding [npc.her] [npc.clit+] into [npc2.her] mouth."));
						break;
					default:
						break;
				}
	...
	public static final SexAction CLIT_ORAL_DOM_GENTLE = new SexAction(
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                    "[npc.Name] gently slide [npc.her] [npc.clit+] past [npc2.namePos] [npc2.lips+],"
                    ...
                    "[npc.Name] slowly push [npc.her] [npc.hips] into [npc2.namePos] [npc2.face], letting out a soft [npc.moan] as [npc.she] gently fuck [npc2.her] throat.",
						"Gently bucking [npc.her] [npc.hips+] into [npc2.namePos] [npc2.face],"
                                + " [npc.name] let out a soft [npc.moan] as [npc.she] continue receiving [npc2.her] oral attention."));
	...
	public static final SexAction CLIT_ORAL_DOM_NORMAL = new SexAction(
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                    "[npc.Name] eagerly thrust [npc.her] [npc.clit+] past [npc2.namePos] [npc2.lips+],"
                    ...
                    "[npc.Name] desperately buck [npc.her] [npc.hips] into [npc2.namePos] [npc2.face], letting out [npc.a_moan+] as [npc.she] eagerly fuck [npc2.her] throat.",
						"Enthusiastically bucking [npc.her] [npc.hips+] into [npc2.namePos] [npc2.face],"
                                + " [npc.name] let out [npc.a_moan+] as [npc.she] continue happily receiving [npc2.her] oral attention."));
		...
		public String getDescription() {
			...
			if(Main.sex.getSexPositionSlot(Main.sex.getCharacterPerformingAction()).hasTag(SexSlotTag.STANDING)
				...
				for(PenetrationModifier pm : Main.sex.getCharacterPerformingAction().getClitorisModifiers()) {
					switch(pm) {
						case BARBED:
                            descriptions.add("With a sudden, violent thrust forwards, [npc.name] bury [npc.her] [npc.clit+] deep down [npc2.namePos] throat."
                                    + " Holding [npc2.her] head in place with both [npc.hands], [npc.she] then proceed to start roughly fucking [npc2.her] [npc2.face]"
												+ (isTargetedCharacterInanimate()
                                    ? ", grinning as [npc.she] feel the barbs lining [npc.her] shaft repeatedly rake up the sides of [npc2.namePos] throat."
						...
						case FLARED:
                            descriptions.add("With a sudden, violent thrust forwards, [npc.name] bury [npc.her] [npc.clit+] deep down [npc2.namePos] throat."
                                    + " Holding [npc2.her] head in place with both [npc.hands], [npc.she] then proceed to start roughly fucking [npc2.her] [npc2.face]"
												+ (isTargetedCharacterInanimate()
                                    ? ", grinning as [npc.she] feel [npc.her] wide, flared head forcing its way up and down [npc2.namePos] throat."
						...
						case KNOTTED:
                            descriptions.add("With a sudden, violent thrust forwards, [npc.name] bury [npc.her] [npc.clit+] deep down [npc2.namePos] throat."
                                    + " Holding [npc2.her] head in place with both [npc.hands], [npc.she] then proceed to start roughly fucking [npc2.her] [npc2.face]"
												+ (isTargetedCharacterInanimate()
                                    ? ", grinning as [npc.she] slam [npc.her] knot repeatedly against [npc2.namePos] [npc2.lips+]."
                ...
                descriptions.add("Letting out [npc.a_moan+], [npc.name] slam [npc.her] [npc.clit+] all the way down [npc2.namePos] throat."
                ...
                descriptions.add("With a forceful thrust, [npc.name] hilt [npc.her] [npc.clit+] deep down [npc2.namePos] throat."
				...
				for(PenetrationModifier pm : Main.sex.getCharacterPerformingAction().getClitorisModifiers()) {
					switch(pm) {
						case BARBED:
                            descriptions.add("Spreading [npc.her] knees out on either side of [npc2.namePos] head, [npc.name] violently thrust downwards, burying [npc.her] [npc.clit+] deep down [npc2.namePos] throat."
				...
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                        "[npc.Name] roughly slam [npc.her] [npc.clit+] past [npc2.namePos] [npc2.lips+],"
	...
	public static final SexAction CLIT_ORAL_SUB_RESISTING = new SexAction(
		...
		public String getDescription() {
			...
			if(!isTargetedCharacterInanimate()) {
				switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(this))) {
					case DOM_GENTLE:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                ...
                                "Tears start to well up in [npc.namePos] [npc.eyes], and with [npc.a_sob+], [npc.she] try to pull [npc.her] [npc.clit+] out of [npc2.namePos] mouth."
                                        + " [npc2.Her] grip proves to be too strong, however, and [npc2.name] gently, but firmly, continue to suck [npc.her] [npc.clit+] as [npc.she] weakly struggles against [npc2.herHim].",

                                "[npc.Sobbing+], [npc.name] try to pull [npc.her] [npc.clit+] out of [npc2.namePos] mouth, but [npc2.her] grip is too strong for [npc.herHim]"
					...
					default: // DOM_NORMAL and in case anything goes wrong:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                ...
                                "Tears start to well up in [npc.namePos] [npc.eyes], and with [npc.a_sob+], [npc.she] try to pull [npc.her] [npc.clit+] out of [npc2.namePos] mouth."
                                        + " [npc2.Her] grip proves to be too strong, however, and [npc2.she] eagerly continue to suck [npc.her] [npc.clit+] as [npc.she] weakly struggles against [npc2.herHim].",
				...
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                        "Letting out [npc.a_sob+], [npc.name] frantically try to pull [npc.her] hips away from [npc2.namePos] face, but [npc.her] efforts prove to be in vain as [npc2.she] [npc2.verb(move)] forwards and"
								+ " [npc2.verb(continue)] giving [npc.herHim] [npc2.her] unwanted oral attention.",
	...
	public static final SexAction CLIT_ORAL_SUB_NORMAL = new SexAction(
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                    "[npc.Name] thrust [npc.her] [npc.clit+] past [npc2.namePos] [npc2.lips+],"
	...
	public static final SexAction CLIT_ORAL_STOP = new SexAction(
		...
		public String getDescription() {
			...
			if(Main.sex.getSexPositionSlot(Main.sex.getCharacterPerformingAction()).hasTag(SexSlotTag.SIXTY_NINE)) {
                UtilText.nodeContentSB.append("Using [npc.her] knees to lift [npc.herself] up, [npc.name] allow [npc.her] [npc.clit+] to slide up and out of [npc2.namePos] mouth."
				...
				switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
					...
					default:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                "Sliding [npc.her] [npc.clit+] out of [npc2.namePos] mouth, [npc.name] let out [npc.a_moan+] as [npc.she] puts an end to the oral experience.",

                                "With [npc.a_moan+], [npc.name] pull [npc.her] [npc.hips] back, sliding [npc.her] [npc.clit+] fully out of [npc2.namePos] mouth."));
						break;
				}
			}
		...
		public String getDescription() {
			...
			if(Main.sex.getSexPositionSlot(Main.sex.getCharacterPerformingAction()).hasTag(SexSlotTag.SIXTY_NINE)) {
					...
					case DOM_GENTLE:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								...
								"Gently lowering [npc.her] head down between [npc2.namePos] [npc2.legs],"
                                        + " [npc.name] deliver a long, slow lick up the length of [npc2.her] [npc2.clit+], before taking the [npc2.clitTip+] into [npc.her] mouth."));
						break;
					case DOM_NORMAL:
					case SUB_EAGER:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								...
								"Eagerly dropping [npc.her] head down between [npc2.namePos] [npc2.legs],"
                                        + " [npc.name] deliver a long, wet lick up the length of [npc2.her] [npc2.clit+], before greedily taking the [npc2.clitTip+] into [npc.her] mouth."));
						break;
					case DOM_ROUGH:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								...
								"Dropping [npc.her] head down between [npc2.namePos] [npc2.legs],"
                                        + " [npc.name] deliver a rough, wet lick up the length of [npc2.her] [npc2.clit+], before forcefully taking the [npc2.clitTip+] into [npc.her] mouth."));
						break;
					case SUB_NORMAL:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								...
								"Dropping [npc.her] head down between [npc2.namePos] [npc2.legs],"
                                        + " [npc.name] deliver a long, wet lick up the length of [npc2.her] [npc2.clit+], before taking the [npc2.clitTip+] into [npc.her] mouth."));
						break;
					default:
						break;
				}
				...
				switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
					case DOM_GENTLE:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								"Bringing [npc.her] [npc.lips+] to the [npc2.clitTip+] of [npc2.namePos] [npc2.clit],"
                                        + " [npc.name] slowly take [npc2.herHim] into [npc.her] mouth, letting out a muffled [npc.moan] as [npc.she] start giving [npc2.herHim] [npc.her] oral attention.",

								"Wrapping [npc.her] [npc.lips+] around the [npc2.clitTip+] of [npc2.namePos] [npc2.clit],"
                                        + " [npc.name] let out a muffled [npc.moan] as [npc.she] start giving [npc2.herHim] [npc.her] oral attention."));
						break;
					case DOM_NORMAL:
					case SUB_EAGER:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								"Bringing [npc.her] [npc.lips+] up to the [npc2.clitTip+] of [npc2.namePos] [npc2.clit],"
                                        + " [npc.name] eagerly take [npc2.herHim] into [npc.her] mouth, letting out a muffled [npc.moan] as [npc.she] happily start giving [npc2.herHim] [npc.her] oral attention.",

								"Wrapping [npc.her] [npc.lips+] around the [npc2.clitTip+] of [npc2.namePos] [npc2.clit],"
                                        + " [npc.name] let out a muffled [npc.moan] as [npc.she] eagerly start giving [npc2.herHim] [npc.her] oral attention."));
						break;
					case DOM_ROUGH:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								"Bringing [npc.her] [npc.lips+] up to the [npc2.clitTip+] of [npc2.namePos] [npc2.clit],"
                                        + " [npc.name] forcefully take [npc2.herHim] into [npc.her] mouth, letting out a muffled [npc.moan] as [npc.she] start giving [npc2.herHim] [npc.her] oral attention.",
					...
					case SUB_NORMAL:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								"Bringing [npc.her] [npc.lips+] up to the [npc2.clitTip+] of [npc2.namePos] [npc2.clit],"
                                        + " [npc.name] take [npc2.herHim] into [npc.her] mouth, letting out a muffled [npc.moan] as [npc.she] start giving [npc2.herHim] [npc.her] oral attention.",
			...
			if(!isTargetedCharacterInanimate()) {
				switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(this))) {
					case DOM_GENTLE:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                " [npc2.Name] gently [npc2.verb(buck)] [npc2.her] [npc2.hips] into [npc.namePos] [npc.face], softly [npc2.moaning] as [npc.she] suck [npc2.her] [npc2.clit+].",
					...
					case SUB_EAGER:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                " [npc2.Name] greedily [npc2.verb(buck)] [npc2.her] [npc2.hips] into [npc.namePos] [npc.face], [npc2.moaning+] as [npc.she] suck [npc2.her] [npc2.clit+].",
					...
					case DOM_ROUGH:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                " [npc2.Name] roughly [npc2.verb(slam)] [npc2.her] [npc2.hips] into [npc.namePos] [npc.face], [npc2.moaning+] as [npc.she] suck [npc2.her] [npc2.clit+].",
					...
					case SUB_NORMAL:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                " [npc2.Name] [npc2.verb(buck)] [npc2.her] [npc2.hips] into [npc.namePos] [npc.face], [npc2.moaning+] as [npc.she] suck [npc2.her] [npc2.clit+].",
	...
	public static final SexAction GIVING_CLIT_ORAL_DEEP_THROAT = new SexAction(
		...
		public String getDescription() {
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Gently wrapping [npc.her] [npc.lips+] around the [npc2.clit+] in [npc.her] mouth, [npc.name] push [npc.her] head forwards,"
                            ...
                            "With a soft, muffled [npc.moan], [npc.name] gently lean forwards,"
                                    + " parting [npc.her] [npc.lips+] as [npc.she] take as much of [npc2.namePos] [npc2.clit+] down [npc.her] throat as [npc.she] can.",

                            "Slowly sliding [npc.her] head forwards, [npc.name] gently part [npc.her] [npc.lips+], before taking [npc2.namePos] [npc2.clit+] deep down [npc.her] throat."));
					break;
				case DOM_NORMAL:
				case SUB_EAGER:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Eagerly wrapping [npc.her] [npc.lips+] around the [npc2.clit+] in [npc.her] mouth, [npc.name] quickly push [npc.her] head forwards,"
                            ...
                            "With a muffled, [npc.moan+], [npc.name] eagerly lean forwards,"
                                    + " parting [npc.her] [npc.lips+] as [npc.she] desperately take as much of [npc2.namePos] [npc2.clit+] down [npc.her] throat as [npc.she] can.",

                            "Greedily sliding [npc.her] head forwards, [npc.name] readily part [npc.her] [npc.lips+] as [npc.she] take [npc2.namePos] [npc2.clit+] deep down [npc.her] throat."));
					break;
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Forcefully wrapping [npc.her] [npc.lips+] around the [npc2.clit+] in [npc.her] mouth, [npc.name] roughly slam [npc.her] head forwards,"
                            ...
                            "With a muffled, [npc.moan+], [npc.name] quickly lean forwards,"
                                    + " parting [npc.her] [npc.lips+] as [npc.she] roughly force as much of [npc2.namePos] [npc2.clit+] down [npc.her] throat as [npc.she] can.",

                            "Aggressively pushing [npc.her] head forwards, [npc.name] part [npc.her] [npc.lips+] as [npc.she] force [npc2.namePos] [npc2.clit+] deep down [npc.her] throat."));
					break;
				case SUB_NORMAL:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Wrapping [npc.her] [npc.lips+] around the [npc2.clit+] in [npc.her] mouth, [npc.name] quickly push [npc.her] head forwards,"
									+ " taking [npc2.namePos] [npc2.clit+] as deep down [npc.her] throat as [npc.she] possibly can.",

                            "With a muffled, [npc.moan+], [npc.name] lean forwards,"
                                    + " parting [npc.her] [npc.lips+] as [npc.she] take as much of [npc2.namePos] [npc2.clit+] down [npc.her] throat as [npc.she] can.",

                            "Sliding [npc.her] head forwards, [npc.name] part [npc.her] [npc.lips+] as [npc.she] take [npc2.namePos] [npc2.clit+] deep down [npc.her] throat."));
					break;
				default:
					break;
			}
	...
	public static final SexAction GIVING_CLIT_ORAL_DOM_GENTLE = new SexAction(
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                    "Gently wrapping [npc.her] [npc.lips+] around [npc2.namePos] [npc2.clit+], [npc.name] start bobbing [npc.her] head up and down as [npc.she] give [npc2.herHim] [npc.her] loving oral attention.",
                    "With a soft, muffled [npc.moan], [npc.name] gently start bobbing [npc.her] head up and down,"
                            + " wrapping [npc.her] [npc.lips+] around [npc2.namePos] [npc2.clit+] as [npc.she] give [npc2.herHim] [npc.her] loving oral attention.",
                    "Slowly bobbing [npc.her] head up and down, [npc.name] gently wrap [npc.her] [npc.lips+] around [npc2.namePos] [npc2.clit+] as [npc.she] give [npc2.herHim] [npc.her] oral attention."));
	...
	public static final SexAction GIVING_CLIT_ORAL_DOM_NORMAL = new SexAction(
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                    "Eagerly wrapping [npc.her] [npc.lips+] around [npc2.namePos] [npc2.clit+], [npc.name] start rapidly bobbing [npc.her] head up and down as [npc.she] give [npc2.herHim] [npc.her] enthusiastic oral attention.",
                    "With a muffled, [npc.moan+], [npc.name] quickly start bobbing [npc.her] head up and down,"
                            + " greedily wrapping [npc.her] [npc.lips+] around [npc2.namePos] [npc2.clit+] as [npc.she] give [npc2.herHim] [npc.her] oral attention.",
                    "Rapidly bobbing [npc.her] head up and down, [npc.name] desperately wrap [npc.her] [npc.lips+] around [npc2.namePos] [npc2.clit+] as [npc.she] give [npc2.herHim] [npc.her] eager oral attention."));
	...
	public static final SexAction GIVING_CLIT_ORAL_DOM_ROUGH = new SexAction(
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                    "Forcefully gripping [npc.her] [npc.lips+] down around [npc2.namePos] [npc2.clit+], [npc.name] start aggressively bobbing [npc.her] head up and down as [npc.she] give [npc2.herHim] [npc.her] oral attention.",
                    "With a muffled, [npc.moan+], [npc.name] violently start bobbing [npc.her] head up and down,"
                            + " roughly wrapping [npc.her] [npc.lips+] around [npc2.namePos] [npc2.clit+] as [npc.she] give [npc2.herHim] [npc.her] oral attention.",
                    "Roughly bobbing [npc.her] head up and down, [npc.name] dominantly wrap [npc.her] [npc.lips+] around [npc2.namePos] [npc2.clit+] as [npc.she] give [npc2.herHim] [npc.her] oral attention."));
	...
	public static final SexAction GIVING_CLIT_ORAL_SUB_NORMAL = new SexAction(
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                    "Wrapping [npc.her] [npc.lips+] around [npc2.namePos] [npc2.clit+], [npc.name] start rapidly bobbing [npc.her] head up and down as [npc.she] give [npc2.herHim] [npc.her] oral attention.",
                    "With a muffled, [npc.moan+], [npc.name] quickly start bobbing [npc.her] head up and down,"
                            + " wrapping [npc.her] [npc.lips+] around [npc2.namePos] [npc2.clit+] as [npc.she] give [npc2.herHim] [npc.her] oral attention.",
                    "Rapidly bobbing [npc.her] head up and down, [npc.name] wrap [npc.her] [npc.lips+] around [npc2.namePos] [npc2.clit+] as [npc.she] give [npc2.herHim] [npc.her] oral attention."));
	...
	public static final SexAction GIVING_CLIT_ORAL_STOP = new SexAction(
		...
		public String getDescription() {
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Roughly forcing [npc2.namePos] [npc2.clit+] down [npc.her] throat one last time, [npc.name] then pull [npc.her] head back, putting a quick end to [npc.her] oral attention.",

                            "Slamming [npc.her] [npc.face] into [npc2.namePos] groin, [npc.name] force [npc2.her] [npc2.clit+] deep down [npc.her] throat,"
									+ " before pulling completely back and letting [npc2.herHim] slip out of [npc.her] mouth."));
					break;
				default:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Sliding [npc2.namePos] [npc2.clit+] out of [npc.her] mouth, [npc.name] let out [npc.a_moan+] as [npc.she] put an end to [npc.her] oral attention.",

                            "With [npc.a_moan+], [npc.name] pull [npc.her] head back, sliding [npc2.namePos] [npc2.clit+] fully out of [npc.her] mouth."));
					break;
			}
				...
				case SUB_RESISTING:
					return UtilText.returnStringAtRandom(
							...
							" [npc2.A_sob+] bursts out from between [npc2.namePos] [npc2.lips] as [npc2.she] weakly [npc2.verb(try)] to push [npc.name] away,"
                                    + " squirming and protesting as [npc.name] continue to force [npc2.her] [npc2.clit+] deep into [npc.her] throat.",
