...
public class ClitAnus {
		...
		public String getDescription() {
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Moving [npc.her] [npc.clit+] up to [npc2.namePos] [npc2.assCloaca+],"
                                    + " [npc.name] start slowly teasing the [npc.clitTip+] up and down over [npc2.her] [npc2.asshole+], ready to penetrate [npc2.herHim] at any moment.",

                            "With a soft [npc.moan], [npc.name] move [npc.her] [npc.clit+] up to [npc2.namePos] [npc2.assCloaca+], before starting to gently slide the [npc.clitTip] up and down over [npc2.her] [npc2.asshole+].",
				...
				case SUB_EAGER:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Moving [npc.her] [npc.clit+] up to [npc2.namePos] [npc2.assCloaca+],"
                                    + " [npc.name] start eagerly sliding the [npc.clitTip+] up and down over [npc2.her] [npc2.asshole+], ready to penetrate [npc2.herHim] at any moment.",

                            "With [npc.a_moan+], [npc.name] move [npc.her] [npc.clit+] up to [npc2.namePos] [npc2.assCloaca+], before starting to eagerly slide the [npc.clitTip] up and down over [npc2.her] [npc2.asshole+].",
				...
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Grinding [npc.her] [npc.clit+] up against [npc2.namePos] [npc2.assCloaca+],"
                                    + " [npc.name] pull back a little before starting to slide the [npc.clitTip+] up and down over [npc2.her] [npc2.asshole+], ready to start fucking [npc2.herHim] at any moment.",

                            "With [npc.a_moan+], [npc.name] line [npc.her] [npc.clit+] up to [npc2.namePos] [npc2.assCloaca+],"
				...
				case SUB_NORMAL:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Moving [npc.her] [npc.clit+] up to [npc2.namePos] [npc2.assCloaca+],"
                                    + " [npc.name] start sliding the [npc.clitTip+] up and down over [npc2.her] [npc2.asshole+], ready to penetrate [npc2.herHim] at any moment.",

                            "With [npc.a_moan+], [npc.name] move [npc.her] [npc.clit+] up to [npc2.namePos] [npc2.assCloaca+], before starting to slide the [npc.clitTip] up and down over [npc2.her] [npc2.asshole+].",
	...
	public static final SexAction FORCE_CLIT_OVER_ANUS = new SexAction(
		...
		public String getDescription() {
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "[npc.Name] grab [npc2.namePos] [npc2.clit+], before guiding it up to [npc.her] [npc.assCloaca+]."
                                    + " Slowly pushing the [npc2.clitTip+] up and down over [npc.her] [npc.asshole+], [npc.she] tease [npc2.name] with the promise of penetration at any moment.",

                            "With a soft [npc.moan], [npc.name] grab [npc2.namePos] [npc2.clit+] и guide it up to [npc.her] [npc.assCloaca+],"
									+ " before starting to gently slide the [npc2.clitTip] up and down over [npc.her] [npc.asshole+].",

                            "Grabbing [npc2.namePos] [npc2.clit+], [npc.name] gently slide the [npc2.clitTip+] over [npc.her] [npc.asshole+],"
				...
				case SUB_EAGER:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "[npc.Name] grab [npc2.namePos] [npc2.clit+], before guiding it up to [npc.her] [npc.assCloaca+]."
                                    + " Eagerly pushing the [npc2.clitTip+] up and down over [npc.her] [npc.asshole+], [npc.she] tease [npc2.name] with the promise of penetration at any moment.",

                            "With [npc.a_moan+], [npc.name] grab [npc2.namePos] [npc2.clit+] и guide it up to [npc.her] [npc.assCloaca+],"
									+ " before starting to eagerly slide the [npc2.clitTip] up and down over [npc.her] [npc.asshole+].",

                            "Grabbing [npc2.namePos] [npc2.clit+], [npc.name] eagerly slide the [npc2.clitTip+] over [npc.her] [npc.asshole+],"
                                    + " letting out [npc.a_moan+] as [npc.she] tease [npc2.herHim] with the promise of penetration."));
					break;
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "[npc.Name] grab [npc2.namePos] [npc2.clit+], before yanking it up to [npc.her] [npc.assCloaca+]."
                                    + " Roughly forcing the [npc2.clitTip+] up and down over [npc.her] [npc.asshole+], [npc.she] tease [npc2.name] with the promise of penetration at any moment.",

                            "With [npc.a_moan+], [npc.name] grab [npc2.namePos] [npc2.clit+] and yank it up to [npc.her] [npc.assCloaca+],"
                                    + " before starting to roughly force the [npc2.clitTip] up and down over [npc.her] [npc.asshole+].",

                            "Grabbing [npc2.namePos] [npc2.clit+], [npc.name] roughly grind the [npc2.clitTip+] over [npc.her] [npc.asshole+],"
                                    + " letting out [npc.a_moan+] as [npc.she] tease [npc2.herHim] with the promise of penetration."));
					break;
				case SUB_NORMAL:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "[npc.Name] grab [npc2.namePos] [npc2.clit+], before guiding it up to [npc.her] [npc.assCloaca+]."
                                    + " Pushing the [npc2.clitTip+] up and down over [npc.her] [npc.asshole+], [npc.she] tease [npc2.name] with the promise of penetration at any moment.",

                            "With [npc.a_moan+], [npc.name] grab [npc2.namePos] [npc2.clit+] и guide it up to [npc.her] [npc.assCloaca+],"
									+ " before starting to slide the [npc2.clitTip] up and down over [npc.her] [npc.asshole+].",

                            "Grabbing [npc2.namePos] [npc2.clit+], [npc.name] slide the [npc2.clitTip+] over [npc.her] [npc.asshole+],"
                                    + " letting out [npc.a_moan+] as [npc.she] tease [npc2.herHim] with the promise of penetration."));
					break;
				default:
					break;
				...
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Slowly teasing the [npc.clitTip+] of [npc.her] [npc.clit] over [npc2.namePos] [npc2.assCloaca+],"
                                    + " [npc.name] let out a little [npc.moan] before slowly pushing forwards, sinking [npc.her] [npc.clit+] into [npc2.her] [npc2.asshole+].",

                            "[npc.Name] position the [npc.clitTip+] of [npc.her] [npc.clit] between [npc2.namePos] ass cheeks,"
				...
				case DOM_NORMAL:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Eagerly teasing the [npc.clitTip+] of [npc.her] [npc.clit] over [npc2.namePos] [npc2.assCloaca+],"
                                    + " [npc.name] let out [npc.a_moan+] before thrusting forwards, greedily sinking [npc.her] [npc.clit+] into [npc2.her] [npc2.asshole+].",
				...
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Roughly grinding the [npc.clitTip+] of [npc.her] [npc.clit] over [npc2.namePos] [npc2.assCloaca+],"
                                    + " [npc.name] let out [npc.a_moan+] before violently slamming forwards, forcing [npc.her] [npc.clit+] deep into [npc2.her] [npc2.asshole+].",
				...
				case SUB_NORMAL:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Teasing the [npc.clitTip+] of [npc.her] [npc.clit] over [npc2.namePos] [npc2.assCloaca+],"
                                    + " [npc.name] let out [npc.a_moan+] before thrusting forwards, sinking [npc.her] [npc.clit+] into [npc2.her] [npc2.asshole+].",
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
					"Gently sinking [npc.her] [npc.clit+] deep into [npc2.namePos] [npc2.asshole+],"
                            + " [npc.name] start sliding it in and out, letting out a little [npc.moan] with every thrust as [npc.she] slowly fuck [npc2.name].",

					"Slowly pushing [npc.her] [npc.clit+] into [npc2.namePos] [npc2.asshole+],"
                            + " [npc.name] softly [npc2.verb(thrust)] it in and out, letting out a little [npc.moan] as [npc.she] gently fuck [npc2.herHim].",

					"Sliding [npc.her] [npc.clit+] into [npc2.namePos] [npc2.asshole+],"
                            + " [npc.name] let out a little [npc.moan] as [npc.she] start to gently pump it in and out, breathing in [npc2.namePos] [npc2.scent] as [npc.she] slowly fuck [npc2.herHim]."));
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
					"Eagerly sinking [npc.her] [npc.clit+] deep into [npc2.namePos] [npc2.asshole+],"
                            + " [npc.name] start enthusiastically pumping it in and out, letting out [npc.a_moan+] with every thrust as [npc.she] happily fuck [npc2.name].",

					"Enthusiastically pushing [npc.her] [npc.clit+] deep into [npc2.namePos] [npc2.asshole+],"
                            + " [npc.name] frantically [npc2.verb(start)] thrusting it in and out, letting out [npc.a_moan+] as [npc.she] greedily fuck [npc2.herHim].",

					"Thrusting [npc.her] [npc.clit+] deep into [npc2.namePos] [npc2.asshole+],"
                            + " [npc.name] let out [npc.a_moan+] as [npc.she] start to eagerly pump it in and out, breathing in [npc2.namePos] [npc2.scent] as [npc.she] desperately fuck [npc2.herHim]."));
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
					"Roughly slamming [npc.her] [npc.clit+] deep into [npc2.namePos] [npc2.asshole+],"
                            + " [npc.name] start roughly pumping it in and out, letting out [npc.a_moan+] with every thrust as [npc.she] brutally fuck [npc2.name].",

					"Violently thrusting [npc.her] [npc.clit+] deep into [npc2.namePos] [npc2.asshole+],"
                            + " [npc.name] start roughly thrusting it in and out, letting out [npc.a_moan+] as [npc.she] forcefully fuck [npc2.herHim].",

					"Forcefully driving [npc.her] [npc.clit+] deep into [npc2.namePos] [npc2.asshole+],"
                            + " [npc.name] let out [npc.a_moan+] as [npc.she] start to roughly slam it in and out, breathing in [npc2.namePos] [npc2.scent] as [npc.she] violently fuck [npc2.herHim]."));
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
					"Sinking [npc.her] [npc.clit+] deep into [npc2.namePos] [npc2.asshole+],"
                            + " [npc.name] start pumping it in and out, letting out [npc.a_moan+] with every thrust as [npc.she] happily fuck [npc2.name].",

					"Pushing [npc.her] [npc.clit+] deep into [npc2.namePos] [npc2.asshole+],"
                            + " [npc.name] start thrusting it in and out, letting out [npc.a_moan+] as [npc.she] eagerly fuck [npc2.herHim].",

					"Thrusting [npc.her] [npc.clit+] deep into [npc2.namePos] [npc2.asshole+],"
                            + " [npc.name] let out [npc.a_moan+] as [npc.she] start to pump it in and out, breathing in [npc2.namePos] [npc2.scent] as [npc.she] fuck [npc2.herHim]."));
		...
		public String getDescription() {
			...
			if(!isTargetedCharacterInanimate()) {
				switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(this))) {
					case DOM_GENTLE:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                "[npc.Name] try to pull [npc.her] [npc.clit] out of [npc2.namePos] [npc2.assCloaca],"
                                ...
                                "With [npc.a_sob+], [npc.name] try to pull [npc.her] [npc.clit] away from [npc2.name], but [npc2.she] quickly [npc2.verb(grab)] it,"
										+ " before gently grinding [npc2.her] [npc2.assCloaca] back and forcing it inside [npc2.her] [npc2.asshole+].",

                                "Tears start to well up in [npc.namePos] [npc.eyes], and with [npc.a_sob+], [npc.she] try to pull [npc.her] [npc.clit] away from [npc2.namePos] [npc2.assCloaca+],"
				...
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                        ...
                        "With [npc.a_sob+], [npc.name] try to pull [npc.her] [npc.clit] away from [npc2.name], but [npc2.she] quickly [npc2.verb(push)] back and [npc2.verb(grind)]"
								+ " [npc2.her] [npc2.assCloaca] against [npc.herHim].",

                        "Tears start to well up in [npc.namePos] [npc.eyes], and with [npc.a_sob+], [npc.she] try to pull [npc.her] [npc.clit] away from [npc2.namePos] [npc2.assCloaca+],"
                                + " but [npc2.name] quickly [npc2.verb(react)] и [npc2.verb(force)] [npc2.her] [npc2.asshole+] down onto [npc.her] [npc.clit+]."));
			}
		...
		public String getDescription() {
				...
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Roughly yanking [npc.her] [npc.clit+] out of [npc2.namePos] [npc2.assCloaca+],"
                                    + " [npc.name] dominantly slide the [npc.clitTip+] up and down over [npc2.her] [npc2.asshole+] one last time before pulling back.",

                            "Thrusting deep inside of [npc2.name] one last time, [npc.name] then yank [npc.her] [npc.clit+] back out of [npc2.her] [npc2.asshole+], putting an end to the rough anal fucking."));
					break;
				default:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Sliding [npc.her] [npc.clit] out of [npc2.namePos] [npc2.assCloaca+], [npc.name] rub the [npc.clitTip] up and down over [npc2.her] [npc2.asshole+] one last time before pulling back.",

                            "Pushing deep inside of [npc2.name] one last time, [npc.name] then slide [npc.her] [npc.clit+] back out of [npc2.her] [npc2.asshole+], putting an end to the anal fucking."));
					break;
			}
			...
			if(!isTargetedCharacterInanimate()) {
				switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(this))) {
					...
					default:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                " [npc2.Name] [npc2.verb(let)] out [npc2.a_moan+] as [npc.name] pull [npc.her] [npc.clit+] out of [npc2.her] [npc2.asshole+], eager for more of [npc.her] attention.",
	...
	public static final SexAction USING_CLIT_START = new SexAction(
		...
		public String getDescription() {
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Grabbing [npc2.namePos] [npc2.clit], [npc.name] slowly guide it up to [npc.her] [npc.assCloaca+],"
                            ...
                            "Grabbing [npc2.namePos] [npc2.clit], [npc.name] line it up to [npc.her] [npc.asshole+],"
                                    + " before slowly pushing [npc.her] [npc.hips] back and letting out a soft [npc.moan] as [npc.she] penetrate [npc.herself] on [npc2.her] [npc2.clit+]."));
					break;
				case DOM_NORMAL:
				case SUB_EAGER:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Grabbing [npc2.namePos] [npc2.clit], [npc.name] eagerly guide it up to [npc.her] [npc.assCloaca+],"
                            ...
                            "Grabbing [npc2.namePos] [npc2.clit], [npc.name] line it up to [npc.her] [npc.asshole+],"
                                    + " before eagerly thrusting [npc.her] [npc.hips] back and letting out [npc.a_moan+] as [npc.she] penetrate [npc.herself] on [npc2.her] [npc2.clit+]."));
					break;
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            ...
                            "Grabbing [npc2.namePos] [npc2.clit], [npc.name] line it up to [npc.her] [npc.asshole+],"
                                    + " before eagerly slamming [npc.her] [npc.hips] back and letting out [npc.a_moan+] as [npc.she] penetrate [npc.herself] on [npc2.her] [npc2.clit+]."));
					break;
				case SUB_NORMAL:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Grabbing [npc2.namePos] [npc2.clit], [npc.name] guide it up to [npc.her] [npc.assCloaca+],"
									+ " letting out [npc.a_moan+] before bucking [npc.her] [npc.hips] back and forcing [npc2.herHim] to penetrate [npc.her] [npc.asshole+].",

                            "Grabbing [npc2.namePos] [npc2.clit], [npc.name] line it up to [npc.her] [npc.asshole+],"
                                    + " before pushing [npc.her] [npc.hips] back and letting out [npc.a_moan+] as [npc.she] penetrate [npc.herself] on [npc2.her] [npc2.clit+]."));
					break;
				default:
					break;
			}
				...
				switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(this))) {
					...
					case SUB_RESISTING:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                ...
                                " With [npc2.a_sob+], [npc2.name] [npc2.verb(struggle)] against [npc.name] as [npc.she] force [npc2.her] [npc2.clit] deep into [npc.her] [npc.asshole+]."));
						break;
					default:
						break;
				}
	...
	public static final SexAction RIDING_CLIT_DOM_GENTLE = new SexAction(
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                    "Gently pushing [npc.her] [npc.hips] back, [npc.name] let out a soft [npc.moan] as [npc.she] help to sink [npc2.namePos] [npc2.clit+] deep into [npc.her] [npc.asshole+].",

                    "With a soft [npc.moan], [npc.name] gently start pushing [npc.her] [npc.hips] back, forcing [npc2.namePos] [npc2.clit+] ever deeper into [npc.her] [npc.asshole+].",
	...
	public static final SexAction RIDING_CLIT_DOM_NORMAL = new SexAction(
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                    "Eagerly pushing [npc.her] [npc.hips] back, [npc.name] let out [npc.a_moan+] as [npc.she] help to sink [npc2.namePos] [npc2.clit+] deep into [npc.her] [npc.asshole+].",

                    "With [npc.a_moan+], [npc.name] enthusiastically start thrusting [npc.her] [npc.hips] back, forcing [npc2.namePos] [npc2.clit+] ever deeper into [npc.her] [npc.asshole+].",
	...
	public static final SexAction RIDING_CLIT_DOM_ROUGH = new SexAction(
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                    "Violently slamming [npc.her] [npc.hips] back, [npc.name] let out [npc.a_moan+] as [npc.she] force [npc2.namePos] [npc2.clit+] deep into [npc.her] [npc.asshole+].",

                    "With [npc.a_moan+], [npc.name] roughly start slamming [npc.her] [npc.hips] back, forcing [npc2.namePos] [npc2.clit+] ever deeper into [npc.her] [npc.asshole+].",
	...
	public static final SexAction RIDING_CLIT_SUB_NORMAL = new SexAction(
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                    "Pushing [npc.her] [npc.hips] back, [npc.name] let out [npc.a_moan+] as [npc.she] help to sink [npc2.namePos] [npc2.clit+] deep into [npc.her] [npc.asshole+].",

                    "With [npc.a_moan+], [npc.name] start thrusting [npc.her] [npc.hips] back, forcing [npc2.namePos] [npc2.clit+] ever deeper into [npc.her] [npc.asshole+].",
	...
	public static final SexAction FUCKED_STOP = new SexAction(
		...
		public String getDescription() {
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Yanking [npc2.namePos] [npc2.clit] out of [npc.her] [npc.asshole+], [npc.name] let out a menacing growl as [npc.she] command [npc2.name] to stop fucking [npc.herHim].",

                            "[npc.Name] lean into [npc2.name], inhaling [npc2.her] [npc2.scent] before yanking [npc2.her] [npc2.clit] out of [npc.her] [npc.asshole+]."));
					break;
				default:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Sliding [npc2.namePos] [npc2.clit] out of [npc.her] [npc.asshole+], [npc.name] let out [npc.a_moan+] as [npc.she] tell [npc2.name] to stop fucking [npc.herHim].",

                            "[npc.Name] lean into [npc2.name], inhaling [npc2.her] [npc2.scent] before sliding [npc2.her] [npc2.clit] out of [npc.her] [npc.asshole+]."));
					break;
			}
	...
	public static final SexAction ANAL_CONTROL = new SexAction(
		...
		public String getDescription() {
			return UtilText.returnStringAtRandom(
                    "Letting out [npc.a_moan+], [npc.name] concentrate on squeezing the extra internal muscles within [npc.her] [npc.asshole] down around [npc2.namePos] [npc2.clit+].",
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(action))) {
				...
				case SUB_RESISTING:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							...
							" [npc2.A_sob+] bursts out from between [npc2.namePos] [npc2.lips] as [npc2.she] weakly [npc2.verb(try)] to push [npc.name] away,"
                                    + " squirming and protesting as [npc.name] continue to force [npc2.her] [npc2.clit+] deep into [npc.her] [npc.asshole+].",
