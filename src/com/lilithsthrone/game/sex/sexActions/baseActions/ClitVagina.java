...
public class ClitVagina {
		...
		public String getDescription() {
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Moving [npc.her] [npc.clit+] up to [npc2.namePos] [npc2.pussy+],"
                                    + " [npc.name] start slowly teasing the [npc.clitTip+] up and down between [npc2.her] [npc2.labia+], ready to penetrate [npc2.herHim] at any moment.",

                            "With a soft [npc.moan], [npc.name] move [npc.her] [npc.clit+] up to [npc2.namePos] [npc2.pussy+], before starting to gently slide the [npc.clitTip] up and down between [npc2.her] [npc2.labia+].",
				...
				case SUB_EAGER:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Moving [npc.her] [npc.clit+] up to [npc2.namePos] [npc2.pussy+],"
                                    + " [npc.name] start eagerly sliding the [npc.clitTip+] up and down between [npc2.her] [npc2.labia+], ready to penetrate [npc2.herHim] at any moment.",

                            "With [npc.a_moan+], [npc.name] move [npc.her] [npc.clit+] up to [npc2.namePos] [npc2.pussy+], before starting to eagerly slide the [npc.clitTip] up and down between [npc2.her] [npc2.labia+].",
				...
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Grinding [npc.her] [npc.clit+] up against [npc2.namePos] [npc2.pussy+],"
                                    + " [npc.name] pull back a little before starting to slide the [npc.clitTip+] up and down between [npc2.her] [npc2.labia+], ready to start fucking [npc2.herHim] at any moment.",

                            "With [npc.a_moan+], [npc.name] line [npc.her] [npc.clit+] up to [npc2.namePos] [npc2.pussy+],"
				...
				case SUB_NORMAL:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Moving [npc.her] [npc.clit+] up to [npc2.namePos] [npc2.pussy+],"
                                    + " [npc.name] start sliding the [npc.clitTip+] up and down between [npc2.her] [npc2.labia+], ready to penetrate [npc2.herHim] at any moment.",

                            "With [npc.a_moan+], [npc.name] move [npc.her] [npc.clit+] up to [npc2.namePos] [npc2.pussy+], before starting to slide the [npc.clitTip] up and down between [npc2.her] [npc2.labia+].",
	...
	public static final SexAction FORCE_CLIT_OVER_VAGINA = new SexAction(
		...
		public String getDescription() {
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "[npc.Name] grab [npc2.namePos] [npc2.clit+], before guiding it up to [npc.her] [npc.pussy+]."
                                    + " Slowly pushing the [npc2.clitTip+] up and down between [npc.her] [npc.labia+], [npc.she] tease [npc2.name] with the promise of penetration at any moment.",

                            "With a soft [npc.moan], [npc.name] grab [npc2.namePos] [npc2.clit+] и guide it up to [npc.her] [npc.pussy+],"
									+ " before starting to gently slide the [npc2.clitTip] up and down between [npc.her] [npc.labia+].",

                            "Grabbing [npc2.namePos] [npc2.clit+], [npc.name] gently slide the [npc2.clitTip+] over [npc.her] [npc.vagina+],"
				...
				case SUB_EAGER:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "[npc.Name] grab [npc2.namePos] [npc2.clit+], before guiding it up to [npc.her] [npc.pussy+]."
                                    + " Eagerly pushing the [npc2.clitTip+] up and down between [npc.her] [npc.labia+], [npc.she] tease [npc2.name] with the promise of penetration at any moment.",

                            "With [npc.a_moan+], [npc.name] grab [npc2.namePos] [npc2.clit+] и guide it up to [npc.her] [npc.pussy+],"
									+ " before starting to eagerly slide the [npc2.clitTip] up and down between [npc.her] [npc.labia+].",

                            "Grabbing [npc2.namePos] [npc2.clit+], [npc.name] eagerly slide the [npc2.clitTip+] over [npc.her] [npc.vagina+],"
                                    + " letting out [npc.a_moan+] as [npc.she] tease [npc2.herHim] with the promise of penetration."));
					break;
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "[npc.Name] grab [npc2.namePos] [npc2.clit+], before yanking it up to [npc.her] [npc.pussy+]."
                                    + " Roughly forcing the [npc2.clitTip+] up and down between [npc.her] [npc.labia+], [npc.she] tease [npc2.name] with the promise of penetration at any moment.",

                            "With [npc.a_moan+], [npc.name] grab [npc2.namePos] [npc2.clit+] and yank it up to [npc.her] [npc.pussy+],"
                                    + " before starting to roughly force the [npc2.clitTip] up and down between [npc.her] [npc.labia+].",

                            "Grabbing [npc2.namePos] [npc2.clit+], [npc.name] roughly grind the [npc2.clitTip+] over [npc.her] [npc.vagina+],"
                                    + " letting out [npc.a_moan+] as [npc.she] tease [npc2.herHim] with the promise of penetration."));
					break;
				case SUB_NORMAL:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "[npc.Name] grab [npc2.namePos] [npc2.clit+], before guiding it up to [npc.her] [npc.pussy+]."
                                    + " Pushing the [npc2.clitTip+] up and down between [npc.her] [npc.labia+], [npc.she] tease [npc2.name] with the promise of penetration at any moment.",

                            "With [npc.a_moan+], [npc.name] grab [npc2.namePos] [npc2.clit+] и guide it up to [npc.her] [npc.pussy+],"
									+ " before starting to slide the [npc2.clitTip] up and down between [npc.her] [npc.labia+].",

                            "Grabbing [npc2.namePos] [npc2.clit+], [npc.name] slide the [npc2.clitTip+] over [npc.her] [npc.vagina+],"
                                    + " letting out [npc.a_moan+] as [npc.she] tease [npc2.herHim] with the promise of penetration."));
					break;
				default:
					break;
			...
			if((Main.sex.getCharacterPerformingAction().isVaginaVirgin() || Main.sex.getCharacterPerformingAction().hasHymen()) && Main.sex.getCharacterPerformingAction().hasFetish(Fetish.FETISH_PURE_VIRGIN)) {
				if(Main.sex.getCharacterPerformingAction().isMute()) {
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            " Treasuring [npc.her] virginity above all else, [npc.name] then quickly pull [npc.her] [npc.pussy] away from [npc2.namePos] [npc2.clit+].",
                            " Not at all ready to lose [npc.her] precious virginity, [npc.name] then quickly pull [npc.her] [npc.pussy] away from [npc2.namePos] [npc2.clit+].",
                            " As [npc.she] treasure [npc.her] precious virginity above all else,"
                                    + " [npc.name] make it clear that [npc.she] [npc.do]n't actually want to be penetrated by pulling [npc.her] [npc.pussy] away from [npc2.namePos] [npc2.clit+]."));
				...
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Slowly teasing the [npc.clitTip+] of [npc.her] [npc.clit] between [npc2.namePos] [npc2.labia+],"
                                    + " [npc.name] let out a little [npc.moan] before slowly pushing forwards, sinking [npc.her] [npc.clit+] into [npc2.her] [npc2.vagina+].",

                            "[npc.Name] position the [npc.clitTip+] of [npc.her] [npc.clit] between [npc2.namePos] [npc2.labia+],"
				...
				case DOM_NORMAL:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Eagerly teasing the [npc.clitTip+] of [npc.her] [npc.clit] between [npc2.namePos] [npc2.labia+],"
                                    + " [npc.name] let out [npc.a_moan+] before thrusting forwards, greedily sinking [npc.her] [npc.clit+] into [npc2.her] [npc2.vagina+].",
				...
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Roughly grinding the [npc.clitTip+] of [npc.her] [npc.clit] between [npc2.namePos] [npc2.labia+],"
                                    + " [npc.name] let out [npc.a_moan+] before violently slamming forwards, forcing [npc.her] [npc.clit+] deep into [npc2.her] [npc2.vagina+].",
				...
				case SUB_NORMAL:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Teasing the [npc.clitTip+] of [npc.her] [npc.clit] between [npc2.namePos] [npc2.labia+],"
                                    + " [npc.name] let out [npc.a_moan+] before thrusting forwards, sinking [npc.her] [npc.clit+] into [npc2.her] [npc2.vagina+].",
		...
		public String getDescription() {
			...
			if(!isTargetedCharacterInanimate()) {
				switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(this))) {
					case DOM_GENTLE:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                "[npc.Name] try to pull [npc.her] [npc.clit] out of [npc2.namePos] [npc2.pussy],"
                                ...
                                "With [npc.a_sob+], [npc.name] try to pull [npc.her] [npc.clit] away from [npc2.name], but [npc2.she] quickly [npc2.verb(grab)] it, before gently forcing it back inside [npc2.her] [npc2.vagina+].",

                                "Tears start to well up in [npc.namePos] [npc.eyes], and with [npc.a_sob+], [npc.she] try to pull [npc.her] [npc.clit] away from [npc2.namePos] [npc2.pussy+],"
					...
					case DOM_ROUGH:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                ...
                                "With [npc.a_sob+], [npc.name] try to pull [npc.her] [npc.clit] away from [npc2.name], but [npc2.she] quickly [npc2.verb(grab)] it, before roughly forcing it back inside [npc2.her] [npc2.vagina+].",
					...
					default: // DOM_NORMAL and in case anything goes wrong:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                ...
                                "With [npc.a_sob+], [npc.name] try to pull [npc.her] [npc.clit] away from [npc2.name], but [npc2.she] quickly [npc2.verb(grab)] it, before eagerly forcing it back inside [npc2.her] [npc2.vagina+].",
				...
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                        ...
                        "With [npc.a_sob+], [npc.name] try to pull [npc.her] [npc.clit] away from [npc2.name], but [npc2.she] quickly [npc2.verb(move)] forwards, keeping it hilted deep inside [npc2.her] [npc2.vagina+].",

                        "Tears start to well up in [npc.namePos] [npc.eyes], and with [npc.a_sob+], [npc.she] try to pull [npc.her] [npc.clit] away from [npc2.namePos] [npc2.pussy+],"
                                + " but [npc2.name] quickly [npc2.verb(react)] и [npc2.verb(force)] [npc2.her] [npc2.pussy+] down onto [npc.her] [npc.clit+]."));
			}
			return UtilText.nodeContentSB.toString();
		}
		...
		public String getDescription() {
				...
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Roughly yanking [npc.her] [npc.clit+] out of [npc2.namePos] [npc2.pussy+],"
                                    + " [npc.name] dominantly slide the [npc.clitTip+] up and down over [npc2.her] [npc2.labia+] one last time before pulling back.",

                            "Thrusting deep inside of [npc2.name] one last time, [npc.name] then yank [npc.her] [npc.clit+] back out of [npc2.her] [npc2.vagina+], putting an end to the rough clit-fucking."));
					break;
				default:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Sliding [npc.her] [npc.clit] out of [npc2.namePos] [npc2.pussy+], [npc.name] rub the [npc.clitTip] up and down over [npc2.her] [npc2.labia+] one last time before pulling back.",

                            "Pushing deep inside of [npc2.name] one last time, [npc.name] then slide [npc.her] [npc.clit+] back out of [npc2.her] [npc2.vagina+], putting an end to the clit-fucking."));
					break;
			}
			...
			if(!isTargetedCharacterInanimate()) {
				switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(this))) {
					...
					default:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                " [npc2.Name] [npc2.verb(let)] out [npc2.a_moan+] as [npc.name] pull [npc.her] [npc.clit+] out of [npc2.her] [npc2.vagina+], eager for more of [npc.her] attention.",
	...
	public static final SexAction USING_CLIT_START = new SexAction(
		...
		public String getDescription() {
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Grabbing [npc2.namePos] [npc2.clit], [npc.name] slowly guide it up to [npc.her] [npc.labia+],"
                            ...
                            "Grabbing [npc2.namePos] [npc2.clit], [npc.name] line it up to [npc.her] [npc.vagina+],"
				...
				case SUB_EAGER:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Grabbing [npc2.namePos] [npc2.clit], [npc.name] eagerly guide it up to [npc.her] [npc.labia+],"
				...
				case SUB_NORMAL:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Grabbing [npc2.namePos] [npc2.clit], [npc.name] guide it up to [npc.her] [npc.labia+],"
				...
				switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(this))) {
					...
					case SUB_RESISTING:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                ...
                                " With [npc2.a_sob+], [npc2.name] [npc2.verb(struggle)] against [npc.name] as [npc.she] force [npc2.her] [npc2.clit] deep into [npc.her] [npc.vagina+]."));
						break;
				}
			}
			return UtilText.nodeContentSB.toString();
	...
	public static final SexAction RIDING_CLIT_DOM_GENTLE = new SexAction(
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                    "Gently pushing [npc.her] [npc.hips] back, [npc.name] let out a soft [npc.moan] as [npc.she] help to sink [npc2.namePos] [npc2.clit+] deep into [npc.her] [npc.vagina+].",

                    "With a soft [npc.moan], [npc.name] gently start pushing [npc.her] [npc.hips] back, forcing [npc2.namePos] [npc2.clit+] ever deeper into [npc.her] [npc.vagina+].",
	...
	public static final SexAction RIDING_CLIT_DOM_NORMAL = new SexAction(
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                    "Eagerly pushing [npc.her] [npc.hips] back, [npc.name] let out [npc.a_moan+] as [npc.she] help to sink [npc2.namePos] [npc2.clit+] deep into [npc.her] [npc.vagina+].",

                    "With [npc.a_moan+], [npc.name] enthusiastically start thrusting [npc.her] [npc.hips] back, forcing [npc2.namePos] [npc2.clit+] ever deeper into [npc.her] [npc.vagina+].",
	...
	public static final SexAction RIDING_CLIT_DOM_ROUGH = new SexAction(
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                    "Violently slamming [npc.her] [npc.hips] back, [npc.name] let out [npc.a_moan+] as [npc.she] force [npc2.namePos] [npc2.clit+] deep into [npc.her] [npc.vagina+].",

                    "With [npc.a_moan+], [npc.name] roughly start slamming [npc.her] [npc.hips] back, forcing [npc2.namePos] [npc2.clit+] ever deeper into [npc.her] [npc.vagina+].",
	...
	public static final SexAction RIDING_CLIT_SUB_NORMAL = new SexAction(
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                    "Pushing [npc.her] [npc.hips] back, [npc.name] let out [npc.a_moan+] as [npc.she] help to sink [npc2.namePos] [npc2.clit+] deep into [npc.her] [npc.vagina+].",

                    "With [npc.a_moan+], [npc.name] start thrusting [npc.her] [npc.hips] back, forcing [npc2.namePos] [npc2.clit+] ever deeper into [npc.her] [npc.vagina+].",
	...
	public static final SexAction FUCKED_STOP = new SexAction(
		...
		public String getDescription() {
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Yanking [npc2.namePos] [npc2.clit] out of [npc.her] [npc.vagina+], [npc.name] let out a menacing growl as [npc.she] command [npc2.name] to stop fucking [npc.herHim].",

                            "[npc.Name] lean into [npc2.name], inhaling [npc2.her] [npc2.scent] before yanking [npc2.her] [npc2.clit] out of [npc.her] [npc.vagina+]."));
					break;
				default:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Sliding [npc2.namePos] [npc2.clit] out of [npc.her] [npc.vagina+], [npc.name] let out [npc.a_moan+] as [npc.she] tell [npc2.name] to stop fucking [npc.herHim].",

                            "[npc.Name] lean into [npc2.name], inhaling [npc2.her] [npc2.scent] before sliding [npc2.her] [npc2.clit] out of [npc.her] [npc.vagina+]."));
					break;
			}
	...
	public static final SexAction PUSSY_CONTROL = new SexAction(
		...
		public String getDescription() {
			return UtilText.returnStringAtRandom(
                    "Letting out [npc.a_moan+], [npc.name] concentrate on squeezing the extra internal muscles within [npc.her] [npc.pussy] down around [npc2.namePos] [npc2.clit+].",
				...
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							" [npc2.Name] violently [npc2.verb(buck)] [npc2.her] [npc2.hips] in response,"
                                    + " letting out [npc2.a_moan+] as [npc2.she] roughly [npc2.verb(demand)] that [npc.name] continue to use [npc.her] [npc.clit] to fuck [npc2.herHim].",
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(action))) {
				...
				case SUB_RESISTING:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							...
							" [npc2.A_sob+] bursts out from between [npc2.namePos] [npc2.lips] as [npc2.she] weakly [npc2.verb(try)] to push [npc.name] away,"
                                    + " squirming and protesting as [npc.name] continue to force [npc2.her] [npc2.clit+] deep into [npc.her] [npc.vagina+].",
