...
public class TongueArmpit {
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Gently lifting up [npc2.namePos] [npc2.arm+(true)], [npc.name] press [npc.her] [npc.lips+] against [npc2.her] [npc2.armpit+], and after planting a series of soft kisses on it,"
                                    + " [npc.she] start sliding [npc.her] [npc.tongue+] over [npc2.her] exposed pit.",

                            "Lifting up [npc2.namePos] [npc2.arm+(true)], [npc.name] plant a series of soft kisses on [npc2.namePos] [npc2.armpit+],"
                                    + " before [npc.moaning+] as [npc.she] start gently sliding [npc.her] [npc.tongue+] over [npc2.her] exposed pit."));
					break;
				case DOM_NORMAL:
				case SUB_EAGER:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Eagerly lifting up [npc2.namePos] [npc2.arm+(true)], [npc.name] desperately press [npc.her] [npc.lips+] against [npc2.her] [npc2.armpit+], and after planting a series of passionate kisses on it,"
                                    + " [npc.she] start greedily sliding [npc.her] [npc.tongue+] over [npc2.her] exposed pit.",

                            "Impatiently lifting up [npc2.namePos] [npc2.arm+(true)], [npc.name] plant a series of passionate kisses on [npc2.namePos] [npc2.armpit+],"
                                    + " before [npc.moaning+] as [npc.she] start greedily sliding [npc.her] [npc.tongue+] over [npc2.her] exposed pit."));
					break;
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Roughly yanking up [npc2.namePos] [npc2.arm+(true)], [npc.name] forcefully press [npc.her] [npc.lips+] against [npc2.her] [npc2.armpit+], and after planting a series of dominant kisses on it,"
                                    + " [npc.she] start greedily sliding [npc.her] [npc.tongue+] over [npc2.her] exposed pit.",

                            "Violently yanking up [npc2.namePos] [npc2.arm+(true)], [npc.name] plant a series of forceful kisses on [npc2.namePos] [npc2.armpit+],"
                                    + " before [npc.moaning+] as [npc.she] start dominantly sliding [npc.her] [npc.tongue+] over [npc2.her] exposed pit."));
					break;
				case SUB_NORMAL:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Lifting up [npc2.namePos] [npc2.arm+(true)], [npc.name] press [npc.her] [npc.lips+] against [npc2.her] [npc2.armpit+], and after planting a series of kisses on it,"
                                    + " [npc.she] start sliding [npc.her] [npc.tongue+] over [npc2.her] exposed pit.",

                            "Lifting up [npc2.namePos] [npc2.arm+(true)], [npc.name] plant a series of kisses on [npc2.namePos] [npc2.armpit+],"
                                    + " before [npc.moaning+] as [npc.she] start sliding [npc.her] [npc.tongue+] over [npc2.her] exposed pit."));
					break;
				case SUB_RESISTING:
					break;
			}
	...
	public static final SexAction ARMPIT_LICKING_DOM_GENTLE = new SexAction(
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                    ...
                    "Pulling [npc.her] [npc.tongue+] back into [npc.her] mouth, [npc.name] start to gently kiss [npc2.namePos] [npc2.underarm+],"
							+ " before pressing forwards and slowly sliding [npc.her] [npc.tongue] over [npc2.her] [npc2.armpit+] once more.",

                    "Sliding [npc.her] [npc.tongue+] back into [npc.her] mouth, [npc.name] start slowly kissing and nuzzling against [npc2.namePos] [npc2.underarm+],"
	...
	public static final SexAction ARMPIT_LICKING_SUB_RESISTING = new SexAction(
		...
		public String getDescription() {
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(this))) {
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "[npc.Name] try to pull [npc.her] [npc.face] back, but [npc2.name] [npc2.verb(continue)] gently pressing [npc2.her] [npc2.armpit+] down against [npc.her] [npc.lips+],"
									+ " holding [npc.herHim] in place as [npc2.she] [npc2.verb(force)] [npc2.herself] on [npc.herHim].",

                            "With [npc.a_sob+], [npc.name] try to pull away from [npc2.name], but [npc2.she] quickly [npc2.verb(force)] [npc.her] [npc.face] right back into [npc2.her] [npc2.underarm+],"
									+ " gently grinding [npc2.herself] against [npc.herHim] as [npc2.she] [npc2.verb(ignore)] [npc.her] struggles.",

                            "Tears start to well up in [npc.namePos] [npc.eyes], and with [npc.a_sob+], [npc.she] try to pull [npc.her] mouth away from [npc2.namePos] [npc2.underarm+],"
				...
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "[npc.Name] try to pull [npc.her] [npc.face] back, but [npc2.name] roughly [npc2.verb(slam)] [npc2.her] [npc2.armpit+] down against [npc.her] [npc.lips+],"
									+ " holding [npc.herHim] in place as [npc2.she] violently [npc2.verb(force)] [npc2.herself] on [npc.herHim].",

                            "With [npc.a_sob+], [npc.name] try to pull away from [npc2.name], but [npc2.she] violently [npc2.verb(force)] [npc.her] [npc.face] right back into [npc2.her] [npc2.underarm+],"
				...
				default: // DOM_NORMAL and in case anything goes wrong:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "[npc.Name] try to pull [npc.her] [npc.face] back, but [npc2.name] [npc2.verb(continue)] eagerly thrusting [npc2.her] [npc2.armpit+] down against [npc.her] [npc.lips+],"
									+ " holding [npc.herHim] in place as [npc2.she] [npc2.verb(force)] [npc2.herself] on [npc.herHim].",
	...
	public static final SexAction ARMPIT_LICKING_STOP = new SexAction(
		...
		public String getDescription() {
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "With one last rough lick, [npc.name] pull [npc.her] [npc.face] away from [npc2.namePos] [npc2.armpit+].",

                            "Giving [npc2.namePos] [npc2.armpit+] a final, rough kiss, [npc.name] pull [npc.her] [npc.face] away from [npc2.her] pit."));
					break;
				default:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "With one last lick, [npc.name] pull [npc.her] [npc.face] away from [npc2.namePos] [npc2.armpit+].",

                            "Giving [npc2.namePos] [npc2.armpit+] a final, wet kiss, [npc.name] pull [npc.her] [npc.face] away from [npc2.her] pit."));
					break;
			}
				...
				switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(this))) {
					...
					default:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                ...
                                " [npc2.A_moan+] drifts out from between [npc2.namePos] [npc2.lips+] as [npc.name] stop pleasuring [npc2.her] [npc2.armpit+], betraying [npc2.her] desire for more of [npc.namePos] attention."));
						break;
				}
			}
		...
		public String getDescription() {
				...
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Gently lifting [npc.her] [npc.arm(true)] and pressing [npc.her] [npc.underarm+] down against [npc2.namePos] [npc2.face],"
                                    + " [npc.name] let out a soft [npc.moan] as [npc.she] start slowly grinding [npc.her] [npc.armpit+] over [npc2.her] [npc2.lips+].",

                            "Lifting [npc.her] [npc.arm(true)], [npc.name] let out a soft [npc.moan] as [npc.she] start gently pressing [npc.her] [npc.armpit+] against [npc2.namePos] [npc2.lips+]."));
					break;
				case DOM_NORMAL:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Eagerly lifting [npc.her] [npc.arm(true)] and pressing [npc.her] [npc.underarm+] down against [npc2.namePos] [npc2.face],"
                                    + " [npc.name] let out [npc.a_moan+] as [npc.she] start frantically grinding [npc.her] [npc.armpit+] over [npc2.her] [npc2.lips+].",

                            "Lifting [npc.her] [npc.arm(true)], [npc.name] let out [npc.a_moan+] as [npc.she] start eagerly pressing [npc.her] [npc.armpit+] against [npc2.namePos] [npc2.lips+]."));
					break;
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Roughly lifting [npc.her] [npc.arm(true)] and slamming [npc.her] [npc.underarm+] down against [npc2.namePos] [npc2.face],"
                                    + " [npc.name] let out [npc.a_moan+] as [npc.she] start forcefully grinding [npc.her] [npc.armpit+] over [npc2.her] [npc2.lips+].",

                            "Lifting [npc.her] [npc.arm(true)], [npc.name] let out [npc.a_moan+] as [npc.she] start roughly grinding [npc.her] [npc.armpit+] against [npc2.namePos] [npc2.lips+]."));
					break;
				case SUB_EAGER:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Eagerly lifting [npc.her] [npc.arm(true)] and pressing [npc.her] [npc.underarm+] down against [npc2.namePos] [npc2.face],"
				...
				case SUB_NORMAL:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Lifting [npc.her] [npc.arm(true)] and pressing [npc.her] [npc.underarm+] down against [npc2.namePos] [npc2.face],"
                                    + " [npc.name] let out [npc.a_moan+] as [npc.she] start grinding [npc.her] [npc.armpit+] over [npc2.her] [npc2.lips+].",

                            "Lifting [npc.her] [npc.arm(true)], [npc.name] let out [npc.a_moan] as [npc.she] start pressing [npc.her] [npc.armpit+] against [npc2.namePos] [npc2.lips+]."));
					break;
				case SUB_RESISTING:
					break;
			}
			...
			if(!isTargetedCharacterInanimate()) {
				switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(this))) {
					...
					case SUB_RESISTING:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                " Struggling in desperation, [npc2.name] [npc2.verb(let)] out [npc2.a_sob+] as [npc.name] force [npc.her] [npc.armpit+] down against [npc2.her] [npc2.lips+].",

                                " [npc2.Sobbing] and struggling in distress, [npc2.namePos] protests prove to be in vain as [npc.name] press [npc.her] [npc.underarm+] down over [npc2.her] [npc2.face]."));
						break;
					default:
						break;
				}
	...
	public static final SexAction RECEIVING_ARMPIT_LICKING_DOM_GENTLE = new SexAction(
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                    "[npc.Name] let out a soft [npc.moan] as [npc.she] gently, yet firmly, plant [npc.her] [npc.armpit+] down over [npc2.namePos] [npc2.lips+].",

                    "With a soft [npc.moan], [npc.name] press [npc.her] [npc.underarm+] against [npc2.namePos] [npc2.face+], before gently grinding [npc.her] [npc.armpit+] against [npc2.her] [npc2.lips+].",

                    "Letting out a soft [npc.moan], [npc.name] gently grind [npc.her] [npc.armpit+] down against [npc2.namePos] [npc2.lips]."));
	...
	public static final SexAction RECEIVING_ARMPIT_LICKING_DOM_NORMAL = new SexAction(
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                    "[npc.Name] let out [npc.a_moan+] as [npc.she] eagerly plant [npc.her] [npc.armpit+] down over [npc2.namePos] [npc2.lips+].",

                    "With [npc.a_moan+], [npc.name] eagerly press [npc.her] [npc.underarm+] against [npc2.namePos] [npc2.face+], before greedily grinding [npc.her] [npc.armpit+] against [npc2.her] [npc2.lips+].",

                    "Letting out [npc.a_moan+], [npc.name] eagerly grind [npc.her] [npc.armpit+] down against [npc2.namePos] [npc2.lips]."));
	...
	public static final SexAction RECEIVING_ARMPIT_LICKING_DOM_ROUGH = new SexAction(
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                    "[npc.Name] let out [npc.a_moan+] as [npc.she] roughly grind [npc.her] [npc.armpit+] down over [npc2.namePos] [npc2.lips+].",

                    "With [npc.a_moan+], [npc.name] roughly force [npc.her] [npc.underarm+] against [npc2.namePos] [npc2.face+], before dominantly grinding [npc.her] [npc.armpit+] against [npc2.her] [npc2.lips+].",

                    "Letting out [npc.a_moan+], [npc.name] roughly grind [npc.her] [npc.armpit+] down against [npc2.namePos] [npc2.lips]."));
	...
	public static final SexAction RECEIVING_ARMPIT_LICKING_SUB_RESIST = new SexAction(
		...
		public String getDescription() {
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(this))) {
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "[npc.Name] desperately try to pull [npc.her] [npc.underarm] away from [npc2.namePos] [npc2.face],"
									+ " letting out [npc.a_sob+] as [npc2.name] gently [npc2.verb(slide)] [npc2.her] [npc2.tongue] over [npc.her] [npc.armpit+].",

                            "Letting out [npc.a_sob+], [npc.name] desperately try to pull [npc.her] [npc.armpit+] away from [npc2.namePos] [npc2.lips+]."
                            ...
                            "With [npc.a_sob+], [npc.name] frantically try to pull [npc.her] [npc.underarm+] away from [npc2.namePos] [npc2.lips+], but [npc2.she] holds [npc.herHim] in place,"
				...
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            ...
                            "With [npc.a_sob+], [npc.name] frantically try to pull [npc.her] [npc.underarm+] away from [npc2.namePos] [npc2.lips+], but [npc2.she] firmly holds [npc.herHim] in place,"
	...
	public static final SexAction RECEIVING_ARMPIT_LICKING_SUB_NORMAL = new SexAction(
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                    "[npc.Name] let out [npc.a_moan+] as [npc.she] firmly plant [npc.her] [npc.armpit+] down over [npc2.namePos] [npc2.lips+].",

                    "With [npc.a_moan+], [npc.name] press [npc.her] [npc.underarm+] against [npc2.namePos] [npc2.face+], before grinding [npc.her] [npc.armpit+] against [npc2.her] [npc2.lips+].",

                    "Letting out [npc.a_moan+], [npc.name] grind [npc.her] [npc.armpit+] down against [npc2.namePos] [npc2.lips]."));
	...
	public static final SexAction RECEIVING_ARMPIT_LICKING_STOP = new SexAction(
		...
		public String getDescription() {
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Roughly yanking [npc2.namePos] head away from [npc.her] [npc.armpit+], [npc.name] order [npc2.herHim] to stop orally servicing [npc.herHim].",

                            "Roughly grinding [npc.her] [npc.armpit+] over [npc2.namePos] [npc2.face] one last time, [npc.name] then pull [npc.her] [npc.underarm] away."));
					break;
				default:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Pulling [npc2.namePos] head away from [npc.her] [npc.armpit+], [npc.name] tell [npc2.herHim] to stop orally servicing [npc.herHim].",

                            "Pressing [npc.her] [npc.armpit+] over [npc2.namePos] [npc2.face] one last time, [npc.name] then pull [npc.her] [npc.underarm] away."));
					break;
			}
				...
				case SUB_RESISTING:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							...
							" [npc2.A_sob+] bursts out from between [npc2.namePos] [npc2.lips] as [npc2.she] weakly [npc2.verb(try)] to push [npc.name] away,"
                                    + " squirming and protesting as [npc.she] continue to lick and kiss [npc2.her] [npc2.armpit+].",

							" [npc2.Sobbing] in distress, [npc2.name] [npc2.verb(try)], in vain, to recoil away from [npc.namePos] [npc.tongue],"
                                    + " struggling against [npc.herHim] as [npc.she] continue to orally service [npc2.her] [npc2.armpit+]."));
					break;
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(action))) {
				...
				case SUB_RESISTING:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							...
							" [npc2.A_sob+] bursts out from between [npc2.namePos] [npc2.lips] as [npc2.she] weakly [npc2.verb(try)] to push [npc.name] away,"
                                    + " squirming and protesting as [npc.she] continue to force [npc.her] [npc.underarm+] against [npc2.her] [npc2.face+].",

							" [npc2.Sobbing] in distress, [npc2.name] [npc2.verb(try)], in vain, to recoil away from [npc.namePos] [npc.underarm],"
                                    + " struggling against [npc.herHim] as [npc.she] continue to press [npc.her] [npc.armpit+] against [npc2.her] [npc2.lips+]."));
					break;
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
