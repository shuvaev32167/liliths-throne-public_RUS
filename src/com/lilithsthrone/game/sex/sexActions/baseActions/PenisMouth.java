...
public class PenisMouth {
			...
			if(Main.sex.getSexPositionSlot(performer).hasTag(SexSlotTag.PERFORMING_ORAL)) {
				return UtilText.parse(Util.newArrayListOfValues(performer, primary, target),
						UtilText.returnStringAtRandom(
                                "Grinning down at " + PenisMouth.getOngoingNames(performer) + ", [npc.name] pull back, sliding [npc.her] [npc.cock+] out of [npc2.namePos] mouth."
                                        + " As [npc3.name] [npc3.verb(look)] up at [npc.herHim], [npc.she] quickly slap [npc.her] hard shaft against [npc3.her] cheek, splattering "
                                ...
                                "Stepping back, [npc.name] slide [npc.her] [npc.cock+] free from [npc2.namePos] mouth,"
									+ " before proceeding to slap the saliva-coated [npc1.cockHead] against "+(primary.equals(target)?"[npc2.her]":"[npc3.namePos]")+" cheeks."
                                        + " As [npc3.name] [npc3.verb(open)] [npc3.her] mouth to gasp in shock, [npc.name] use the opportunity to guide the [npc.cockHead] of [npc.her] [npc.cock] past [npc3.her] [npc3.lips+],"
							...
							"[npc.Name] #IF(npc.isPlayer())[npc.step]#ELSE[npc.steps]#ENDIF back, allowing [npc.her] [npc.cock+] to slide out from [npc2.namePos] mouth."
                                    + " Looking up at [npc.herHim], [npc3.nameIs] taken by surprise as [npc.name] suddenly slap [npc.her] "
                                ...
                                "Quickly pulling [npc.her] [npc.cock+] out from [npc2.namePos] mouth, [npc.name] hold the base in one hand while holding " + (primary.equals(target) ? "[npc2.her]" : "[npc3.namePos]") + " head still with the other."
                                        + " As [npc3.name] [npc2.verb(look)] up to see what's happening, [npc3.sheIs] met with a wet slap as [npc.name] swing [npc.her] "
									+(Main.sex.hasLubricationTypeFromAnyone(target, SexAreaOrifice.MOUTH, LubricationType.PRECUM)?"slimy":"saliva-coated")+" [npc.cock] against [npc3.her] cheek."
                                        + " As [npc3.name] [npc3.verb(open)] [npc3.her] mouth in shock, [npc.name] use the opportunity to thrust [npc.her] [npc.cock+] down [npc3.her] throat."));
				
			} else {
				return UtilText.parse(Util.newArrayListOfValues(performer, primary, target),
						UtilText.returnStringAtRandom(
                                "Pulling [npc.her] [npc.hips] back, [npc.name] slide [npc.her] [npc.cock+] out of [npc2.namePos] mouth."
                                        + " Before " + (primary.equals(target) ? "[npc2.she]" : "[npc3.name]") + " can react, [npc.she] quickly slap [npc.her] hard shaft against [npc3.her] cheek, splattering saliva "
                                ...
                                "Pulling back, [npc.name] slide [npc.her] [npc.cock+] free from [npc2.namePos] mouth,"
                                        + " and with [npc.a_moan+], [npc.she] proceed to slap the saliva-coated [npc.cockHead] against " + (primary.equals(target) ? "[npc2.her]" : "[npc3.namePos]") + " [npc3.face],"
									+ " before sliding [npc.her] throbbing length down [npc3.her] throat.",

                                "[npc.Name] slide [npc.her] [npc.cock+] out from [npc2.namePos] mouth, and, grinning to [npc.herself], [npc.she] then slap [npc.her] hard shaft against "
								...
								+ " With a streak of "+(Main.sex.hasLubricationTypeFromAnyone(performer, SexAreaPenetration.PENIS, LubricationType.PRECUM)?"cummy":"wet")
                                        + " saliva now drooling down [npc3.her] cheek, [npc3.name] [npc3.verb(open)] [npc3.her] [npc3.eyes] wide in surprise as [npc.name] force [npc.her] [npc.cock] down [npc3.her] throat.",

                                "Quickly pulling [npc.her] [npc.hips+] back, [npc.name] draw [npc.her] [npc.cock+] out from [npc2.namePos] mouth, before starting to slap [npc.her] slimy length against "
									+(primary.equals(target)?"[npc2.her]":"[npc3.namePos]")+" cheeks."
                                        + " Before [npc3.name] can react, [npc.name] suddenly push [npc.her] [npc.hips] forwards, ramming [npc.her] [npc.cock+] down [npc3.her] throat."));
			}
		}
	};
		...
		public String getDescription() {
			...
			if(PenisMouth.getOngoingCharacters(Main.sex.getCharacterPerformingAction()).size()>1) {
				...
				if(!primary.equals(target)) {
					start = new String[] {
                            ...
                            "[npc.Name] slide [npc.her] [npc.cock+] into [npc2.namePos] mouth,",
					...
					start = new String[] {
                            ...
                            "[npc.Name] slide [npc.her] [npc.cock+] out of [npc2.namePos] mouth and then down [npc3.namePos] throat,",
				...
				switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
					case DOM_GENTLE:
						mid = new String[] {
                                " [npc.name] shuffle about until [npc.her] [npc.balls+] are gently pressing against [npc3.namePos] [npc3.lips+].",
                                " [npc.name] reposition [npc.herself] so that [npc.her] [npc.balls+] are gently pressing against [npc3.namePos] [npc3.lips+].",
								" before repositioning [npc.herself] so that [npc3.namePos] [npc3.lips+] are gently pressed against [npc.her] [npc.balls+].",
                                " [npc.name] reposition [npc.herself] until [npc.sheIs] gently pressing [npc.her] [npc.balls+] against [npc3.namePos] [npc3.lips+]."};
						break;
					case DOM_ROUGH:
						mid = new String[] {
                                " [npc.name] shuffle about until [npc.her] [npc.balls+] are roughly grinding against [npc3.namePos] [npc3.lips+].",
                                " [npc.name] reposition [npc.herself] so that [npc.her] [npc.balls+] are roughly grinding against [npc3.namePos] [npc3.lips+].",
								" before repositioning [npc.herself] so that [npc3.namePos] [npc3.lips+] are roughly grinding against [npc.her] [npc.balls+].",
                                " [npc.name] reposition [npc.herself] until [npc.sheIs] roughly forcing [npc.her] [npc.balls+] against [npc3.namePos] [npc3.lips+]."};
						break;
					case SUB_NORMAL:
						mid = new String[] {
                                " [npc.name] shuffle about until [npc.her] [npc.balls+] are pressing down against [npc3.namePos] [npc3.lips+].",
                                " [npc.name] reposition [npc.herself] so that [npc.her] [npc.balls+] are pressing against [npc3.namePos] [npc3.lips+].",
								" before repositioning [npc.herself] so that [npc3.namePos] [npc3.lips+] are pressed against [npc.her] [npc.balls+].",
                                " [npc.name] reposition [npc.herself] until [npc.sheIs] forcing [npc.her] [npc.balls+] against [npc3.namePos] [npc3.lips+]."};
						break;
					default: // Dom normal and sub eager:
						mid = new String[] {
                                " [npc.name] shuffle about until [npc.her] [npc.balls+] are pressing against [npc3.namePos] [npc3.lips+].",
                                " [npc.name] reposition [npc.herself] so that [npc.her] [npc.balls+] are pressing against [npc3.namePos] [npc3.lips+].",
								" before repositioning [npc.herself] so that [npc3.namePos] [npc3.lips+] are pressed against [npc.her] [npc.balls+].",
                                " [npc.name] reposition [npc.herself] until [npc.sheIs] forcing [npc.her] [npc.balls+] against [npc3.namePos] [npc3.lips+]."};
						break;
				...
				start = new String[] {
                        "Drawing [npc.her] [npc.hips] back, [npc.name] allow [npc.her] [npc.cock+] to slide out of [npc2.namePos] mouth,",
						"Sliding [npc.her] [npc.cock+] out of [npc2.namePos] mouth,",
                        "[npc.Name] slide [npc.her] [npc.cock+] out of [npc2.namePos] mouth,",
				...
				switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
					case DOM_GENTLE:
						mid = new String[] {
                                ...
                                " [npc.name] reposition [npc.herself] so that [npc.her] [npc.balls+] are gently pressing against [npc2.her] [npc2.lips+].",
								" before repositioning [npc.herself] so that [npc2.her] [npc2.lips+] are gently pressed against [npc.her] [npc.balls+].",
                                " [npc.name] reposition [npc.herself] until [npc.sheIs] gently pressing [npc.her] [npc.balls+] against [npc2.namePos] [npc2.lips+]."};
						break;
					case DOM_ROUGH:
						mid = new String[] {
								" before shuffling about until [npc.her] [npc.balls+] are roughly grinding against [npc2.her] [npc2.lips+].",
                                " [npc.name] reposition [npc.herself] so that [npc.her] [npc.balls+] are roughly grinding against [npc2.her] [npc2.lips+].",
								" before repositioning [npc.herself] so that [npc2.her] [npc2.lips+] are roughly grinding against [npc.her] [npc.balls+].",
                                " [npc.name] reposition [npc.herself] until [npc.sheIs] roughly forcing [npc.her] [npc.balls+] against [npc2.namePos] [npc2.lips+]."};
						break;
					case SUB_NORMAL:
						mid = new String[] {
								" before shuffling about until [npc.her] [npc.balls+] are pressing down against [npc2.her] [npc2.lips+].",
                                " [npc.name] reposition [npc.herself] so that [npc.her] [npc.balls+] are pressing against [npc2.her] [npc2.lips+].",
								" before repositioning [npc.herself] so that [npc2.her] [npc2.lips+] are pressed against [npc.her] [npc.balls+].",
                                " [npc.name] reposition [npc.herself] until [npc.sheIs] forcing [npc.her] [npc.balls+] against [npc2.namePos] [npc2.lips+]."};
						break;
					default: // Dom normal and sub eager:
						mid = new String[] {
			...
			if(!isTargetedCharacterInanimate()) {
				switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(this))) {
					...
					case SUB_RESISTING:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                " [npc2.Name] desperately [npc2.verb(try)] to pull away, letting out [npc2.a_sob+] as [npc.namePos] [npc.balls+] continue grinding against [npc2.her] [npc2.lips+].",
	...
	public static final SexAction SUCK_BALLS = new SexAction(
		...
		public String getDescription() {
			...
			if(PenisMouth.getOngoingCharacters(Main.sex.getCharacterTargetedForSexAction(this)).size()>1) {
				...
				if(!primary.equals(performer)) {
					start = new String[] {
                            ...
                            "As [npc3.name] [npc3.verb(bob)] [npc3.her] head up in [npc2.namePos] lap, [npc.name] lean in to plant a kiss on the side of [npc2.her] [npc2.cock+],",
					...
					start = new String[] {
                            ...
                            "[npc.Name] swap with [npc3.name], allowing [npc3.herHim] to take [npc2.namePos] [npc2.cock+] into [npc3.her] mouth,",
				...
				start = new String[] {
                        ...
                        "[npc.Name] let [npc2.namePos] [npc2.cock+] slide out of [npc.her] mouth,",
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
				case DOM_GENTLE:
					mid = new String[] {
                            " [npc.name] move [npc.her] head down and start to gently lick and suck on [npc2.her] [npc2.balls+].",
							" before moving [npc.her] [npc.lips+] down to start gently licking and kissing [npc2.her] [npc2.balls+].",
                            " [npc.name] move [npc.her] head down to start gently kissing and licking [npc2.her] [npc2.balls+].",
                            " [npc.name] move [npc.her] head down, before starting to gently kiss and nuzzle into [npc2.her] [npc2.balls+]."};
					break;
				case DOM_ROUGH:
					mid = new String[] {
                            " [npc.name] move [npc.her] head down and start to roughly lick and suck on [npc2.her] [npc2.balls+].",
							" before moving [npc.her] [npc.lips+] down to start roughly licking and kissing [npc2.her] [npc2.balls+].",
                            " [npc.name] move [npc.her] head down to start roughly kissing and licking [npc2.her] [npc2.balls+].",
                            " [npc.name] move [npc.her] head down, before starting to roughly kiss and nuzzle into [npc2.her] [npc2.balls+]."};
					break;
				case SUB_NORMAL:
					mid = new String[] {
                            " [npc.name] move [npc.her] head down and start to lick and suck on [npc2.her] [npc2.balls+].",
							" before moving [npc.her] [npc.lips+] down to start licking and kissing [npc2.her] [npc2.balls+].",
                            " [npc.name] move [npc.her] head down to start kissing and licking [npc2.her] [npc2.balls+].",
                            " [npc.name] move [npc.her] head down, before starting to kiss and nuzzle into [npc2.her] [npc2.balls+]."};
					break;
				default: // Dom normal and sub eager:
					mid = new String[] {
                            " [npc.name] move [npc.her] head down and start to eagerly lick and suck on [npc2.her] [npc2.balls+].",
							" before moving [npc.her] [npc.lips+] down to start desperately licking and kissing [npc2.her] [npc2.balls+].",
                            " [npc.name] move [npc.her] head down to start eagerly kissing and licking [npc2.her] [npc2.balls+].",
                            " [npc.name] move [npc.her] head down, before starting to eagerly kiss and nuzzle into [npc2.her] [npc2.balls+]."};
					break;
			}
		...
		public String getDescription() {
			...
			if(PenisMouth.getOngoingCharacters(Main.sex.getCharacterTargetedForSexAction(this)).size()>1 && !primary.equals(performer)) {
				...
				for(PenetrationModifier pm : Main.sex.getCharacterTargetedForSexAction(this).getPenisModifiers()) {
					switch(pm) {
						case FLARED:
                            descriptions.add("Lifting [npc3.namePos] head up so that [npc2.namePos] [npc2.cock+] slides fully out of [npc3.her] mouth, [npc.name] quickly move to take [npc3.her] place."
                                    + " Immediately pressing [npc.her] [npc.lips+] down against the wide, flared head, [npc.she] then start to passionately kiss and lick the top of [npc2.namePos] [npc2.cock+].");
							break;
						default:
							break;
					}
				}
                descriptions.add("With a hungry [npc.moan], [npc.name] pull [npc3.namePos] head back, before taking [npc3.her] place and wrapping [npc.her] [npc.lips+] around the [npc2.cockHead+] of [npc2.namePos] [npc2.cock+]."
						+ " Letting out a satisfied [npc.moan], [npc.she] then starts to lick and kiss [npc2.her] [npc2.cockHead+].");
                descriptions.add("Wanting to get in on the action, [npc.name] pull [npc3.namePos] head back,"
                        + " letting out [npc.a_moan+] as [npc.she] take [npc3.her] place and start concentrating on sucking and kissing the [npc2.cockHead+] of [npc2.namePos] [npc2.cock+].");
                descriptions.add("Pulling [npc3.namePos] head back a little, [npc.name] take [npc3.her] place, and,"
                        + " focusing on using [npc.her] [npc.tongue+], [npc.she] start licking and kissing the [npc2.cockHead+] that's now pressed up against [npc.her] [npc.lips+].");
				...
				switch(Main.sex.getSexPace(primary)) {
					case SUB_RESISTING:
						descriptionsEnd.add(" Happy to have been pushed aside, [npc3.name] [npc3.verb(try)] to stay quiet as [npc3.she] [npc3.verb(attempt)] to shuffle further away, but, realising that [npc3.she] [npc3.verb(need)] some 'encouragement',"
                                + " [npc.name] soon pull back from [npc2.namePos] crotch, before grabbing [npc3.name] and pushing [npc3.her] mouth down onto [npc2.namePos] [npc2.cock+] once more.");
						descriptionsEnd.add(" Relieved to have been pushed out of [npc3.her] position, [npc3.name] [npc3.verb(try)] to get away from [npc2.name], but, seeing what's happening,"
                                + " [npc.name] quickly put an end to [npc.her] oral servicing, before grabbing [npc3.name] and forcing [npc3.herHim] to swallow [npc2.namePos] [npc2.cock+] once again.");
						break;
					default:
				...
				for(PenetrationModifier pm : Main.sex.getCharacterTargetedForSexAction(this).getPenisModifiers()) {
					switch(pm) {
						case BARBED:
                            descriptions.add("[npc.Name] slide [npc.her] head back, letting out a muffled [npc.moan] as [npc.she] feel the barbs lining [npc2.namePos] [npc2.cock] rake their way up [npc.her] throat."
                                    + " Leaving just the [npc2.cockHead+] pushed past [npc.her] [npc.lips+], [npc.she] then start to passionately kiss and suck the tip of [npc2.her] [npc2.cock+].");
							break;
						case FLARED:
                            descriptions.add("Sliding [npc.her] head back, [npc.name] allow [npc2.namePos] [npc2.cock+] to slip completely out of [npc.her] mouth."
                                    + " Immediately pressing [npc.her] [npc.lips+] down against the wide, flared head, [npc.she] then start to passionately kiss and lick it.");
							break;
						default:
							break;
					}
				}
                descriptions.add("With [npc.a_moan+], [npc.name] pull [npc.her] head back, wrapping [npc.her] [npc.lips+] around the [npc2.cockHead+] of [npc2.namePos] [npc2.cock+], before starting to lick and kiss it.");
                descriptions.add("[npc.Name] pull [npc.her] head back, letting out [npc.a_moan+] as [npc.she] start concentrating on sucking and kissing the [npc2.cockHead+] of [npc2.namePos] [npc2.cock+].");
                descriptions.add("Pulling [npc.her] head back a little, [npc.name] let most of [npc2.namePos] [npc2.cock+] slide out of [npc.her] mouth, and,"
                        + " focusing on using [npc.her] [npc.tongue+], [npc.she] start licking and kissing the [npc2.cockHead+] that's left poking past [npc.her] [npc.lips+].");
	...
	public static final SexAction HERM_FUN = new SexAction(
		...
		@Override
		public String getActionDescription() {
            return "Pleasure both [npc2.namePos] [npc2.cock+] и [npc2.pussy+].";
		}
		...
		public String getDescription() {
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Not wanting to ignore [npc2.namePos] other sexual organ, [npc.name] give the [npc2.cockHead] of [npc2.her] [npc2.cock+] a gentle suck,"
									+ " before pulling back and starting to slowly lick and kiss [npc2.her] [npc2.pussy+].",

                            "Deciding to give [npc2.namePos] [npc2.pussy] some attention, [npc.name] deliver a long, slow lick up the length of [npc2.her] [npc2.cock+],"
									+ " before pressing forwards and gently sliding [npc.her] [npc.tongue+] into [npc2.her] [npc2.pussy+].",

                            "Delivering a gentle kiss to the [npc2.cockHead] of [npc2.namePos] [npc2.cock+], [npc.name] move down,"
									+ " bringing [npc.her] [npc.lips+] to [npc2.her] [npc2.pussy+] before slowly pushing [npc.her] [npc.tongue+] between [npc2.her] [npc2.labia+]."));
					break;
				case DOM_NORMAL:
				case SUB_EAGER:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Not wanting to ignore [npc2.namePos] other sexual organ, [npc.name] give the [npc2.cockHead] of [npc2.her] [npc2.cock+] a wet suck,"
									+ " before pulling back and starting to eagerly lick and kiss [npc2.her] [npc2.pussy+].",

                            "Deciding to give [npc2.namePos] [npc2.pussy] some attention, [npc.name] deliver a long, wet lick up the length of [npc2.her] [npc2.cock+],"
									+ " before pressing forwards and eagerly darting [npc.her] [npc.tongue+] into [npc2.her] [npc2.pussy+].",

                            "Delivering a wet kiss to the [npc2.cockHead] of [npc2.namePos] [npc2.cock+], [npc.name] move down,"
				...
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            ...
                            "Deciding to give [npc2.namePos] [npc2.pussy] some attention, [npc.name] deliver a long, roughly lick up the length of [npc2.her] [npc2.cock+],"
									+ " before pressing forwards and dominantly thrusting [npc.her] [npc.tongue+] into [npc2.her] [npc2.pussy+].",

                            "Delivering a rough kiss to the [npc2.cockHead] of [npc2.namePos] [npc2.cock+], [npc.name] move down,"
			...
			if(!isTargetedCharacterInanimate()) {
				switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(this))) {
					case DOM_GENTLE:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								" [npc2.Name] [npc2.verb(let)] out a soft [npc2.moan],"
                                        + " gently pushing [npc2.her] [npc2.pussy+] against [npc.namePos] [npc.lips+] before [npc.she] decide to shift [npc2.her] focus back to [npc2.her] [npc2.cock+] once again.",
								...
								" Softly [npc2.moaning], [npc2.name] gently [npc2.verb(buck)] [npc2.her] [npc2.hips] into [npc.namePos] [npc.face] for a few moments,"
                                        + " before [npc.she] decide to shift [npc.her] oral attention back to [npc2.her] [npc2.cock+]."));
						break;
					case DOM_NORMAL:
					case SUB_EAGER:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								" [npc2.Name] [npc2.verb(let)] out [npc2.a_moan+],"
                                        + " eagerly pushing [npc2.her] [npc2.pussy+] against [npc.namePos] [npc.lips+] before [npc.she] decide to shift [npc2.her] focus back to [npc2.her] [npc2.cock+] once again.",
					...
					case DOM_ROUGH:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								" [npc2.Name] [npc2.verb(let)] out [npc2.a_moan+],"
                                        + " roughly grinding [npc2.her] [npc2.pussy+] against [npc.namePos] [npc.lips+] before [npc.she] decide to shift [npc2.her] focus back to [npc2.her] [npc2.cock+] once again.",
					...
					case SUB_NORMAL:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								" [npc2.Name] [npc2.verb(let)] out [npc2.a_moan+],"
                                        + " pushing [npc2.her] [npc2.pussy+] against [npc.namePos] [npc.lips+] before [npc.she] decide to shift [npc2.her] focus back to [npc2.her] [npc2.cock+] once again.",
					...
					case SUB_RESISTING:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								" [npc2.Sobbing] and squirming in discomfort, [npc2.she] desperately [npc2.verb(try)] to pull away from [npc.herHim],"
                                        + " begging to be left alone as [npc.she] shift [npc.her] attention back down to [npc2.her] [npc2.cock+] once again.",

                                " With [npc2.a_sob+], [npc2.name] tries to push [npc.name] away, squirming in discomfort as [npc.she] move back to focusing [npc.her] attention on [npc2.her] [npc2.cock+].",

                                " With tears streaming down [npc2.her] [npc2.face], [npc2.name] [npc2.verb(let)] out [npc2.a_sob+] as [npc.name] move back to focusing on [npc2.her] [npc2.cock+]."));
						break;
					default:
						break;
				}
				...
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                        " After spending a few moments eating [npc2.name] out, [npc.name] shift [npc.her] attention back down to [npc2.her] [npc2.cock+] once again.",
                        " After enjoying the taste of [npc2.namePos] [npc2.pussy+] for a few moments, [npc.name] move back to focusing [npc.her] attention on [npc2.her] [npc2.cock+]."));
			}
			...
			if(PenisMouth.getOngoingCharacters(Main.sex.getCharacterPerformingAction()).size()>1 && !primary.equals(target)) {
				switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
					case DOM_GENTLE:
						UtilText.nodeContentSB.append(UtilText.parse(Util.newArrayListOfValues(performer, target, primary),
								UtilText.returnStringAtRandom(
                                        "First sliding [npc3.name] back off of [npc.her] [npc.cock+], [npc.name] reach forwards to grab hold of [npc2.namePos] " + style + ","
                                                + " before gently pull [npc2.her] forwards and forcing [npc2.herHim] to swallow [npc.her] [npc.cock+] all the way down to the base.",
                                        "After slowly pushing [npc3.name] back, [npc.name] reach down to take a gentle, but firm, grip on each of [npc2.namePos] " + style + ", before steadily pulling [npc2.herHim] into [npc.her] groin,"
                                                + " letting out [npc.a_moan+] as [npc.she] force [npc2.herHim] to deepthroat [npc.her] [npc.cock+].",
                                        "Gently pushing [npc3.name] back, [npc.name] then reach down to take hold of [npc2.namePos] " + style + ","
					...
					case DOM_ROUGH:
						UtilText.nodeContentSB.append(UtilText.parse(Util.newArrayListOfValues(performer, target, primary),
								UtilText.returnStringAtRandom(
                                        "First pushing [npc3.name] back off of [npc.her] [npc.cock+], [npc.name] roughly grasp [npc2.namePos] " + style + ","
                                        ...
                                        "After roughly pushing [npc3.name] back, [npc.name] reach down to grab [npc2.namePos] " + style + ", before mercilessly yanking [npc2.her] head into [npc.her] groin,"
                                                + " letting out [npc.a_moan+] as [npc.she] force [npc2.herHim] to deepthroat [npc.her] [npc.cock+].",
                                        "Roughly pushing [npc3.name] back, [npc.name] then reach down to grab [npc2.namePos] " + style + ","
					...
					default: // For dom normal, sub normal, and sub eager:
						UtilText.nodeContentSB.append(UtilText.parse(Util.newArrayListOfValues(performer, target, primary),
								UtilText.returnStringAtRandom(
                                        "First sliding [npc3.name] back off of [npc.her] [npc.cock+], [npc.name] reach forwards to take hold of [npc2.namePos] " + style + ","
                                        ...
                                        "After pushing [npc3.name] back, [npc.name] reach down to take a firm grip on each of [npc2.namePos] " + style + ", before steadily pulling [npc2.herHim] into [npc.her] groin,"
                                                + " letting out [npc.a_moan+] as [npc.she] force [npc2.herHim] to deepthroat [npc.her] [npc.cock+].",
                                        "Pushing [npc3.name] back, [npc.name] then reach down to take hold of [npc2.namePos] " + style + ","
				...
				switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
					case DOM_GENTLE:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                "Taking hold of [npc2.namePos] " + style + ", [npc.name] gently pull [npc2.her] forwards, forcing [npc2.herHim] to swallow [npc.her] [npc.cock+] all the way down to the base.",
                                "Reaching down to take a gentle, but firm, grip on each of [npc2.namePos] " + style + ", [npc.name] slowly pull [npc2.herHim] into [npc.her] groin,"
                                        + " letting out [npc.a_moan+] as [npc.she] force [npc2.herHim] to deepthroat [npc.her] [npc.cock+].",
                                "With [npc.a_moan+], [npc.name] reach down to take hold of [npc2.namePos] " + style + ","
					...
					case DOM_ROUGH:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                "Roughly grasping [npc2.namePos] " + style + ", [npc.name] violently jerk [npc2.her] head forwards, forcing [npc2.herHim] to swallow [npc.her] [npc.cock+] all the way down to the base.",
                                "Reaching down to grab [npc2.namePos] " + style + ", [npc.name] mercilessly yank [npc2.her] head into [npc2.her] groin,"
                                        + " letting out [npc.a_moan+] as [npc.she] force [npc2.herHim] to deepthroat [npc.her] [npc.cock+].",
                                "With [npc.a_moan+], [npc.name] reach down to grab [npc2.namePos] " + style + ","
										+ " before violently yanking [npc2.herHim] forwards, hilting [npc.her] [npc.cock+] down [npc2.her] throat so that [npc2.her] [npc2.lips+] are pressed up against "
										+(Main.sex.getCharacterPerformingAction().hasPenisModifier(PenetrationModifier.KNOTTED)?"[npc.her] knot":"the base")+"."));
						break;
					default: // For dom normal, sub normal, and sub eager:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                "Taking hold of [npc2.namePos] " + style + ", [npc.name] firmly pull [npc2.her] head forwards, forcing [npc2.herHim] to swallow [npc.her] [npc.cock+] all the way down to the base.",
                                "Reaching down to take a firm grip on each of [npc2.namePos] " + style + ", [npc.name] steadily pull [npc2.herHim] into [npc.her] groin,"
                                        + " letting out [npc.a_moan+] as [npc.she] force [npc2.herHim] to deepthroat [npc.her] [npc.cock+].",
                                "With [npc.a_moan+], [npc.name] reach down to take hold of [npc2.namePos] " + style + ","
										+ " before steadily pulling [npc2.herHim] forwards, hilting [npc.her] [npc.cock+] down [npc2.her] throat so that [npc2.her] [npc2.lips+] are pressed up against "
										+(Main.sex.getCharacterPerformingAction().hasPenisModifier(PenetrationModifier.KNOTTED)?"[npc.her] knot":"the base")+"."));
					...
					case DOM_GENTLE:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								" With tears welling up in [npc2.her] [npc2.eyes], [npc2.name] [npc2.verb(spend)] a moment gently caressing the underside of [npc.namePos] [npc.cock] with [npc2.her] [npc2.tongue],"
                                        + " before finally being able to gasp for air as [npc.she] momentarily withdraw [npc.her] [npc.cock+] from [npc2.her] throat.",
					...
					case SUB_RESISTING:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								" Scrunching [npc2.her] [npc2.eyes] shut, [npc2.name] [npc2.verb(beat)] against #IF(npc.isPlayer())your#ELSE[npc.her] tormentor's#ENDIF thighs in a futile gesture of resistance,"
                                        + " before finally being able to cry and gasp for air as [npc.name] momentarily withdraw [npc.her] [npc.cock+] from [npc2.her] throat.",
			...
			if(PenisMouth.getOngoingCharacters(Main.sex.getCharacterPerformingAction()).size()>1 && !primary.equals(target)) {
				switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
					case DOM_GENTLE:
						UtilText.nodeContentSB.append(UtilText.parse(Util.newArrayListOfValues(performer, target, primary),
								UtilText.returnStringAtRandom(
                                        "First sliding [npc3.name] back off of [npc.her] [npc.cock+], [npc.name] reach forwards to grab hold of [npc2.namePos] [npc2.ears+],"
                                                + " before gently pull [npc2.her] forwards and forcing [npc2.herHim] to swallow [npc.her] [npc.cock+] all the way down to the base.",
                                        "After slowly pushing [npc3.name] back, [npc.name] reach down to take a gentle, but firm, grip on each of [npc2.namePos] [npc2.ears+], before steadily pulling [npc2.herHim] into [npc.her] groin,"
                                                + " letting out [npc.a_moan+] as [npc.she] force [npc2.herHim] to deepthroat [npc.her] [npc.cock+].",
                                        "Gently pushing [npc3.name] back, [npc.name] then reach down to take hold of [npc2.namePos] [npc2.ears+],"
										+ " before slowly pulling [npc2.herHim] forwards, hilting [npc.her] [npc.cock+] down [npc2.her] throat so that [npc2.her] [npc2.lips+] are pressed up against "
										+(Main.sex.getCharacterPerformingAction().hasPenisModifier(PenetrationModifier.KNOTTED)?"[npc.her] knot":"the base")+".")));
						break;
					case DOM_ROUGH:
						UtilText.nodeContentSB.append(UtilText.parse(Util.newArrayListOfValues(performer, target, primary),
								UtilText.returnStringAtRandom(
                                        "First pushing [npc3.name] back off of [npc.her] [npc.cock+], [npc.name] roughly grasp [npc2.namePos] [npc2.ears+],"
										+ " before violently jerking [npc2.her] head forwards and forcing [npc2.herHim] to swallow [npc.her] [npc.cock+] all the way down to the base.",
                                        "After roughly pushing [npc3.name] back, [npc.name] reach down to grab [npc2.namePos] [npc2.ears+], before mercilessly yanking [npc2.her] head into [npc2.her] groin,"
                                                + " letting out [npc.a_moan+] as [npc.she] force [npc2.herHim] to deepthroat [npc.her] [npc.cock+].",
                                        "Roughly pushing [npc3.name] back, [npc.name] then reach down to grab [npc2.namePos] [npc2.ears+],"
										+ " before violently yanking [npc2.herHim] forwards, hilting [npc.her] [npc.cock+] down [npc2.her] throat so that [npc2.her] [npc2.lips+] are pressed up against "
										+(Main.sex.getCharacterPerformingAction().hasPenisModifier(PenetrationModifier.KNOTTED)?"[npc.her] knot":"the base")+".")));
						break;
					default: // For dom normal, sub normal, and sub eager:
						UtilText.nodeContentSB.append(UtilText.parse(Util.newArrayListOfValues(performer, target, primary),
								UtilText.returnStringAtRandom(
                                        "First sliding [npc3.name] back off of [npc.her] [npc.cock+], [npc.name] reach forwards to take hold of [npc2.namePos] [npc2.ears+],"
										+ " before firmly pulling [npc2.her] head forwards and forcing [npc2.herHim] to swallow [npc.her] [npc.cock+] all the way down to the base.",
                                        "After pushing [npc3.name] back, [npc.name] reach down to take a firm grip on each of [npc2.namePos] [npc2.ears+], before steadily pulling [npc2.herHim] into [npc.her] groin,"
                                                + " letting out [npc.a_moan+] as [npc.she] force [npc2.herHim] to deepthroat [npc.her] [npc.cock+].",
                                        "Pushing [npc3.name] back, [npc.name] then reach down to take hold of [npc2.namePos] [npc2.ears+],"
										+ " before steadily pulling [npc2.herHim] forwards, hilting [npc.her] [npc.cock+] down [npc2.her] throat so that [npc2.her] [npc2.lips+] are pressed up against "
										+(Main.sex.getCharacterPerformingAction().hasPenisModifier(PenetrationModifier.KNOTTED)?"[npc.her] knot":"the base")+".")));
						break;
				}
				...
				switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
					case DOM_GENTLE:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                "Taking hold of [npc2.namePos] [npc2.ears+], [npc.name] gently pull [npc2.her] forwards, forcing [npc2.herHim] to swallow [npc.her] [npc.cock+] all the way down to the base.",
                                "Reaching down to take a gentle, but firm, grip on each of [npc2.namePos] [npc2.ears+], [npc.name] slowly pull [npc2.her] into [npc2.her] groin,"
                                        + " letting out [npc.a_moan+] as [npc.she] force [npc2.herHim] to deepthroat [npc.her] [npc.cock+].",
                                "With [npc.a_moan+], [npc.name] reach down to take hold of [npc2.namePos] [npc2.ears+],"
										+ " before gently pulling [npc2.herHim] forwards, hilting [npc.her] [npc.cock+] down [npc2.her] throat so that [npc2.her] [npc2.lips+] are pressed up against "
										+(Main.sex.getCharacterPerformingAction().hasPenisModifier(PenetrationModifier.KNOTTED)?"[npc.her] knot":"the base")+"."));
						break;
					case DOM_ROUGH:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                "Roughly grasping [npc2.namePos] [npc2.ears+], [npc.name] violently jerk [npc2.her] head forwards, forcing [npc2.herHim] to swallow [npc.her] [npc.cock+] all the way down to the base.",
                                "Reaching down to grab [npc2.namePos] [npc2.ears+], [npc.name] mercilessly yank [npc2.her] head into [npc2.her] groin,"
                                        + " letting out [npc.a_moan+] as [npc.she] force [npc2.herHim] to deepthroat [npc.her] [npc.cock+].",
                                "With [npc.a_moan+], [npc.name] reach down to grab [npc2.namePos] [npc2.ears+],"
										+ " before violently yanking [npc2.herHim] forwards, hilting [npc.her] [npc.cock+] down [npc2.her] throat so that [npc2.her] [npc2.lips+] are pressed up against "
										+(Main.sex.getCharacterPerformingAction().hasPenisModifier(PenetrationModifier.KNOTTED)?"[npc.her] knot":"the base")+"."));
						break;
					default: // For dom normal, sub normal, and sub eager:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                "Taking hold of [npc2.namePos] [npc2.ears+], [npc.name] firmly pull [npc2.her] head forwards, forcing [npc2.herHim] to swallow [npc.her] [npc.cock+] all the way down to the base.",
                                "Reaching down to take a firm grip on each of [npc2.namePos] [npc2.ears+], [npc.name] steadily pull [npc2.her] into [npc2.her] groin,"
                                        + " letting out [npc.a_moan+] as [npc.she] force [npc2.herHim] to deepthroat [npc.her] [npc.cock+].",
                                "With [npc.a_moan+], [npc.name] reach down to take hold of [npc2.namePos] [npc2.ears+],"
										+ " before steadily pulling [npc2.herHim] forwards, hilting [npc.her] [npc.cock+] down [npc2.her] throat so that [npc2.her] [npc2.lips+] are pressed up against "
										+(Main.sex.getCharacterPerformingAction().hasPenisModifier(PenetrationModifier.KNOTTED)?"[npc.her] knot":"the base")+"."));
			...
			if(PenisMouth.getOngoingCharacters(Main.sex.getCharacterPerformingAction()).size()>1 && !primary.equals(target)) {
				switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
					case DOM_GENTLE:
						UtilText.nodeContentSB.append(UtilText.parse(Util.newArrayListOfValues(performer, target, primary),
								UtilText.returnStringAtRandom(
                                        "First sliding [npc3.name] back off of [npc.her] [npc.cock+], [npc.name] reach forwards to grab hold of [npc2.namePos] [npc2.horns+],"
                                                + " before gently pull [npc2.her] forwards and forcing [npc2.herHim] to swallow [npc.her] [npc.cock+] all the way down to the base.",
                                        "After slowly pushing [npc3.name] back, [npc.name] reach down to take a gentle, but firm, grip on each of [npc2.namePos] [npc2.horns+], before steadily pulling [npc2.herHim] into [npc.her] groin,"
                                                + " letting out [npc.a_moan+] as [npc.she] force [npc2.herHim] to deepthroat [npc.her] [npc.cock+].",
                                        "Gently pushing [npc3.name] back, [npc.name] then reach down to take hold of [npc2.namePos] [npc2.horns+],"
										+ " before slowly pulling [npc2.herHim] forwards, hilting [npc.her] [npc.cock+] down [npc2.her] throat so that [npc2.her] [npc2.lips+] are pressed up against "
										+(Main.sex.getCharacterPerformingAction().hasPenisModifier(PenetrationModifier.KNOTTED)?"[npc.her] knot":"the base")+".")));
						break;
					case DOM_ROUGH:
						UtilText.nodeContentSB.append(UtilText.parse(Util.newArrayListOfValues(performer, target, primary),
								UtilText.returnStringAtRandom(
                                        "First pushing [npc3.name] back off of [npc.her] [npc.cock+], [npc.name] roughly grasp [npc2.namePos] [npc2.horns+],"
										+ " before violently jerking [npc2.her] head forwards and forcing [npc2.herHim] to swallow [npc.her] [npc.cock+] all the way down to the base.",
                                        "After roughly pushing [npc3.name] back, [npc.name] reach down to grab [npc2.namePos] [npc2.horns+], before mercilessly yanking [npc2.her] head into [npc2.her] groin,"
                                                + " letting out [npc.a_moan+] as [npc.she] force [npc2.herHim] to deepthroat [npc.her] [npc.cock+].",
                                        "Roughly pushing [npc3.name] back, [npc.name] then reach down to grab [npc2.namePos] [npc2.horns+],"
										+ " before violently yanking [npc2.herHim] forwards, hilting [npc.her] [npc.cock+] down [npc2.her] throat so that [npc2.her] [npc2.lips+] are pressed up against "
										+(Main.sex.getCharacterPerformingAction().hasPenisModifier(PenetrationModifier.KNOTTED)?"[npc.her] knot":"the base")+".")));
						break;
					default: // For dom normal, sub normal, and sub eager:
						UtilText.nodeContentSB.append(UtilText.parse(Util.newArrayListOfValues(performer, target, primary),
								UtilText.returnStringAtRandom(
                                        "First sliding [npc3.name] back off of [npc.her] [npc.cock+], [npc.name] reach forwards to take hold of [npc2.namePos] [npc2.horns+],"
										+ " before firmly pulling [npc2.her] head forwards and forcing [npc2.herHim] to swallow [npc.her] [npc.cock+] all the way down to the base.",
                                        "After pushing [npc3.name] back, [npc.name] reach down to take a firm grip on each of [npc2.namePos] [npc2.horns+], before steadily pulling [npc2.herHim] into [npc.her] groin,"
                                                + " letting out [npc.a_moan+] as [npc.she] force [npc2.herHim] to deepthroat [npc.her] [npc.cock+].",
                                        "Pushing [npc3.name] back, [npc.name] then reach down to take hold of [npc2.namePos] [npc2.horns+],"
										+ " before steadily pulling [npc2.herHim] forwards, hilting [npc.her] [npc.cock+] down [npc2.her] throat so that [npc2.her] [npc2.lips+] are pressed up against "
										+(Main.sex.getCharacterPerformingAction().hasPenisModifier(PenetrationModifier.KNOTTED)?"[npc.her] knot":"the base")+".")));
						break;
				}
				...
				switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
					case DOM_GENTLE:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                "Taking hold of [npc2.namePos] [npc2.horns+], [npc.name] gently pull [npc2.her] forwards, forcing [npc2.herHim] to swallow [npc.her] [npc.cock+] all the way down to the base.",
                                "Reaching down to take a gentle, but firm, grip on each of [npc2.namePos] [npc2.horns+], [npc.name] slowly pull [npc2.her] into [npc2.her] groin,"
                                        + " letting out [npc.a_moan+] as [npc.she] force [npc2.herHim] to deepthroat [npc.her] [npc.cock+].",
                                "With [npc.a_moan+], [npc.name] reach down to take hold of [npc2.namePos] [npc2.horns+],"
										+ " before gently pulling [npc2.herHim] forwards, hilting [npc.her] [npc.cock+] down [npc2.her] throat so that [npc2.her] [npc2.lips+] are pressed up against "
										+(Main.sex.getCharacterPerformingAction().hasPenisModifier(PenetrationModifier.KNOTTED)?"[npc.her] knot":"the base")+"."));
						break;
					case DOM_ROUGH:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                "Roughly grasping [npc2.namePos] [npc2.horns+], [npc.name] violently jerk [npc2.her] head forwards, forcing [npc2.herHim] to swallow [npc.her] [npc.cock+] all the way down to the base.",
                                "Reaching down to grab [npc2.namePos] [npc2.horns+], [npc.name] mercilessly yank [npc2.her] head into [npc2.her] groin,"
                                        + " letting out [npc.a_moan+] as [npc.she] force [npc2.herHim] to deepthroat [npc.her] [npc.cock+].",
                                "With [npc.a_moan+], [npc.name] reach down to grab [npc2.namePos] [npc2.horns+],"
										+ " before violently yanking [npc2.herHim] forwards, hilting [npc.her] [npc.cock+] down [npc2.her] throat so that [npc2.her] [npc2.lips+] are pressed up against "
										+(Main.sex.getCharacterPerformingAction().hasPenisModifier(PenetrationModifier.KNOTTED)?"[npc.her] knot":"the base")+"."));
						break;
					default: // For dom normal, sub normal, and sub eager:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                "Taking hold of [npc2.namePos] [npc2.horns+], [npc.name] firmly pull [npc2.her] head forwards, forcing [npc2.herHim] to swallow [npc.her] [npc.cock+] all the way down to the base.",
                                "Reaching down to take a firm grip on each of [npc2.namePos] [npc2.horns+], [npc.name] steadily pull [npc2.her] into [npc2.her] groin,"
                                        + " letting out [npc.a_moan+] as [npc.she] force [npc2.herHim] to deepthroat [npc.her] [npc.cock+].",
                                "With [npc.a_moan+], [npc.name] reach down to take hold of [npc2.namePos] [npc2.horns+],"
										+ " before steadily pulling [npc2.herHim] forwards, hilting [npc.her] [npc.cock+] down [npc2.her] throat so that [npc2.her] [npc2.lips+] are pressed up against "
										+(Main.sex.getCharacterPerformingAction().hasPenisModifier(PenetrationModifier.KNOTTED)?"[npc.her] knot":"the base")+"."));
			...
			if(PenisMouth.getOngoingCharacters(Main.sex.getCharacterPerformingAction()).size()>1 && !primary.equals(target)) {
				switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
					case DOM_GENTLE:
						UtilText.nodeContentSB.append(UtilText.parse(Util.newArrayListOfValues(performer, target, primary),
								UtilText.returnStringAtRandom(
                                        "First sliding [npc3.name] back off of [npc.her] [npc.cock+], [npc.name] reach forwards to grab hold of [npc2.namePos] [npc2.antennae+],"
                                                + " before gently pull [npc2.her] forwards and forcing [npc2.herHim] to swallow [npc.her] [npc.cock+] all the way down to the base.",
                                        "After slowly pushing [npc3.name] back, [npc.name] reach down to take a gentle, but firm, grip on each of [npc2.namePos] [npc2.antennae+], before steadily pulling [npc2.herHim] into [npc.her] groin,"
                                                + " letting out [npc.a_moan+] as [npc.she] force [npc2.herHim] to deepthroat [npc.her] [npc.cock+].",
                                        "Gently pushing [npc3.name] back, [npc.name] then reach down to take hold of [npc2.namePos] [npc2.antennae+],"
										+ " before slowly pulling [npc2.herHim] forwards, hilting [npc.her] [npc.cock+] down [npc2.her] throat so that [npc2.her] [npc2.lips+] are pressed up against "
										+(Main.sex.getCharacterPerformingAction().hasPenisModifier(PenetrationModifier.KNOTTED)?"[npc.her] knot":"the base")+".")));
						break;
					case DOM_ROUGH:
						UtilText.nodeContentSB.append(UtilText.parse(Util.newArrayListOfValues(performer, target, primary),
								UtilText.returnStringAtRandom(
                                        "First pushing [npc3.name] back off of [npc.her] [npc.cock+], [npc.name] roughly grasp [npc2.namePos] [npc2.antennae+],"
										+ " before violently jerking [npc2.her] head forwards and forcing [npc2.herHim] to swallow [npc.her] [npc.cock+] all the way down to the base.",
                                        "After roughly pushing [npc3.name] back, [npc.name] reach down to grab [npc2.namePos] [npc2.antennae+], before mercilessly yanking [npc2.her] head into [npc2.her] groin,"
                                                + " letting out [npc.a_moan+] as [npc.she] force [npc2.herHim] to deepthroat [npc.her] [npc.cock+].",
                                        "Roughly pushing [npc3.name] back, [npc.name] then reach down to grab [npc2.namePos] [npc2.antennae+],"
										+ " before violently yanking [npc2.herHim] forwards, hilting [npc.her] [npc.cock+] down [npc2.her] throat so that [npc2.her] [npc2.lips+] are pressed up against "
										+(Main.sex.getCharacterPerformingAction().hasPenisModifier(PenetrationModifier.KNOTTED)?"[npc.her] knot":"the base")+".")));
						break;
					default: // For dom normal, sub normal, and sub eager:
						UtilText.nodeContentSB.append(UtilText.parse(Util.newArrayListOfValues(performer, target, primary),
								UtilText.returnStringAtRandom(
                                        "First sliding [npc3.name] back off of [npc.her] [npc.cock+], [npc.name] reach forwards to take hold of [npc2.namePos] [npc2.antennae+],"
										+ " before firmly pulling [npc2.her] head forwards and forcing [npc2.herHim] to swallow [npc.her] [npc.cock+] all the way down to the base.",
                                        "After pushing [npc3.name] back, [npc.name] reach down to take a firm grip on each of [npc2.namePos] [npc2.antennae+], before steadily pulling [npc2.herHim] into [npc.her] groin,"
                                                + " letting out [npc.a_moan+] as [npc.she] force [npc2.herHim] to deepthroat [npc.her] [npc.cock+].",
                                        "Pushing [npc3.name] back, [npc.name] then reach down to take hold of [npc2.namePos] [npc2.antennae+],"
										+ " before steadily pulling [npc2.herHim] forwards, hilting [npc.her] [npc.cock+] down [npc2.her] throat so that [npc2.her] [npc2.lips+] are pressed up against "
										+(Main.sex.getCharacterPerformingAction().hasPenisModifier(PenetrationModifier.KNOTTED)?"[npc.her] knot":"the base")+".")));
						break;
				}
				...
				switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
					case DOM_GENTLE:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                "Taking hold of [npc2.namePos] [npc2.antennae+], [npc.name] gently pull [npc2.her] forwards, forcing [npc2.herHim] to swallow [npc.her] [npc.cock+] all the way down to the base.",
                                "Reaching down to take a gentle, but firm, grip on each of [npc2.namePos] [npc2.antennae+], [npc.name] slowly pull [npc2.her] into [npc2.her] groin,"
                                        + " letting out [npc.a_moan+] as [npc.she] force [npc2.herHim] to deepthroat [npc.her] [npc.cock+].",
                                "With [npc.a_moan+], [npc.name] reach down to take hold of [npc2.namePos] [npc2.antennae+],"
										+ " before gently pulling [npc2.herHim] forwards, hilting [npc.her] [npc.cock+] down [npc2.her] throat so that [npc2.her] [npc2.lips+] are pressed up against "
										+(Main.sex.getCharacterPerformingAction().hasPenisModifier(PenetrationModifier.KNOTTED)?"[npc.her] knot":"the base")+"."));
						break;
					case DOM_ROUGH:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                "Roughly grasping [npc2.namePos] [npc2.antennae+], [npc.name] violently jerk [npc2.her] head forwards, forcing [npc2.herHim] to swallow [npc.her] [npc.cock+] all the way down to the base.",
                                "Reaching down to grab [npc2.namePos] [npc2.antennae+], [npc.name] mercilessly yank [npc2.her] head into [npc2.her] groin,"
                                        + " letting out [npc.a_moan+] as [npc.she] force [npc2.herHim] to deepthroat [npc.her] [npc.cock+].",
                                "With [npc.a_moan+], [npc.name] reach down to grab [npc2.namePos] [npc2.antennae+],"
										+ " before violently yanking [npc2.herHim] forwards, hilting [npc.her] [npc.cock+] down [npc2.her] throat so that [npc2.her] [npc2.lips+] are pressed up against "
										+(Main.sex.getCharacterPerformingAction().hasPenisModifier(PenetrationModifier.KNOTTED)?"[npc.her] knot":"the base")+"."));
						break;
					default: // For dom normal, sub normal, and sub eager:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                "Taking hold of [npc2.namePos] [npc2.antennae+], [npc.name] firmly pull [npc2.her] head forwards, forcing [npc2.herHim] to swallow [npc.her] [npc.cock+] all the way down to the base.",
                                "Reaching down to take a firm grip on each of [npc2.namePos] [npc2.antennae+], [npc.name] steadily pull [npc2.her] into [npc2.her] groin,"
                                        + " letting out [npc.a_moan+] as [npc.she] force [npc2.herHim] to deepthroat [npc.her] [npc.cock+].",
                                "With [npc.a_moan+], [npc.name] reach down to take hold of [npc2.namePos] [npc2.antennae+],"
										+ " before steadily pulling [npc2.herHim] forwards, hilting [npc.her] [npc.cock+] down [npc2.her] throat so that [npc2.her] [npc2.lips+] are pressed up against "
										+(Main.sex.getCharacterPerformingAction().hasPenisModifier(PenetrationModifier.KNOTTED)?"[npc.her] knot":"the base")+"."));
	...
	public static final SexAction THROAT_MUSCLE_CONTROL = new SexAction(
		...
		public String getDescription() {
			...
			return UtilText.parse(performer, target,
					UtilText.returnStringAtRandom(
                            "Letting out a muffled [npc.moan], [npc.name] concentrate on squeezing the extra internal muscles within [npc.her] throat down around [npc2.namePos] [npc2.cock+].",
						(!isTargetedCharacterInanimate()
                                ? "[npc.Name] let out a muffled [npc.moan] as [npc.she] focus on controlling the extra muscles lining the insides of [npc.her] throat."
                                + " Gripping and squeezing them down around the [npc2.cock+] in [npc.her] mouth, [npc.name] cause [npc2.name] to let out an involuntary cry of pleasure."
							:""),
                            "[npc.Name] find [npc.her] letting out a series of muffled [npc.moans] as [npc.she] concentrate on squeezing the extra muscles within [npc.her] throat down around [npc2.namePos] [npc2.cock+].",
                            "With a muffled [npc.moan], [npc.name] focus on controlling the extra muscles deep within [npc.her] throat, gripping them down and massaging [npc2.namePos] [npc2.cock+]."));
		}
	};
		...
		public String getDescription() {
			...
			if(Main.sex.getSexPositionSlot(Main.sex.getCharacterTargetedForSexAction(this)).hasTag(SexSlotTag.PERFORMING_ORAL)) {
				...
				switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
					case DOM_GENTLE:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                "Reaching down to grab [npc2.namePos] head, [npc.name] line the [npc.cockHead+] of [npc.her] [npc.cock] up to [npc2.her] [npc2.lips+],"
										+ " before gently pushing [npc.her] [npc.hips] forwards and sliding [npc.her] [npc.cock+] into [npc2.her] mouth.",

                                "Reaching down to take hold of [npc2.namePos] head, [npc.name] push the [npc.cockHead+] of [npc.her] [npc.cock] against [npc2.namePos] [npc2.lips+],"
				...
				switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
					case DOM_GENTLE:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                "Shuffling back a little, [npc.name] slowly lower [npc.her] [npc.cock+] down to [npc2.namePos] mouth,"
										+ " before gently pushing the [npc.cockHead+] past [npc2.her] [npc2.lips+] and collapsing down onto [npc2.her] [npc2.face+].",

                                "Gently lowering [npc.her] [npc.cock+] down to [npc2.namePos] mouth, [npc.name] slowly allow [npc.her] [npc.legs] to give out from under [npc.herHim]"
										+ " as [npc.she] forces the [npc.cockHead+] past [npc2.her] [npc2.lips+]."));
						break;
					case DOM_NORMAL:
					case SUB_EAGER:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                "Shuffling back a little, [npc.name] quickly drop [npc.her] [npc.cock+] down to [npc2.namePos] mouth,"
										+ " before eagerly pushing the [npc.cockHead+] past [npc2.her] [npc2.lips+] and collapsing down onto [npc2.her] [npc2.face+].",

                                "Quickly dropping [npc.her] [npc.cock+] down to [npc2.namePos] mouth, [npc.name] allow [npc.her] [npc.legs] to give out from under [npc.herHim]"
										+ " as [npc.she] eagerly forces the [npc.cockHead+] past [npc2.her] [npc2.lips+]."));
						break;
					case DOM_ROUGH:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                "Shuffling back a little, [npc.name] roughly grind [npc.her] [npc.cock+] down against [npc2.namePos] mouth,"
										+ " before forcefully pushing the [npc.cockHead+] past [npc2.her] [npc2.lips+] and collapsing down onto [npc2.her] [npc2.face+].",

                                "Roughly grinding [npc.her] [npc.cock+] down against [npc2.namePos] mouth, [npc.name] allow [npc.her] [npc.legs] to give out from under [npc.herHim]"
										+ " as [npc.she] forces the [npc.cockHead+] past [npc2.her] [npc2.lips+]."));
						break;
					case SUB_NORMAL:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
					...
					case DOM_GENTLE:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								"Lining the [npc.cockHead+] of [npc.her] [npc.cock] up to [npc2.namePos] [npc2.lips+],"
                                        + " [npc.name] gently push [npc.her] [npc.hips] forwards and slide [npc.her] [npc.cock+] into [npc2.her] mouth.",

								"Pushing the [npc.cockHead+] of [npc.her] [npc.cock] against [npc2.namePos] [npc2.lips+],"
                                        + " [npc.name] slowly push [npc.her] [npc.hips] into [npc2.her] [npc2.face], gently sliding [npc.her] [npc.cock+] into [npc2.her] mouth."));
						break;
					case DOM_NORMAL:
					case SUB_EAGER:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								"Lining the [npc.cockHead+] of [npc.her] [npc.cock] up to [npc2.namePos] [npc2.lips+],"
                                        + " [npc.name] eagerly push [npc.her] [npc.hips] forwards and slide [npc.her] [npc.cock+] into [npc2.namePos] mouth.",

								"Pushing the [npc.cockHead+] of [npc.her] [npc.cock] against [npc2.namePos] [npc2.lips+],"
                                        + " [npc.name] eagerly buck [npc.her] [npc.hips] into [npc2.her] [npc2.face], sliding [npc.her] [npc.cock+] into [npc2.her] mouth."));
						break;
					case DOM_ROUGH:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								"Lining the [npc.cockHead+] of [npc.her] [npc.cock] up to [npc2.namePos] [npc2.lips+],"
                                        + " [npc.name] roughly slams [npc.her] [npc.hips] forwards and force [npc.her] [npc.cock+] into [npc2.namePos] mouth.",

								"Grinding the [npc.cockHead+] of [npc.her] [npc.cock] against [npc2.namePos] [npc2.lips+],"
                                        + " [npc.name] roughly slam [npc.her] [npc.hips] into [npc2.her] [npc2.face], forcing [npc.her] [npc.cock+] into [npc2.her] mouth."));
						break;
					case SUB_NORMAL:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								"Lining the [npc.cockHead+] of [npc.her] [npc.cock] up to [npc2.namePos] [npc2.lips+],"
                                        + " [npc.name] push [npc.her] [npc.hips] forwards and slide [npc.her] [npc.cock+] into [npc2.her] mouth.",

								"Pushing the [npc.cockHead+] of [npc.her] [npc.cock] against [npc2.namePos] [npc2.lips+],"
                                        + " [npc.name] buck [npc.her] [npc.hips] into [npc2.her] [npc2.face], sliding [npc.her] [npc.cock+] into [npc2.her] mouth."));
						break;
					default:
						break;
				}
					...
					case SUB_RESISTING:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								...
								" With a muffled [npc2.sob], [npc2.name] frantically [npc2.verb(try)] to pull away from [npc.namePos] [npc.cock+],"
                                        + " gargling and choking as [npc2.she] [npc2.verb(squirm)] и [npc2.verb(struggle)] against [npc.herHim]."));
						break;
					default:
						break;
				}
		...
		public String getDescription() {
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(
							UtilText.parse(getCharactersForParsing(),
                                    "Not satisfied with having just " + getOngoingNames() + " sucking [npc.her] [npc.cock], [npc.name] get " + (getOngoingCharacters().size() == 1 ? "[npc3.herHim]" : "them") + " to pull back and temporarily move aside a little,"
				...
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(
							UtilText.parse(getCharactersForParsing(),
                                    "Not satisfied with having just " + getOngoingNames() + " sucking [npc.her] [npc.cock], [npc.name] push " + (getOngoingCharacters().size() == 1 ? "[npc3.herHim]" : "them") + " back,"
	...
	public static final SexAction BLOWJOB_DOM_GENTLE = new SexAction(
		...
		public String getDescription() {
			...
			if(PenisMouth.getOngoingCharacters(Main.sex.getCharacterPerformingAction()).size()>1 && !primary.equals(target)) {
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                        "Getting " + PenisMouth.getOngoingNames(Main.sex.getCharacterPerformingAction(), target) + " to move aside a little, [npc.name] gently slide [npc.her] [npc.cock+] past [npc2.namePos] [npc2.lips+],"
                                + " letting out a soft [npc.moan] as [npc.she] steadily pump [npc.her] [npc.hips] into [npc2.her] [npc2.face].",
							"Gently instructing "+PenisMouth.getOngoingNames(Main.sex.getCharacterPerformingAction(), target)+" to let [npc2.name] take the lead,"
                                    + " [npc.name] slowly push [npc.her] [npc.hips] into [npc2.her] [npc2.face], letting out a soft [npc.moan] as [npc.she] rhythmically fuck [npc2.her] throat.",
                        "After telling " + PenisMouth.getOngoingNames(Main.sex.getCharacterPerformingAction(), target) + " to make room for [npc2.name], [npc.name] gently buck [npc.her] [npc.hips+] into [npc2.her] [npc2.face],"
                                + " letting out a soft [npc.moan] as [npc.she] get [npc2.herHim] to suck [npc.her] [npc.cock+]."));
				
			} else {
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                        "[npc.Name] gently slide [npc.her] [npc.cock+] past [npc2.namePos] [npc2.lips+],"
                                + " letting out a soft [npc.moan] as [npc.she] steadily pump [npc.her] [npc.hips] into [npc2.her] [npc2.face].",
                        "[npc.Name] slowly push [npc.her] [npc.hips] into [npc2.namePos] [npc2.face], letting out a soft [npc.moan] as [npc.she] gently fuck [npc2.her] throat.",
							"Gently bucking [npc.her] [npc.hips+] into [npc2.namePos] [npc2.face],"
                                    + " [npc.name] let out a soft [npc.moan] as [npc.she] continue receiving [npc.her] blowjob."));
			}
	...
	public static final SexAction BLOWJOB_DOM_NORMAL = new SexAction(
		...
		public String getDescription() {
			...
			if(PenisMouth.getOngoingCharacters(Main.sex.getCharacterPerformingAction()).size()>1 && !primary.equals(target)) {
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                        "Getting " + PenisMouth.getOngoingNames(Main.sex.getCharacterPerformingAction(), target) + " to move aside a little, [npc.name] eagerly slide [npc.her] [npc.cock+] past [npc2.namePos] [npc2.lips+],"
                                + " letting out [npc.a_moan+] as [npc.she] greedily pump [npc.her] [npc.hips] into [npc2.her] [npc2.face].",
							"Impatiently instructing "+PenisMouth.getOngoingNames(Main.sex.getCharacterPerformingAction(), target)+" to let [npc2.name] take the lead,"
                                    + " [npc.name] desperately buck [npc.her] [npc.hips] into [npc2.her] [npc2.face], letting out [npc.a_moan+] as [npc.she] eagerly fuck [npc2.her] throat.",
                        "After telling " + PenisMouth.getOngoingNames(Main.sex.getCharacterPerformingAction(), target) + " to make room for [npc2.name], [npc.name] enthusiastically buck [npc.her] [npc.hips+] into [npc2.her] [npc2.face],"
                                + " letting out [npc.a_moan+] as [npc.she] get [npc2.herHim] to suck [npc.her] [npc.cock+]."));
				
			} else {
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                        "[npc.Name] eagerly thrust [npc.her] [npc.cock+] past [npc2.namePos] [npc2.lips+],"
                                + " letting out [npc.a_moan+] as [npc.she] greedily pump [npc.her] [npc.hips] into [npc2.her] [npc2.face].",
                        "[npc.Name] desperately buck [npc.her] [npc.hips] into [npc2.namePos] [npc2.face], letting out [npc.a_moan+] as [npc.she] eagerly fuck [npc2.her] throat.",
							"Enthusiastically bucking [npc.her] [npc.hips+] into [npc2.namePos] [npc2.face],"
                                    + " [npc.name] let out [npc.a_moan+] as [npc.she] continue happily receiving [npc.her] blowjob."));
			}
			...
			if(Main.sex.getSexPositionSlot(Main.sex.getCharacterPerformingAction()).hasTag(SexSlotTag.STANDING)
				...
				if(PenisMouth.getOngoingCharacters(Main.sex.getCharacterPerformingAction()).size()>1 && !primary.equals(target)) {
					...
					for(PenetrationModifier pm : Main.sex.getCharacterPerformingAction().getPenisModifiers()) {
						switch(pm) {
							case BARBED:
                                descriptions.add(" [npc.name] bury [npc.her] [npc.cock+] deep down [npc2.namePos] throat."
                                        + " Holding [npc2.her] head in place with both [npc.hands], [npc.she] then proceed to start roughly fucking [npc2.her] [npc2.face],"
							...
							case FLARED:
								...
								break;
							case KNOTTED:
                                descriptions.add(" [npc.name] suddenly, and violently, bury [npc.her] [npc.cock+] deep down [npc2.namePos] throat."
													+ " Holding [npc2.her] head in place with both [npc.hands], [npc.she] then proceeds to start roughly fucking [npc2.her] [npc2.face],"
                                        + " causing tears to start streaming from [npc2.her] [npc2.eyes] as [npc.namePos] slam [npc.her] knot repeatedly against [npc2.her] [npc2.lips+].");
								break;
							default:
								break;
						}
                    ...
                    descriptions.add(" [npc.name] grab the sides of [npc2.namePos] head, and before [npc2.she] [npc2.verb(know)] what's happening,"
										+ " [npc.sheIs] roughly slamming [npc.her] [npc.cock+] in and out of [npc2.her] facial fuck-hole.");
                    descriptions.add(" [npc.name] slam [npc.her] [npc.cock+] all the way down [npc2.namePos] throat."
                            + " As [npc2.she] [npc2.verb(blink)] back tears, [npc.name] start rapidly bucking [npc.her] [npc.hips] back and forth,"
                            + " holding [npc2.namePos] head in place with both hands as [npc.she] ruthlessly fuck [npc2.her] [npc2.face].");
                    descriptions.add(" [npc.name] roughly pull [npc2.her] face into [npc.her] groin,"
										+ " sinking [npc.her] [npc.cock+] deep down [npc2.her] throat before starting to ruthlessly fuck [npc2.her] [npc2.face].");
                    descriptions.add(" [npc.name] roughly hilt [npc.her] [npc.cock+] deep down [npc2.namePos] throat."
					...
					for(PenetrationModifier pm : Main.sex.getCharacterPerformingAction().getPenisModifiers()) {
						switch(pm) {
							case BARBED:
                                descriptions.add("With a sudden, violent thrust forwards, [npc.name] bury [npc.her] [npc.cock+] deep down [npc2.namePos] throat."
                                        + " Holding [npc2.her] head in place with both [npc.hands], [npc.she] then proceed to start roughly fucking [npc2.her] [npc2.face],"
													+ " causing tears to start streaming from [npc2.her] [npc2.eyes] as the barbs lining [npc.namePos] shaft repeatedly rake up the sides of [npc2.her] throat.");
								break;
							case FLARED:
                    ...
                    descriptions.add("[npc.Name] grab the sides of [npc2.namePos] head, and before [npc2.she] [npc2.verb(know)] what's happening,"
										+ " [npc.sheIs] roughly slamming [npc.her] [npc.cock+] in and out of [npc2.her] facial fuck-hole.");
                    descriptions.add("Letting out [npc.a_moan+], [npc.name] slam [npc.her] [npc.cock+] all the way down [npc2.namePos] throat."
                            + " As [npc2.she] [npc2.verb(blink)] back tears, [npc.name] start rapidly bucking [npc.her] [npc.hips] back and forth,"
                            + " holding [npc2.namePos] head in place with both hands as [npc.she] ruthlessly fuck [npc2.her] [npc2.face].");
					descriptions.add("Grabbing the sides of [npc2.namePos] head, [npc.name] roughly [npc2.verb(pull)] [npc2.her] face into [npc.her] groin,"
										+ " sinking [npc.her] [npc.cock+] deep down [npc2.her] throat before starting to ruthlessly fuck [npc2.her] [npc2.face].");
                    descriptions.add("With a forceful thrust, [npc.name] hilt [npc.her] [npc.cock+] deep down [npc2.namePos] throat."
										+ " As a slimy stream of saliva "+(Main.sex.hasLubricationTypeFromAnyone(Main.sex.getCharacterPerformingAction(), SexAreaPenetration.PENIS, LubricationType.PRECUM)?"and precum ":"")
										+"drools from the corners of [npc2.her] mouth, [npc.name] bucks back, letting [npc2.name] gasp for air for a brief moment before starting to aggressively fuck [npc2.her] [npc2.face].");
				...
				for(PenetrationModifier pm : Main.sex.getCharacterPerformingAction().getPenisModifiers()) {
					switch(pm) {
						case BARBED:
                            descriptions.add("Spreading [npc.her] knees out on either side of [npc2.namePos] head, [npc.name] violently thrust downwards, burying [npc.her] [npc.cock+] deep down [npc2.namePos] throat."
                                    + " Grinding the base against [npc2.her] [npc2.lips+] for moment, [npc.she] then proceed to start roughly fucking [npc2.her] face,"
				...
				if(Main.sex.getCharacterPerformingAction().hasLegs()) {
                    descriptions.add("[npc.Name] spread [npc.her] knees out on either side of [npc2.namePos] head, and before [npc2.she] [npc2.verb(know)] what's happening,"
							+ " [npc.nameIs] roughly slamming [npc.her] [npc.cock+] in and out of [npc2.her] facial fuck-hole.");
					
				} else {
                    descriptions.add("[npc.Name] push [npc.her] groin down onto [npc2.namePos] face, and before [npc2.she] [npc2.verb(know)] what's happening,"
							+ " [npc.nameIs] roughly slamming [npc.her] [npc.cock+] in and out of [npc2.her] facial fuck-hole.");
				}

                descriptions.add("Letting out [npc.a_moan+], [npc.name] slam [npc.her] [npc.cock+] all the way down [npc2.namePos] throat."
                        + " As [npc2.she] [npc2.verb(blink)] back tears, [npc.name] start rapidly slamming [npc.her] [npc.hips] up and down,"
                        + " letting out more [npc.moans+] as [npc.she] ruthlessly fuck [npc2.her] [npc2.face].");

				descriptions.add("Dropping down onto [npc2.namePos] face, [npc.name] roughly slams [npc.her] [npc.cock+] deep down [npc2.her] throat,"
                        + " letting out [npc.a_moan+] before starting to violently slam [npc.her] [npc.hips] up and down as [npc.she] ruthlessly fuck [npc2.her] face.");
				...
				if(PenisMouth.getOngoingCharacters(Main.sex.getCharacterPerformingAction()).size()>1 && !primary.equals(target)) {
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Forcing " + PenisMouth.getOngoingNames(Main.sex.getCharacterPerformingAction(), target) + " to move aside, [npc.name] roughly slam [npc.her] [npc.cock+] past [npc2.namePos] [npc2.lips+],"
                                    + " letting out [npc.a_moan+] as [npc.she] violently thrust [npc.her] [npc.hips] into [npc2.her] [npc2.face].",
								"Impatiently shouting at "+PenisMouth.getOngoingNames(Main.sex.getCharacterPerformingAction(), target)+" to let [npc2.name] take the lead,"
                                        + " [npc.name] violently slam [npc.her] [npc.hips] into [npc2.her] [npc2.face], letting out [npc.a_moan+] as [npc.she] roughly fuck [npc2.her] throat.",
                            "After ordering " + PenisMouth.getOngoingNames(Main.sex.getCharacterPerformingAction(), target) + " to make room for [npc2.name], [npc.name] aggressively buck [npc.her] [npc.hips+] into [npc2.her] [npc2.face],"
                                    + " letting out [npc.a_moan+] as [npc.she] forcefully fuck [npc2.her] face."));
					
				} else {
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "[npc.Name] roughly slam [npc.her] [npc.cock+] past [npc2.namePos] [npc2.lips+],"
                                    + " letting out [npc.a_moan+] as [npc.she] violently thrust [npc.her] [npc.hips] into [npc2.her] [npc2.face].",
                            "[npc.Name] violently slam [npc.her] [npc.hips] into [npc2.namePos] [npc2.face], letting out [npc.a_moan+] as [npc.she] roughly fuck [npc2.her] throat.",
								"Aggressively bucking [npc.her] [npc.hips+] into [npc2.namePos] [npc2.face],"
                                        + " [npc.name] let out [npc.a_moan+] as [npc.she] continue roughly fucking [npc2.her] face."));
				}
				UtilText.nodeContentSB.append(getTargetedCharacterResponse(this));
			...
			if(PenisMouth.getOngoingCharacters(Main.sex.getCharacterPerformingAction()).size()>1 && !primary.equals(target)) {
				switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(this))) {
					case DOM_GENTLE:
						UtilText.nodeContentSB.append(UtilText.parse(Util.newArrayListOfValues(performer, target, primary),
								UtilText.returnStringAtRandom(
                                        "Letting out [npc.a_sob+], [npc.name] frantically try to pull [npc.her] hips away from [npc2.namePos] face, but [npc.her] efforts prove to be in vain as [npc2.she] gently, but firmly,"
                                            + " [npc2.verb(hold)] [npc.herHim] in place, planting kiss after gentle kiss on the sides of [npc.her] [npc.cock+] и [npc.balls] as [npc3.name] [npc3.verb(continue)] giving [npc.herHim] an unwanted blowjob.",
                                        "Tears start to well up in [npc.namePos] [npc.eyes], and with [npc.a_sob+], [npc.she] try to pull [npc.her] [npc.cock+] out of [npc3.namePos] mouth."
                                        ...
                                        "[npc.Sobbing+], [npc.name] try to pull [npc.her] [npc.cock+] out of [npc3.namePos] mouth, but [npc2.namePos] grip is too strong for [npc.herHim] to break away from"
					...
					case DOM_ROUGH:
						UtilText.nodeContentSB.append(UtilText.parse(Util.newArrayListOfValues(performer, target, primary),
								UtilText.returnStringAtRandom(
                                        "Letting out [npc.a_sob+], [npc.name] frantically try to pull [npc.her] hips away from [npc2.namePos] face, but [npc.her] efforts prove to be in vain as [npc2.she] roughly"
                                            + " [npc2.verb(hold)] [npc.herHim] in place, planting kiss after forceful kiss on the sides of [npc.her] [npc.cock+] и [npc.balls] as [npc3.name] [npc3.verb(continue)] giving [npc.herHim] an unwanted blowjob.",
                                        "Tears start to well up in [npc.namePos] [npc.eyes], and with [npc.a_sob+], [npc.she] try to pull [npc.her] [npc.cock+] out of [npc3.namePos] mouth."
                                        ...
                                        "[npc.Sobbing+], [npc.name] try to pull [npc.her] [npc.cock+] out of [npc3.namePos] mouth, but [npc2.namePos] grip is far too strong for [npc.herHim] to break away from"
											+ ", and [npc.her] struggles prove to be in vain as [npc2.she] [npc2.verb(hold)] [npc.herHim] in place,"
					...
					default: // DOM_NORMAL and in case anything goes wrong:
						UtilText.nodeContentSB.append(UtilText.parse(Util.newArrayListOfValues(performer, target, primary),
								UtilText.returnStringAtRandom(
                                        "Letting out [npc.a_sob+], [npc.name] frantically try to pull [npc.her] hips away from [npc2.namePos] face, but [npc.her] efforts prove to be in vain as [npc2.she] firmly"
                                            + " [npc2.verb(hold)] [npc.herHim] in place, planting kiss after eager kiss on the sides of [npc.her] [npc.cock+] и [npc.balls] as [npc3.name] [npc3.verb(continue)] giving [npc.herHim] an unwanted blowjob.",
                                        "Tears start to well up in [npc.namePos] [npc.eyes], and with [npc.a_sob+], [npc.she] try to pull [npc.her] [npc.cock+] out of [npc3.namePos] mouth."
				...
				switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(this))) {
					case DOM_GENTLE:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                ...
                                "Tears start to well up in [npc.namePos] [npc.eyes], and with [npc.a_sob+], [npc.she] try to pull [npc.her] [npc.cock+] out of [npc2.namePos] mouth."
                                        + " [npc2.Her] grip proves to be too strong, however, and [npc2.name] gently, but firmly, continue to suck [npc.her] [npc.cock+] as [npc.she] weakly struggles against [npc2.herHim].",

                                "[npc.Sobbing+], [npc.name] try to pull [npc.her] [npc.cock+] out of [npc2.namePos] mouth, but [npc2.her] grip is too strong for [npc.herHim]"
									+ ", and [npc.her] struggles prove to be in vain as [npc2.name] [npc2.verb(continue)] giving [npc.herHim] a slow, gentle blowjob."));
						break;
					case DOM_ROUGH:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                "Letting out [npc.a_sob+], [npc.name] frantically try to pull [npc.her] hips away from [npc2.namePos] face, but [npc.her] efforts prove to be in vain as [npc2.she] roughly [npc2.verb(hold)] [npc.herHim] in place,"
					...
					default: // DOM_NORMAL and in case anything goes wrong:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                "Letting out [npc.a_sob+], [npc.name] frantically try to pull [npc.her] hips away from [npc2.namePos] face, but [npc.her] efforts prove to be in vain as [npc2.she] firmly [npc2.verb(hold)] [npc.herHim] in place,"
                                ...
                                "Tears start to well up in [npc.namePos] [npc.eyes], and with [npc.a_sob+], [npc.she] try to pull [npc.her] [npc.cock+] out of [npc2.namePos] mouth."
                                        + " [npc2.Her] grip proves to be too strong, however, and [npc2.she] eagerly continue to suck [npc.her] [npc.cock+] as [npc.she] weakly struggles against [npc2.herHim].",
	...
	public static final SexAction BLOWJOB_SUB_NORMAL = new SexAction(
		...
		public String getDescription() {
			...
			if(PenisMouth.getOngoingCharacters(Main.sex.getCharacterPerformingAction()).size()>1 && !primary.equals(target)) {
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                        "Getting " + PenisMouth.getOngoingNames(Main.sex.getCharacterPerformingAction(), target) + " to move aside a little, [npc.name] thrust [npc.her] [npc.cock+] past [npc2.namePos] [npc2.lips+],"
                                + " letting out [npc.a_moan+] as [npc.she] pump [npc.her] [npc.hips] into [npc2.her] [npc2.face].",
							"Instructing "+PenisMouth.getOngoingNames(Main.sex.getCharacterPerformingAction(), target)+" to let [npc2.name] take the lead,"
                                    + " [npc.name] buck [npc.her] [npc.hips] into [npc2.her] [npc2.face], letting out [npc.a_moan+] as [npc.she] fuck [npc2.her] throat.",
                        "After telling " + PenisMouth.getOngoingNames(Main.sex.getCharacterPerformingAction(), target) + " to make room for [npc2.name], [npc.name] buck [npc.her] [npc.hips+] into [npc2.her] [npc2.face],"
                                + " letting out [npc.a_moan+] as [npc.she] get [npc2.herHim] to suck [npc.her] [npc.cock+]."));
				
			} else {
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                        "[npc.Name] thrust [npc.her] [npc.cock+] past [npc2.namePos] [npc2.lips+],"
                                + " letting out [npc.a_moan+] as [npc.she] pump [npc.her] [npc.hips] into [npc2.her] [npc2.face].",
                        "[npc.Name] buck [npc.her] [npc.hips] into [npc2.namePos] [npc2.face], letting out [npc.a_moan+] as [npc.she] fuck [npc2.her] throat.",
	...
	public static final SexAction BLOWJOB_STOP = new SexAction(
		...
		public String getDescription() {
			...
			if(Main.sex.getSexPositionSlot(Main.sex.getCharacterPerformingAction()).hasTag(SexSlotTag.SIXTY_NINE)) {
                UtilText.nodeContentSB.append("Using [npc.her] knees to lift [npc.herself] up, [npc.name] allow [npc.her] [npc.cock+] to slide up and out of [npc2.namePos] mouth."
				...
				switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
					case DOM_ROUGH:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								"Roughly slamming [npc.her] [npc.cock+] deep down [npc2.namePos] throat one last time, [npc.name] then [npc2.verb(pull)] [npc.her] [npc.hips] back,"
                                        + " grinning as [npc2.name] [npc2.verb(splutter)] и [npc2.verb(gasp)] for air.",
					...
					default:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                "Sliding [npc.her] [npc.cock+] out of [npc2.namePos] mouth, [npc.name] let out [npc.a_moan+] as [npc.she] puts an end to the blowjob.",

                                "With [npc.a_moan+], [npc.name] pull [npc.her] [npc.hips] back, sliding [npc.her] [npc.cock+] fully out of [npc2.namePos] mouth."));
						break;
				}
			}
		...
		public String getDescription() {
			...
			if(Main.sex.getSexPositionSlot(Main.sex.getCharacterPerformingAction()).hasTag(SexSlotTag.SIXTY_NINE)) {
				switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
					case DOM_GENTLE:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                "[npc.NamePos] hot breath falls down onto [npc2.namePos] groin as [npc.she] slowly lower [npc.her] head down between [npc2.her] [npc2.legs],"
								...
								"Gently lowering [npc.her] head down between [npc2.namePos] [npc2.legs],"
                                        + " [npc.name] deliver a long, slow lick up the length of [npc2.her] [npc2.cock+], before taking the [npc2.cockHead+] into [npc.her] mouth."));
						break;
					case DOM_NORMAL:
					case SUB_EAGER:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                "[npc.NamePos] hot breath falls down onto [npc2.namePos] groin as [npc.she] eagerly drop [npc.her] head down between [npc2.her] [npc2.legs],"
								...
								"Eagerly dropping [npc.her] head down between [npc2.namePos] [npc2.legs],"
                                        + " [npc.name] deliver a long, wet lick up the length of [npc2.her] [npc2.cock+], before greedily taking the [npc2.cockHead+] into [npc.her] mouth."));
						break;
					case DOM_ROUGH:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                "[npc.NamePos] hot breath falls down onto [npc2.namePos] groin as [npc.she] quickly drop [npc.her] head down between [npc2.her] [npc2.legs],"
								...
								"Dropping [npc.her] head down between [npc2.namePos] [npc2.legs],"
                                        + " [npc.name] deliver a rough, wet lick up the length of [npc2.her] [npc2.cock+], before forcefully taking the [npc2.cockHead+] into [npc.her] mouth."));
						break;
					case SUB_NORMAL:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                "[npc.NamePos] hot breath falls down onto [npc2.namePos] groin as [npc.she] drop [npc.her] head down between [npc2.her] [npc2.legs],"
										+ " kissing the [npc2.cockHead+] of [npc2.her] [npc2.cock+] before taking [npc2.herHim] into [npc.her] mouth.",

								"Dropping [npc.her] head down between [npc2.namePos] [npc2.legs],"
                                        + " [npc.name] deliver a long, wet lick up the length of [npc2.her] [npc2.cock+], before taking the [npc2.cockHead+] into [npc.her] mouth."));
						break;
					default:
						break;
				}
					...
					case DOM_GENTLE:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								"Bringing [npc.her] [npc.lips+] to the [npc2.cockHead+] of [npc2.namePos] [npc2.cock],"
                                        + " [npc.name] slowly take [npc2.herHim] into [npc.her] mouth, letting out a muffled [npc.moan] as [npc.she] start giving [npc2.herHim] a blowjob.",

								"Wrapping [npc.her] [npc.lips+] around the [npc2.cockHead+] of [npc2.namePos] [npc2.cock],"
                                        + " [npc.name] let out a muffled [npc.moan] as [npc.she] start giving [npc2.herHim] a gentle blowjob."));
						break;
					case DOM_NORMAL:
					case SUB_EAGER:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								"Bringing [npc.her] [npc.lips+] up to the [npc2.cockHead+] of [npc2.namePos] [npc2.cock],"
                                        + " [npc.name] eagerly take [npc2.herHim] into [npc.her] mouth, letting out a muffled [npc.moan] as [npc.she] happily start giving [npc2.herHim] a blowjob.",

								"Wrapping [npc.her] [npc.lips+] around the [npc2.cockHead+] of [npc2.namePos] [npc2.cock],"
                                        + " [npc.name] let out a muffled [npc.moan] as [npc.she] eagerly start giving [npc2.herHim] an enthusiastic blowjob."));
						break;
					case DOM_ROUGH:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								"Bringing [npc.her] [npc.lips+] up to the [npc2.cockHead+] of [npc2.namePos] [npc2.cock],"
                                        + " [npc.name] forcefully take [npc2.herHim] into [npc.her] mouth, letting out a muffled [npc.moan] as [npc.she] start giving [npc2.herHim] a rough blowjob.",

								"Forcefully wrapping [npc.her] [npc.lips+] around the [npc2.cockHead+] of [npc2.namePos] [npc2.cock],"
                                        + " [npc.name] let out a muffled [npc.moan] as [npc.she] start giving [npc2.herHim] a rough blowjob."));
						break;
					case SUB_NORMAL:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								"Bringing [npc.her] [npc.lips+] up to the [npc2.cockHead+] of [npc2.namePos] [npc2.cock],"
                                        + " [npc.name] take [npc2.herHim] into [npc.her] mouth, letting out a muffled [npc.moan] as [npc.she] start giving [npc2.herHim] a blowjob.",

								"Wrapping [npc.her] [npc.lips+] around the [npc2.cockHead+] of [npc2.namePos] [npc2.cock],"
                                        + " [npc.name] let out a muffled [npc.moan] as [npc.she] eagerly start giving [npc2.herHim] a blowjob."));
						break;
					default:
						break;
				}
			...
			if(!isTargetedCharacterInanimate()) {
				switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(this))) {
					case DOM_GENTLE:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                " [npc2.Name] gently [npc2.verb(buck)] [npc2.her] [npc2.hips] into [npc.namePos] [npc.face], softly [npc2.moaning] as [npc.she] suck [npc2.her] [npc2.cock+].",
					...
					case SUB_EAGER:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                " [npc2.Name] greedily [npc2.verb(buck)] [npc2.her] [npc2.hips] into [npc.namePos] [npc.face], [npc2.moaning+] as [npc.she] suck [npc2.her] [npc2.cock+].",
					...
					case DOM_ROUGH:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                " [npc2.Name] roughly [npc2.verb(slam)] [npc2.her] [npc2.hips] into [npc.namePos] [npc.face], [npc2.moaning+] as [npc.she] suck [npc2.her] [npc2.cock+].",

                                " With a rough thrust of [npc2.her] [npc2.hips],"
										+ " [npc2.name] [npc2.verb(let)] out [npc2.a_moan+] as [npc2.she] [npc2.verb(enjoy)] the feeling of [npc.namePos] [npc.lips+] sliding up and down the length of [npc2.her] [npc2.cock+]."));
						break;
					case SUB_NORMAL:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                " [npc2.Name] [npc2.verb(buck)] [npc2.her] [npc2.hips] into [npc.namePos] [npc.face], [npc2.moaning+] as [npc.she] suck [npc2.her] [npc2.cock+].",
		...
		public String getDescription() {
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(
							UtilText.parse(getCharactersForParsing(),
                                    "Wanting to join " + getOngoingNames() + " in giving [npc2.name] a blowjob, [npc.name] move forwards beside " + (getOngoingCharacters().size() == 1 ? "[npc3.herHim]" : "them")
								+", before leaning in and delivering a gentle kiss to the side of [npc2.her] [npc2.penisGirth] [npc2.cock]."));
					break;
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(
							UtilText.parse(getCharactersForParsing(),
                                    "Wanting to join " + getOngoingNames() + " in giving [npc2.name] a blowjob, [npc.name] elbow [npc.her] way in beside " + (getOngoingCharacters().size() == 1 ? "[npc3.herHim]" : "them")
				...
				default: // Dom normal and sub eager:
					UtilText.nodeContentSB.append(
							UtilText.parse(getCharactersForParsing(),
                                    "Wanting to join " + getOngoingNames() + " in giving [npc2.name] a blowjob, [npc.name] eagerly move forwards beside " + (getOngoingCharacters().size() == 1 ? "[npc3.herHim]" : "them")
					...
					case SUB_RESISTING:
						UtilText.nodeContentSB.append(
								...
								" [npc2.Name] [npc2.verb(let)] out a distressed [npc2.moan] in response,"
                                        + " which only gets louder and more frantic as [npc.name] push " + getOngoingNames() + " aside in order to take [npc2.her] [npc2.cock+] into [npc.her] mouth."));
						break;
					default: // Dom normal and sub eager:
						UtilText.nodeContentSB.append(
								UtilText.parse(getCharactersForParsing(),
			...
			if(PenisMouth.getOngoingCharacters(Main.sex.getCharacterTargetedForSexAction(this)).size()>1 && !primary.equals(performer)) {
				switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
					case DOM_GENTLE:
						UtilText.nodeContentSB.append(UtilText.parse(Util.newArrayListOfValues(performer, target, primary),
								UtilText.returnStringAtRandom(
                                        "Getting [npc3.name] to pull back, [npc.name] gently wrap [npc.her] [npc.lips+] around [npc2.namePos] [npc2.cock+],"
											+ " before pushing [npc.her] head forwards and taking it as deep down [npc.her] throat as [npc.she] possibly can.",
                                        "With a soft [npc.moan], [npc.name] gently pull [npc3.name] away from [npc2.namePos] [npc2.cock+], before leaning forwards,"
											+ " parting [npc.her] [npc.lips+], and taking as much of [npc2.namePos] [npc2.cock+] down [npc.her] throat as [npc.she] possibly can.",
                                        "After gently moving [npc3.name] out of the way, [npc.name] slide [npc.her] head forwards,"
											+ " before gently parting [npc.her] [npc.lips+] and taking [npc2.namePos] [npc2.cock+] deep down [npc.her] throat.")));
						break;
					case DOM_ROUGH:
						UtilText.nodeContentSB.append(UtilText.parse(Util.newArrayListOfValues(performer, target, primary),
								UtilText.returnStringAtRandom(
                                        "Unceremoniously pushing [npc3.name] out of the way, [npc.name] roughly wrap [npc.her] [npc.lips+] around [npc2.namePos] [npc2.cock+],"
											+ " before forcing [npc.her] head forwards and forcing it as deep down [npc.her] throat as [npc.she] possibly can.",
                                        "With [npc.a_moan+], [npc.name] roughly push [npc3.name] away from [npc2.namePos] [npc2.cock+], before quickly leaning forwards,"
                                        ...
                                        "After aggressively shoving [npc3.name] out of the way, [npc.name] push [npc.her] head forwards,"
											+ " before greedily parting [npc.her] [npc.lips+] and forcing [npc2.namePos] [npc2.cock+] deep down [npc.her] throat.")));
						break;
					case SUB_NORMAL:
						UtilText.nodeContentSB.append(UtilText.parse(Util.newArrayListOfValues(performer, target, primary),
								UtilText.returnStringAtRandom(
                                        "Getting [npc3.name] to pull back, [npc.name] wrap [npc.her] [npc.lips+] around [npc2.namePos] [npc2.cock+],"
											+ " before pushing [npc.her] head forwards and taking it as deep down [npc.her] throat as [npc.she] possibly can.",
                                        "With [npc.a_moan+], [npc.name] pull [npc3.name] away from [npc2.namePos] [npc2.cock+], before leaning forwards,"
											+ " parting [npc.her] [npc.lips+], and taking as much of [npc2.namePos] [npc2.cock+] down [npc.her] throat as [npc.she] possibly can.",
                                        "After moving [npc3.name] out of the way, [npc.name] slide [npc.her] head forwards,"
											+ " before parting [npc.her] [npc.lips+] and taking [npc2.namePos] [npc2.cock+] deep down [npc.her] throat.")));
						break;
					default: // Dom normal and sub eager:
						UtilText.nodeContentSB.append(UtilText.parse(Util.newArrayListOfValues(performer, target, primary),
								UtilText.returnStringAtRandom(
                                        "Getting [npc3.name] to pull back, [npc.name] eagerly wrap [npc.her] [npc.lips+] around [npc2.namePos] [npc2.cock+],"
											+ " before quickly pushing [npc.her] head forwards and greedily taking it as deep down [npc.her] throat as [npc.she] possibly can.",
                                        "With [npc.a_moan+], [npc.name] quickly pull [npc3.name] away from [npc2.namePos] [npc2.cock+], before eagerly leaning forwards,"
                                        ...
                                        "After impatiently moving [npc3.name] out of the way, [npc.name] slide [npc.her] head forwards,"
				...
				switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
					case DOM_GENTLE:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                "Gently wrapping [npc.her] [npc.lips+] around the [npc2.cock+] in [npc.her] mouth, [npc.name] push [npc.her] head forwards,"
										+ " taking [npc2.namePos] [npc2.cock+] as deep down [npc.her] throat as [npc.she] possibly can.",

                                "With a soft, muffled [npc.moan], [npc.name] gently lean forwards,"
                                        + " parting [npc.her] [npc.lips+] as [npc.she] take as much of [npc2.namePos] [npc2.cock+] down [npc.her] throat as [npc.she] can.",

                                "Slowly sliding [npc.her] head forwards, [npc.name] gently part [npc.her] [npc.lips+], before taking [npc2.namePos] [npc2.cock+] deep down [npc.her] throat."));
						break;
					case DOM_NORMAL:
					case SUB_EAGER:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                "Eagerly wrapping [npc.her] [npc.lips+] around the [npc2.cock+] in [npc.her] mouth, [npc.name] quickly push [npc.her] head forwards,"
										+ " greedily taking [npc2.namePos] [npc2.cock+] as deep down [npc.her] throat as [npc.she] possibly can.",

                                "With a muffled, [npc.moan+], [npc.name] eagerly lean forwards,"
                                        + " parting [npc.her] [npc.lips+] as [npc.she] desperately take as much of [npc2.namePos] [npc2.cock+] down [npc.her] throat as [npc.she] can.",

                                "Greedily sliding [npc.her] head forwards, [npc.name] readily part [npc.her] [npc.lips+] as [npc.she] take [npc2.namePos] [npc2.cock+] deep down [npc.her] throat."));
						break;
					case DOM_ROUGH:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                "Forcefully wrapping [npc.her] [npc.lips+] around the [npc2.cock+] in [npc.her] mouth, [npc.name] roughly slam [npc.her] head forwards,"
										+ " forcing [npc2.namePos] [npc2.cock+] as deep down [npc.her] throat as [npc.she] possibly can.",

                                "With a muffled, [npc.moan+], [npc.name] quickly lean forwards,"
                                        + " parting [npc.her] [npc.lips+] as [npc.she] roughly force as much of [npc2.namePos] [npc2.cock+] down [npc.her] throat as [npc.she] can.",

                                "Aggressively pushing [npc.her] head forwards, [npc.name] part [npc.her] [npc.lips+] as [npc.she] force [npc2.namePos] [npc2.cock+] deep down [npc.her] throat."));
						break;
					case SUB_NORMAL:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                "Wrapping [npc.her] [npc.lips+] around the [npc2.cock+] in [npc.her] mouth, [npc.name] quickly push [npc.her] head forwards,"
										+ " taking [npc2.namePos] [npc2.cock+] as deep down [npc.her] throat as [npc.she] possibly can.",

                                "With a muffled, [npc.moan+], [npc.name] lean forwards,"
                                        + " parting [npc.her] [npc.lips+] as [npc.she] take as much of [npc2.namePos] [npc2.cock+] down [npc.her] throat as [npc.she] can.",

                                "Sliding [npc.her] head forwards, [npc.name] part [npc.her] [npc.lips+] as [npc.she] take [npc2.namePos] [npc2.cock+] deep down [npc.her] throat."));
						break;
					default:
						break;
				}
			...
			if(PenisMouth.getOngoingCharacters(Main.sex.getCharacterTargetedForSexAction(this)).size()>1 && !primary.equals(performer)) {
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
						"Leaning in alongside "+PenisMouth.getOngoingNames(target, performer)+","
                                + " [npc.name] press [npc.her] [npc.lips+] against an exposed part of [npc2.namePos] [npc2.cock+], before starting to gently kiss and lick [npc2.her] shaft.",
                        "With a soft [npc.moan], [npc.name] gently lean in alongside " + PenisMouth.getOngoingNames(target, performer) + ","
                                + " pressing [npc.her] [npc.lips+] against a free part of [npc2.namePos] [npc2.cock+] as [npc.she] kiss и nuzzle in against [npc2.herHim].",
						"With [npc.her] head positioned in close alongside "+PenisMouth.getOngoingNames(target, performer)
                                + ", [npc.name] gently kiss и lick any exposed part of [npc2.namePos] [npc2.cock+] that [npc.she] can find."));

			} else {
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                        "Gently wrapping [npc.her] [npc.lips+] around [npc2.namePos] [npc2.cock+], [npc.name] start bobbing [npc.her] head up and down as [npc.she] give [npc2.herHim] a loving blowjob.",
                        "With a soft, muffled [npc.moan], [npc.name] gently start bobbing [npc.her] head up and down,"
                                + " wrapping [npc.her] [npc.lips+] around [npc2.namePos] [npc2.cock+] as [npc.she] give [npc2.herHim] head.",
                        "Slowly bobbing [npc.her] head up and down, [npc.name] gently wrap [npc.her] [npc.lips+] around [npc2.namePos] [npc2.cock+] as [npc.she] give [npc2.herHim] a blowjob."));
			}
			...
			if(PenisMouth.getOngoingCharacters(Main.sex.getCharacterTargetedForSexAction(this)).size()>1 && !primary.equals(performer)) {
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
						"Happily leaning in alongside "+PenisMouth.getOngoingNames(target, performer)+","
                                + " [npc.name] eagerly press [npc.her] [npc.lips+] against an exposed part of [npc2.namePos] [npc2.cock+], before starting to greedily kiss and lick [npc2.her] shaft.",
                        "With [npc.a_moan+], [npc.name] impatiently lean in alongside " + PenisMouth.getOngoingNames(target, performer) + ","
                                + " pressing [npc.her] [npc.lips+] against a free part of [npc2.namePos] [npc2.cock+] as [npc.she] desperately kiss и nuzzle in against [npc2.herHim].",
						"With [npc.her] head positioned in close alongside "+PenisMouth.getOngoingNames(target, performer)
                                + ", [npc.name] greedily kiss и lick any exposed part of [npc2.namePos] [npc2.cock+] that [npc.she] can find."));

			} else {
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                        "Eagerly wrapping [npc.her] [npc.lips+] around [npc2.namePos] [npc2.cock+], [npc.name] start rapidly bobbing [npc.her] head up and down as [npc.she] give [npc2.herHim] an enthusiastic blowjob.",
                        "With a muffled, [npc.moan+], [npc.name] quickly start bobbing [npc.her] head up and down,"
                                + " greedily wrapping [npc.her] [npc.lips+] around [npc2.namePos] [npc2.cock+] as [npc.she] give [npc2.herHim] head.",
                        "Rapidly bobbing [npc.her] head up and down, [npc.name] desperately wrap [npc.her] [npc.lips+] around [npc2.namePos] [npc2.cock+] as [npc.she] give [npc2.herHim] an eager blowjob."));
			}
			...
			if(PenisMouth.getOngoingCharacters(Main.sex.getCharacterTargetedForSexAction(this)).size()>1 && !primary.equals(performer)) {
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
						"Elbowing [npc.her] way in alongside "+PenisMouth.getOngoingNames(target, performer)+","
                                + " [npc.name] roughly press [npc.her] [npc.lips+] against an exposed part of [npc2.namePos] [npc2.cock+], before starting to forcefully kiss and lick [npc2.her] shaft.",
                        "With [npc.a_moan+], [npc.name] aggressively push in alongside " + PenisMouth.getOngoingNames(target, performer) + ","
                                + " pressing [npc.her] [npc.lips+] against a free part of [npc2.namePos] [npc2.cock+] as [npc.she] roughly kiss и press in against [npc2.herHim].",
						"With [npc.her] head positioned in close alongside "+PenisMouth.getOngoingNames(target, performer)
                                + ", [npc.name] forcefully kiss и lick any exposed part of [npc2.namePos] [npc2.cock+] that [npc.she] can find."));

			} else {
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                        "Forcefully gripping [npc.her] [npc.lips+] down around [npc2.namePos] [npc2.cock+], [npc.name] start aggressively bobbing [npc.her] head up and down as [npc.she] give [npc2.herHim] a rough blowjob.",
                        "With a muffled, [npc.moan+], [npc.name] violently start bobbing [npc.her] head up and down,"
                                + " roughly wrapping [npc.her] [npc.lips+] around [npc2.namePos] [npc2.cock+] as [npc.she] give [npc2.herHim] head.",
                        "Roughly bobbing [npc.her] head up and down, [npc.name] dominantly wrap [npc.her] [npc.lips+] around [npc2.namePos] [npc2.cock+] as [npc.she] give [npc2.herHim] a forceful blowjob."));
			}
		...
		public String getDescription() {
			...
			if(PenisMouth.getOngoingCharacters(Main.sex.getCharacterTargetedForSexAction(this)).size()>1 && !primary.equals(performer)) {
				switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(this))) {
					case DOM_GENTLE:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                "[npc.Name] let out a muffled [npc.sob], squirming and struggling in distress as [npc2.name] [npc2.verb(hold)] [npc.herHim] in place alongside "
										+PenisMouth.getOngoingNames(target, performer)+", gently pressing [npc.her] [npc.face] in towards [npc2.her] [npc2.cock+].",
                                "With [npc.a_sob+], [npc.name] try to pull [npc.her] head back and away from [npc2.namePos] [npc2.cock+],"
                                ...
                                "[npc.Name] feel tears running down [npc.namePos] cheeks as [npc.she] weakly try to push [npc2.name] away,"
					...
					case DOM_ROUGH:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                "[npc.Name] let out a muffled [npc.sob], squirming and struggling in distress as [npc2.name] forcefully [npc2.verb(hold)] [npc.herHim] in place alongside "
				...
				switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(this))) {
					case DOM_GENTLE:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                "[npc.Name] let out a muffled [npc.sob], squirming and struggling in distress as [npc2.name] holds [npc.herHim] in place,"
										+ " slowly sliding [npc2.her] [npc2.cock+] back and forth past [npc.her] [npc.lips+].",
                                "With [npc.a_sob+], [npc.name] try to pull [npc.her] head back,"
					...
					case DOM_ROUGH:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                "[npc.Name] let out a muffled [npc.sob], squirming and struggling in distress as [npc2.name] forcefully holds [npc.herHim] in place,"
	...
	public static final SexAction GIVING_BLOWJOB_SUB_NORMAL = new SexAction(
		...
		public String getDescription() {
			...
			if(PenisMouth.getOngoingCharacters(Main.sex.getCharacterTargetedForSexAction(this)).size()>1 && !primary.equals(performer)) {
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
						"Leaning in alongside "+PenisMouth.getOngoingNames(target, performer)+","
                                + " [npc.name] press [npc.her] [npc.lips+] against an exposed part of [npc2.namePos] [npc2.cock+], before starting to kiss and lick [npc2.her] shaft.",
                        "With [npc.a_moan+], [npc.name] lean in alongside " + PenisMouth.getOngoingNames(target, performer) + ","
                                + " pressing [npc.her] [npc.lips+] against a free part of [npc2.namePos] [npc2.cock+] as [npc.she] kiss и nuzzle in against [npc2.herHim].",
						"With [npc.her] head positioned in close alongside "+PenisMouth.getOngoingNames(target, performer)
                                + ", [npc.name] kiss и lick any exposed part of [npc2.namePos] [npc2.cock+] that [npc.she] can find."));

			} else {
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                        "Wrapping [npc.her] [npc.lips+] around [npc2.namePos] [npc2.cock+], [npc.name] start rapidly bobbing [npc.her] head up and down as [npc.she] give [npc2.herHim] a blowjob.",
                        "With a muffled, [npc.moan+], [npc.name] quickly start bobbing [npc.her] head up and down,"
                                + " wrapping [npc.her] [npc.lips+] around [npc2.namePos] [npc2.cock+] as [npc.she] give [npc2.herHim] head.",
                        "Rapidly bobbing [npc.her] head up and down, [npc.name] wrap [npc.her] [npc.lips+] around [npc2.namePos] [npc2.cock+] as [npc.she] give [npc2.herHim] a blowjob."));
			}
	...
	public static final SexAction GIVING_BLOWJOB_STOP = new SexAction(
		...
		public String getDescription() {
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Roughly forcing [npc2.namePos] [npc2.cock+] down [npc.her] throat one last time, [npc.name] then pull [npc.her] head back, putting a quick end to [npc2.her] blowjob.",

                            "Slamming [npc.her] [npc.face] into [npc2.namePos] groin, [npc.name] force [npc2.her] [npc2.cock+] deep down [npc.her] throat,"
									+ " before pulling completely back and letting [npc2.herHim] slip out of [npc.her] mouth."));
					break;
				default:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Sliding [npc2.namePos] [npc2.cock+] out of [npc.her] mouth, [npc.name] let out [npc.a_moan+] as [npc.she] put an end to the blowjob.",

                            "With [npc.a_moan+], [npc.name] pull [npc.her] head back, sliding [npc2.namePos] [npc2.cock+] fully out of [npc.her] mouth."));
					break;
			}
					...
					case SUB_RESISTING:
						return UtilText.returnStringAtRandom(
								...
								" [npc2.A_sob+] bursts out from between [npc2.namePos] [npc2.lips] as [npc2.she] weakly [npc2.verb(try)] to push [npc.name] away,"
                                        + " squirming and protesting as [npc.name] continue to force [npc2.her] [npc2.cock+] deep into [npc.her] throat.",
