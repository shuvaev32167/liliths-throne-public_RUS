...
public class FingerNippleCrotch {
	...
	public static final SexAction PINCH_NIPPLES = new SexAction(
		...
		public String getDescription() {
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Reaching up to [npc2.namePos] [npc2.crotchBoobs+], [npc.name] let out a soft [npc.moan] as [npc.she] start to gently pinch and rub at [npc2.her] [npc2.crotchNipples+].",

							"[npc2.NamePos] [npc2.crotchBoobs+], fully on display, prove to be too tempting a target for [npc.name] to ignore,"
                                    + " and with a soft little [npc.moan], [npc.she] start gently tugging and pinching [npc2.her] [npc2.crotchNipples+].",

                            "Teasing [npc.her] [npc.fingers] over [npc2.namePos] [npc2.crotchBoobRows] [npc2.crotchBoobs+], [npc.name] start to gently tug and pinch at [npc2.her] [npc2.crotchNipples+]."));
					break;
				case DOM_NORMAL:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Reaching up to [npc2.namePos] [npc2.crotchBoobs+], [npc.name] let out [npc.a_moan+] as [npc.she] start to eagerly pinch and rub at [npc2.her] [npc2.crotchNipples+].",

							"[npc2.NamePos] [npc2.crotchBoobs+], fully on display, prove to be too tempting a target for [npc.name] to ignore,"
                                    + " and with [npc.a_moan+], [npc.she] start eagerly tugging and pinching [npc2.her] [npc2.crotchNipples+].",

                            "Teasing [npc.her] [npc.fingers] over [npc2.namePos] [npc2.crotchBoobRows] [npc2.crotchBoobs+], [npc.name] start eagerly tugging and pinching at [npc2.her] [npc2.crotchNipples+]."));
					break;
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Reaching up to [npc2.namePos] [npc2.crotchBoobs+],"
                                    + " [npc.name] let out [npc.a_moan+] as [npc.she] start roughly groping [npc2.namePos] chest, before moving up to forcefully pinch and squeeze [npc2.her] [npc2.crotchNipples+].",

							"[npc2.NamePos] [npc2.crotchBoobs+], fully on display, prove to be too tempting a target for [npc.name] to ignore,"
                                    + " and with [npc.a_moan+], [npc.she] start roughly pinching and squeezing [npc2.her] [npc2.crotchNipples+].",

							"Sinking [npc.her] [npc.fingers] into [npc2.namePos] [npc2.crotchBoobRows] [npc2.crotchBoobs+],"
                                    + " [npc.name] let out [npc.a_moan+] before starting to roughly pinch and squeeze [npc2.her] [npc2.crotchNipples+]."));
					break;
				case SUB_EAGER:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Reaching up to [npc2.namePos] [npc2.crotchBoobs+], [npc.name] let out [npc.a_moan+] as [npc.she] start to eagerly pinch and rub at [npc2.her] [npc2.crotchNipples+].",
				...
				case SUB_NORMAL:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Reaching up to [npc2.namePos] [npc2.crotchBoobs+], [npc.name] let out [npc.a_moan+] as [npc.she] start to pinch and rub at [npc2.her] [npc2.crotchNipples+].",

							"[npc2.NamePos] [npc2.crotchBoobs+], fully on display, prove to be too tempting a target for [npc.name] to ignore,"
                                    + " and with [npc.a_moan+], [npc.she] start tugging and pinching [npc2.her] [npc2.crotchNipples+].",

                            "Teasing [npc.her] [npc.fingers] over [npc2.namePos] [npc2.crotchBoobRows] [npc2.crotchBoobs+], [npc.name] start tugging and pinching at [npc2.her] [npc2.crotchNipples+]."));
					break;
				default:
					break;
			}
					...
					case SUB_RESISTING:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								...
								" With [npc2.a_sob+], [npc2.name] [npc2.verb(start)] writhing around in discomfort,"
                                        + " pleading for [npc.name] to leave [npc2.herHim] alone as [npc.she] continue stimulating [npc2.her] [npc2.crotchNipples+].",
			...
			switch (Main.sex.getCharacterTargetedForSexAction(this).getBreastCrotchStoredMilk()) {
				case ONE_TRICKLE:
                    UtilText.nodeContentSB.append(" As [npc.name] start pinching [npc2.namePos] [npc2.crotchNipples], a small trickle of [npc2.milk] leaks out to run down [npc2.her] [npc2.crotchBoobs+].");
					break;
				case TWO_SMALL_AMOUNT:
                    UtilText.nodeContentSB.append(" As [npc.name] start pinching [npc2.namePos] [npc2.crotchNipples], a small squirt of [npc2.milk] leaks out to run down [npc2.her] [npc2.crotchBoobs+].");
					break;
				case THREE_DECENT_AMOUNT:
                    UtilText.nodeContentSB.append(" As [npc.name] start pinching [npc2.namePos] [npc2.crotchNipples], a trickle of [npc2.milk] runs down over [npc2.her] [npc2.crotchBoobs+].");
					break;
				case FOUR_LARGE_AMOUNT:
                    UtilText.nodeContentSB.append(" [npc2.NamePos] [npc2.milk] start to flow out over [npc.namePos] fingertips as [npc.she] greedily milk [npc2.her] [npc2.crotchBoobs+].");
					break;
				case FIVE_VERY_LARGE_DROOLING:
                    UtilText.nodeContentSB.append(" [npc2.NamePos] [npc2.milk] start drooling out over [npc.namePos] fingertips as [npc.she] greedily milk [npc2.her] [npc2.crotchBoobs+].");
					break;
				case SIX_EXTREME_AMOUNT_DRIPPING:
                    UtilText.nodeContentSB.append(" [npc2.NamePos] [npc2.milk] start pouring out over [npc.namePos] fingertips as [npc.she] greedily milk [npc2.her] [npc2.crotchBoobs+].");
					break;
	...
	public static final SexAction MILK_TARGET = new SexAction(
		...
		public String getDescription() {
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "[npc.Name] trace [npc.her] [npc.fingers+] up and over [npc2.namePos] [npc2.crotchBoobs+], before homing in on [npc2.her] [npc2.crotchNipples+]."
                                    + " Gently tugging and squeezing at [npc2.namePos] [npc2.crotchNipples+], [npc.name] let out a soft cry of delight as [npc.she] manage to draw out",

                            "With a soft [npc.moan], [npc.name] gently press [npc.her] [npc.fingers] into [npc2.namePos] [npc2.crotchBoobs+], before moving down to tease [npc2.her] [npc2.crotchNipples+]."
                                    + " Delicately pinching and squeezing at [npc2.namePos] [npc2.crotchNipples+], [npc.name] let out a delighted cry as [npc.she] manage to draw out"));
					break;
				case SUB_NORMAL: case DOM_NORMAL: case SUB_EAGER:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "[npc.Name] eagerly trace [npc.her] [npc.fingers+] up and over [npc2.namePos] [npc2.crotchBoobs+], before quickly homing in on [npc2.her] [npc2.crotchNipples+]."
                                    + " Greedily tugging and squeezing at [npc2.namePos] [npc2.crotchNipples+], [npc.name] let out a delighted cry as [npc.she] manage to draw out",

                            "With [npc.a_moan+], [npc.name] eagerly press [npc.her] [npc.fingers] into [npc2.namePos] [npc2.crotchBoobs+], before quickly moving down to tease [npc2.her] [npc2.crotchNipples+]."
                                    + " Greedily pinching and squeezing at [npc2.namePos] [npc2.crotchNipples+], [npc.name] let out a delighted cry as [npc.she] manage to draw out"));
					break;
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"[npc.Name] digs [npc.her] [npc.fingers+] into [npc2.namePos] [npc2.crotchBoobs+], before moving [npc.her] rough touch up to [npc2.her] [npc2.crotchNipples+]."
                                    + " Forcefully pinching and squeezing [npc2.namePos] [npc2.crotchNipples+], [npc.name] let out a triumphant growl as [npc.she] manage to draw out",
							...
							"With [npc.a_moan+], [npc.name] roughly digs [npc.her] [npc.fingers] into [npc2.namePos] [npc2.crotchBoobs+], before quickly moving down to roughly flick [npc2.her] [npc2.crotchNipples+]."
                                    + " Dominantly pinching and squeezing at [npc2.namePos] [npc2.crotchNipples+], [npc.name] let out [npc.a_moan+] as [npc.she] manage to draw out"));
					break;
				case SUB_RESISTING:
					break;
			}
	...
	public static final SexAction GET_MILKED = new SexAction(
		...
		public String getDescription() {
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Taking hold of [npc2.namePos] [npc2.hand], [npc.name] encourage [npc2.herHim] to trace [npc2.her] [npc2.fingers+] up and over [npc.her] [npc.crotchBoobs+],"
									+ " before gently guiding [npc2.herHim] down to [npc.her] [npc.crotchNipples+]."
                                    + " Instructing [npc2.herHim] to tug and squeeze at [npc.her] [npc.crotchNipples+], [npc.name] let out a soft cry as [npc2.namePos] [npc2.verb(manage)] to draw out",

                            "With a soft [npc.moan], [npc.name] gently guide [npc2.namePos] [npc2.fingers] into [npc.her] [npc.crotchBoobs+], before moving [npc2.her] touch down to tease [npc.her] [npc.crotchNipples+]."
                                    + " Instructing [npc2.herHim] to pinch and squeeze at [npc.her] [npc.crotchNipples+], [npc.name] let out a delighted cry as [npc2.namePos] [npc2.verb(manage)] to draw out"));
					break;
				case SUB_NORMAL: case DOM_NORMAL: case SUB_EAGER:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Taking hold of [npc2.namePos] [npc2.hand], [npc.name] guide [npc2.her] [npc2.fingers+] up and over [npc.her] [npc.crotchBoobs+], before greedily guiding [npc2.herHim] down to [npc.her] [npc.crotchNipples+]."
                                    + " Telling [npc2.herHim] to tug and squeeze at [npc.her] [npc.crotchNipples+], [npc.name] let out [npc.a_moan+] as [npc2.namePos] [npc2.verb(manage)] to draw out",

                            "With [npc.a_moan+], [npc.name] eagerly guide [npc2.namePos] [npc2.fingers] into [npc.her] [npc.crotchBoobs+], before moving [npc2.her] touch down to tease [npc.her] [npc.crotchNipples+]."
                                    + " Instructing [npc2.herHim] to pinch and squeeze at [npc.her] [npc.crotchNipples+], [npc.name] let out a delighted cry as [npc2.namePos] [npc2.verb(manage)] to draw out"));
					break;
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Grabbing hold of [npc2.namePos] [npc2.hand], [npc.name] roughly force [npc2.her] [npc2.fingers+] up and over [npc.her] [npc.crotchBoobs+],"
									+ " before dominantly guiding [npc2.her] touch down to [npc.her] [npc.crotchNipples+]."
                                    + " Ordering [npc2.herHim] to tug and squeeze at [npc.her] [npc.crotchNipples+], [npc.name] let out [npc.a_moan+] as [npc2.namePos] [npc2.verb(manage)] to draw out",

                            "With [npc.a_moan+], [npc.name] forcefully guide [npc2.namePos] [npc2.fingers] into [npc.her] [npc.crotchBoobs+], before moving [npc2.her] touch down to tease [npc.her] [npc.crotchNipples+]."
                                    + " Ordering [npc2.herHim] to pinch and squeeze at [npc.her] [npc.crotchNipples+], [npc.name] let out a delighted cry as [npc2.namePos] [npc2.verb(manage)] to draw out"));
					break;
				case SUB_RESISTING:
					break;
			}
			...
			if(!isTargetedCharacterInanimate()) {
				switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(this))) {
					case DOM_GENTLE:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								" [npc2.Name] [npc2.verb(let)] out a soft [npc2.moan] as [npc2.she] [npc2.verb(start)] to milk [npc.name],"
                                        + " and as [npc.name] push [npc.her] [npc.crotchBoobs] out into [npc2.her] [npc2.hands], [npc2.name] [npc2.verb(continue)] gently drawing the [npc.milk+] from [npc.her] [npc.crotchNipples].",
					...
					case SUB_NORMAL:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								" [npc2.Name] [npc2.verb(let)] out [npc2.a_moan+] as [npc2.she] [npc2.verb(start)] to milk [npc.name],"
                                        + " and as [npc.name] push [npc.her] [npc.crotchBoobs] out into [npc2.her] [npc2.hands], [npc2.name] [npc2.verb(continue)] eagerly drawing the [npc.milk+] from [npc.her] [npc.crotchNipples].",
					...
					case DOM_ROUGH:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								" [npc2.Name] [npc2.verb(let)] out a growl as [npc2.she] [npc2.verb(start)] to milk [npc.name],"
                                        + " and as [npc.name] push [npc.her] [npc.crotchBoobs] out into [npc2.her] [npc2.hands], [npc2.name] [npc2.verb(continue)] roughly drawing the [npc.milk+] from [npc.her] [npc.crotchNipples].",
					...
					case SUB_RESISTING:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                " [npc2.Name] [npc2.verb(let)] out [npc2.a_moan+] и [npc2.verb(try)] to pull away, but, with a forceful yank, [npc.name] pull [npc2.her] [npc2.hands] back into [npc.her] [npc.crotchBoobs],"
								...
								" [npc2.Name] desperately tries to pull away from [npc.namePos] [npc.crotchBoobs],"
                                        + " but, grabbing hold of [npc2.her] [npc2.hand], [npc.name] force [npc2.herHim] to continue squeezing the [npc.milk+] from [npc.her] [npc.crotchNipples]."));
						break;
				}
			}
	...
	public static final SexAction NIPPLE_FINGERING_START = new SexAction(
		...
		@Override
		public String getActionDescription() {
            return "Sink your [npc.fingers] into one of [npc2.namePos] fuckable [npc2.crotchNipples] и [npc2.verb(start)] fingering [npc2.her] breasts.";
		}
		...
		public String getDescription() {
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            ...
                            "[npc.Name] press [npc.her] [npc.fingers] against one of [npc2.namePos] [npc2.crotchNipples+],"
				...
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Groping and squeezing [npc2.namePos] [npc2.crotchBoobs+],"
                                    + " [npc.name] start to circle [npc.her] [npc.fingers] around one of [npc2.her] [npc2.crotchNipples+], before roughly forcing [npc.her] digits into [npc2.namePos] inviting orifice.",
			...
			if(!isTargetedCharacterInanimate()) {
				switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(this))) {
					case DOM_GENTLE:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                " [npc2.Name] [npc2.verb(let)] out a soft [npc2.moan] as [npc.name] start fingering [npc2.namePos] [npc2.crotchBoobs],"
					...
					case DOM_NORMAL:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                " [npc2.Name] [npc2.verb(let)] out [npc2.a_moan+] as [npc.name] start fingering [npc2.namePos] [npc2.crotchBoob],"
					...
					case DOM_ROUGH:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                " [npc2.Name] [npc2.verb(let)] out [npc2.a_moan+] as [npc.name] start fingering [npc2.namePos] [npc2.crotchBoobs],"
					...
					case SUB_RESISTING:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								" [npc2.Name] [npc2.verb(try)] to pull back,"
                                        + " [npc2.sobbing] and writhing in discomfort as [npc.name] start to pump [npc.her] [npc.fingers] in and out of [npc2.her] [npc2.crotchNipple+].",
	
								" With [npc2.a_sob+], [npc2.name] [npc2.verb(try)], in vain, to pull away from the unwanted penetration,"
                                        + " protesting and struggling against [npc.namePos] touch as [npc.she] pump [npc.her] [npc.fingers+] in and out of [npc2.her] [npc2.crotchNipple+]."));
						break;
					default:
						break;
				}
	...
	public static final SexAction NIPPLE_FINGERING_DOM_GENTLE = new SexAction(
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                    "Gently sinking [npc.her] [npc.fingers+] deep into [npc2.namePos] [npc2.crotchNipple+], [npc.name] slowly start to slide [npc.her] digits in and out of [npc2.her] [npc2.crotchBoob].",

                    "[npc.Name] gently lean in against [npc2.name], causing [npc2.herHim] to inhale [npc.her] [npc.scent+] as [npc.she] gently pump [npc.her] [npc.fingers+] in and out of [npc2.her] [npc2.crotchNipple+].",

                    "Gently pressing [npc.herself] against [npc2.name], [npc.name] let out [npc.a_moan+] as [npc.she] softly pump [npc.her] [npc.fingers+] in and out of [npc2.namePos] [npc2.crotchNipple+]."));
	...
	public static final SexAction NIPPLE_FINGERING_DOM_NORMAL = new SexAction(
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                    "Sinking [npc.her] [npc.fingers+] deep into [npc2.namePos] [npc2.crotchNipple+], [npc.name] start eagerly fingering [npc2.her] [npc2.crotchBoobs],"
                            + " letting out [npc.a_moan+] as [npc.she] press [npc.herself] up against [npc2.herHim].",

                    "[npc.Name] lean in against [npc2.herHim],"
                            + " [npc.her] [npc.scent+] overwhelming [npc2.namePos] senses as [npc.she] start eagerly pumping [npc.her] [npc.fingers+] in and out of [npc2.namePos] [npc2.crotchNipple+].",

                    "Pressing [npc.herself] against [npc2.name], [npc.name] let out [npc.a_moan+] as [npc.she] start eagerly pumping [npc.her] [npc.fingers+] in and out of [npc2.namePos] [npc2.crotchNipple+]."));
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
					"Greedily plunging [npc.her] [npc.fingers+] deep into [npc2.namePos] [npc2.crotchNipple+],"
                            + " [npc.name] start roughly slamming [npc.her] digits in and out, rapidly fingering [npc2.namePos] [npc2.crotchBoob] as [npc.she] grinds [npc.herself] up against [npc2.herHim].",

					"[npc.Name] grinds [npc.herself] against [npc2.name],"
                            + " forcing [npc2.herHim] to inhale [npc.her] [npc.scent+] as [npc.she] start roughly slamming [npc.her] [npc.fingers+] in and out of [npc2.namePos] [npc2.crotchNipple+].",

                    "Grinding [npc.herself] up against [npc2.name], [npc.name] let out [npc.a_moan+] as [npc.she] start roughly slamming [npc.her] [npc.fingers+] in and out of [npc2.namePos] [npc2.crotchNipple+]."));
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
					"Sinking [npc.her] [npc.fingers+] deep into [npc2.namePos] [npc2.crotchNipple+],"
                            + " [npc.name] start sliding [npc.her] digits in and out, fingering [npc2.namePos] [npc2.crotchBoob] as [npc.she] press [npc.herself] up against [npc2.herHim].",

                    "[npc.Name] lean in against [npc2.name], causing [npc2.herHim] to inhale [npc.her] [npc.scent+] as [npc.she] start pumping [npc.her] [npc.fingers+] in and out of [npc2.her] [npc2.crotchNipple+].",

                    "Pressing [npc.herself] against [npc2.name], [npc.name] let out [npc.a_moan+] as [npc.she] start pumping [npc.her] [npc.fingers+] in and out of [npc2.namePos] [npc2.crotchNipple+]."));
	...
	public static final SexAction PARTNER_NIPPLE_FINGERING_SUB_EAGER = new SexAction(
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
					"Sinking [npc.her] [npc.fingers+] deep into [npc2.namePos] [npc2.crotchNipple+],"
                            + " [npc.name] start sliding [npc.her] digits in and out, eagerly fingering [npc2.her] [npc2.crotchBoob] as [npc.she] press [npc.herself] up against [npc2.herHim].",

                    "[npc.Name] lean in against [npc2.name],"
                            + " causing [npc2.herHim] to breathe in [npc.her] [npc.scent+] as [npc.she] start eagerly pumping [npc.her] [npc.fingers+] in and out of [npc2.her] [npc2.crotchNipple+].",
				...
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "[npc.Name] feel tears starting to well up in [npc.namePos] [npc.eyes], and, unable to keep it in any longer,"
                                    + " [npc.a_sob+] bursts out from [npc.her] mouth as [npc.she] weakly try to pull [npc.her] [npc.fingers] out of [npc2.namePos] [npc2.crotchNipple+].",

                            "[npc.A_sob+] bursts out from [npc.namePos] mouth as [npc.she] frantically try to pull [npc.her] [npc.fingers+] out of [npc2.namePos] [npc2.crotchNipple+].",
	...
	public static final SexAction NIPPLE_FINGERING_STOP = new SexAction(
		...
		public String getDescription() {
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Yanking [npc.her] [npc.fingers] out of [npc2.namePos] [npc2.crotchNipple+], [npc.name] give [npc2.namePos] [npc2.crotchBoob] one last rough squeeze as [npc.she] stops fingering [npc2.her] chest.",

                            "[npc.Name] sharply inhale, breathing in [npc2.namePos] [npc2.scent+] before roughly yanking [npc.her] [npc.fingers] out of [npc2.her] [npc2.crotchNipple]."));
					break;
				default:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Sliding [npc.her] [npc.fingers] out of [npc2.namePos] [npc2.crotchNipple], [npc.name] give [npc2.namePos] [npc2.crotchBoob] one last squeeze as [npc.she] stops fingering [npc2.her] chest.",

                            "[npc.Name] sharply inhale, breathing in [npc2.namePos] [npc2.scent+] before sliding [npc.her] [npc.fingers] out of [npc2.her] [npc2.crotchNipple]."));
					break;
			}
	...
	public static final SexAction NIPPLE_FINGERED_START = new SexAction(
		...
		public String getDescription() {
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Taking a gentle, but firm, grip on [npc2.namePos] [npc2.hand], [npc.name] slowly guide [npc2.her] [npc2.fingers] up and over [npc.her] [npc.crotchBoobs],"
									+ " letting out a little [npc.moan] before pushing [npc2.her] digits into [npc.her] [npc.crotchNipple+].",

                            "Taking hold of [npc2.namePos] [npc2.hand], [npc.name] guide [npc2.her] [npc2.fingers] up to [npc.her] [npc.crotchBoobs], and with a slow, steady pressure,"
                                    + " [npc.she] gently push [npc2.her] digits into [npc.her] [npc.crotchNipple+]."));
					break;
				case DOM_NORMAL:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "With a firm grip on [npc2.her] [npc2.hand], [npc.name] eagerly guide [npc2.namePos] [npc2.fingers] up and over [npc.her] [npc.crotchBoobs],"
									+ " letting out [npc.a_moan+] before greedily pushing [npc2.her] digits into [npc.her] [npc.crotchNipple+].",

                            "Taking hold of [npc2.namePos] [npc2.hand], [npc.name] eagerly guide [npc2.her] [npc2.fingers] up to [npc.her] [npc.crotchBoobs], and with a determined pressure,"
                                    + " [npc.she] greedily push [npc2.her] digits into [npc.her] [npc.crotchNipple+]."));
					break;
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "With a vice-like grip on [npc2.her] [npc2.hand], [npc.name] grind [npc2.namePos] [npc2.fingers] up and over [npc.her] [npc.crotchBoobs],"
									+ " letting out [npc.a_moan+] before roughly forcing [npc2.her] digits into [npc.her] [npc.crotchNipple+].",

                            "Grabbing [npc2.namePos] [npc2.hand], [npc.name] forcefully push [npc2.namePos] [npc2.fingers] up to [npc.her] [npc.crotchBoobs], and with a dominant, jerking motion,"
                                    + " [npc.she] roughly stuff [npc2.her] digits into [npc.her] [npc.crotchNipple+]."));
					break;
				case SUB_EAGER:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "With a firm grip on [npc2.her] [npc2.hand], [npc.name] eagerly guide [npc2.namePos] [npc2.fingers] up and over [npc.her] [npc.crotchBoobs],"
                            ...
                            "Taking hold of [npc2.namePos] [npc2.hand], [npc.name] eagerly guide [npc2.namePos] [npc2.fingers] up to [npc.her] [npc.crotchBoobs], and with a determined pressure,"
                                    + " [npc.she] greedily push [npc2.her] digits into [npc.her] [npc.crotchNipple+]."));
					break;
				case SUB_NORMAL:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "With a firm grip on [npc2.her] [npc2.hand], [npc.name] guide [npc2.namePos] [npc2.fingers] up and over [npc.her] [npc.crotchBoobs],"
									+ " letting out [npc.a_moan+] before pushing [npc2.her] digits into [npc.her] [npc.crotchNipple+].",

                            "Taking hold of [npc2.namePos] [npc2.hand], [npc.name] guide [npc2.namePos] [npc2.fingers] up to [npc.her] [npc.crotchBoobs], and with a determined pressure,"
                                    + " [npc.she] push [npc2.her] digits into [npc.her] [npc.crotchNipple+]."));
					break;
				default:
					break;
			}
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
					"Gently pushing [npc.her] [npc.crotchBoob] out against [npc2.namePos] [npc2.hand],"
                            + " [npc.name] let out a soft [npc.moan] as [npc.she] help to sink [npc2.namePos] [npc2.fingers+] deep into [npc.her] [npc.crotchNipple+].",

                    "With a soft [npc.moan], [npc.name] gently start thrusting [npc.her] [npc.crotchBoob] out against [npc2.namePos] [npc2.hand], forcing [npc2.her] [npc2.fingers+] ever deeper into [npc.her] [npc.crotchNipple+].",
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
					"Eagerly pushing [npc.her] [npc.crotchBoob] out against [npc2.namePos] [npc2.hand],"
                            + " [npc.name] let out [npc.a_moan+] as [npc.she] help to sink [npc2.namePos] [npc2.fingers+] deep into [npc.her] [npc.crotchNipple+].",

                    "With [npc.a_moan+], [npc.name] energetically start thrusting [npc.her] [npc.crotchBoob] out against [npc2.namePos] [npc2.hand], forcing [npc2.her] [npc2.fingers+] ever deeper into [npc.her] [npc.crotchNipple+].",
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
					"Violently slamming [npc.her] [npc.crotchBoob] out against [npc2.namePos] [npc2.hand],"
                            + " [npc.name] let out [npc.a_moan+] as [npc.she] roughly force [npc2.namePos] [npc2.fingers+] deep into [npc.her] [npc.crotchNipple+].",

                    "With [npc.a_moan+], [npc.name] start aggressively thrusting [npc.her] [npc.crotchBoob] out against [npc2.namePos] [npc2.hand], forcing [npc2.her] [npc2.fingers+] ever deeper into [npc.her] [npc.crotchNipple+].",
	...
	public static final SexAction NIPPLE_FINGERED_SUB_NORMAL = new SexAction(
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                    ...
                    "With [npc.a_moan+], [npc.name] start thrusting [npc.her] [npc.crotchBoob] out against [npc2.namePos] [npc2.hand], forcing [npc2.her] [npc2.fingers+] ever deeper into [npc.her] [npc.crotchNipple+].",
		...
		public String getDescription() {
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(this))) {
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "[npc.Name] feel tears starting to well up in [npc.namePos] [npc.eyes], and, unable to keep it in any longer,"
                                    + " [npc.a_sob+] bursts out from [npc.her] mouth as [npc.she] weakly try to pull [npc2.namePos] gently-pumping [npc2.fingers] out of [npc.her] [npc.crotchNipple+].",

                            "[npc.A_sob+] bursts out from [npc.namePos] mouth as [npc.she] frantically try to pull [npc.her] [npc.crotchBoob] away from [npc2.namePos] unwanted touch,"
				...
				case DOM_NORMAL:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "[npc.Name] feel tears starting to well up in [npc.namePos] [npc.eyes], and, unable to keep it in any longer,"
                                    + " [npc.a_sob+] bursts out from [npc.her] mouth as [npc.she] weakly try to pull [npc2.namePos] greedily-thrusting [npc2.fingers] out of [npc.her] [npc.crotchNipple+].",
				...
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "[npc.Name] feel tears starting to well up in [npc.namePos] [npc.eyes], and, unable to keep it in any longer,"
                                    + " [npc.a_sob+] bursts out from [npc.her] mouth as [npc.she] weakly try to pull [npc2.namePos] roughly-thrusting [npc2.fingers] out of [npc.her] [npc.crotchNipple+].",
	...
	public static final SexAction NIPPLE_FINGERED_STOP = new SexAction(
		...
		public String getDescription() {
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Yanking [npc2.namePos] [npc2.fingers] out of [npc.her] [npc.crotchNipple+], [npc.name] growl at [npc2.name] as [npc.she] command [npc2.herHim] to stop fingering [npc.herHim].",

                            "[npc.Name] lean into [npc2.name], inhaling [npc2.her] [npc2.scent] before yanking [npc2.her] [npc2.fingers] out of [npc.her] [npc.crotchNipple+]."));
					break;
				default:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Sliding [npc2.namePos] [npc2.fingers] out of [npc.her] [npc.crotchNipple+], [npc.name] let out [npc.a_moan+] before telling [npc2.herHim] to stop fingering [npc.herHim].",

                            "[npc.Name] lean into [npc2.name], inhaling [npc2.her] [npc2.scent] as [npc.name] slide [npc2.her] [npc2.fingers] out of [npc.her] [npc.crotchNipple+]."));
					break;
			}
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(this))) {
				...
				default:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            " [npc2.Name] [npc2.verb(let)] out [npc2.a_moan+] as [npc.name] stop [npc2.herHim] from stimulating [npc.her] [npc.crotchNipple+].",
				...
				case SUB_RESISTING:
					return (UtilText.returnStringAtRandom(
							...
							" [npc2.A_sob+] bursts out from between [npc2.namePos] [npc2.lips],"
                                    + " before [npc2.she] [npc2.verb(start)] weakly trying to push [npc.name] away, squirming and protesting as [npc.name] continue to gently finger [npc2.her] [npc2.crotchNipple+].",

							" [npc2.Sobbing] in distress, [npc2.name] [npc2.verb(try)], in vain,"
                                    + " to recoil [npc2.her] chest away from [npc.namePos] touch, struggling against [npc.herHim] as [npc.her] [npc.fingers] continue gently sliding deep into [npc2.her] [npc2.crotchNipple+]."));
				case DOM_GENTLE:
					return (UtilText.returnStringAtRandom(
							" [npc2.Name] [npc2.verb(push)] [npc2.her] chest out in response,"
