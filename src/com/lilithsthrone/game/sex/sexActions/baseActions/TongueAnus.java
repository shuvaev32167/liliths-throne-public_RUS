			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Pressing [npc.her] [npc.lips+] against [npc2.namePos] [npc2.assCloaca+], [npc.name] plant a series soft kisses on [npc2.her] cheeks,"
									+ " before slowly, but firmly, sliding [npc.her] [npc.tongue+] into [npc2.her] [npc2.asshole+].",

                            "Planting a series of soft kisses on [npc2.namePos] [npc2.assCloaca+], [npc.name] give [npc2.her] [npc2.asshole+] a long, wet lick, before gently pushing [npc.her] [npc.tongue+] deep inside."));
					break;
				case DOM_NORMAL:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Eagerly pressing [npc.her] [npc.lips+] against [npc2.namePos] [npc2.assCloaca+], [npc.name] plant a series of passionate kisses on [npc2.her] cheeks,"
									+ " before desperately sliding [npc.her] [npc.tongue+] into [npc2.her] [npc2.asshole+].",

                            "Planting a series of passionate kisses on [npc2.namePos] [npc2.assCloaca+], [npc.name] give [npc2.her] [npc2.asshole+] a hungry lick, before greedily pushing [npc.her] [npc.tongue+] deep inside."));
					break;
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Roughly grinding [npc.her] [npc.lips+] against [npc2.namePos] [npc2.assCloaca+], [npc.name] plant a series of forceful kisses on [npc2.her] cheeks,"
									+ " before greedily sliding [npc.her] [npc.tongue+] into [npc2.her] [npc2.asshole+].",

                            "Planting a series of forceful kisses on [npc2.namePos] [npc2.assCloaca+], [npc.name] give [npc2.her] [npc2.asshole+] a rough lick, before greedily pushing [npc.her] [npc.tongue+] deep inside."));
					break;
				case SUB_EAGER:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Eagerly pressing [npc.her] [npc.lips+] against [npc2.namePos] [npc2.assCloaca+], [npc.name] plant a series of passionate kisses on [npc2.her] cheeks,"
				...
				case SUB_NORMAL:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Pressing [npc.her] [npc.lips+] against [npc2.namePos] [npc2.assCloaca+], [npc.name] plant a series of kisses on [npc2.her] cheeks, before sliding [npc.her] [npc.tongue+] into [npc2.her] [npc2.asshole+].",

                            "Planting a series of kisses on [npc2.namePos] [npc2.assCloaca+], [npc.name] give [npc2.her] [npc2.asshole+] a wet lick, before pushing [npc.her] [npc.tongue+] deep inside."));
					break;
				default:
					break;
			}
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
					"Gently driving [npc.her] [npc.tongue+] as deep as possible into [npc2.namePos] [npc2.assCloaca+],"
                            + " [npc.name] press [npc.her] [npc.lips+] up against [npc2.her] [npc2.asshole+] и let out a muffled [npc.moan].",

                    "Withdrawing [npc.her] [npc.tongue+] from [npc2.namePos] [npc2.asshole+], [npc.name] start to gently kiss and lick [npc2.namePos] [npc2.assCloaca+],"
							+ " before pressing forwards and slowly sliding [npc.her] [npc.tongue] into [npc2.her] [npc2.asshole+] once more.",

                    "Drawing [npc.her] [npc.tongue+] out from [npc2.namePos] [npc2.asshole+], [npc.name] start slowly kissing and nuzzling against [npc2.namePos] [npc2.assCloaca+],"
	...
	public static final SexAction ANILINGUS_DOM_NORMAL = new SexAction(
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                    ...
                    "Withdrawing [npc.her] [npc.tongue+] from [npc2.namePos] [npc2.asshole+], [npc.name] start to eagerly kiss and lick [npc2.namePos] [npc2.assCloaca+],"
							+ " before pressing forwards and greedily sliding [npc.her] [npc.tongue] into [npc2.her] [npc2.asshole+] once more.",

                    "Drawing [npc.her] [npc.tongue+] out from [npc2.namePos] [npc2.asshole+], [npc.name] start happily kissing and nuzzling against [npc2.namePos] [npc2.assCloaca+],"
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
					"Roughly thrusting [npc.her] [npc.tongue+] as deep as possible into [npc2.namePos] [npc2.assCloaca+],"
                            + " [npc.name] grind [npc.her] [npc.lips+] up against [npc2.her] [npc2.asshole+] и let out a muffled [npc.moan].",

                    "Withdrawing [npc.her] [npc.tongue+] from [npc2.namePos] [npc2.asshole+], [npc.name] start to roughly kiss and lick [npc2.namePos] [npc2.assCloaca+],"
							+ " before pressing forwards and violently thrusting [npc.her] [npc.tongue] into [npc2.her] [npc2.asshole+] once more.",

                    "Drawing [npc.her] [npc.tongue+] out from [npc2.namePos] [npc2.asshole+], [npc.name] start forcefully kissing and licking [npc2.namePos] [npc2.assCloaca+],"
	...
	public static final SexAction ANILINGUS_SUB_RESISTING = new SexAction(
		...
		public String getDescription() {
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(this))) {
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "[npc.Name] try to pull [npc.her] [npc.face] back, but [npc2.name] [npc2.verb(continue)] gently pressing [npc2.her] [npc2.asshole+] down against [npc.her] [npc.lips+],"
									+ " holding [npc.herHim] in place as [npc2.she] [npc2.verb(force)] [npc2.herself] on [npc.herHim].",

                            "With [npc.a_sob+], [npc.name] try to pull away from [npc2.name], but [npc2.she] quickly [npc2.verb(force)] [npc.her] [npc.face] right back into [npc2.her] [npc2.assCloaca+],"
									+ " gently grinding [npc2.herself] against [npc.herHim] as [npc2.she] [npc2.verb(ignore)] [npc.her] struggles.",

                            "Tears start to well up in [npc.namePos] [npc.eyes], and with [npc.a_sob+], [npc.she] try to pull [npc.her] mouth away from [npc2.namePos] [npc2.assCloaca+],"
				...
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "[npc.Name] try to pull [npc.her] [npc.face] back, but [npc2.name] roughly [npc2.verb(slam)] [npc2.her] [npc2.asshole+] down against [npc.her] [npc.lips+],"
									+ " holding [npc.herHim] in place as [npc2.she] violently [npc2.verb(force)] [npc2.herself] on [npc.herHim].",

                            "With [npc.a_sob+], [npc.name] try to pull away from [npc2.name], but [npc2.she] violently [npc2.verb(force)] [npc.her] [npc.face] right back into [npc2.her] [npc2.assCloaca+],"
				...
				default: // DOM_NORMAL and in case anything goes wrong:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "[npc.Name] try to pull [npc.her] [npc.face] back, but [npc2.name] [npc2.verb(continue)] eagerly thrusting [npc2.her] [npc2.asshole+] down against [npc.her] [npc.lips+],"
									+ " holding [npc.herHim] in place as [npc2.she] [npc2.verb(force)] [npc2.herself] on [npc.herHim].",
	...
	public static final SexAction ANILINGUS_SUB_NORMAL = new SexAction(
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                    ...
                    "Withdrawing [npc.her] [npc.tongue+] from [npc2.namePos] [npc2.asshole+], [npc.name] start to kiss and lick [npc2.namePos] [npc2.assCloaca+],"
							+ " before pressing forwards and sliding [npc.her] [npc.tongue] into [npc2.her] [npc2.asshole+] once more.",

                    "Drawing [npc.her] [npc.tongue+] out from [npc2.namePos] [npc2.asshole+], [npc.name] start kissing and nuzzling against [npc2.namePos] [npc2.assCloaca+],"
	...
	public static final SexAction ANILINGUS_STOP = new SexAction(
		...
		public String getDescription() {
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "With one last rough lick, [npc.name] pull [npc.her] [npc.face] away from [npc2.namePos] [npc2.asshole+].",

                            "Giving [npc2.namePos] [npc2.asshole+] a final, rough kiss, [npc.name] pull [npc.her] [npc.face] away from [npc2.her] [npc2.assCloaca+]."));
					break;
				default:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "With one last lick, [npc.name] pull [npc.her] [npc.face] away from [npc2.namePos] [npc2.asshole+].",

                            "Giving [npc2.namePos] [npc2.asshole+] a final, wet kiss, [npc.name] pull [npc.her] [npc.face] away from [npc2.her] [npc2.assCloaca+]."));
					break;
			}
				...
				switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(this))) {
					...
					default:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                ...
                                " [npc2.A_moan+] drifts out from between [npc2.namePos] [npc2.lips+] as [npc.name] stop pleasuring [npc2.her] [npc2.asshole+], betraying [npc2.her] desire for more of [npc.namePos] attention."));
						break;
				}
			}
		...
		public String getDescription() {
				...
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Gently pressing [npc.her] [npc.assCloaca+] down against [npc2.namePos] [npc2.face],"
                                    + " [npc.name] let out a soft [npc.moan] as [npc.she] start slowly grinding [npc.her] [npc.asshole+] down on [npc2.her] [npc2.lips+].",

							"Shifting [npc.her] [npc.hips] so that [npc2.namePos] [npc2.face] is forced into [npc.her] [npc.assCloaca+],"
                                    + " [npc.name] let out a soft [npc.moan] as [npc.she] start gently pressing [npc.her] [npc.asshole+] down against [npc2.her] [npc2.lips+]."));
					break;
				case DOM_NORMAL:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Eagerly pressing [npc.her] [npc.assCloaca+] down against [npc2.namePos] [npc2.face],"
                                    + " [npc.name] let out [npc.a_moan+] as [npc.she] start frantically grinding [npc.her] [npc.asshole+] down on [npc2.her] [npc2.lips+].",

							"Shifting [npc.her] [npc.hips] so that [npc2.namePos] [npc2.face] is forced into [npc.her] [npc.assCloaca+],"
                                    + " [npc.name] let out [npc.a_moan+] as [npc.she] start eagerly pressing [npc.her] [npc.asshole+] down against [npc2.her] [npc2.lips+]."));
					break;
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Roughly slamming [npc.her] [npc.assCloaca+] down against [npc2.namePos] [npc2.face],"
                                    + " [npc.name] let out [npc.a_moan+] as [npc.she] start forcefully grinding [npc.her] [npc.asshole+] down on [npc2.her] [npc2.lips+].",

							"Shifting [npc.her] [npc.hips] so that [npc2.namePos] [npc2.face] is forced into [npc.her] [npc.assCloaca+],"
                                    + " [npc.name] let out [npc.a_moan+] as [npc.she] start roughly grinding [npc.her] [npc.asshole+] down against [npc2.her] [npc2.lips+]."));
					break;
				case SUB_EAGER:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Eagerly pressing [npc.her] [npc.assCloaca+] down against [npc2.namePos] [npc2.face],"
				...
				case SUB_NORMAL:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Pressing [npc.her] [npc.assCloaca+] down against [npc2.namePos] [npc2.face],"
                                    + " [npc.name] let out [npc.a_moan+] as [npc.she] start grinding [npc.her] [npc.asshole+] down on [npc2.her] [npc2.lips+].",

							"Shifting [npc.her] [npc.hips] so that [npc2.namePos] [npc2.face] is forced into [npc.her] [npc.assCloaca+],"
                                    + " [npc.name] let out [npc.a_moan+] as [npc.she] start pressing [npc.her] [npc.asshole+] down against [npc2.her] [npc2.lips+]."));
					break;
				default:
					break;
			}
			...
			if(!isTargetedCharacterInanimate()) {
				switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(this))) {
					...
					case SUB_RESISTING:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                " Struggling in desperation, [npc2.name] [npc2.verb(let)] out [npc2.a_sob+] as [npc.name] force [npc.her] [npc.asshole+] down against [npc2.her] [npc2.lips+].",

                                " [npc2.Sobbing] and struggling in distress, [npc2.namePos] protests prove to be in vain as [npc.name] press [npc.her] [npc.assCloaca+] down over [npc2.her] [npc2.face]."));
						break;
					default:
						break;
				}
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
					"Gently pressing [npc.her] [npc.assCloaca+] down over [npc2.namePos] [npc2.face+],"
                            + " [npc.name] let out a soft [npc.moan] as [npc.she] firmly plant [npc.her] [npc.asshole+] down over [npc2.her] [npc2.lips+].",

                    "With a soft [npc.moan], [npc.name] press [npc.her] [npc.assCloaca+] against [npc2.namePos] [npc2.face+], before gently grinding [npc.her] [npc.asshole+] against [npc2.her] [npc2.lips+].",

                    "Letting out a soft [npc.moan], [npc.name] gently grind [npc.her] [npc.asshole+] down against [npc2.namePos] [npc2.lips]."));
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
					"Eagerly pressing [npc.her] [npc.assCloaca+] down over [npc2.namePos] [npc2.face+],"
                            + " [npc.name] let out [npc.a_moan+] as [npc.she] firmly plant [npc.her] [npc.asshole+] down over [npc2.her] [npc2.lips+].",

                    "With [npc.a_moan+], [npc.name] eagerly press [npc.her] [npc.assCloaca+] against [npc2.namePos] [npc2.face+], before greedily grinding [npc.her] [npc.asshole+] against [npc2.her] [npc2.lips+].",

                    "Letting out [npc.a_moan+], [npc.name] eagerly grind [npc.her] [npc.asshole+] down against [npc2.namePos] [npc2.lips]."));
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
					"Roughly pressing [npc.her] [npc.assCloaca+] down over [npc2.namePos] [npc2.face+],"
                            + " [npc.name] let out [npc.a_moan+] as [npc.she] violently slam [npc.her] [npc.asshole+] down over [npc2.her] [npc2.lips+].",

                    "With [npc.a_moan+], [npc.name] roughly slam [npc.her] [npc.assCloaca+] against [npc2.namePos] [npc2.face+], before forcefully grinding [npc.her] [npc.asshole+] against [npc2.her] [npc2.lips+].",

                    "Letting out [npc.a_moan+], [npc.name] roughly grind [npc.her] [npc.asshole+] down against [npc2.namePos] [npc2.lips]."));
	...
	public static final SexAction RECEIVING_ANILINGUS_SUB_RESIST = new SexAction(
		...
		public String getDescription() {
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(this))) {
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "[npc.Name] desperately try to pull [npc.her] [npc.assCloaca] away from [npc2.namePos] [npc2.face],"
									+ " letting out [npc.a_sob+] as [npc2.name] gently [npc2.verb(slide)] [npc2.her] [npc2.tongue] deep into [npc.her] [npc.asshole+].",

                            "Letting out [npc.a_sob+], [npc.name] desperately try to pull [npc.her] [npc.asshole+] away from [npc2.namePos] [npc2.lips+]."
                            ...
                            "With [npc.a_sob+], [npc.name] frantically try to pull [npc.her] [npc.assCloaca+] away from [npc2.namePos] [npc2.lips+], but [npc2.she] holds [npc.herHim] in place,"
				...
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            ...
                            "With [npc.a_sob+], [npc.name] frantically try to pull [npc.her] [npc.assCloaca+] away from [npc2.namePos] [npc2.lips+], but [npc2.she] firmly holds [npc.herHim] in place,"
	...
	public static final SexAction RECEIVING_ANILINGUS_SUB_NORMAL = new SexAction(
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                    ...
                    "With [npc.a_moan+], [npc.name] press [npc.her] [npc.assCloaca+] against [npc2.namePos] [npc2.face+], before grinding [npc.her] [npc.asshole+] against [npc2.her] [npc2.lips+].",

                    "Letting out [npc.a_moan+], [npc.name] grind [npc.her] [npc.asshole+] down against [npc2.namePos] [npc2.lips]."));
	...
	public static final SexAction RECEIVING_ANILINGUS_STOP = new SexAction(
		...
		public String getDescription() {
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Roughly yanking [npc2.namePos] head away from [npc.her] [npc.asshole+], [npc.name] order [npc2.herHim] to stop performing anilingus on [npc.herHim].",

                            "Roughly grinding [npc.her] [npc.asshole+] into [npc2.namePos] [npc2.face] one last time, [npc.name] then pull [npc.her] [npc.assCloaca] away, putting an end to the ongoing anilingus."));
					break;
				default:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Pulling [npc2.namePos] head away from [npc.her] [npc.asshole+], [npc.name] tell [npc2.herHim] to stop performing anilingus on [npc.herHim].",

                            "Pressing [npc.her] [npc.asshole+] into [npc2.namePos] [npc2.face] one last time, [npc.name] then pull [npc.her] [npc.assCloaca] away, putting an end to the ongoing anilingus."));
					break;
			}
				...
				case SUB_RESISTING:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							...
							" [npc2.A_sob+] bursts out from between [npc2.namePos] [npc2.lips] as [npc2.she] weakly [npc2.verb(try)] to push [npc.name] away,"
                                    + " squirming and protesting as [npc.she] continue to lick and kiss [npc2.her] [npc2.asshole+].",

							" [npc2.Sobbing] in distress, [npc2.name] [npc2.verb(try)], in vain, to recoil away from [npc.namePos] [npc.tongue],"
                                    + " struggling against [npc.herHim] as [npc.she] continue to orally service [npc2.her] [npc2.asshole+]."));
					break;
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(action))) {
				...
				case SUB_RESISTING:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							...
							" [npc2.A_sob+] bursts out from between [npc2.namePos] [npc2.lips] as [npc2.she] weakly [npc2.verb(try)] to push [npc.name] away,"
                                    + " squirming and protesting as [npc.she] continue to force [npc.her] [npc.assCloaca+] down against [npc2.her] [npc2.face+].",

							" [npc2.Sobbing] in distress, [npc2.name] [npc2.verb(try)], in vain, to recoil away from [npc.namePos] [npc.assCloaca],"
                                    + " struggling against [npc.herHim] as [npc.she] continue to press [npc.her] [npc.asshole+] against [npc2.her] [npc2.lips+]."));
					break;
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
