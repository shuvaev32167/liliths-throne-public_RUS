...
public class PenisNippleCrotch {
		...
		public String getDescription() {
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Guiding [npc.her] [npc.cock+] up to [npc2.namePos] [npc2.crotchBoobs+],"
                                    + " [npc.name] start slowly teasing the [npc.cockTip+] up and down over ones of [npc2.her] [npc2.crotchNipples+], ready to penetrate [npc2.herHim] at any moment.",

                            "With a soft [npc.moan], [npc.name] guide [npc.her] [npc.cock+] up to [npc2.namePos] [npc2.crotchBoobs+],"
				...
				case SUB_EAGER:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Guiding [npc.her] [npc.cock+] up to [npc2.namePos] [npc2.crotchBoobs+],"
                                    + " [npc.name] start eagerly sliding the [npc.cockTip+] up and down over one of [npc2.her] [npc2.crotchNipples+], ready to penetrate [npc2.herHim] at any moment.",

                            "With [npc.a_moan+], [npc.name] guide [npc.her] [npc.cock+] up to [npc2.namePos] [npc2.crotchBoobs+],"
				...
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Grinding [npc.her] [npc.cock+] up against [npc2.namePos] [npc2.crotchBoobs+],"
                                    + " [npc.name] pull back a little before starting to slide the [npc.cockTip+] up and down over one of [npc2.her] [npc2.crotchNipples+], ready to start fucking [npc2.herHim] at any moment.",

                            "With [npc.a_moan+], [npc.name] line [npc.her] [npc.cock+] up to [npc2.namePos] [npc2.crotchBoobs+],"
				...
				case SUB_NORMAL:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Guiding [npc.her] [npc.cock+] up to [npc2.namePos] [npc2.crotchBoobs+],"
                                    + " [npc.name] start sliding the [npc.cockTip+] up and down over one of [npc2.her] [npc2.crotchNipples+], ready to penetrate [npc2.herHim] at any moment.",

                            "With [npc.a_moan+], [npc.name] guide [npc.her] [npc.cock+] up to [npc2.namePos] [npc2.crotchBoobs+], before starting to slide the [npc.cockTip] up and down over one of [npc2.her] [npc2.crotchNipples+].",
	...
	public static final SexAction FORCE_PENIS_OVER_NIPPLE_CROTCH = new SexAction(
		...
		public String getDescription() {
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "[npc.Name] grab [npc2.namePos] [npc2.cock+], before guiding it up to [npc.her] [npc.crotchBoobs+]."
                                    + " Slowly pushing the [npc2.cockTip+] up and down over [npc.her] [npc.crotchNipple+], [npc.she] tease [npc2.name] with the promise of penetration at any moment.",

                            "With a soft [npc.moan], [npc.name] grab [npc2.namePos] [npc2.cock+] и guide it up to [npc.her] [npc.crotchBoobs+],"
									+ " before starting to gently slide the [npc2.cockTip] up and down over [npc.her] [npc.crotchNipple+].",

                            "Grabbing [npc2.namePos] [npc2.cock+], [npc.name] gently slide the [npc2.cockTip+] over [npc.her] [npc.crotchNipple+],"
				...
				case SUB_EAGER:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "[npc.Name] grab [npc2.namePos] [npc2.cock+], before guiding it up to [npc.her] [npc.crotchBoobs+]."
                                    + " Eagerly pushing the [npc2.cockTip+] up and down over [npc.her] [npc.crotchNipple+], [npc.she] tease [npc2.name] with the promise of penetration at any moment.",

                            "With [npc.a_moan+], [npc.name] grab [npc2.namePos] [npc2.cock+] и guide it up to [npc.her] [npc.crotchBoobs+],"
									+ " before starting to eagerly slide the [npc2.cockTip] up and down over [npc.her] [npc.crotchNipple+].",

                            "Grabbing [npc2.namePos] [npc2.cock+], [npc.name] eagerly slide the [npc2.cockTip+] over [npc.her] [npc.crotchNipple+],"
                                    + " letting out [npc.a_moan+] as [npc.she] tease [npc2.herHim] with the promise of penetration."));
					break;
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "[npc.Name] grab [npc2.namePos] [npc2.cock+], before yanking it up to [npc.her] [npc.crotchBoobs+]."
                                    + " Roughly forcing the [npc2.cockTip+] up and down over [npc.her] [npc.crotchNipple+], [npc.she] tease [npc2.name] with the promise of penetration at any moment.",

                            "With [npc.a_moan+], [npc.name] grab [npc2.namePos] [npc2.cock+] and yank it up to [npc.her] [npc.crotchBoobs+],"
                                    + " before starting to roughly force the [npc2.cockTip] up and down over [npc.her] [npc.crotchNipple+].",

                            "Grabbing [npc2.namePos] [npc2.cock+], [npc.name] roughly grind the [npc2.cockTip+] over [npc.her] [npc.crotchNipple+],"
                                    + " letting out [npc.a_moan+] as [npc.she] tease [npc2.herHim] with the promise of penetration."));
					break;
				case SUB_NORMAL:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "[npc.Name] grab [npc2.namePos] [npc2.cock+], before guiding it up to [npc.her] [npc.crotchBoobs+]."
                                    + " Pushing the [npc2.cockTip+] up and down over [npc.her] [npc.crotchNipple+], [npc.she] tease [npc2.name] with the promise of penetration at any moment.",

                            "With [npc.a_moan+], [npc.name] grab [npc2.namePos] [npc2.cock+] и guide it up to [npc.her] [npc.crotchBoobs+],"
									+ " before starting to slide the [npc2.cockTip] up and down over [npc.her] [npc.crotchNipple+].",

                            "Grabbing [npc2.namePos] [npc2.cock+], [npc.name] slide the [npc2.cockTip+] over [npc.her] [npc.crotchNipple+],"
                                    + " letting out [npc.a_moan+] as [npc.she] tease [npc2.herHim] with the promise of penetration."));
					break;
				default:
					break;
				...
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Slowly teasing the [npc.cockTip+] of [npc.her] [npc.cock] over [npc2.namePos] [npc2.crotchBoobs+],"
                                    + " [npc.name] let out a little [npc.moan] before slowly pushing forwards, sinking [npc.her] [npc.cock+] into [npc2.her] [npc2.crotchNipple+].",

                            "[npc.Name] position the [npc.cockTip+] of [npc.her] [npc.cock] over [npc2.namePos] [npc2.crotchBoobs+],"
				...
				case DOM_NORMAL:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Eagerly teasing the [npc.cockTip+] of [npc.her] [npc.cock] over [npc2.namePos] [npc2.crotchBoobs+],"
                                    + " [npc.name] let out [npc.a_moan+] before thrusting forwards, greedily sinking [npc.her] [npc.cock+] into [npc2.her] [npc2.crotchNipple+].",
				...
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Roughly grinding the [npc.cockTip+] of [npc.her] [npc.cock] over [npc2.namePos] [npc2.crotchBoobs+],"
                                    + " [npc.name] let out [npc.a_moan+] before violently slamming forwards, forcing [npc.her] [npc.cock+] deep into [npc2.her] [npc2.crotchNipple+].",
				...
				case SUB_NORMAL:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Teasing the [npc.cockTip+] of [npc.her] [npc.cock] over [npc2.namePos] [npc2.crotchBoobs+],"
                                    + " [npc.name] let out [npc.a_moan+] before thrusting forwards, sinking [npc.her] [npc.cock+] into [npc2.her] [npc2.crotchNipple+].",
	...
	public static final SexAction PENIS_FUCKING_DOM_GENTLE = new SexAction(
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                    ...
                    "Sliding [npc.her] [npc.cock+] into [npc2.namePos] [npc2.crotchNipple+], [npc.name] let out a little [npc.moan] as [npc.she] start to gently pump [npc.her] [npc.hips] back and forth,"
	...
	public static final SexAction PENIS_FUCKING_DOM_NORMAL = new SexAction(
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                    ...
                    "Thrusting [npc.her] [npc.cock+] deep into [npc2.namePos] [npc2.crotchNipple+], [npc.name] let out [npc.a_moan+] as [npc.she] start to eagerly pump [npc.her] [npc.hips] back and forth,"
	...
	public static final SexAction PENIS_FUCKING_DOM_ROUGH = new SexAction(
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                    ...
                    "Forcefully driving [npc.her] [npc.cock+] deep into [npc2.namePos] [npc2.crotchNipple+], [npc.name] let out [npc.a_moan+] as [npc.she] start to roughly slam [npc.her] [npc.hips] back and forth,"
	...
	public static final SexAction PENIS_FUCKING_SUB_NORMAL = new SexAction(
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                    ...
                    "Thrusting [npc.her] [npc.cock+] deep into [npc2.namePos] [npc2.crotchNipple+], [npc.name] let out [npc.a_moan+] as [npc.she] start to pump [npc.her] [npc.hips] back and forth,"
	...
	public static final SexAction PENIS_FUCKING_SUB_EAGER = new SexAction(
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                    ...
                    "Thrusting [npc.her] [npc.cock+] deep into [npc2.namePos] [npc2.crotchNipple+], [npc.name] let out [npc.a_moan+] as [npc.she] start to eagerly pump [npc.her] [npc.crotchBoobs] back and forth,"
	...
	public static final SexAction PENIS_FUCKING_SUB_RESIST = new SexAction(
		...
		public String getDescription() {
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(this))) {
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "[npc.Name] try to pull [npc.her] [npc.cock] out of [npc2.namePos] [npc2.crotchNipple],"
                            ...
                            "With [npc.a_sob+], [npc.name] try to pull [npc.her] [npc.cock] away from [npc2.name], but [npc2.she] quickly [npc2.verb(grab)] it, before gently forcing it back inside [npc2.her] [npc2.crotchNipple+].",

                            "Tears start to well up in [npc.namePos] [npc.eyes], and with [npc.a_sob+], [npc.she] try to pull [npc.her] [npc.cock] away from [npc2.namePos] [npc2.crotchNipple+],"
				...
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            ...
                            "With [npc.a_sob+], [npc.name] try to pull [npc.her] [npc.cock] away from [npc2.name], but [npc2.she] quickly [npc2.verb(grab)] it, before roughly forcing it back inside [npc2.her] [npc2.crotchNipple+].",
				...
				default: // DOM_NORMAL and in case anything goes wrong:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            ...
                            "With [npc.a_sob+], [npc.name] try to pull [npc.her] [npc.cock] away from [npc2.name], but [npc2.she] quickly [npc2.verb(grab)] it, before eagerly forcing it back inside [npc2.her] [npc2.crotchNipple+].",
		...
		public String getDescription() {
				...
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Roughly yanking [npc.her] [npc.cock+] out of [npc2.namePos] [npc2.crotchNipple+],"
                                    + " [npc.name] dominantly slide the [npc.cockTip+] up and down over one of [npc2.her] [npc2.crotchBoobs+] one last time before pulling back.",

                            "Thrusting deep inside of [npc2.name] one last time, [npc.name] then yank [npc.her] [npc.cock+] back out of [npc2.her] [npc2.crotchNipple+], putting an end to the rough fucking."));
					break;
				default:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Sliding [npc.her] [npc.cock] out of [npc2.namePos] [npc2.crotchNipple+], [npc.name] rub the [npc.cockTip] up and down over one of [npc2.her] [npc2.crotchBoobs+] one last time before pulling back.",

                            "Pushing deep inside of [npc2.name] one last time, [npc.name] then slide [npc.her] [npc.cock+] back out of [npc2.her] [npc2.crotchNipple+], putting an end to the fucking."));
					break;
			}
			...
			if(!isTargetedCharacterInanimate()) {
				switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(this))) {
					...
					default:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                " [npc2.Name] [npc2.verb(let)] out [npc2.a_moan+] as [npc.name] pull [npc.her] [npc.cock+] out of [npc2.her] [npc2.crotchNipple+], eager for more of [npc.her] attention.",
	...
	public static final SexAction USING_PENIS_START = new SexAction(
		...
		public String getDescription() {
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Grabbing [npc2.namePos] [npc2.cock], [npc.name] slowly guide it up to [npc.her] [npc.crotchBoobs+],"
                            ...
                            "Grabbing [npc2.namePos] [npc2.cock], [npc.name] line it up to [npc.her] [npc.crotchNipple+],"
                                    + " before slowly pushing [npc.her] [npc.crotchBoobs] forwards and letting out a soft [npc.moan] as [npc.she] penetrate [npc.herself] on [npc2.her] [npc2.cock+]."));
					break;
				case DOM_NORMAL:
				case SUB_EAGER:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Grabbing [npc2.namePos] [npc2.cock], [npc.name] eagerly guide it up to [npc.her] [npc.crotchBoobs+],"
                            ...
                            "Grabbing [npc2.namePos] [npc2.cock], [npc.name] line it up to [npc.her] [npc.crotchNipple+],"
                                    + " before eagerly pushing [npc.her] [npc.crotchBoobs] forwards and letting out [npc.a_moan+] as [npc.she] penetrate [npc.herself] on [npc2.her] [npc2.cock+]."));
					break;
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            ...
                            "Grabbing [npc2.namePos] [npc2.cock], [npc.name] line it up to [npc.her] [npc.crotchNipple+],"
                                    + " before dominantly pushing [npc.her] [npc.crotchBoobs] forwards and letting out [npc.a_moan+] as [npc.she] penetrate [npc.herself] on [npc2.her] [npc2.cock+]."));
					break;
				case SUB_NORMAL:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Grabbing [npc2.namePos] [npc2.cock], [npc.name] guide it up to [npc.her] [npc.crotchBoobs+],"
									+ " letting out [npc.a_moan+] before pushing out [npc.her] stomach and forcing [npc2.herHim] to penetrate [npc.her] [npc.crotchNipple+].",

                            "Grabbing [npc2.namePos] [npc2.cock], [npc.name] line it up to [npc.her] [npc.crotchNipple+],"
                                    + " before pushing [npc.her] [npc.crotchBoobs] forwards and letting out [npc.a_moan+] as [npc.she] penetrate [npc.herself] on [npc2.her] [npc2.cock+]."));
					break;
				default:
					break;
			}
				...
				switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(this))) {
					...
					case SUB_RESISTING:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                ...
                                " With [npc2.a_sob+], [npc2.name] [npc2.verb(struggle)] against [npc.name] as [npc.she] force [npc2.her] [npc2.cock] deep into [npc.her] [npc.crotchNipple+]."));
						break;
					default:
						break;
				}
	...
	public static final SexAction RIDING_PENIS_DOM_GENTLE = new SexAction(
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                    "With a gentle forwards thrust of [npc.her] stomach, [npc.name] let out a soft [npc.moan] as [npc.she] help to sink [npc2.namePos] [npc2.cock+] deep into [npc.her] [npc.crotchNipple+].",

                    "With a soft [npc.moan], [npc.name] gently push [npc.her] stomach forwards, forcing [npc2.namePos] [npc2.cock+] ever deeper into [npc.her] [npc.crotchNipple+].",
	...
	public static final SexAction RIDING_PENIS_DOM_NORMAL = new SexAction(
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                    "With an eager forwards thrust of [npc.her] stomach, [npc.name] let out [npc.a_moan+] as [npc.she] help to sink [npc2.namePos] [npc2.cock+] deep into [npc.her] [npc.crotchNipple+].",

                    "With [npc.a_moan+], [npc.name] enthusiastically push [npc.her] stomach forwards, forcing [npc2.namePos] [npc2.cock+] ever deeper into [npc.her] [npc.crotchNipple+].",
	...
	public static final SexAction RIDING_PENIS_DOM_ROUGH = new SexAction(
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                    "With a violent forwards thrust of [npc.her] stomach, [npc.name] let out [npc.a_moan+] as [npc.she] force [npc2.namePos] [npc2.cock+] deep into [npc.her] [npc.crotchNipple+].",

                    "With [npc.a_moan+], [npc.name] roughly thrust [npc.her] stomach forwards, forcing [npc2.namePos] [npc2.cock+] ever deeper into [npc.her] [npc.crotchNipple+].",
	...
	public static final SexAction RIDING_PENIS_SUB_NORMAL = new SexAction(
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                    "With a quick forwards thrust of [npc.her] stomach, [npc.name] let out [npc.a_moan+] as [npc.she] help to sink [npc2.namePos] [npc2.cock+] deep into [npc.her] [npc.crotchNipple+].",

                    "With [npc.a_moan+], [npc.name] push [npc.her] stomach forwards, forcing [npc2.namePos] [npc2.cock+] ever deeper into [npc.her] [npc.crotchNipple+].",
	...
	public static final SexAction FUCKED_STOP = new SexAction(
		...
		public String getDescription() {
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Yanking [npc2.namePos] [npc2.cock] out of [npc.her] [npc.crotchNipple+], [npc.name] let out a menacing growl as [npc.she] command [npc2.name] to stop fucking [npc.herHim].",

                            "[npc.Name] lean into [npc2.name], inhaling [npc2.her] [npc2.scent] before yanking [npc2.her] [npc2.cock] out of [npc.her] [npc.crotchNipple+]."));
					break;
				default:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Sliding [npc2.namePos] [npc2.cock] out of [npc.her] [npc.crotchNipple+], [npc.name] let out [npc.a_moan+] as [npc.she] tell [npc2.name] to stop fucking [npc.herHim].",

                            "[npc.Name] lean into [npc2.name], inhaling [npc2.her] [npc2.scent] before sliding [npc2.her] [npc2.cock] out of [npc.her] [npc.crotchNipple+]."));
					break;
			}
	...
	public static final SexAction NIPPLE_CROTCH_CONTROL = new SexAction(
		...
		public String getDescription() {
			return UtilText.returnStringAtRandom(
                    "Letting out [npc.a_moan+], [npc.name] concentrate on squeezing the extra internal muscles within [npc.her] [npc.crotchNipple] down around [npc2.namePos] [npc2.cock+].",
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(action))) {
				...
				case SUB_RESISTING:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							...
							" [npc2.A_sob+] bursts out from between [npc2.namePos] [npc2.lips] as [npc2.she] weakly [npc2.verb(try)] to push [npc.name] away,"
                                    + " squirming and protesting as [npc.name] continue to force [npc2.her] [npc2.cock+] deep into [npc.her] [npc.crotchNipple+].",
