...
public class FingerVagina {
	...
	public static final SexAction FINGER_INSEMINATION_ONGOING = new SexAction(
		...
		public String getActionTitle() {
			return "Пальцевое осеменение";
		}
		@Override
		public String getActionDescription() {
			return "Заставь [npc2.name] зачерпнуть сперму с твоего тела и затолкнуть её глубоко в твою пизду.";
		}
		@Override
		...
		public String getDescription() {
            return "As [npc.name] feel " + getRandomCharacterCumDescription(true) + " sliding down over [npc.her] [npc.skin], a fun idea suddenly springs into [npc.her] mind."
                    + " Reaching down, [npc.she] take hold of [npc2.namePos] [npc2.hand], grinning devilishly as [npc2.she] [npc2.verb(pull)] [npc2.her] [npc2.fingers] out of [npc.her] [npc.pussy+]."
                    + " Guiding [npc2.her] [npc2.fingers] to the " + getRandomCharacterCumDescription(false) + " that's splattered over [npc.her] body, [npc.she] get [npc2.herHim] to scoop up some of the fresh seed."
                    + " Once [npc.sheIs] satisfied that [npc2.sheHas] collected enough, [npc.she] push [npc2.her] [npc.fingers] back into [npc.her] hungry pussy."
						+ "<br/>"
                    + "[npc.Name] grin as [npc.she] feel the " + getRandomCharacterCumDescription(false) + " on [npc2.namePos] fingers being pushed deep into [npc.her] cunt,"
                    + " and [npc.moansVerb+] as [npc2.name] start fingering [npc.herHim] once again, using the slick cum as lubricant."
                    + " Grinding [npc.her] hips against [npc2.namePos] [npc2.hand], [npc.name] let out a desperate, shuddering [npc.moan] at the feeling of being inseminated.";
		}
		@Override
	...
	public static final SexAction FINGER_INSEMINATION_START = new SexAction(
		...
		public String getDescription() {
            return "As [npc.name] feel " + getRandomCharacterCumDescription(true) + " sliding down over [npc.her] [npc.skin], a fun idea suddenly springs into [npc.her] mind,"
                    + " and [npc.she] devilishly grin as [npc.she] take hold of [npc2.namePos] [npc2.hand]."
                    + " Guiding [npc2.her] [npc2.fingers] to the " + getRandomCharacterCumDescription(false) + " that's splattered over [npc.her] body, [npc.she] get [npc2.herHim] to scoop up some of the fresh seed."
                    + " Once [npc.sheIs] satisfied that [npc2.sheHas] collected enough, [npc.she] push [npc2.her] [npc.fingers] into [npc.her] hungry pussy."
					+ "<br/>"
                    + "[npc.Name] grin as [npc.she] feel the " + getRandomCharacterCumDescription(false) + " on [npc2.namePos] fingers being pushed deep into [npc.her] cunt,"
                    + " and [npc.moansVerb+] as [npc2.name] start fingering [npc.herHim], using the slick cum as lubricant."
                    + " Grinding [npc.her] hips against [npc2.namePos] [npc2.hand], [npc.name] let out a desperate, shuddering [npc.moan] at the feeling of being inseminated.";
		}
		@Override
		public String applyEffectsString() {
	...
	public static final SexAction STROKE_PUSSY = new SexAction(
		...
		@Override
		public String getActionTitle() {
			return "Погладить киску";
		}

		@Override
		public String getActionDescription() {
			return "Протяни руку между [npc2.namePos] [npc2.legs] и начни поглаживать [npc2.her] [npc2.pussy+].";
		}
		...
		public String getDescription() {
			if(!Main.sex.getCharacterTargetedForSexAction(this).isCoverableAreaExposed(CoverableArea.VAGINA)){
				...
				switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
					case DOM_GENTLE:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                "Reaching down between [npc2.namePos] [npc2.legs], [npc.name] trace [npc.her] [npc.fingers+] over [npc2.namePos] [npc2.topClothing(VAGINA)],"
                                        + " gently pushing down and letting out a soft [npc.moan] as [npc.she] rub [npc2.her] [npc2.lowClothing(VAGINA)] against [npc2.her] [npc2.pussy+].",

                                "With a soft [npc.moan], [npc.name] reach down between [npc2.namePos] [npc2.legs],"
                                        + " gently pushing [npc.her] [npc.fingers] down as [npc.she] rub [npc2.namePos] [npc2.lowClothing(VAGINA)] against [npc2.her] [npc2.pussy+].",

                                "Slowly teasing [npc.her] [npc.fingers+] between [npc2.namePos] [npc2.legs], [npc.name] gently press down,"
                                        + " rubbing [npc2.her] [npc2.lowClothing(VAGINA)] against [npc2.her] [npc2.pussy+] as [npc.she] let out a soft [npc.moan]."));
						break;
					case DOM_NORMAL:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                "Reaching down between [npc2.namePos] [npc2.legs], [npc.name] trace [npc.her] [npc.fingers+] over [npc2.namePos] [npc2.topClothing(VAGINA)],"
                                        + " eagerly pushing down and letting out [npc.a_moan+] as [npc.she] rub [npc2.her] [npc2.lowClothing(VAGINA)] against [npc2.her] [npc2.pussy+].",

                                "With [npc.a_moan+], [npc.name] reach down between [npc2.namePos] [npc2.legs],"
                                        + " eagerly pushing [npc.her] [npc.fingers] down as [npc.she] rub [npc2.namePos] [npc2.lowClothing(VAGINA)] against [npc2.her] [npc2.pussy+].",

                                "Eagerly teasing [npc.her] [npc.fingers+] between [npc2.namePos] [npc2.legs], [npc.name] start to press down,"
                                        + " rubbing [npc2.her] [npc2.lowClothing(VAGINA)] against [npc2.her] [npc2.pussy+] as [npc.she] let out [npc.a_moan+]."));
						break;
					case DOM_ROUGH:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                "Reaching down between [npc2.namePos] [npc2.legs], [npc.name] roughly press [npc.her] [npc.fingers+] against [npc2.namePos] [npc2.topClothing(VAGINA)],"
                                        + " forcefully pushing down and letting out [npc.a_moan+] as [npc.she] rapidly start rubbing [npc2.her] [npc2.lowClothing(VAGINA)] against [npc2.her] [npc2.pussy+].",

                                "With [npc.a_moan+], [npc.name] reach down between [npc2.namePos] [npc2.legs],"
                                        + " roughly pushing [npc.her] [npc.fingers] down as [npc.she] rapidly start rubbing [npc2.namePos] [npc2.lowClothing(VAGINA)] against [npc2.her] [npc2.pussy+].",

                                "Roughly teasing [npc.her] [npc.fingers+] between [npc2.namePos] [npc2.legs], [npc.name] start to press down,"
                                        + " rapidly rubbing [npc2.her] [npc2.lowClothing(VAGINA)] against [npc2.her] [npc2.pussy+] as [npc.she] let out [npc.a_moan+]."));
						break;
					case SUB_EAGER:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                "Reaching down between [npc2.namePos] [npc2.legs], [npc.name] trace [npc.her] [npc.fingers+] over [npc2.namePos] [npc2.topClothing(VAGINA)],"
					...
					case SUB_NORMAL:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                "Reaching down between [npc2.namePos] [npc2.legs], [npc.name] trace [npc.her] [npc.fingers+] over [npc2.namePos] [npc2.topClothing(VAGINA)],"
                                        + " pushing down and letting out [npc.a_moan+] as [npc.she] rub [npc2.her] [npc2.lowClothing(VAGINA)] against [npc2.her] [npc2.pussy+].",

                                "With [npc.a_moan+], [npc.name] reach down between [npc2.namePos] [npc2.legs],"
                                        + " pushing [npc.her] [npc.fingers] down as [npc.she] rub [npc2.namePos] [npc2.lowClothing(VAGINA)] against [npc2.her] [npc2.pussy+].",

                                "Teasing [npc.her] [npc.fingers+] between [npc2.namePos] [npc2.legs], [npc.name] press down,"
                                        + " rubbing [npc2.her] [npc2.lowClothing(VAGINA)] against [npc2.her] [npc2.pussy+] as [npc.she] let out [npc.a_moan+]."));
						break;
					default:
						break;
				...
				switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
					case DOM_GENTLE:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                "Reaching down between [npc2.namePos] [npc2.legs], [npc.name] trace [npc.her] [npc.fingers+] over [npc2.her] [npc2.pussy+],"
                                        + " letting out a soft [npc.moan] as [npc.she] start gently stroking [npc2.her] [npc2.labia+].",

                                "With a soft [npc.moan], [npc.name] reach down between [npc2.namePos] [npc2.legs],"
                                        + " gently pushing [npc.her] [npc.fingers] against [npc2.her] [npc2.labia+] as [npc.she] start stroking [npc2.her] [npc2.pussy+].",

                                "Slowly teasing [npc.her] [npc.fingers+] between [npc2.namePos] [npc2.legs], [npc.name] gently press down,"
                                        + " letting out a soft [npc.moan] as [npc.she] start stroking [npc2.her] [npc2.pussy+]."));
						break;
					case DOM_NORMAL:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                "Reaching down between [npc2.namePos] [npc2.legs], [npc.name] eagerly trace [npc.her] [npc.fingers+] over [npc2.her] [npc2.pussy+],"
                                        + " letting out [npc.a_moan+] as [npc.she] start greedily stroking [npc2.her] [npc2.labia+].",

                                "With [npc.a_moan+], [npc.name] reach down between [npc2.namePos] [npc2.legs],"
                                        + " eagerly pressing [npc.her] [npc.fingers] against [npc2.her] [npc2.labia+] as [npc.she] start stroking [npc2.her] [npc2.pussy+].",

                                "Teasing [npc.her] [npc.fingers+] between [npc2.namePos] [npc2.legs], [npc.name] eagerly press down,"
                                        + " letting out [npc.a_moan+] as [npc.she] start happily stroking [npc2.her] [npc2.pussy+]."));
						break;
					case DOM_ROUGH:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								"Reaching down between [npc2.namePos] [npc2.legs], [npc.name] roughly grinds [npc.her] [npc.fingers+] over [npc2.her] [npc2.pussy+],"
                                        + " letting out [npc.a_moan+] as [npc.she] start rapidly stroking [npc2.her] [npc2.labia+].",

                                "With [npc.a_moan+], [npc.name] reach down between [npc2.namePos] [npc2.legs],"
                                        + " greedily pressing [npc.her] [npc.fingers] against [npc2.her] [npc2.labia+] as [npc.she] start roughly rubbing [npc2.her] [npc2.pussy+].",

                                "Roughly pushing [npc.her] [npc.fingers+] between [npc2.namePos] [npc2.legs], [npc.name] roughly press down,"
                                        + " letting out [npc.a_moan+] as [npc.she] start greedily fondling [npc2.her] [npc2.pussy+]."));
						break;
					case SUB_EAGER:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                "Reaching down between [npc2.namePos] [npc2.legs], [npc.name] eagerly trace [npc.her] [npc.fingers+] over [npc2.her] [npc2.pussy+],"
					...
					case SUB_NORMAL:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                "Reaching down between [npc2.namePos] [npc2.legs], [npc.name] trace [npc.her] [npc.fingers+] over [npc2.her] [npc2.pussy+],"
                                        + " letting out [npc.a_moan+] as [npc.she] start stroking [npc2.her] [npc2.labia+].",

                                "With [npc.a_moan+], [npc.name] reach down between [npc2.namePos] [npc2.legs],"
                                        + " pressing [npc.her] [npc.fingers] against [npc2.her] [npc2.labia+] as [npc.she] start stroking [npc2.her] [npc2.pussy+].",

                                "Teasing [npc.her] [npc.fingers+] between [npc2.namePos] [npc2.legs], [npc.name] press down,"
                                        + " letting out [npc.a_moan+] as [npc.she] start stroking [npc2.her] [npc2.pussy+]."));
						break;
					default:
						break;
				}
	...
	public static final SexAction FINGERING_PROSTATE_MASSAGE = new SexAction(
		...
		@Override
		public String getActionDescription() {
			return "Согните свои [npc.fingers] внутри [npc2.namePos] [npc2.pussy+] и начните поглаживать [npc2.her] простату.";
		}
				...
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Gently pushing the palm of [npc.her] [npc.hand] in against [npc2.namePos] [npc2.labia+],"
                                    + " [npc.name] slide [npc.her] [npc.fingers] deep into [npc2.her] [npc2.pussy], before curling them up and starting to softly stroke and massage [npc2.her] prostate.",
                            "With a soft [npc.moan], [npc.name] gently slide [npc.her] [npc.fingers+] as deep as possible into [npc2.namePos] [npc2.pussy+],"
				...
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Roughly slamming the palm of [npc.her] [npc.hand] in against [npc2.namePos] [npc2.labia+],"
                                    + " [npc.name] force [npc.her] [npc.fingers] deep into [npc2.her] [npc2.pussy], before curling them up and starting to forcefully stroke and massage [npc2.her] prostate.",
                            "With [npc.a_moan+], [npc.name] violently slam [npc.her] [npc.fingers+] as deep as possible into [npc2.namePos] [npc2.pussy+],"
				...
				case SUB_NORMAL:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Pushing the palm of [npc.her] [npc.hand] in against [npc2.namePos] [npc2.labia+],"
                                    + " [npc.name] slide [npc.her] [npc.fingers] deep into [npc2.her] [npc2.pussy], before curling them up and starting to stroke and massage [npc2.her] prostate.",
                            "With [npc.a_moan+], [npc.name] push [npc.her] [npc.fingers+] as deep as possible into [npc2.namePos] [npc2.pussy+],"
				...
				default: // Normal dom and eager sub:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Eagerly pushing the palm of [npc.her] [npc.hand] in against [npc2.namePos] [npc2.labia+],"
                                    + " [npc.name] slide [npc.her] [npc.fingers] deep into [npc2.her] [npc2.pussy], before curling them up and starting to rapidly stroke and massage [npc2.her] prostate.",
                            "With [npc.a_moan+], [npc.name] desperately push [npc.her] [npc.fingers+] as deep as possible into [npc2.namePos] [npc2.pussy+],"
	...
	public static final SexAction FINGERING_START = new SexAction(
		...
		@Override
		public String getActionTitle() {
            return "Пальцевание [npc2.herHim]";
		}

		@Override
		public String getActionDescription() {
			return "Погрузите свои [npc.fingers] в [npc2.namePos] [npc2.pussy+] и начните трогать [npc2.herHim].";
		}
		...
		public String getDescription() {
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Slowly teasing [npc.her] [npc.fingers+] over [npc2.namePos] [npc2.labia+], [npc.name] let out a little [npc.moan] before slowly sinking [npc.her] digits into [npc2.her] [npc2.pussy+].",

                            "[npc.Name] press [npc.her] [npc.fingers+] down between [npc2.namePos] [npc2.legs+],"
                                    + " and with a slow, steady pressure, [npc.she] gently sink [npc.her] digits into [npc2.her] [npc2.pussy+]."));
					break;
				case DOM_NORMAL:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Eagerly teasing [npc.her] [npc.fingers+] over [npc2.namePos] [npc2.labia+], [npc.name] let out [npc.a_moan+] before greedily sinking [npc.her] digits into [npc2.her] [npc2.pussy+].",

                            "[npc.Name] eagerly press [npc.her] [npc.fingers+] down between [npc2.namePos] [npc2.legs+],"
                                    + " and with a determined thrust, [npc.she] greedily sink [npc.her] digits into [npc2.her] [npc2.pussy+]."));
					break;
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Roughly grinding [npc.her] [npc.fingers+] over [npc2.namePos] [npc2.labia+], [npc.name] let out [npc.a_moan+] before violently slamming [npc.her] digits deep into [npc2.her] [npc2.pussy+].",
				...
				case SUB_NORMAL:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Teasing [npc.her] [npc.fingers+] over [npc2.namePos] [npc2.labia+], [npc.name] let out [npc.a_moan+] before sinking [npc.her] digits into [npc2.her] [npc2.pussy+].",

                            "[npc.Name] press [npc.her] [npc.fingers+] down between [npc2.namePos] [npc2.legs+], and with a little push, [npc.she] sink [npc.her] digits into [npc2.her] [npc2.pussy+]."));
					break;
				default:
					break;
			}
	...
	public static final SexAction FINGERING_DOM_GENTLE = new SexAction(
		...
		@Override
		public String getActionTitle() {
			return "Нежное пальцевание";
		}

		@Override
		public String getActionDescription() {
			return "Аккуратно проведите пальцем по [npc2.namePos] [npc2.pussy+].";
		}
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                    "Gently sinking [npc.her] [npc.fingers+] into [npc2.namePos] [npc2.pussy+], [npc.name] curl [npc.her] digits up, softly stroking [npc2.her] vaginal walls as [npc.she] start slowly fingering [npc2.herHim].",

					"Slowly pushing [npc.her] [npc.hand] into [npc2.namePos] groin,"
                            + " [npc.name] gently slides [npc.her] [npc.fingers+] deep into [npc2.namePos] [npc2.pussy+], letting out a little [npc.moan] as [npc.she] start softly fingering [npc2.herHim].",

                    "Pressing [npc.her] [npc.hand] down between [npc2.namePos] [npc2.legs], [npc.name] let out a little [npc.moan] before gently sliding [npc.her] [npc.fingers+] deep into [npc2.her] [npc2.pussy+]."));
	...
	public static final SexAction FINGERING_DOM_NORMAL = new SexAction(
		...
		@Override
		public String getActionTitle() {
			return "Ласкание пальцами";
		}

		@Override
		public String getActionDescription() {
			return "Продолжайте ласкать пальцами [npc2.namePos] [npc2.pussy+].";
		}
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                    "Eagerly sinking [npc.her] [npc.fingers+] deep into [npc2.namePos] [npc2.pussy+], [npc.name] curl [npc.her] digits up,"
                            + " stroking [npc2.her] vaginal walls as [npc.she] start passionately fingering [npc2.herHim].",

                    "Firmly pushing [npc.her] [npc.hand] into [npc2.namePos] groin, [npc.name] eagerly slide [npc.her] [npc.fingers+] deep into [npc2.namePos] [npc2.pussy+],"
                            + " letting out [npc.a_moan+] as [npc.she] start rapidly fingering [npc2.herHim].",

					"Eagerly pressing [npc.her] [npc.hand] down between [npc2.namePos] [npc2.legs],"
                            + " [npc.name] let out [npc.a_moan+] before enthusiastically sliding [npc.her] [npc.fingers+] deep into [npc2.her] [npc2.pussy+]."));
	...
	public static final SexAction FINGERING_DOM_ROUGH = new SexAction(
		...
		@Override
		public String getActionTitle() {
			return "Грубое пальцевание";
		}

		@Override
		public String getActionDescription() {
			return "Грубо ласкать пальцами [npc2.namePos] [npc2.pussy+].";
		}
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                    "Greedily thrusting [npc.her] [npc.fingers+] deep into [npc2.namePos] [npc2.pussy+], [npc.name] curl [npc.her] digits up,"
                            + " roughly stroking [npc2.namePos] vaginal walls as [npc.she] start ruthlessly fingering [npc2.herHim].",

                    "Roughly slamming [npc.her] [npc.hand] into [npc2.namePos] groin, [npc.name] greedily pump [npc.her] [npc.fingers+] deep into [npc2.namePos] [npc2.pussy+],"
                            + " letting out [npc.a_moan+] as [npc.she] start violently fingering [npc2.herHim].",

					"Forcefully pressing [npc.her] [npc.hand] down between [npc2.namePos] [npc2.legs],"
                            + " [npc.name] let out [npc.a_moan+] before roughly slamming [npc.her] [npc.fingers+] deep into [npc2.her] [npc2.pussy+]."));
	...
	public static final SexAction FINGERING_SUB_NORMAL = new SexAction(
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                    "Sinking [npc.her] [npc.fingers+] into [npc2.namePos] [npc2.pussy+], [npc.name] curl [npc.her] digits up, stroking [npc2.her] vaginal walls as [npc.she] focus [npc.her] efforts on fingering [npc2.herHim].",

					"Pushing [npc.her] [npc.hand] into [npc2.namePos] groin, [npc.name] slides [npc.her] [npc.fingers+] deep into [npc2.her] [npc2.pussy+],"
                            + " letting out [npc.a_moan+] as [npc.she] start focusing [npc.her] efforts on fingering [npc2.herHim].",

                    "Pressing [npc.her] [npc.hand] down between [npc2.namePos] [npc2.legs], [npc.name] let out [npc.a_moan+] before sliding [npc.her] [npc.fingers+] deep into [npc2.her] [npc2.pussy+]."));
	...
	public static final SexAction FINGERING_SUB_EAGER = new SexAction(
		...
		@Override
		public String getActionTitle() {
			return "Жадное пальцевание";
		}

		@Override
		public String getActionDescription() {
			return "Жадно ласкать пальцами [npc2.namePos] [npc2.pussy+].";
		}
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                    "Eagerly sinking [npc.her] [npc.fingers+] deep into [npc2.namePos] [npc2.pussy+], [npc.name] curl [npc.her] digits up,"
                            + " stroking [npc2.namePos] vaginal walls as [npc.she] start passionately fingering [npc2.herHim].",
	...
	public static final SexAction FINGERING_SUB_RESIST = new SexAction(
		...
		@Override
		public String getActionTitle() {
			return "Сопрот. пальцеванию";
		}

		@Override
		public String getActionDescription() {
			return "Попробуй вытащить свои [npc.fingers] из [npc2.namePos] [npc2.vagin+].";
		}
				...
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "[npc.Name] feel tears starting to well up in [npc.namePos] [npc.eyes], and, unable to keep it in any longer,"
                                    + " [npc.a_sob+] bursts out from [npc.her] mouth as [npc.she] weakly try to pull [npc.her] [npc.fingers] out of [npc2.namePos] [npc2.vagina+].",

                            "[npc.A_sob+] bursts out from [npc.namePos] mouth as [npc.she] frantically try to pull [npc.her] [npc.fingers+] out of [npc2.namePos] [npc2.vagina+].",
	...
	public static final SexAction FINGERING_STOP = new SexAction(
		...
		@Override
		public String getActionTitle() {
			return "Прекратить пальцевание";
		}

		@Override
		public String getActionDescription() {
			return "Вытащите свои [npc.fingers] из [npc2.namePos] [npc2.pussy+] и прекратите ласкать [npc2.herHim].";
		}
		...
		public String getDescription() {
				...
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Roughly yanking [npc.her] [npc.fingers] out of [npc2.namePos] [npc2.pussy+],"
                                    + " [npc.name] give [npc2.her] [npc2.clit+] a cruel squeeze before taking [npc.her] [npc.hand] away from [npc2.her] groin.",
				...
				default:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Sliding [npc.her] [npc.fingers] out of [npc2.namePos] [npc2.pussy+],"
                                    + " [npc.name] give [npc2.her] [npc2.clit+] a little squeeze before taking [npc.her] [npc.hand] away from [npc2.her] groin.",

                            "Pushing deep inside of [npc2.name] one last time, [npc.name] then slide [npc.her] [npc.fingers] back out of [npc2.namePos] [npc2.pussy+], putting an end to [npc.her] fingering."));
					break;
			}
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(this))) {
				...
				default:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            " [npc2.Name] [npc2.verb(let)] out [npc2.a_moan+] as [npc.name] pull [npc.her] [npc.fingers+] out of [npc2.her] [npc2.pussy+].",
	...
	public static final SexAction FINGERED_START = new SexAction(
		...
		@Override
		public String getActionTitle() {
			return "Получить пальцевание";
		}

		@Override
		public String getActionDescription() {
			return "Заставь [npc2.name] начать ласкать твою [npc.pussy+].";
		}
		...
		public String getDescription() {
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Taking a gentle, but firm, grip on [npc2.namePos] [npc2.hand], [npc.name] slowly guide [npc2.her] [npc2.fingers] over [npc.her] [npc.labia+],"
									+ " letting out a little [npc.moan] before pushing [npc2.her] digits into [npc.her] [npc.pussy+].",

                            "Taking hold of [npc2.namePos] [npc2.hand], [npc.name] guide [npc2.her] [npc2.fingers] down between [npc.her] [npc.legs+], and with a slow, steady pressure,"
                                    + " [npc.name] gently push [npc2.her] digits into [npc.her] [npc.pussy+]."));
					break;
				case DOM_NORMAL:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "With a firm grip on [npc2.her] [npc2.hand], [npc.name] eagerly guide [npc2.namePos] [npc2.fingers] over [npc.her] [npc.labia+],"
									+ " letting out [npc.a_moan+] before greedily pushing [npc2.her] digits into [npc.her] [npc.pussy+].",

                            "Taking hold of [npc2.namePos] [npc2.hand], [npc.name] eagerly guide [npc2.her] [npc2.fingers] down between [npc.her] [npc.legs+],"
                                    + " and with a determined pressure, [npc.name] greedily push [npc2.her] digits into [npc.her] [npc.pussy+]."));
					break;
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "With a vice-like grip on [npc2.her] [npc2.hand], [npc.name] grind [npc2.namePos] [npc2.fingers] over [npc.her] [npc.labia+],"
									+ " letting out [npc.a_moan+] before roughly forcing [npc2.her] digits into [npc.her] [npc.pussy+].",

                            "Grabbing [npc2.namePos] [npc2.hand], [npc.name] forcefully push [npc2.her] [npc2.fingers] down between [npc.her] [npc.legs+],"
                                    + " and with a dominant, jerking motion, [npc.name] roughly stuff [npc2.her] digits into [npc.her] [npc.pussy+]."));
					break;
				case SUB_EAGER:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "With a firm grip on [npc2.her] [npc2.hand], [npc.name] eagerly guide [npc2.namePos] [npc2.fingers] over [npc.her] [npc.labia+],"
				...
				case SUB_NORMAL:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "With a firm grip on [npc2.her] [npc2.hand], [npc.name] guide [npc2.namePos] [npc2.fingers] over [npc.her] [npc.labia+],"
									+ " letting out [npc.a_moan+] before pushing [npc2.her] digits into [npc.her] [npc.pussy+].",

                            "Taking hold of [npc2.namePos] [npc2.hand], [npc.name] guide [npc2.her] [npc2.fingers] down between [npc.her] [npc.legs+],"
                                    + " and with a determined pressure, [npc.name] push [npc2.her] digits into [npc.her] [npc.pussy+]."));
					break;
				default:
					break;
			}
					...
					case SUB_RESISTING:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								...
								" With [npc2.a_sob+], [npc2.name] [npc2.verb(start)] struggling against [npc.namePos] tight grip on [npc2.her] [npc2.hand],"
                                        + " pleading for [npc.herHim] to stop as [npc.she] force [npc2.her] [npc2.fingers] deep into [npc.her] [npc.pussy+]."));
						break;
					default:
						break;
				}
	...
	public static final SexAction FINGERED_DOM_GENTLE = new SexAction(
		...
		@Override
		public String getActionTitle() {
			return "Нежно опальцеваться";
		}

		@Override
		public String getActionDescription() {
			return "Нежно наслаждайся [npc2.fingers+] [npc2.namePos] в твоей [npc.pussy+].";
		}
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
					"Gently pushing [npc.her] [npc.hips] out against [npc2.namePos] [npc2.hand],"
                            + " [npc.name] let out a soft [npc.moan] as [npc.she] help to sink [npc2.namePos] [npc2.fingers+] deep into [npc.her] [npc.pussy+].",

                    "With a soft [npc.moan], [npc.name] gently start gyrating [npc.her] [npc.hips] against [npc2.namePos] [npc2.hand],"
	...
	public static final SexAction FINGERED_DOM_NORMAL = new SexAction(
		...
		@Override
		public String getActionTitle() {
			return "Опальцеваться";
		}

		@Override
		public String getActionDescription() {
			return "Наслаждайся [npc2.fingers+] [npc2.namePos] в твоей [npc.pussy+].";
		}
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
					"Eagerly pushing [npc.her] [npc.hips] out against [npc2.namePos] [npc2.hand],"
                            + " [npc.name] let out [npc.a_moan+] as [npc.she] energetically help to sink [npc2.namePos] [npc2.fingers+] deep into [npc.her] [npc.pussy+].",

                    "With [npc.a_moan+], [npc.name] energetically start gyrating [npc.her] [npc.hips] against [npc2.namePos] [npc2.hand],"
							+ " forcing [npc2.her] [npc2.fingers+] ever deeper into [npc.her] [npc.pussy+].",
	...
	public static final SexAction FINGERED_DOM_ROUGH = new SexAction(
		...
		@Override
		public String getActionTitle() {
			return "Грубо опальцеваться";
		}

		@Override
		public String getActionDescription() {
            return "Грубо властно [npc2.fingers+] [npc2.namePos] глубоко внутрь твоей [npc.pussy+].";
		}
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
					"Violently slamming [npc.her] [npc.hips] out against [npc2.namePos] [npc2.hand],"
                            + " [npc.name] let out [npc.a_moan+] as [npc.she] roughly force [npc2.namePos] [npc2.fingers+] deep into [npc.her] [npc.pussy+].",

                    "With [npc.a_moan+], [npc.name] aggressively start gyrating [npc.her] [npc.hips] against [npc2.namePos] [npc2.hand],"
							+ " forcing [npc2.her] [npc2.fingers+] ever deeper into [npc.her] [npc.pussy+].",
	...
	public static final SexAction FINGERED_SUB_EAGER = new SexAction(
		...
		@Override
		public String getActionTitle() {
			return "Жадно опальцеваться";
		}

		@Override
		public String getActionDescription() {
			return "Жадно поднимай бедра навстречу [npc2.hand] [npc2.namePos], когда [npc2.she] ласкает твою [npc.pussy+].";
		}
	...
	public static final SexAction FINGERED_SUB_RESIST = new SexAction(
		...
		@Override
		public String getActionTitle() {
			return "Сопрот. опальцеванию";
		}

		@Override
		public String getActionDescription() {
			return "Попробуй вытащить [npc2.fingers] [npc2.namePos] из твоей [npc.pussy+].";
		}
		...
		public String getDescription() {
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(this))) {
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "[npc.Name] feel tears starting to well up in [npc.her] [npc.eyes],"
                                    + " and, unable to keep it in any longer, [npc.a_sob+] bursts out from [npc.namePos] mouth as [npc.she] weakly try to pull [npc2.namePos] [npc2.fingers] out of [npc.her] [npc.pussy+].",

                            "[npc.A_sob+] bursts out from [npc.namePos] mouth as [npc.she] frantically try to pull [npc.her] [npc.hips] back from [npc2.namePos] unwanted touch,"
				...
				case DOM_NORMAL:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "[npc.Name] feel tears starting to well up in [npc.her] [npc.eyes],"
                                    + " and, unable to keep it in any longer, [npc.a_sob+] bursts out from [npc.namePos] mouth as [npc.she] weakly try to pull [npc2.namePos] greedy [npc2.fingers] out of [npc.her] [npc.pussy+].",
				...
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "[npc.Name] feel tears starting to well up in [npc.her] [npc.eyes],"
                                    + " and, unable to keep it in any longer, [npc.a_sob+] bursts out from [npc.namePos] mouth as [npc.she] weakly try to pull [npc2.namePos] rough [npc2.fingers] out of [npc.her] [npc.pussy+].",
	...
	public static final SexAction FINGERED_STOP = new SexAction(
		...
		@Override
		public String getActionTitle() {
			return "Прекратить быть опальцованным";
		}

		@Override
		public String getActionDescription() {
			return "Заставь [npc2.name] вытащить [npc2.her] [npc2.fingers] из твоей [npc.pussy+].";
		}
		...
		public String getDescription() {
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Yanking [npc2.namePos] [npc2.fingers] out of [npc.her] [npc.pussy+], [npc.name] growl as [npc.she] command [npc2.herHim] to stop fingering [npc.herHim].",

                            "[npc.Name] lean into [npc2.name], inhaling [npc2.her] [npc2.scent+] before yanking [npc2.her] [npc2.fingers] out of [npc.her] [npc.pussy+]."));
					break;
				default:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Sliding [npc2.namePos] [npc2.fingers] out of [npc.her] [npc.pussy+], [npc.name] let out [npc.a_moan+] before telling [npc2.herHim] to stop fingering [npc.herHim].",

                            "[npc.Name] lean into [npc2.name], inhaling [npc2.her] [npc2.scent+] before sliding [npc2.her] [npc2.fingers] out of [npc.her] [npc.pussy+]."));
					break;
			}
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(this))) {
				...
				default:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            " [npc2.Name] [npc2.verb(let)] out [npc2.a_moan+] as [npc.name] stop [npc2.herHim] from stimulating [npc.her] [npc.pussy+].",
				...
				case SUB_RESISTING:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							...
							" [npc2.A_sob+] bursts out from between [npc2.namePos] [npc2.lips] as [npc2.she] weakly [npc2.verb(try)] to push [npc.name] away,"
                                    + " squirming and protesting as [npc.she] continue to finger [npc2.namePos] [npc2.pussy+].",

							" [npc2.Sobbing] in distress, [npc2.name] [npc2.verb(try)], in vain, to recoil away from [npc.namePos] touch,"
                                    + " struggling against [npc.herHim] as [npc.her] [npc.fingers+] continue sliding deep into [npc2.namePos] [npc2.pussy+]."));
					break;
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
				...
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							...
							" [npc2.A_moan+] bursts out from between [npc2.namePos] [npc2.lips+],"
                                    + " and, roughly grinding [npc2.her] [npc2.hips] against [npc.her] [npc.hand], [npc2.name] dominantly command [npc.name] to continue fingering [npc2.herHim].",
