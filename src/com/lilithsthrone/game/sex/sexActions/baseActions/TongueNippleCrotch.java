			...
			switch(Main.sex.getCharacterTargetedForSexAction(this).getNippleCrotchShape()) {
				case LIPS:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "[npc.Name] " + desc[0] + " lean in towards [npc2.namePos] [npc2.crotchBoobs+], before pressing [npc.her] [npc.lips+] against [npc2.her] lipples and " + desc[1] + " starting to make out with them.",
                            Util.capitaliseSentence(desc[0]) + " pressing [npc.her] [npc.lips+] against ones of [npc2.namePos] [npc2.crotchBoobs+], [npc.name] start " + desc[1] + " to making out with [npc2.her] lipples."));
				...
				case NORMAL:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "[npc.Name] " + desc[0] + " press [npc.her] [npc.lips+] against " + oneOfBoobsDescriptor + "[npc2.namePos] [npc2.crotchBoobs+], before starting to " + desc[1] + " suck and kiss [npc2.her] [npc2.crotchNipple+].",
                            Util.capitaliseSentence(desc[0]) + " pressing [npc.her] [npc.lips+] against [npc2.namePos] [npc2.crotchBoob], [npc.name] start " + desc[1] + " sucking and kissing [npc2.her] [npc2.crotchNipple+]."));

					if(Main.sex.getCharacterTargetedForSexAction(this).isBreastCrotchFuckableNipplePenetration()) {
                        UtilText.nodeContentSB.append(" [npc.Name] feel that the centre of [npc2.namePos] nipple opens up to reveal an orifice, allowing [npc.herHim] to thrust [npc.her] tongue into [npc2.her] [npc2.crotchBoob].");
					}
					break;
				case VAGINA:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "[npc.Name] " + desc[0] + " lean in towards [npc2.namePos] [npc2.crotchBoobs+], before pressing [npc.her] [npc.lips+] against one of [npc2.her] pussy-like nipples and " + desc[1] + " starting to kiss and lick it.",
                            Util.capitaliseSentence(desc[0]) + " pressing [npc.her] [npc.lips+] against " + oneOfBoobsDescriptor + "[npc2.namePos] [npc2.crotchBoobs], [npc.name] start " + desc[1] + " sucking and kissing [npc2.her] pussy-like nipple."));
			...
			switch(Main.sex.getCharacterTargetedForSexAction(this).getNippleCrotchShape()) {
				case LIPS:
					if(Main.sex.getCharacterTargetedForSexAction(this).getBreastCrotchRawStoredMilkValue()==0) {
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                ...
                                "Gently running the tip of [npc.her] [npc.tongue+] over [npc2.namePos] [npc2.crotchBoob+], [npc.name] home in on [npc2.her] lipple, before starting to slowly kiss and make out with it."));
						...
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                ...
                                "Gently running the tip of [npc.her] [npc.tongue+] over [npc2.namePos] [npc2.crotchBoob+], [npc.name] home in on [npc2.her] lipple,"
				...
				case NORMAL:
					if(Main.sex.getCharacterTargetedForSexAction(this).getBreastCrotchRawStoredMilkValue()==0) {
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								"Gently pressing [npc.her] [npc.lips+] against [npc2.namePos] [npc2.crotchBoob+],"
                                        + " [npc.name] suck и kiss [npc2.her] [npc2.crotchNipple+], letting out a muffled [npc.moan] as [npc.she] [npc.do] so.",
                                "With a muffled [npc.moan], [npc.name] focus on gently kissing and licking [npc2.namePos] [npc2.crotchNipple+].",
                                "Gently running the tip of [npc.her] [npc.tongue+] over [npc2.namePos] [npc2.crotchBoob+], [npc.name] home in on [npc2.her] [npc2.crotchNipple+], before starting to slowly lick and kiss it."));

					} else {
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								"Gently pressing [npc.her] [npc.lips+] against [npc2.namePos] [npc2.crotchBoob+],"
                                        + " [npc.name] suck и kiss [npc2.her] [npc2.crotchNipple+], letting out a muffled [npc.moan] as [npc.she] drink down the [npc2.milk] that flows forth.",
                                "With a muffled [npc.moan], [npc.name] focus on gently kissing and licking [npc2.namePos] [npc2.crotchNipple+], drinking down the [npc2.milk] that flows out in the process.",
                                "Gently running the tip of [npc.her] [npc.tongue+] over [npc2.namePos] [npc2.crotchBoob+], [npc.name] home in on [npc2.her] [npc2.crotchNipple+],"
				...
				case VAGINA:
					if(Main.sex.getCharacterTargetedForSexAction(this).getBreastCrotchRawStoredMilkValue()==0) {
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                ...
                                "Gently running the tip of [npc.her] [npc.tongue+] over [npc2.namePos] [npc2.crotchBoob+], [npc.name] home in on [npc2.her] nipple-cunt, before starting to slowly kiss and lick it."));
						...
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                ...
                                "With a muffled [npc.moan], [npc.name] focus on gently " + (Main.sex.getCharacterTargetedForSexAction(this).isBreastCrotchFuckableNipplePenetration() ? "eating out" : "kissing and licking")
									+" [npc2.namePos] pussy-like nipple-cunt, drinking down the [npc2.milk] that flows out in the process.",
                                "Gently running the tip of [npc.her] [npc.tongue+] over [npc2.namePos] [npc2.crotchBoob+], [npc.name] home in on [npc2.her] nipple-cunt,"
				...
				case LIPS:
					if(Main.sex.getCharacterTargetedForSexAction(this).getBreastCrotchRawStoredMilkValue()==0) {
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                ...
                                "Eagerly running the tip of [npc.her] [npc.tongue+] over [npc2.namePos] [npc2.crotchBoob+], [npc.name] home in on [npc2.her] lipple, before starting to desperately kiss and make out with it."));
						...
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                ...
                                "Eagerly running the tip of [npc.her] [npc.tongue+] over [npc2.namePos] [npc2.crotchBoob+], [npc.name] home in on [npc2.her] lipple,"
										+ " before starting to make out with it and drink down the [npc2.milk] which flows forth."));
					}
					break;
				case INVERTED:
				case NORMAL:
					if(Main.sex.getCharacterTargetedForSexAction(this).getBreastCrotchRawStoredMilkValue()==0) {
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								"Eagerly pressing [npc.her] [npc.lips+] against [npc2.namePos] [npc2.crotchBoob+],"
                                        + " [npc.name] suck и kiss [npc2.her] [npc2.crotchNipple+], letting out a muffled [npc.moan] as [npc.she] [npc.do] so.",
                                "With a muffled [npc.moan], [npc.name] focus on greedily kissing and licking [npc2.namePos] [npc2.crotchNipple+].",
                                "Eagerly running the tip of [npc.her] [npc.tongue+] over [npc2.namePos] [npc2.crotchBoob+], [npc.name] home in on [npc2.her] [npc2.crotchNipple+], before starting to desperately lick and kiss it."));

					} else {
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								"Eagerly pressing [npc.her] [npc.lips+] against [npc2.namePos] [npc2.crotchBoob+],"
                                        + " [npc.name] suck и kiss [npc2.her] [npc2.crotchNipple+], letting out a muffled [npc.moan] as [npc.she] drink down the [npc2.milk] that flows forth.",
                                "With a muffled [npc.moan], [npc.name] focus on greedily kissing and licking [npc2.namePos] [npc2.crotchNipple+], drinking down the [npc2.milk] that flows out in the process.",
                                "Eagerly running the tip of [npc.her] [npc.tongue+] over [npc2.namePos] [npc2.crotchBoob+], [npc.name] home in on [npc2.her] [npc2.crotchNipple+],"
										+ " before starting to suckle it and drink down the [npc2.milk] which flows out into [npc.her] mouth."));
					}
					break;
				case VAGINA:
					if(Main.sex.getCharacterTargetedForSexAction(this).getBreastCrotchRawStoredMilkValue()==0) {
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                ...
                                "With a muffled [npc.moan], [npc.name] focus on greedily "
										+(Main.sex.getCharacterTargetedForSexAction(this).isBreastCrotchFuckableNipplePenetration()?"eating out":"kissing and licking")+" [npc2.namePos] pussy-like nipple-cunt.",
                                "Eagerly running the tip of [npc.her] [npc.tongue+] over [npc2.namePos] [npc2.crotchBoob+], [npc.name] home in on [npc2.her] nipple-cunt, before starting to desperately kiss and lick it."));

					} else {
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								"Eagerly pressing [npc.her] [npc.lips+] against [npc2.namePos] [npc2.crotchBoob+],"
                                        + " [npc.name] kiss [npc2.her] pussy-like nipple-cunt, letting out a muffled [npc.moan] as [npc.she] drink down the [npc2.milk] that flows forth.",
                                "With a muffled [npc.moan], [npc.name] focus on greedily " + (Main.sex.getCharacterTargetedForSexAction(this).isBreastCrotchFuckableNipplePenetration() ? "eating out" : "kissing and licking")
										+" [npc2.namePos] pussy-like nipple-cunt, drinking down the [npc2.milk] that flows out in the process.",
                                "Eagerly running the tip of [npc.her] [npc.tongue+] over [npc2.namePos] [npc2.crotchBoob+], [npc.name] home in on [npc2.her] nipple-cunt,"
										+ " before starting to lick it and drink down the [npc2.milk] which flows forth."));
					}
					break;
			}
				...
				case LIPS:
					if(Main.sex.getCharacterTargetedForSexAction(this).getBreastCrotchRawStoredMilkValue()==0) {
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                ...
                                "Roughly running the tip of [npc.her] [npc.tongue+] over [npc2.namePos] [npc2.crotchBoob+], [npc.name] home in on [npc2.her] lipple, before starting to forcefully kiss and make out with it."));
						...
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                ...
                                "Roughly running the tip of [npc.her] [npc.tongue+] over [npc2.namePos] [npc2.crotchBoob+], [npc.name] home in on [npc2.her] lipple,"
										+ " before starting to make out with it and drink down the [npc2.milk] which flows forth."));
					}
					break;
				case INVERTED:
				case NORMAL:
					if(Main.sex.getCharacterTargetedForSexAction(this).getBreastCrotchRawStoredMilkValue()==0) {
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								"Roughly pressing [npc.her] [npc.lips+] against [npc2.namePos] [npc2.crotchBoob+],"
                                        + " [npc.name] suck и kiss [npc2.her] [npc2.crotchNipple+], letting out a muffled [npc.moan] as [npc.she] [npc.do] so.",
                                "With a muffled [npc.moan], [npc.name] focus on roughly kissing and licking [npc2.namePos] [npc2.crotchNipple+].",
                                "Roughly running the tip of [npc.her] [npc.tongue+] over [npc2.namePos] [npc2.crotchBoob+], [npc.name] home in on [npc2.her] [npc2.crotchNipple+], before starting to forcefully lick and kiss it."));

					} else {
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								"Roughly pressing [npc.her] [npc.lips+] against [npc2.namePos] [npc2.crotchBoob+],"
                                        + " [npc.name] suck и kiss [npc2.her] [npc2.crotchNipple+], letting out a muffled [npc.moan] as [npc.she] drink down the [npc2.milk] that flows forth.",
                                "With a muffled [npc.moan], [npc.name] focus on roughly kissing and licking [npc2.namePos] [npc2.crotchNipple+], drinking down the [npc2.milk] that flows out in the process.",
                                "Roughly running the tip of [npc.her] [npc.tongue+] over [npc2.namePos] [npc2.crotchBoob+], [npc.name] home in on [npc2.her] [npc2.crotchNipple+],"
										+ " before starting to suckle it and drink down the [npc2.milk] which flows out into [npc.her] mouth."));
					}
					break;
				case VAGINA:
					if(Main.sex.getCharacterTargetedForSexAction(this).getBreastCrotchRawStoredMilkValue()==0) {
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                ...
                                "With a muffled [npc.moan], [npc.name] focus on roughly "
										+(Main.sex.getCharacterTargetedForSexAction(this).isBreastCrotchFuckableNipplePenetration()?"eating out":"kissing and licking")+" [npc2.namePos] pussy-like nipple-cunt.",
                                "Roughly running the tip of [npc.her] [npc.tongue+] over [npc2.namePos] [npc2.crotchBoob+], [npc.name] home in on [npc2.her] nipple-cunt, before starting to forcefully kiss and lick it."));
						...
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                ...
                                "With a muffled [npc.moan], [npc.name] focus on roughly "
										...
										+" [npc2.namePos] pussy-like nipple-cunt, drinking down the [npc2.milk] that flows out in the process.",
                                "Roughly running the tip of [npc.her] [npc.tongue+] over [npc2.namePos] [npc2.crotchBoob+], [npc.name] home in on [npc2.her] nipple-cunt,"
										+ " before starting to lick it and drink down the [npc2.milk] which flows forth."));
					}
					break;
			}
	...
	public static final SexAction SUCKLE_SUB_RESISTING = new SexAction(
		...
		public String getDescription() {
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(this))) {
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "[npc.Name] try to pull [npc.her] [npc.face] back, but [npc2.name] [npc2.verb(continue)] gently pressing [npc2.her] [npc2.crotchNipple+] down against [npc.her] [npc.lips+],"
									+ " holding [npc.herHim] in place as [npc2.she] [npc2.verb(force)] [npc2.herself] on [npc.herHim].",
                            "With [npc.a_sob+], [npc.name] try to pull away from [npc2.name], but [npc2.she] quickly [npc2.verb(force)] [npc.her] [npc.lips] right back against [npc2.her] [npc2.crotchNipple+],"
									+ " gently grinding [npc2.herself] against [npc.herHim] as [npc2.she] [npc2.verb(ignore)] [npc.her] struggles.",
                            "Tears start to well up in [npc.namePos] [npc.eyes], and with [npc.a_sob+], [npc.she] try to pull [npc.her] mouth away from [npc2.namePos] [npc2.crotchBoobs+],"
				...
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "[npc.Name] try to pull [npc.her] [npc.face] back, but [npc2.name] roughly [npc2.verb(slam)] [npc2.her] [npc2.crotchNipple+] down against [npc.her] [npc.lips+],"
									+ " holding [npc.herHim] in place as [npc2.she] violently [npc2.verb(force)] [npc2.herself] on [npc.herHim].",
                            "With [npc.a_sob+], [npc.name] try to pull away from [npc2.name], but [npc2.she] violently [npc2.verb(force)] [npc.her] [npc.lips] right back against [npc2.her] [npc2.crotchNipple+],"
				...
				default: // DOM_NORMAL and in case anything goes wrong:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "[npc.Name] try to pull [npc.her] [npc.face] back, but [npc2.name] [npc2.verb(continue)] eagerly pressing [npc2.her] [npc2.crotchNipple+] down against [npc.her] [npc.lips+],"
									+ " holding [npc.herHim] in place as [npc2.she] [npc2.verb(force)] [npc2.herself] on [npc.herHim].",
                            "With [npc.a_sob+], [npc.name] try to pull away from [npc2.name], but [npc2.she] quickly [npc2.verb(force)] [npc.her] [npc.lips] right back against [npc2.her] [npc2.crotchNipple+],"
				...
				case LIPS:
					if(Main.sex.getCharacterTargetedForSexAction(this).getBreastCrotchRawStoredMilkValue()==0) {
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                ...
                                "Running the tip of [npc.her] [npc.tongue+] over [npc2.namePos] [npc2.crotchBoob+], [npc.name] home in on [npc2.her] lipple, before starting to desperately kiss and make out with it."));
						...
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                ...
                                "Running the tip of [npc.her] [npc.tongue+] over [npc2.namePos] [npc2.crotchBoob+], [npc.name] home in on [npc2.her] lipple,"
										+ " before starting to make out with it and drink down the [npc2.milk] which flows forth."));
					}
					break;
				case INVERTED:
				case NORMAL:
					if(Main.sex.getCharacterTargetedForSexAction(this).getBreastCrotchRawStoredMilkValue()==0) {
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								"Pressing [npc.her] [npc.lips+] against [npc2.namePos] [npc2.crotchBoob+],"
                                        + " [npc.name] suck и kiss [npc2.her] [npc2.crotchNipple+], letting out a muffled [npc.moan] as [npc.she] [npc.do] so.",
                                "With a muffled [npc.moan], [npc.name] focus on kissing and licking [npc2.namePos] [npc2.crotchNipple+].",
                                "Running the tip of [npc.her] [npc.tongue+] over [npc2.namePos] [npc2.crotchBoob+], [npc.name] home in on [npc2.her] [npc2.crotchNipple+], before starting to desperately lick and kiss it."));

					} else {
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								"Pressing [npc.her] [npc.lips+] against [npc2.namePos] [npc2.crotchBoob+],"
                                        + " [npc.name] suck и kiss [npc2.her] [npc2.crotchNipple+], letting out a muffled [npc.moan] as [npc.she] drink down the [npc2.milk] that flows forth.",
                                "With a muffled [npc.moan], [npc.name] focus on kissing and licking [npc2.namePos] [npc2.crotchNipple+], drinking down the [npc2.milk] that flows out in the process.",
                                "Running the tip of [npc.her] [npc.tongue+] over [npc2.namePos] [npc2.crotchBoob+], [npc.name] home in on [npc2.her] [npc2.crotchNipple+],"
										+ " before starting to suckle it and drink down the [npc2.milk] which flows out into [npc.her] mouth."));
					}
					break;
				case VAGINA:
					if(Main.sex.getCharacterTargetedForSexAction(this).getBreastCrotchRawStoredMilkValue()==0) {
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                ...
                                "With a muffled [npc.moan], [npc.name] focus on "
										+(Main.sex.getCharacterTargetedForSexAction(this).isBreastCrotchFuckableNipplePenetration()?"eating out":"kissing and licking")+" [npc2.namePos] pussy-like nipple-cunt.",
                                "Running the tip of [npc.her] [npc.tongue+] over [npc2.namePos] [npc2.crotchBoob+], [npc.name] home in on [npc2.her] nipple-cunt, before starting to desperately kiss and lick it."));

					} else {
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								"Pressing [npc.her] [npc.lips+] against [npc2.namePos] [npc2.crotchBoob+],"
                                        + " [npc.name] kiss [npc2.her] pussy-like nipple-cunt, letting out a muffled [npc.moan] as [npc.she] drink down the [npc2.milk] that flows forth.",
                                "With a muffled [npc.moan], [npc.name] focus on " + (Main.sex.getCharacterTargetedForSexAction(this).isBreastCrotchFuckableNipplePenetration() ? "eating out" : "kissing and licking")
									+" [npc2.namePos] pussy-like nipple-cunt, drinking down the [npc2.milk] that flows out in the process.",
                                "Running the tip of [npc.her] [npc.tongue+] over [npc2.namePos] [npc2.crotchBoob+], [npc.name] home in on [npc2.her] nipple-cunt,"
										+ " before starting to lick it and drink down the [npc2.milk] which flows forth."));
					}
					break;
			}
	...
	public static final SexAction SUCKLE_STOP = new SexAction(
		...
		public String getDescription() {
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "With one last rough lick, [npc.name] pull [npc.her] [npc.face] away from [npc2.namePos] [npc2.crotchNipple+].",
                            "Giving [npc2.namePos] [npc2.crotchNipple+] a final, rough kiss, [npc.name] pull [npc.her] [npc.face] away from [npc2.her] [npc2.crotchBoobs+]."));
					break;
				default:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "With one last lick, [npc.name] pull [npc.her] [npc.face] away from [npc2.namePos] [npc2.crotchNipple+].",
                            "Giving [npc2.namePos] [npc2.crotchNipple+] a final, wet kiss, [npc.name] pull [npc.her] [npc.face] away from [npc2.her] [npc2.crotchBoobs+]."));
					break;
			}
	...
	public static final SexAction BREASTFEED_START = new SexAction(
		...
		public String getDescription() {
			...
			switch(Main.sex.getCharacterPerformingAction().getNippleCrotchShape()) {
				case LIPS:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Taking hold of [npc2.namePos] head, [npc.name] " + desc[0] + " guide [npc2.her] [npc2.lips+] up to " + oneOfBoobsDescriptor + "[npc.her] [npc.crotchBoobs+],"
									+ " before "+desc[1]+" getting [npc2.herHim] to kiss and make out with [npc.her] lipple.",
                            "Taking hold of [npc2.namePos] head, [npc.name] " + desc[0] + " pull [npc2.herHim] into [npc.her] [npc.crotchBoobs+], before " + desc[1] + " getting [npc2.herHim] to kiss [npc.her] mouth-like lipple."));
				...
				case NORMAL:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Taking hold of [npc2.namePos] head, [npc.name] " + desc[0] + " guide [npc2.her] [npc2.lips+] up to " + oneOfBoobsDescriptor + "[npc.her] [npc.crotchBoobs+], before " + desc[1] + " getting [npc2.herHim] to suck and kiss [npc.her] [npc.crotchNipple+].",
                            "Taking hold of [npc2.namePos] head, [npc.name] " + desc[0] + " pull [npc2.herHim] into [npc.her] [npc.crotchBoobs+], before " + desc[1] + " getting [npc2.herHim] to suck and kiss [npc.her] [npc.crotchNipple+]."));
				...
				case VAGINA:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Taking hold of [npc2.namePos] head, [npc.name] " + desc[0] + " guide [npc2.her] [npc2.lips+] up to " + oneOfBoobsDescriptor + "[npc.her] [npc.crotchBoobs+], before " + desc[1] + " getting [npc2.herHim] to lick and kiss [npc.her] nipple-cunt.",
                            "Taking hold of [npc2.namePos] head, [npc.name] " + desc[0] + " pull [npc2.herHim] into [npc.her] [npc.crotchBoobs+], before " + desc[1] + " getting [npc2.herHim] to lick and kiss [npc.her] nipple-cunt."));
			...
			if(Main.sex.getCharacterPerformingAction().getBreastCrotchRawStoredMilkValue()>0) { // Milk:
				...
				switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(this))) {
					case DOM_GENTLE:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                " and, with a soft, muffled sigh, [npc2.she] [npc2.verb(bury)] [npc2.her] face in [npc.namePos] [npc.crotchBoobs+] и [npc2.verb(continue)] drinking [npc.her] [npc.milk].",
					...
					case SUB_NORMAL:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                " and, with a muffled, [npc2.moan+], [npc2.she] [npc2.verb(bury)] [npc2.her] face in [npc.namePos] [npc.crotchBoobs+] и [npc2.verb(continue)] drinking [npc.her] [npc.milk].",
					...
					case DOM_ROUGH:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                " and, with a muffled, [npc2.moan+], [npc2.she] roughly [npc2.verb(bury)] [npc2.her] face in [npc.namePos] [npc.crotchBoobs+] и [npc2.verb(continue)] greedily drinking [npc.her] [npc.milk].",
	...
	public static final SexAction BREASTFEED_DOM_GENTLE = new SexAction(
		...
		public String getDescription() {
			...
			switch(Main.sex.getCharacterPerformingAction().getNippleCrotchShape()) {
				...
				case NORMAL:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "[npc.Name] let out a soft [npc.moan] as [npc.she] gently push [npc.her] [npc.crotchNipple+] against [npc2.namePos] [npc2.lips+].",
                            "With [npc.a_moan+], [npc.name] gently press [npc.her] [npc.crotchNipple+] against [npc2.namePos] [npc2.lips+].",
                            "Letting out a soft [npc.moan], [npc.name] gently grind [npc.her] [npc.crotchNipple+] down against [npc2.namePos] [npc2.lips]."));
					break;
				case VAGINA:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
	...
	public static final SexAction BREASTFEED_DOM_NORMAL = new SexAction(
		...
		public String getDescription() {
			...
			switch(Main.sex.getCharacterPerformingAction().getNippleCrotchShape()) {
				...
				case NORMAL:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "[npc.Name] let out [npc.a_moan+] as [npc.she] eagerly push [npc.her] [npc.crotchNipple+] against [npc2.namePos] [npc2.lips+].",
                            "With [npc.a_moan+], [npc.name] eagerly press [npc.her] [npc.crotchNipple+] against [npc2.namePos] [npc2.lips+].",
                            "Letting out [npc.a_moan+], [npc.name] eagerly grind [npc.her] [npc.crotchNipple+] down against [npc2.namePos] [npc2.lips]."));
					break;
				case VAGINA:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
	...
	public static final SexAction BREASTFEED_DOM_ROUGH = new SexAction(
		...
		public String getDescription() {
			...
			switch(Main.sex.getCharacterPerformingAction().getNippleCrotchShape()) {
				...
				case NORMAL:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "[npc.Name] let out [npc.a_moan+] as [npc.she] roughly push [npc.her] [npc.crotchNipple+] against [npc2.namePos] [npc2.lips+].",
                            "With [npc.a_moan+], [npc.name] roughly press [npc.her] [npc.crotchNipple+] against [npc2.namePos] [npc2.lips+].",
                            "Letting out [npc.a_moan+], [npc.name] roughly grind [npc.her] [npc.crotchNipple+] down against [npc2.namePos] [npc2.lips]."));
					break;
				case VAGINA:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
	...
	public static final SexAction BREASTFEED_SUB_RESIST = new SexAction(
		...
		public String getDescription() {
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(this))) {
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "[npc.Name] desperately try to pull [npc.her] [npc.crotchBoobs] away from [npc2.namePos] [npc2.face],"
									+ " letting out [npc.a_sob+] as [npc2.name] gently [npc2.verb(slide)] [npc2.her] [npc2.tongue] over [npc.her] [npc.crotchNipple+].",
                            "Letting out [npc.a_sob+], [npc.name] desperately try to pull [npc.her] [npc.crotchBoobs+] away from [npc2.namePos] [npc2.lips+]."
                            ...
                            "With [npc.a_sob+], [npc.name] frantically try to pull [npc.her] [npc.crotchBoobs+] away from [npc2.namePos] [npc2.lips+], but [npc2.she] holds [npc.herHim] in place,"
				...
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            ...
                            "With [npc.a_sob+], [npc.name] frantically try to pull [npc.her] [npc.crotchBoobs+] away from [npc2.namePos] [npc2.lips+], but [npc2.she] firmly holds [npc.herHim] in place,"
	...
	public static final SexAction BREASTFEED_SUB_NORMAL = new SexAction(
		...
		public String getDescription() {
			...
			switch(Main.sex.getCharacterPerformingAction().getNippleCrotchShape()) {
				...
				case NORMAL:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "[npc.Name] let out [npc.a_moan+] as [npc.she] push [npc.her] [npc.crotchNipple+] against [npc2.namePos] [npc2.lips+].",
                            "With [npc.a_moan+], [npc.name] press [npc.her] [npc.crotchNipple+] against [npc2.namePos] [npc2.lips+].",
                            "Letting out [npc.a_moan+], [npc.name] grind [npc.her] [npc.crotchNipple+] down against [npc2.namePos] [npc2.lips]."));
					break;
				case VAGINA:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
	...
	public static final SexAction BREASTFEED_STOP = new SexAction(
		...
		public String getDescription() {
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Roughly yanking [npc2.namePos] head away from [npc.her] [npc.crotchBoobs+], [npc.name] order [npc2.herHim] to stop kissing [npc.her] [npc.crotchNipple].",
                            "Roughly grinding [npc.her] [npc.crotchNipple+] into [npc2.namePos] [npc2.face] one last time, [npc.name] then push [npc.herHim] away."));
					break;
				default:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Pulling [npc2.namePos] head away from [npc.her] [npc.crotchBoobs+], [npc.name] tell [npc2.herHim] to stop kissing [npc.her] [npc.crotchNipple].",
                            "Pressing [npc.her] [npc.crotchNipple+] into [npc2.namePos] [npc2.face] one last time, [npc.name] then push [npc.herHim] away."));
					break;
			}
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(action))) {
				...
				case SUB_RESISTING:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							...
							" [npc2.A_sob+] bursts out from between [npc2.namePos] [npc2.lips] as [npc2.she] weakly [npc2.verb(try)] to push [npc.name] away,"
                                    + " squirming and protesting as [npc.she] continue to force [npc.her] [npc.crotchNipple+] down against [npc2.her] [npc2.lips+].",
							" [npc2.Sobbing] in distress, [npc2.name] [npc2.verb(try)], in vain, to recoil away from [npc.namePos] [npc.crotchBoobs],"
                                    + " struggling against [npc.herHim] as [npc.she] continue to press [npc.her] [npc.crotchNipple+] against [npc2.her] [npc2.lips+]."));
					break;
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
