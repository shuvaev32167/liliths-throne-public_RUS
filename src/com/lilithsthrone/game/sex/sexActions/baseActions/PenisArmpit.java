...
public class PenisArmpit {
	...
	public static final SexAction ARMPIT_SEX_RECEIVING_START = new SexAction(
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                    "[npc.Eagerly(pulling)] [npc2.namePos] [npc2.arm(true)] up, [npc.name] press the [npc.cockHead+] of [npc.her] [npc.cock+] up against [npc2.her] now-exposed armpit,"
								+ " before [npc.eagerly] starting to rub [npc.her] [npc.cock+] up and down against it.",

                    "[npc.Name] pull [npc2.namePos] [npc2.arm(true)] up, before rubbing the [npc.cockHead+] of [npc.her] [npc.cock] up against [npc2.her] [npc2.armpit+]."));

			if(!isTargetedCharacterInanimate()) {
				switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(this))) {
					case SUB_RESISTING:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                " [npc2.Name] [npc2.verb(let)] out [npc2.a_sob+] as [npc.name] start using [npc2.her] [npc2.armpit],"
					...
					default:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                " [npc2.Name] [npc2.verb(let)] out [npc2.a_moan+] as [npc.name] start using [npc2.her] [npc2.armpit],"
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
					"Gently sliding [npc.her] [npc.cock+] up and down against [npc2.namePos] [npc2.armpit],"
                            + " [npc.name] start steadily bucking [npc.her] [npc.hips] back and forth, letting out a little [npc.moan] with every thrust as [npc.she] slowly fuck [npc2.her] [npc2.armpit+].",

					"Gently rubbing [npc.her] [npc.cock+] up and down against [npc2.namePos] [npc2.armpit],"
                            + " [npc.name] start softly thrusting [npc.her] [npc.hips] forwards, letting out a little [npc.moan] as [npc.she] gently fuck [npc2.her] [npc2.armpit+].",

                    "Softly pushing [npc.her] [npc.cock+] up against [npc2.namePos] [npc2.armpit], [npc.name] let out a little [npc.moan] as [npc.she] start to gently pump [npc.her] [npc.hips] back and forth,"
                            + " breathing in [npc2.her] [npc2.scent] as [npc.she] slowly fuck [npc2.her] [npc2.armpit+]."));
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
					"Eagerly pushing [npc.her] [npc.cock+] up and down against [npc2.namePos] [npc2.armpit],"
                            + " [npc.name] start energetically bucking [npc.her] [npc.hips] back and forth, letting out [npc.a_moan+] with every thrust as [npc.she] greedily fuck [npc2.her] [npc2.armpit+].",

					"Desperately pushing [npc.her] [npc.cock+] up and down against [npc2.namePos] [npc2.armpit],"
                            + " [npc.name] start frantically thrusting [npc.her] [npc.hips] forwards, letting out [npc.a_moan+] as [npc.she] greedily fuck [npc2.her] [npc2.armpit+].",

                    "Greedily pushing [npc.her] [npc.cock+] up against [npc2.namePos] [npc2.armpit], [npc.name] let out [npc.a_moan+] as [npc.she] start to desperately pump [npc.her] [npc.hips] back and forth,"
                            + " breathing in [npc2.her] [npc2.scent] as [npc.she] energetically fuck [npc2.her] [npc2.armpit+]."));
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
					"Roughly thrusting [npc.her] [npc.cock+] up and down against [npc2.namePos] [npc2.armpit],"
                            + " [npc.name] start dominantly pumping [npc.her] [npc.hips] back and forth, letting out [npc.a_moan+] with every thrust as [npc.she] forcefully fuck [npc2.her] [npc2.armpit+].",

					"Forcefully pushing [npc.her] [npc.cock+] up and down against [npc2.namePos] [npc2.armpit],"
                            + " [npc.name] start violently thrusting [npc.her] [npc.hips] forwards, letting out [npc.a_moan+] as [npc.she] roughly fuck [npc2.her] [npc2.armpit+].",

                    "Dominantly pushing [npc.her] [npc.cock+] up against [npc2.namePos] [npc2.armpit], [npc.name] let out [npc.a_moan+] as [npc.she] start to slam [npc.her] [npc.hips] back and forth,"
                            + " breathing in [npc2.her] [npc2.scent] as [npc.she] roughly fuck [npc2.her] [npc2.armpit+]."));
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
					"Pushing [npc.her] [npc.cock+] up and down against [npc2.namePos] [npc2.armpit],"
                            + " [npc.name] start bucking [npc.her] [npc.hips] back and forth, letting out [npc.a_moan+] with every thrust as [npc.she] greedily fuck [npc2.her] [npc2.armpit+].",

					"Pushing [npc.her] [npc.cock+] up and down against [npc2.namePos] [npc2.armpit],"
                            + " [npc.name] start thrusting [npc.her] [npc.hips] forwards, letting out [npc.a_moan+] as [npc.she] happily fuck [npc2.her] [npc2.armpit+].",

                    "Pushing [npc.her] [npc.cock+] up against [npc2.namePos] [npc2.armpit], [npc.name] let out [npc.a_moan+] as [npc.she] start to pump [npc.her] [npc.hips] back and forth,"
                            + " breathing in [npc2.her] [npc2.scent] as [npc.she] fuck [npc2.her] [npc2.armpit+]."));
				...
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Roughly yanking [npc.her] [npc.cock+] away from [npc2.namePos] [npc2.armpit+],"
                                    + " [npc.name] dominantly slide the [npc.cockHead] of [npc.her] [npc.cock] up and down against [npc2.her] [npc2.arm+(true)] one last time before pulling [npc.her] [npc.hips] back.",
	...
	public static final SexAction ARMPIT_SEX_GIVING_START = new SexAction(
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                    "With [npc.a_moan+], [npc.name] lift [npc.her] [npc.arm(true)] и [npc.eagerly] press [npc.her] [npc.armpit+] against [npc2.namePos] [npc2.cock+],"
							+ " before [npc.eagerly] rubbing it up and down against [npc2.her] [npc2.cockHead+].",

                    "Lifting up [npc.her] [npc.arm(true)], [npc.name] bring [npc.her] [npc.armpit+] down to [npc2.namePos] groin, before [npc.eagerly] pressing [npc.her] [npc.armpit+] against [npc2.her] [npc2.cock+]."));

			if(!isTargetedCharacterInanimate()) {
				switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(this))) {
					case SUB_RESISTING:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                " [npc2.Name] [npc2.verb(let)] out [npc2.a_sob+] as [npc.name] force [npc.her] [npc.armpit] against [npc2.her] [npc2.cock+],"
										+ " and struggling against [npc.herHim], [npc2.she] desperately [npc2.verb(try)] to pull away.",

                                " With [npc2.a_sob+], [npc2.name] [npc2.verb(struggle)] against [npc.name] as [npc.she] force [npc.her] [npc.armpit] against [npc2.her] [npc2.cock]."));
						break;
					default:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
	...
	public static final SexAction ARMPIT_SEX_GIVING_DOM_GENTLE = new SexAction(
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                    "[npc.Name] let out a soft [npc.moan] as [npc.she] gently slide [npc.her] [npc.armpit] up and down against [npc2.namePos] [npc2.cock+].",

                    "With a soft [npc.moan], [npc.name] gently start sliding [npc.her] [npc.armpit+] up and down against [npc2.namePos] [npc2.cock+].",

                    "Slowly pressing [npc.her] [npc.armpit+] against [npc2.namePos] [npc2.cock+], [npc.name] let out [npc.a_moan+] as [npc.she] get [npc2.herHim] to fuck it."));
	...
	public static final SexAction ARMPIT_SEX_GIVING_DOM_NORMAL = new SexAction(
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                    "[npc.Name] let out [npc.a_moan+] as [npc.she] eagerly slide [npc.her] [npc.armpit] up and down against [npc2.namePos] [npc2.cock+].",

                    "With [npc.a_moan+], [npc.name] happily start sliding [npc.her] [npc.armpit+] up and down against [npc2.namePos] [npc2.cock+].",

                    "Eagerly pressing [npc.her] [npc.armpit+] down against [npc2.namePos] [npc2.cock+], [npc.name] let out [npc.a_moan+] as [npc.she] get [npc2.herHim] to fuck it."));
	...
	public static final SexAction ARMPIT_SEX_GIVING_DOM_ROUGH = new SexAction(
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                    "[npc.Name] let out [npc.a_moan+] as [npc.she] roughly grind [npc.her] [npc.armpit] up and down against [npc2.namePos] [npc2.cock+].",
                    "With [npc.a_moan+], [npc.name] start forcefully sliding [npc.her] [npc.armpit+] up and down against [npc2.namePos] [npc2.cock+].",
                    "Roughly pressing [npc.her] [npc.armpit+] down against [npc2.namePos] [npc2.cock+], [npc.name] let out [npc.a_moan+] as [npc.she] get [npc2.herHim] to fuck it."));
	...
	public static final SexAction ARMPIT_SEX_GIVING_SUB_NORMAL = new SexAction(
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                    "[npc.Name] let out [npc.a_moan+] as [npc.she] slide [npc.her] [npc.armpit] up and down against [npc2.namePos] [npc2.cock+].",

                    "With [npc.a_moan+], [npc.name] happily start sliding [npc.her] [npc.armpit+] up and down against [npc2.namePos] [npc2.cock+].",

                    "Pressing [npc.her] [npc.armpit+] down against [npc2.namePos] [npc2.cock+], [npc.name] let out [npc.a_moan+] as [npc.she] get [npc2.herHim] to fuck it."));
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(this))) {
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            ...
                            "[npc.A_sob+] bursts out from [npc.namePos] mouth as [npc.she] frantically try to pull [npc.her] [npc.armpit] away from [npc2.namePos] [npc2.cock],"
	...
	public static final SexAction ARMPIT_SEX_GIVING_STOP = new SexAction(
		...
		public String getDescription() {
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Taking [npc.her] [npc.armpit] away from [npc2.namePos] [npc2.cock+], [npc.name] let out a menacing growl as [npc.she] command [npc2.herHim] to leave [npc.her] [npc.arm(true)] alone.",

                            "[npc.Name] lean into [npc2.name], inhaling [npc2.her] [npc2.scent] before quickly taking [npc.her] [npc.armpit] away from [npc2.her] [npc2.cock+]."));
					break;
				default:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Taking [npc.her] [npc.armpit] away from [npc2.namePos] [npc2.cock+], [npc.name] let out [npc.a_moan+] as [npc.she] tell [npc2.herHim] to leave [npc.her] [npc.arm(true)] alone.",

                            "[npc.Name] lean into [npc2.name], inhaling [npc2.her] [npc2.scent] before taking [npc.her] [npc.armpit] away from [npc2.her] [npc2.cock+]."));
					break;
			}
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(action))) {
				...
				case SUB_RESISTING:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							...
							" [npc2.A_sob+] bursts out from between [npc2.namePos] [npc2.lips] as [npc2.she] weakly [npc2.verb(try)] to push [npc.name] away,"
                                    + " squirming and protesting as [npc.name] continue to force [npc2.her] [npc2.cock+] in against [npc.her] [npc.armpit+].",
