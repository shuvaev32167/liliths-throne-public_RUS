			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Not wanting to ignore [npc2.namePos] other sexual organ, [npc.name] give [npc2.her] [npc2.pussy+] a gentle kiss,"
									+ " before pulling back and starting to slowly suck and kiss the [npc2.cockHead] of [npc2.her] [npc2.cock+].",

                            "Deciding to give [npc2.namePos] [npc2.cock] some attention, [npc.name] deliver a long, slow lick up the length of [npc2.her] [npc2.pussy+],"
									+ " before pulling back and starting to kiss and suck the [npc2.cockHead] of [npc2.her] [npc2.cock+].",

                            "Delivering a gentle kiss to [npc2.namePos] [npc2.pussy+], [npc.name] pull back,"
									+ " bringing [npc.her] [npc.lips+] up to the [npc2.cockHead] of [npc2.her] [npc2.cock+] before taking [npc2.herHim] into [npc.her] mouth."));
					break;
				case DOM_NORMAL:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Not wanting to ignore [npc2.namePos] other sexual organ, [npc.name] give [npc2.her] [npc2.pussy+] a wet kiss,"
									+ " before pulling back and starting to eagerly suck and kiss the [npc2.cockHead] of [npc2.her] [npc2.cock+].",

                            "Deciding to give [npc2.namePos] [npc2.cock] some attention, [npc.name] deliver a long, wet lick up the length of [npc2.her] [npc2.pussy+],"
									+ " before pulling back and starting to eagerly kiss and suck the [npc2.cockHead] of [npc2.her] [npc2.cock+].",

                            "Delivering a wet kiss to [npc2.namePos] [npc2.pussy+], [npc.name] pull back,"
				...
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Not wanting to ignore [npc2.namePos] other sexual organ, [npc.name] give [npc2.her] [npc2.pussy+] a rough kiss,"
									+ " before pulling back and starting to dominantly suck and kiss the [npc2.cockHead] of [npc2.her] [npc2.cock+].",

                            "Deciding to give [npc2.namePos] [npc2.cock] some attention, [npc.name] deliver a long, rough lick up the length of [npc2.her] [npc2.pussy+],"
									+ " before pulling back and starting to dominantly kiss and suck the [npc2.cockHead] of [npc2.her] [npc2.cock+].",

                            "Delivering a rough kiss to [npc2.namePos] [npc2.pussy+], [npc.name] pull back,"
				...
				case SUB_NORMAL:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Not wanting to ignore [npc2.namePos] other sexual organ, [npc.name] give [npc2.her] [npc2.pussy+] a kiss,"
									+ " before pulling back and starting to suck and kiss the [npc2.cockHead] of [npc2.her] [npc2.cock+].",

                            "Deciding to give [npc2.namePos] [npc2.cock] some attention, [npc.name] deliver a long lick up the length of [npc2.her] [npc2.pussy+],"
									+ " before pulling back and starting to kiss and suck the [npc2.cockHead] of [npc2.her] [npc2.cock+].",

                            "Delivering a kiss to [npc2.namePos] [npc2.pussy+], [npc.name] pull back,"
									+ " bringing [npc.her] [npc.lips+] up to the [npc2.cockHead] of [npc2.her] [npc2.cock+] before taking [npc2.herHim] into [npc.her] mouth."));
					break;
				default:
					break;
			...
			if(!isTargetedCharacterInanimate()) {
				switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(this))) {
					case DOM_GENTLE:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								" [npc2.Name] [npc2.verb(let)] out a soft [npc2.moan],"
                                        + " gently pushing [npc2.her] [npc2.cock] into [npc.namePos] mouth before [npc.she] decide to shift [npc.her] focus back to [npc2.her] [npc2.pussy+] once again.",
	
								" Gently thrusting [npc2.her] [npc2.cock] into [npc.namePos] mouth, [npc2.name] [npc2.verb(let)] out a soft [npc2.moan],"
                                        + " before [npc.she] decide to move back down to focusing on [npc2.her] [npc2.pussy+].",
	
								" Softly [npc2.moaning], [npc2.name] gently [npc2.verb(buck)] [npc2.her] [npc2.hips] into [npc.namePos] [npc.face] for a few moments,"
                                        + " before [npc.she] decide to shift [npc.her] oral attention back down to [npc2.her] [npc2.pussy+]."));
						break;
					case DOM_NORMAL:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								" [npc2.Name] [npc2.verb(let)] out [npc2.a_moan+],"
                                        + " eagerly pushing [npc2.her] [npc2.cock] into [npc.namePos] mouth before [npc.she] decide to shift [npc.her] focus back to [npc2.her] [npc2.pussy+] once again.",
					...
					case DOM_ROUGH:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								" [npc2.Name] [npc2.verb(let)] out [npc2.a_moan+],"
                                        + " roughly slamming [npc2.her] [npc2.cock] into [npc.namePos] mouth before [npc.she] decide to shift [npc.her] focus back to [npc2.her] [npc2.pussy+] once again.",
					...
					case SUB_NORMAL:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								" [npc2.Name] [npc2.verb(let)] out [npc2.a_moan+],"
                                        + " pushing [npc2.her] [npc2.cock] into [npc.namePos] mouth before [npc.she] decide to shift [npc.her] focus back to [npc2.her] [npc2.pussy+] once again.",

                                " Thrusting [npc2.her] [npc2.cock] into [npc.namePos] mouth, [npc2.name] [npc2.verb(let)] out [npc2.a_moan+], before [npc.she] decide to move back down to focusing on [npc2.her] [npc2.pussy+].",
					...
					case SUB_RESISTING:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								" [npc2.Sobbing] and squirming in discomfort, [npc2.name] desperately [npc2.verb(try)] to pull away from [npc.name],"
                                        + " begging to be left alone as [npc.she] shift [npc.her] attention back down to [npc2.her] [npc2.pussy+] once again.",

                                " With [npc2.a_sob+], [npc2.name] [npc2.verb(try)] to push [npc.name] away, squirming in discomfort as [npc.she] move back to focusing [npc.her] attention on [npc2.her] [npc2.pussy+].",

                                " With tears streaming down [npc2.her] [npc2.face], [npc2.name] [npc2.verb(let)] out [npc2.a_sob+] as [npc.name] move back down to focusing on [npc2.her] [npc2.pussy+]."));
						break;
					default:
						break;
				}
				...
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                        " After spending a few moments sucking [npc2.namePos] [npc2.cock+], [npc.name] shift [npc.her] attention back down to [npc2.her] [npc2.pussy+] once again.",
                        " After enjoying the taste of [npc2.namePos] [npc2.cock+] for a few moments, [npc.name] move back to focusing [npc.her] attention on [npc2.her] [npc2.pussy+]."));
			}
	...
	public static final SexAction TWINTAIL_PULL = new SexAction(
		...
		public String getDescription() {
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Taking hold of one of [npc2.namePos] " + style + " in each [npc.hand], [npc.name] gently pull [npc2.her] forwards, forcing [npc2.herHim] to push [npc2.her] [npc2.tongue+] deep into [npc.her] [npc.pussy].",
                            "Reaching down to take a gentle, but firm, grip on each of [npc2.namePos] " + style + ", [npc.name] slowly pull [npc2.her] into [npc2.her] groin,"
                                    + " letting out [npc.a_moan+] as [npc.she] force [npc2.herHim] to perform cunnilingus on [npc.herHim].",
				...
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Roughly grasping [npc2.namePos] " + style + " in each [npc.hand], [npc.name] violently jerk [npc2.her] head forwards, forcing [npc2.herHim] to push [npc2.her] [npc2.tongue+] deep into [npc.her] [npc.pussy].",
                            "Reaching down to grab [npc2.namePos] " + style + " in each fist, [npc.name] mercilessly yank [npc2.her] head into [npc2.her] groin,"
                                    + " letting out [npc.a_moan+] as [npc.she] force [npc2.herHim] to perform cunnilingus on [npc.herHim].",
				...
				default: // For dom normal, sub normal, and sub eager:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Taking hold of one of [npc2.namePos] " + style + " in each [npc.hand], [npc.name] firmly pull [npc2.her] head forwards, forcing [npc2.herHim] to push [npc2.her] [npc2.tongue+] deep into [npc.her] [npc.pussy].",
                            "Reaching down to take a firm grip on each of [npc2.namePos] " + style + ", [npc.name] steadily pull [npc2.her] into [npc2.her] groin,"
                                    + " letting out [npc.a_moan+] as [npc.she] force [npc2.herHim] to perform cunnilingus on [npc.herHim].",
                            "With [npc.a_moan+], [npc.name] reach down to take hold of [npc2.namePos] " + style + ","
			...
			if(!isTargetedCharacterInanimate()) {
				switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(this))) {
					case DOM_GENTLE:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                " Muffling [npc2.her] [npc2.moans+] into [npc.namePos] groin, [npc2.name] gently lick и kiss [npc.her] [npc.pussy+],"
                                        + " before eventually pulling back and [npc2.verb(gasp)] for air as [npc.name] momentarily release [npc.her] grip on [npc2.her] [npc2.hair(true)].",
								" Gently humming and [npc2.moaning] in delight, [npc2.name] [npc2.verb(use)] [npc2.her] [npc2.tongue] to lick and lap at [npc.namePos] [npc.pussy+],"
                                        + " obediently eating [npc.herHim] out until [npc.she] eventually release [npc.her] grip on [npc2.her] [npc2.hair(true)]."));
						break;
					case DOM_ROUGH:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
					...
					case SUB_RESISTING:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								" Scrunching [npc2.her] [npc2.eyes] shut, [npc2.name] [npc2.verb(beat)] against #IF(npc.isPlayer())your#ELSE[npc.her] tormentor's#ENDIF thighs in a futile gesture of resistance,"
                                        + " before finally being able to cry and gasp for air as [npc.name] momentarily release [npc.her] grip on [npc2.her] [npc2.hair(true)].",
					...
					default: // For dom normal, sub normal, and sub eager:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                " Muffling [npc2.her] [npc2.moans+] into [npc.namePos] groin, [npc2.name] eagerly lick и kiss [npc.her] [npc.pussy+],"
                                        + " before eventually pulling back and [npc2.verb(gasp)] for air as [npc.name] momentarily release [npc.her] grip on [npc2.her] [npc2.hair(true)].",
	...
	public static final SexAction EAR_PULL = new SexAction(
		...
		public String getDescription() {
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Taking hold of one of [npc2.namePos] [npc2.ears+] in each [npc.hand], [npc.name] gently pull [npc2.her] forwards, forcing [npc2.herHim] to push [npc2.her] [npc2.tongue+] deep into [npc.her] [npc.pussy].",
				...
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Roughly grasping [npc2.namePos] [npc2.ears+] in each [npc.hand], [npc.name] violently jerk [npc2.her] head forwards, forcing [npc2.herHim] to push [npc2.her] [npc2.tongue+] deep into [npc.her] [npc.pussy].",
                            "Reaching down to grab [npc2.namePos] [npc2.ears+] in each fist, [npc.name] mercilessly yank [npc2.her] head into [npc2.her] groin,"
                                    + " letting out [npc.a_moan+] as [npc.she] force [npc2.herHim] to perform cunnilingus on [npc.herHim].",
				...
				default: // For dom normal, sub normal, and sub eager:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Taking hold of one of [npc2.namePos] [npc2.ears+] in each [npc.hand], [npc.name] firmly pull [npc2.her] head forwards, forcing [npc2.herHim] to push [npc2.her] [npc2.tongue+] deep into [npc.her] [npc.pussy].",
			...
			if(!isTargetedCharacterInanimate()) {
				switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(this))) {
					case DOM_GENTLE:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                " Muffling [npc2.her] [npc2.moans+] into [npc.namePos] groin, [npc2.name] gently lick и kiss [npc.her] [npc.pussy+],"
                                        + " before eventually pulling back and [npc2.verb(gasp)] for air as [npc.name] momentarily release [npc.her] grip on [npc2.her] [npc2.ears].",
								" Gently humming and [npc2.moaning] in delight, [npc2.name] [npc2.verb(use)] [npc2.her] [npc2.tongue] to lick and lap at [npc.namePos] [npc.pussy+],"
                                        + " obediently eating [npc.herHim] out until [npc.she] eventually release [npc.her] grip on [npc2.her] [npc2.ears]."));
						break;
					case DOM_ROUGH:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								" Narrowing [npc2.her] [npc2.eyes], [npc2.name] [npc2.verb(put)] up with [npc.namePos] daring move for just a moment,"
					...
					case SUB_RESISTING:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								" Scrunching [npc2.her] [npc2.eyes] shut, [npc2.name] [npc2.verb(beat)] against #IF(npc.isPlayer())your#ELSE[npc.her] tormentor's#ENDIF thighs in a futile gesture of resistance,"
                                        + " before finally being able to cry and gasp for air as [npc.name] momentarily release [npc.her] grip on [npc2.her] [npc2.ears].",
								" The vibrations of [npc2.namePos] muffled cries and sobs only serve to give #IF(npc.isPlayer())you#ELSE[npc.her] tormentor#ENDIF some extra pleasure,"
										+ " but, after spending several seconds punching and pushing against [npc.namePos] thighs,"
	...
	public static final SexAction GRAB_HORNS = new SexAction(
		...
		public String getDescription() {
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Taking hold of one of [npc2.namePos] [npc2.horns+] in each [npc.hand], [npc.name] gently pull [npc2.her] forwards, forcing [npc2.herHim] to push [npc2.her] [npc2.tongue+] deep into [npc.her] [npc.pussy].",
				...
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Roughly grasping [npc2.namePos] [npc2.horns+] in each [npc.hand], [npc.name] violently jerk [npc2.her] head forwards, forcing [npc2.herHim] to push [npc2.her] [npc2.tongue+] deep into [npc.her] [npc.pussy].",
                            "Reaching down to grab [npc2.namePos] [npc2.horns+] in each fist, [npc.name] mercilessly yank [npc2.her] head into [npc2.her] groin,"
                                    + " letting out [npc.a_moan+] as [npc.she] force [npc2.herHim] to perform cunnilingus on [npc.herHim].",
				...
				default: // For dom normal, sub normal, and sub eager:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Taking hold of one of [npc2.namePos] [npc2.horns+] in each [npc.hand], [npc.name] firmly pull [npc2.her] head forwards, forcing [npc2.herHim] to push [npc2.her] [npc2.tongue+] deep into [npc.her] [npc.pussy].",
			...
			if(!isTargetedCharacterInanimate()) {
				switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(this))) {
					case DOM_GENTLE:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                " Muffling [npc2.her] [npc2.moans+] into [npc.namePos] groin, [npc2.name] gently lick и kiss [npc.her] [npc.pussy+],"
                                        + " before eventually pulling back and [npc2.verb(gasp)] for air as [npc.name] momentarily release [npc.her] grip on [npc2.her] [npc2.horns].",
								" Gently humming and [npc2.moaning] in delight, [npc2.name] [npc2.verb(use)] [npc2.her] [npc2.tongue] to lick and lap at [npc.namePos] [npc.pussy+],"
                                        + " obediently eating [npc.herHim] out until [npc.she] eventually release [npc.her] grip on [npc2.her] [npc2.horns]."));
						break;
					case DOM_ROUGH:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								" Narrowing [npc2.her] [npc2.eyes], [npc2.name] [npc2.verb(put)] up with [npc.namePos] daring move for just a moment,"
					...
					case SUB_RESISTING:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								" Scrunching [npc2.her] [npc2.eyes] shut, [npc2.name] [npc2.verb(beat)] against #IF(npc.isPlayer())your#ELSE[npc.her] tormentor's#ENDIF thighs in a futile gesture of resistance,"
                                        + " before finally being able to cry and gasp for air as [npc.name] momentarily release [npc.her] grip on [npc2.her] [npc2.horns].",
								" The vibrations of [npc2.namePos] muffled cries and sobs only serve to give #IF(npc.isPlayer())you#ELSE[npc.her] tormentor#ENDIF some extra pleasure,"
										+ " but, after spending several seconds punching and pushing against [npc.namePos] thighs,"
	...
	public static final SexAction GRAB_ANTENNAE = new SexAction(
		...
		public String getDescription() {
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Taking hold of one of [npc2.namePos] [npc2.antennae+] in each [npc.hand], [npc.name] gently pull [npc2.her] forwards, forcing [npc2.herHim] to push [npc2.her] [npc2.tongue+] deep into [npc.her] [npc.pussy].",
				...
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Roughly grasping [npc2.namePos] [npc2.antennae+] in each [npc.hand], [npc.name] violently jerk [npc2.her] head forwards, forcing [npc2.herHim] to push [npc2.her] [npc2.tongue+] deep into [npc.her] [npc.pussy].",
                            "Reaching down to grab [npc2.namePos] [npc2.antennae+] in each fist, [npc.name] mercilessly yank [npc2.her] head into [npc2.her] groin,"
                                    + " letting out [npc.a_moan+] as [npc.she] force [npc2.herHim] to perform cunnilingus on [npc.herHim].",
				...
				default: // For dom normal, sub normal, and sub eager:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Taking hold of one of [npc2.namePos] [npc2.antennae+] in each [npc.hand], [npc.name] firmly pull [npc2.her] head forwards, forcing [npc2.herHim] to push [npc2.her] [npc2.tongue+] deep into [npc.her] [npc.pussy].",
			...
			if(!isTargetedCharacterInanimate()) {
				switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(this))) {
					case DOM_GENTLE:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                " Muffling [npc2.her] [npc2.moans+] into [npc.namePos] groin, [npc2.name] gently lick и kiss [npc.her] [npc.pussy+],"
                                        + " before eventually pulling back and [npc2.verb(gasp)] for air as [npc.name] momentarily release [npc.her] grip on [npc2.her] [npc2.antennae].",
								" Gently humming and [npc2.moaning] in delight, [npc2.name] [npc2.verb(use)] [npc2.her] [npc2.tongue] to lick and lap at [npc.namePos] [npc.pussy+],"
                                        + " obediently eating [npc.herHim] out until [npc.she] eventually release [npc.her] grip on [npc2.her] [npc2.antennae]."));
						break;
					case DOM_ROUGH:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								" Narrowing [npc2.her] [npc2.eyes], [npc2.name] [npc2.verb(put)] up with [npc.namePos] daring move for just a moment,"
					...
					case SUB_RESISTING:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								" Scrunching [npc2.her] [npc2.eyes] shut, [npc2.name] [npc2.verb(beat)] against #IF(npc.isPlayer())your#ELSE[npc.her] tormentor's#ENDIF thighs in a futile gesture of resistance,"
                                        + " before finally being able to cry and gasp for air as [npc.name] momentarily release [npc.her] grip on [npc2.her] [npc2.antennae].",
								" The vibrations of [npc2.namePos] muffled cries and sobs only serve to give #IF(npc.isPlayer())you#ELSE[npc.her] tormentor#ENDIF some extra pleasure,"
										+ " but, after spending several seconds punching and pushing against [npc.namePos] thighs,"
	...
	public static final SexAction CUNNILINGUS_START = new SexAction(
		...
		public String getDescription() {
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Pressing [npc.her] [npc.lips+] against [npc2.namePos] [npc2.pussy], [npc.name] plant a series soft kisses on [npc2.her] [npc2.labia+],"
									+ " before slowly, but firmly, sliding [npc.her] [npc.tongue+] into [npc2.her] [npc2.pussy+].",

                            "Planting a series of soft kisses on [npc2.namePos] [npc2.labia+], [npc.name] give [npc2.her] [npc2.pussy+] a long, wet lick, before gently pushing [npc.her] [npc.tongue+] deep inside."));
					break;
				case DOM_NORMAL:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Eagerly pressing [npc.her] [npc.lips+] against [npc2.namePos] [npc2.pussy], [npc.name] plant a series of passionate kisses on [npc2.her] [npc2.labia+],"
									+ " before desperately sliding [npc.her] [npc.tongue+] into [npc2.her] [npc2.pussy+].",

                            "Planting a series of passionate kisses on [npc2.namePos] [npc2.labia+], [npc.name] give [npc2.her] [npc2.pussy+] a hungry lick, before greedily pushing [npc.her] [npc.tongue+] deep inside."));
					break;
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Roughly grinding [npc.her] [npc.lips+] against [npc2.namePos] [npc2.pussy], [npc.name] plant a series of forceful kisses on [npc2.her] [npc2.labia+],"
									+ " before greedily sliding [npc.her] [npc.tongue+] into [npc2.her] [npc2.pussy+].",

                            "Planting a series of forceful kisses on [npc2.namePos] [npc2.labia+], [npc.name] give [npc2.her] [npc2.pussy+] a rough lick, before greedily pushing [npc.her] [npc.tongue+] deep inside."));
					break;
				case SUB_EAGER:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Eagerly pressing [npc.her] [npc.lips+] against [npc2.namePos] [npc2.pussy], [npc.name] plant a series of passionate kisses on [npc2.her] [npc2.labia+],"
				...
				case SUB_NORMAL:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Pressing [npc.her] [npc.lips+] against [npc2.namePos] [npc2.pussy], [npc.name] plant a series of kisses on [npc2.her] [npc2.labia+], before sliding [npc.her] [npc.tongue+] into [npc2.her] [npc2.pussy+].",

                            "Planting a series of kisses on [npc2.namePos] [npc2.labia+], [npc.name] give [npc2.her] [npc2.pussy+] a wet lick, before pushing [npc.her] [npc.tongue+] deep inside."));
					break;
				default:
					break;
			}
		...
		public String getDescription() {
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(
							UtilText.parse(getCharactersForParsing(),
                                    "Wanting to join " + getOngoingNames() + " in orally servicing [npc2.namePos] [npc2.pussy+], [npc.name] move forwards beside " + (getOngoingCharacters().size() == 1 ? "[npc3.herHim]" : "them")
								+", before leaning in and delivering a gentle kiss to the side of [npc2.her] [npc2.labia+]."));
					break;
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(
							UtilText.parse(getCharactersForParsing(),
                                    "Wanting to join " + getOngoingNames() + " in orally servicing [npc2.namePos] [npc2.pussy+], [npc.name] elbow [npc.her] way in beside " + (getOngoingCharacters().size() == 1 ? "[npc3.herHim]" : "them")
				...
				default: // Dom normal and sub eager:
					UtilText.nodeContentSB.append(
							UtilText.parse(getCharactersForParsing(),
                                    "Wanting to join " + getOngoingNames() + " in orally servicing [npc2.namePos] [npc2.pussy+], [npc.name] eagerly move forwards beside " + (getOngoingCharacters().size() == 1 ? "[npc3.herHim]" : "them")
					...
					case SUB_RESISTING:
						UtilText.nodeContentSB.append(
								...
								" [npc2.Name] [npc2.verb(let)] out a distressed [npc2.moan] in response,"
                                        + " which only gets louder and more frantic as [npc.name] push " + getOngoingNames() + " aside in order to take the prime position in licking and kissing [npc2.her] [npc2.pussy+]."));
						break;
					default: // Dom normal and sub eager:
						UtilText.nodeContentSB.append(
								UtilText.parse(getCharactersForParsing(),
			...
			if(TongueVagina.getOngoingCharacters(Main.sex.getCharacterTargetedForSexAction(this)).size()>1 && !primary.equals(performer)) {
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
						"Leaning in alongside "+TongueVagina.getOngoingNames(target, performer)+","
                                + " [npc.name] press [npc.her] [npc.lips+] against an exposed part of [npc2.namePos] [npc2.labia+], before starting to gently kiss and lick [npc2.her] [npc2.pussy+].",
                        "With a soft [npc.moan], [npc.name] gently lean in alongside " + TongueVagina.getOngoingNames(target, performer) + ","
                                + " pressing [npc.her] [npc.lips+] against a free part of [npc2.namePos] [npc2.labia+] as [npc.she] kiss и nuzzle in against [npc2.herHim].",
						"With [npc.her] head positioned in close alongside "+TongueVagina.getOngoingNames(target, performer)
                                + ", [npc.name] gently kiss и lick any exposed part of [npc2.namePos] [npc2.labia+] that [npc.she] can find."));

			} else {
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
						"Gently driving [npc.her] [npc.tongue+] as deep as possible into [npc2.namePos] [npc2.pussy+],"
                                + " [npc.name] press [npc.her] [npc.lips+] up against [npc2.her] [npc2.labia+] и let out a muffled [npc.moan].",
                        "Withdrawing [npc.her] [npc.tongue+] from [npc2.namePos] [npc2.pussy+], [npc.name] start to gently kiss and lick [npc2.namePos] [npc2.labia+],"
								+ " before pressing forwards and slowly sliding [npc.her] [npc.tongue] into [npc2.her] [npc2.pussy+] once more.",
                        "Drawing [npc.her] [npc.tongue+] out from [npc2.namePos] [npc2.pussy+], [npc.name] start slowly kissing and nuzzling against [npc2.namePos] [npc2.labia+],"
	...
	public static final SexAction CUNNILINGUS_DOM_NORMAL = new SexAction(
		...
		public String getDescription() {
			...
			if(TongueVagina.getOngoingCharacters(Main.sex.getCharacterTargetedForSexAction(this)).size()>1 && !primary.equals(performer)) {
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
						"Leaning in alongside "+TongueVagina.getOngoingNames(target, performer)+","
                                + " [npc.name] hungrily press [npc.her] [npc.lips+] against an exposed part of [npc2.namePos] [npc2.labia+], before starting to eagerly kiss and lick [npc2.her] [npc2.pussy+].",
                        "With [npc.a_moan+], [npc.name] enthusiastically lean in alongside " + TongueVagina.getOngoingNames(target, performer) + ","
                                + " pressing [npc.her] [npc.lips+] against a free part of [npc2.namePos] [npc2.labia+] as [npc.she] eagerly kiss и nuzzle in against [npc2.herHim].",
						"With [npc.her] head positioned in close alongside "+TongueVagina.getOngoingNames(target, performer)
                                + ", [npc.name] hungrily kiss и lick any exposed part of [npc2.namePos] [npc2.labia+] that [npc.she] can find."));

			} else {
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
						"Eagerly driving [npc.her] [npc.tongue+] as deep as possible into [npc2.namePos] [npc2.pussy+],"
                                + " [npc.name] press [npc.her] [npc.lips+] up against [npc2.her] [npc2.labia+] и let out a muffled [npc.moan].",
                        "Withdrawing [npc.her] [npc.tongue+] from [npc2.namePos] [npc2.pussy+], [npc.name] start to eagerly kiss and lick [npc2.namePos] [npc2.labia+],"
								+ " before pressing forwards and greedily sliding [npc.her] [npc.tongue] into [npc2.her] [npc2.pussy+] once more.",
                        "Drawing [npc.her] [npc.tongue+] out from [npc2.namePos] [npc2.pussy+], [npc.name] start happily kissing and nuzzling against [npc2.namePos] [npc2.labia+],"
	...
	public static final SexAction CUNNILINGUS_DOM_ROUGH = new SexAction(
		...
		public String getDescription() {
			...
			if(TongueVagina.getOngoingCharacters(Main.sex.getCharacterTargetedForSexAction(this)).size()>1 && !primary.equals(performer)) {
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
						"Leaning in alongside "+TongueVagina.getOngoingNames(target, performer)+","
                                + " [npc.name] roughly press [npc.her] [npc.lips+] against an exposed part of [npc2.namePos] [npc2.labia+], before starting to forcefully kiss and lick [npc2.her] [npc2.pussy+].",
                        "With [npc.a_moan+], [npc.name] forcefully push in alongside " + TongueVagina.getOngoingNames(target, performer) + ","
                                + " pressing [npc.her] [npc.lips+] against a free part of [npc2.namePos] [npc2.labia+] as [npc.she] roughly kiss и nuzzle in against [npc2.herHim].",
						"With [npc.her] head positioned in close alongside "+TongueVagina.getOngoingNames(target, performer)
                                + ", [npc.name] roughly kiss и lick any exposed part of [npc2.namePos] [npc2.labia+] that [npc.she] can find."));

			} else {
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
						"Roughly thrusting [npc.her] [npc.tongue+] as deep as possible into [npc2.namePos] [npc2.pussy+],"
                                + " [npc.name] grind [npc.her] [npc.lips+] up against [npc2.her] [npc2.labia+] и let out a muffled [npc.moan].",
                        "Withdrawing [npc.her] [npc.tongue+] from [npc2.namePos] [npc2.pussy+], [npc.name] start to roughly kiss and lick [npc2.namePos] [npc2.labia+],"
								+ " before pressing forwards and violently thrusting [npc.her] [npc.tongue] into [npc2.her] [npc2.pussy+] once more.",
                        "Drawing [npc.her] [npc.tongue+] out from [npc2.namePos] [npc2.pussy+], [npc.name] start forcefully kissing and licking [npc2.namePos] [npc2.labia+],"
	...
	public static final SexAction CUNNILINGUS_SUB_RESISTING = new SexAction(
		...
		public String getDescription() {
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(this))) {
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "[npc.Name] try to pull [npc.her] [npc.face] back, but [npc2.name] [npc2.verb(continue)] gently pressing [npc2.her] [npc2.pussy+] down against [npc.her] [npc.lips+],"
									+ " holding [npc.herHim] in place as [npc2.she] [npc2.verb(force)] [npc2.herself] on [npc.herHim].",

                            "With [npc.a_sob+], [npc.name] try to pull away from [npc2.name], but [npc2.she] quickly [npc2.verb(force)] [npc.her] [npc.face] right back into [npc2.her] [npc2.pussy+],"
									+ " gently grinding [npc2.herself] against [npc.herHim] as [npc2.she] [npc2.verb(ignore)] [npc.her] struggles.",

                            "Tears start to well up in [npc.namePos] [npc.eyes], and with [npc.a_sob+], [npc.she] try to pull [npc.her] mouth away from [npc2.namePos] [npc2.pussy+],"
				...
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "[npc.Name] try to pull [npc.her] [npc.face] back, but [npc2.name] roughly [npc2.verb(slam)] [npc2.her] [npc2.pussy+] down against [npc.her] [npc.lips+],"
									+ " holding [npc.herHim] in place as [npc2.she] violently [npc2.verb(force)] [npc2.herself] on [npc.herHim].",

                            "With [npc.a_sob+], [npc.name] try to pull away from [npc2.name], but [npc2.she] violently [npc2.verb(force)] [npc.her] [npc.face] right back into [npc2.her] [npc2.pussy+],"
				...
				default: // DOM_NORMAL and in case anything goes wrong:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "[npc.Name] try to pull [npc.her] [npc.face] back, but [npc2.name] [npc2.verb(continue)] eagerly thrusting [npc2.her] [npc2.pussy+] down against [npc.her] [npc.lips+],"
									+ " holding [npc.herHim] in place as [npc2.she] [npc2.verb(force)] [npc2.herself] on [npc.herHim].",
	...
	public static final SexAction CUNNILINGUS_SUB_NORMAL = new SexAction(
		...
		public String getDescription() {
			...
			if(TongueVagina.getOngoingCharacters(Main.sex.getCharacterTargetedForSexAction(this)).size()>1 && !primary.equals(performer)) {
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
						"Leaning in alongside "+TongueVagina.getOngoingNames(target, performer)+","
                                + " [npc.name] press [npc.her] [npc.lips+] against an exposed part of [npc2.namePos] [npc2.labia+], before starting to kiss and lick [npc2.her] [npc2.pussy+].",
                        "With [npc.a_moan+], [npc.name] lean in alongside " + TongueVagina.getOngoingNames(target, performer) + ","
                                + " pressing [npc.her] [npc.lips+] against a free part of [npc2.namePos] [npc2.labia+] as [npc.she] kiss и nuzzle in against [npc2.herHim].",
						"With [npc.her] head positioned in close alongside "+TongueVagina.getOngoingNames(target, performer)
                                + ", [npc.name] kiss и lick any exposed part of [npc2.namePos] [npc2.labia+] that [npc.she] can find."));

			} else {
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
						"Driving [npc.her] [npc.tongue+] as deep as possible into [npc2.namePos] [npc2.pussy+],"
                                + " [npc.name] press [npc.her] [npc.lips+] up against [npc2.her] [npc2.labia+] и let out a muffled [npc.moan].",
                        "Withdrawing [npc.her] [npc.tongue+] from [npc2.namePos] [npc2.pussy+], [npc.name] start to kiss and lick [npc2.namePos] [npc2.labia+],"
								+ " before pressing forwards and sliding [npc.her] [npc.tongue] into [npc2.her] [npc2.pussy+] once more.",
                        "Drawing [npc.her] [npc.tongue+] out from [npc2.namePos] [npc2.pussy+], [npc.name] start kissing and nuzzling against [npc2.namePos] [npc2.labia+],"
	...
	public static final SexAction CUNNILINGUS_STOP = new SexAction(
		...
		public String getDescription() {
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "With one last rough lick, [npc.name] pull [npc.her] [npc.face] away from [npc2.namePos] [npc2.pussy+].",

                            "Giving [npc2.namePos] [npc2.labia+] a final, rough kiss, [npc.name] pull [npc.her] [npc.face] away from [npc2.her] [npc2.pussy+]."));
					break;
				default:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "With one last lick, [npc.name] pull [npc.her] [npc.face] away from [npc2.namePos] [npc2.pussy+].",

                            "Giving [npc2.namePos] [npc2.labia+] a final, wet kiss, [npc.name] pull [npc.her] [npc.face] away from [npc2.her] [npc2.pussy+]."));
					break;
			}
				...
				switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(this))) {
					...
					default:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                ...
                                " [npc2.A_moan+] drifts out from between [npc2.namePos] [npc2.lips+] as [npc.name] stop pleasuring [npc2.her] [npc2.pussy+], betraying [npc2.her] desire for more of [npc.namePos] attention."));
						break;
				}
			}
		...
		public String getDescription() {
				...
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Gently pressing [npc.her] [npc.labia+] down against [npc2.namePos] [npc2.face],"
                                    + " [npc.name] let out a soft [npc.moan] as [npc.she] start slowly grinding [npc.her] [npc.pussy+] down on [npc2.her] [npc2.lips+].",

							"Shifting [npc.her] [npc.hips] so that [npc2.namePos] [npc2.face] is forced into [npc.her] [npc.labia+],"
                                    + " [npc.Name] let out a soft [npc.moan] as [npc.she] start gently pressing [npc.her] [npc.pussy+] down against [npc2.her] [npc2.lips+]."));
					break;
				case DOM_NORMAL:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Eagerly pressing [npc.her] [npc.labia+] down against [npc2.namePos] [npc2.face],"
                                    + " [npc.name] let out [npc.a_moan+] as [npc.she] start frantically grinding [npc.her] [npc.pussy+] down on [npc2.her] [npc2.lips+].",

							"Shifting [npc.her] [npc.hips] so that [npc2.namePos] [npc2.face] is forced into [npc.her] [npc.labia+],"
                                    + " [npc.Name] let out [npc.a_moan+] as [npc.she] start eagerly pressing [npc.her] [npc.pussy+] down against [npc2.her] [npc2.lips+]."));
					break;
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Roughly slamming [npc.her] [npc.labia+] down against [npc2.namePos] [npc2.face],"
                                    + " [npc.name] let out [npc.a_moan+] as [npc.she] start forcefully grinding [npc.her] [npc.pussy+] down on [npc2.her] [npc2.lips+].",

							"Shifting [npc.her] [npc.hips] so that [npc2.namePos] [npc2.face] is forced into [npc.her] [npc.labia+],"
                                    + " [npc.Name] let out [npc.a_moan+] as [npc.she] start roughly grinding [npc.her] [npc.pussy+] down against [npc2.her] [npc2.lips+]."));
					break;
				case SUB_EAGER:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Eagerly pressing [npc.her] [npc.labia+] down against [npc2.namePos] [npc2.face],"
				...
				case SUB_NORMAL:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Pressing [npc.her] [npc.labia+] down against [npc2.namePos] [npc2.face],"
                                    + " [npc.name] let out [npc.a_moan+] as [npc.she] start grinding [npc.her] [npc.pussy+] down on [npc2.her] [npc2.lips+].",

							"Shifting [npc.her] [npc.hips] so that [npc2.namePos] [npc2.face] is forced into [npc.her] [npc.labia+],"
                                    + " [npc.Name] let out [npc.a_moan+] as [npc.she] start pressing [npc.her] [npc.pussy+] down against [npc2.her] [npc2.lips+]."));
					break;
				default:
					break;
			}
			...
			if(!isTargetedCharacterInanimate()) {
				switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(this))) {
					...
					case SUB_RESISTING:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                " Struggling in desperation, [npc2.name] [npc2.verb(let)] out [npc2.a_sob+] as [npc.name] force [npc.her] [npc.pussy+] down against [npc2.her] [npc2.lips+].",

                                " [npc2.Sobbing] and struggling in distress, [npc2.namePos] protests prove to be in vain as [npc.name] press [npc.her] [npc.labia+] down over [npc2.her] [npc2.face]."));
						break;
					default:
						break;
				}
		...
		public String getDescription() {
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(
							UtilText.parse(getCharactersForParsing(),
                                    "Not satisfied with having just " + getOngoingNames() + " eating [npc.herHim] out, [npc.name] get " + (getOngoingCharacters().size() == 1 ? "[npc3.herHim]" : "them") + " to pull back and temporarily move aside a little,"
				...
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(
							UtilText.parse(getCharactersForParsing(),
                                    "Not satisfied with having just " + getOngoingNames() + " eating [npc.herHim] out, [npc.name] push " + (getOngoingCharacters().size() == 1 ? "[npc3.herHim]" : "them")
                                            + " back and order " + (getOngoingCharacters().size() == 1 ? "[npc3.herHim]" : "them") + " to temporarily move aside,"
			...
			if(TongueVagina.getOngoingCharacters(Main.sex.getCharacterPerformingAction()).size()>1 && !primary.equals(target)) {
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Getting "+TongueVagina.getOngoingNames(Main.sex.getCharacterPerformingAction(), target)+" to move aside a little,"
                                    + " [npc.name] gently pull [npc2.namePos] head forwards until [npc2.her] [npc2.lips+] are pressed against [npc.her] [npc.labia+],"
							...
							"Gently instructing "+TongueVagina.getOngoingNames(Main.sex.getCharacterPerformingAction(), target)+" to let [npc2.name] take the lead,"
                                    + " [npc.name] slowly push [npc.her] [npc.hips] into [npc2.her] [npc2.face], letting out a soft [npc.moan] as [npc.she] get [npc2.herHim] to eat [npc.herHim] out.",
                        "After telling " + TongueVagina.getOngoingNames(Main.sex.getCharacterPerformingAction(), target) + " to make room for [npc2.name], [npc.name] gently buck [npc.her] [npc.hips+] into [npc2.her] [npc2.face],"
                                + " letting out a soft [npc.moan] as [npc.she] get [npc2.herHim] to orally service [npc.her] [npc.pussy+]."));

			} else {
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
						"Gently pressing [npc.her] [npc.labia+] down over [npc2.namePos] [npc2.face+],"
                                + " [npc.name] let out a soft [npc.moan] as [npc.she] firmly plant [npc.her] [npc.pussy+] down over [npc2.her] [npc2.lips+].",
                        "With a soft [npc.moan], [npc.name] press [npc.her] [npc.labia+] against [npc2.namePos] [npc2.face+], before gently grinding [npc.her] [npc.pussy+] against [npc2.her] [npc2.lips+].",
                        "Letting out a soft [npc.moan], [npc.name] gently grind [npc.her] [npc.pussy+] down against [npc2.namePos] [npc2.lips]."));
			}
	...
	public static final SexAction RECEIVING_CUNNILINGUS_DOM_NORMAL = new SexAction(
		...
		public String getDescription() {
			...
			if(TongueVagina.getOngoingCharacters(Main.sex.getCharacterPerformingAction()).size()>1 && !primary.equals(target)) {
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Getting "+TongueVagina.getOngoingNames(Main.sex.getCharacterPerformingAction(), target)+" to move aside a little,"
                                    + " [npc.name] eagerly pull [npc2.namePos] head forwards until [npc2.her] [npc2.lips+] are pressed against [npc.her] [npc.labia+],"
							...
							"Firmly instructing "+TongueVagina.getOngoingNames(Main.sex.getCharacterPerformingAction(), target)+" to let [npc2.name] take the lead,"
                                    + " [npc.name] eagerly push [npc.her] [npc.hips] into [npc2.her] [npc2.face], letting out [npc.a_moan+] as [npc.she] get [npc2.herHim] to eat [npc.herHim] out.",
                        "After telling " + TongueVagina.getOngoingNames(Main.sex.getCharacterPerformingAction(), target) + " to make room for [npc2.name], [npc.name] eagerly buck [npc.her] [npc.hips+] into [npc2.her] [npc2.face],"
                                + " letting out [npc.a_moan+] as [npc.she] get [npc2.herHim] to orally service [npc.her] [npc.pussy+]."));

			} else {
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
						"Eagerly pressing [npc.her] [npc.labia+] down over [npc2.namePos] [npc2.face+],"
                                + " [npc.name] let out [npc.a_moan+] as [npc.she] firmly plant [npc.her] [npc.pussy+] down over [npc2.her] [npc2.lips+].",
                        "With [npc.a_moan+], [npc.name] eagerly press [npc.her] [npc.labia+] against [npc2.namePos] [npc2.face+], before greedily grinding [npc.her] [npc.pussy+] against [npc2.her] [npc2.lips+].",
                        "Letting out [npc.a_moan+], [npc.name] eagerly grind [npc.her] [npc.pussy+] down against [npc2.namePos] [npc2.lips]."));
			}
			...
			if(TongueVagina.getOngoingCharacters(Main.sex.getCharacterPerformingAction()).size()>1 && !primary.equals(target)) {
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Ordering "+TongueVagina.getOngoingNames(Main.sex.getCharacterPerformingAction(), target)+" to move aside a little,"
                                    + " [npc.name] roughly pull [npc2.namePos] head forwards until [npc2.her] [npc2.lips+] are pressed against [npc.her] [npc.labia+],"
									+ " before letting out [npc.a_moan+] and forcefully grinding [npc.her] [npc.pussy+] into [npc2.her] [npc2.face].",
							"Firmly instructing "+TongueVagina.getOngoingNames(Main.sex.getCharacterPerformingAction(), target)+" to let [npc2.name] take the lead,"
                                    + " [npc.name] roughly push [npc.her] [npc.hips] into [npc2.her] [npc2.face], letting out [npc.a_moan+] as [npc.she] make [npc2.herHim] to eat [npc.herHim] out.",
                        "After telling " + TongueVagina.getOngoingNames(Main.sex.getCharacterPerformingAction(), target) + " to make room for [npc2.name], [npc.name] roughly buck [npc.her] [npc.hips+] into [npc2.her] [npc2.face],"
                                + " letting out [npc.a_moan+] as [npc.she] force [npc2.herHim] to orally service [npc.her] [npc.pussy+]."));

			} else {
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
						"Roughly pressing [npc.her] [npc.labia+] down over [npc2.namePos] [npc2.face+],"
                                + " [npc.name] let out [npc.a_moan+] as [npc.she] violently slam [npc.her] [npc.pussy+] down over [npc2.her] [npc2.lips+].",
                        "With [npc.a_moan+], [npc.name] roughly slam [npc.her] [npc.labia+] against [npc2.namePos] [npc2.face+], before forcefully grinding [npc.her] [npc.pussy+] against [npc2.her] [npc2.lips+].",
                        "Letting out [npc.a_moan+], [npc.name] roughly grind [npc.her] [npc.pussy+] down against [npc2.namePos] [npc2.lips]."));
			}
	...
	public static final SexAction RECEIVING_CUNNILINGUS_SUB_RESIST = new SexAction(
		...
		public String getDescription() {
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(this))) {
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "[npc.Name] desperately try to pull [npc.her] [npc.labia] away from [npc2.namePos] [npc2.face],"
									+ " letting out [npc.a_sob+] as [npc2.name] gently [npc2.verb(slide)] [npc2.her] [npc2.tongue] deep into [npc.her] [npc.pussy+].",

                            "Letting out [npc.a_sob+], [npc.name] desperately try to pull [npc.her] [npc.pussy+] away from [npc2.namePos] [npc2.lips+]."
                            ...
                            "With [npc.a_sob+], [npc.name] frantically try to pull [npc.her] [npc.labia+] away from [npc2.namePos] [npc2.lips+], but [npc2.she] holds [npc.herHim] in place,"
				...
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            ...
                            "With [npc.a_sob+], [npc.name] frantically try to pull [npc.her] [npc.labia+] away from [npc2.namePos] [npc2.lips+], but [npc2.she] firmly holds [npc.herHim] in place,"
	...
	public static final SexAction RECEIVING_CUNNILINGUS_SUB_NORMAL = new SexAction(
		...
		public String getDescription() {
			...
			if(TongueVagina.getOngoingCharacters(Main.sex.getCharacterPerformingAction()).size()>1 && !primary.equals(target)) {
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Getting "+TongueVagina.getOngoingNames(Main.sex.getCharacterPerformingAction(), target)+" to move aside a little,"
                                    + " [npc.name] pull [npc2.namePos] head forwards until [npc2.her] [npc2.lips+] are pressed against [npc.her] [npc.labia+],"
							...
							"Asking "+TongueVagina.getOngoingNames(Main.sex.getCharacterPerformingAction(), target)+" to let [npc2.name] take the lead,"
                                    + " [npc.name] push [npc.her] [npc.hips] into [npc2.her] [npc2.face], letting out [npc.a_moan+] as [npc.she] get [npc2.herHim] to eat [npc.herHim] out.",
                        "After asking " + TongueVagina.getOngoingNames(Main.sex.getCharacterPerformingAction(), target) + " to make room for [npc2.name], [npc.name] buck [npc.her] [npc.hips+] into [npc2.her] [npc2.face],"
                                + " letting out [npc.a_moan+] as [npc.she] get [npc2.herHim] to orally service [npc.her] [npc.pussy+]."));
				...
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
						"Pressing [npc.her] [npc.labia+] down over [npc2.namePos] [npc2.face+],"
                                + " [npc.name] let out [npc.a_moan+] as [npc.she] firmly plant [npc.her] [npc.pussy+] down over [npc2.her] [npc2.lips+].",
                        "With [npc.a_moan+], [npc.name] press [npc.her] [npc.labia+] against [npc2.namePos] [npc2.face+], before grinding [npc.her] [npc.pussy+] against [npc2.her] [npc2.lips+].",
                        "Letting out [npc.a_moan+], [npc.name] grind [npc.her] [npc.pussy+] down against [npc2.namePos] [npc2.lips]."));
			}
	...
	public static final SexAction RECEIVING_CUNNILINGUS_STOP = new SexAction(
		...
		public String getDescription() {
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Roughly yanking [npc2.namePos] head away from [npc.her] [npc.pussy+], [npc.name] order [npc2.herHim] to stop performing cunnilingus on [npc.herHim].",

                            "Roughly grinding [npc.her] [npc.pussy+] into [npc2.namePos] [npc2.face] one last time, [npc.name] then pull [npc.her] [npc.hips] away, putting an end to the ongoing cunnilingus."));
					break;
				default:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Pulling [npc2.namePos] head away from [npc.her] [npc.pussy+], [npc.name] tell [npc2.herHim] to stop performing cunnilingus on [npc.herHim].",

                            "Pressing [npc.her] [npc.pussy+] into [npc2.namePos] [npc2.face] one last time, [npc.name] then pull [npc.her] [npc.hips] away, putting an end to the ongoing cunnilingus."));
					break;
			}
				...
				case SUB_RESISTING:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							...
							" [npc2.A_sob+] bursts out from between [npc2.namePos] [npc2.lips] as [npc2.she] weakly [npc2.verb(try)] to push [npc.name] away,"
                                    + " squirming and protesting as [npc.she] continue to lick and kiss [npc2.her] [npc2.pussy+].",

							" [npc2.Sobbing] in distress, [npc2.name] [npc2.verb(try)], in vain, to recoil away from [npc.namePos] [npc.tongue],"
                                    + " struggling against [npc.herHim] as [npc.she] continue to orally service [npc2.her] [npc2.pussy+]."));
					break;
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(action))) {
				...
				case SUB_RESISTING:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							...
							" [npc2.A_sob+] bursts out from between [npc2.namePos] [npc2.lips] as [npc2.she] weakly [npc2.verb(try)] to push [npc.name] away,"
                                    + " squirming and protesting as [npc.she] continue to force [npc.her] [npc.labia+] down against [npc2.her] [npc2.face+].",

							" [npc2.Sobbing] in distress, [npc2.name] [npc2.verb(try)], in vain, to recoil away from [npc.namePos] [npc.labia],"
                                    + " struggling against [npc.herHim] as [npc.she] continue to press [npc.her] [npc.pussy+] against [npc2.her] [npc2.lips+]."));
					break;
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
