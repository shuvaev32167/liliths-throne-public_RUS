...
public class FingerPenis {
		...
		public String getDescription() {
			if(Main.sex.getSexPositionSlot(Main.sex.getCharacterPerformingAction()).hasTag(SexSlotTag.SIXTY_NINE)) {
				return UtilText.returnStringAtRandom(
                        "[npc.Name] prop [npc.herself] up on one [npc.arm], before using [npc.her] free [npc.hand] to stroke and squeeze [npc2.namePos] [npc2.balls+].",
                        "[npc.Name] let out [npc.a_moan+] as [npc.she] prop [npc.herself] up on one [npc.arm], before reaching down and starting to stroke and play with [npc2.namePos] [npc2.balls+].",
                        "Propping [npc.herself] up on one [npc.arm], [npc.name] run [npc.her] [npc.fingers+] over [npc2.namePos] groin, grinning as [npc.she] start to stroke and cup [npc2.namePos] [npc2.balls+].",
				...
				return UtilText.returnStringAtRandom(
                        "[npc.Name] reach between [npc2.namePos] [npc2.legs] with one [npc.hand] и start to stroke and squeeze [npc2.her] [npc2.balls+].",
                        "[npc2.Name] [npc2.verb(find)] [npc2.herself] letting out [npc2.a_moan+] as [npc.name] reach across with one [npc.hand] to start stroking and playing with [npc2.her] [npc2.balls+].",
                        "Running [npc.her] [npc.fingers+] over [npc2.namePos] [npc2.balls+], [npc.name] start to stroke and cup them, letting out [npc.a_moan+] as [npc2.namePos] [npc2.cock+] twitches in response.");
			}
		}
	};
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Reaching down between [npc2.namePos] [npc2.legs], [npc.name] wrap [npc.her] [npc.fingers] around [npc2.her] [npc2.cock+],"
                                    + " letting out a soft [npc.moan] as [npc.she] start slowly stroking up and down its length.",

                            "[npc.Name] drop one of [npc.her] [npc.hands] down between [npc2.namePos] [npc2.legs],"
                                    + " and, taking hold of [npc2.her] [npc2.cock+], [npc.she] start slowly jerking [npc2.herHim] off.",

                            "Teasing [npc.her] [npc.fingers] over [npc2.namePos] [npc2.cock+], [npc.name] let out a soft [npc.moan] as [npc.she] start gently stroking up and down its throbbing length."));
					break;
				case DOM_NORMAL:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Reaching down between [npc2.namePos] [npc2.legs], [npc.name] eagerly wrap [npc.her] [npc.fingers] around [npc2.her] [npc2.cock+],"
                                    + " letting out [npc.a_moan+] as [npc.she] start rapidly stroking up and down its length.",

                            "[npc.Name] drop one of [npc.her] [npc.hands] down between [npc2.namePos] [npc2.legs],"
                                    + " and, taking hold of [npc2.her] [npc2.cock+], [npc.she] start eagerly jerking [npc2.herHim] off.",

                            "Teasing [npc.her] [npc.fingers] over [npc2.namePos] [npc2.cock+], [npc.name] let out [npc.a_moan+] as [npc.she] start rapidly stroking up and down its throbbing length."));
					break;
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Reaching down between [npc2.namePos] [npc2.legs], [npc.name] forcefully wrap [npc.her] [npc.fingers] around [npc2.her] [npc2.cock+],"
                                    + " letting out [npc.a_moan+] as [npc.she] start frantically stroking up and down its length.",

                            "[npc.Name] drop one of [npc.her] [npc.hands] down between [npc2.namePos] [npc2.legs],"
                                    + " and, roughly taking hold of [npc2.her] [npc2.cock+], [npc.she] start forcefully jerking [npc2.herHim] off.",

                            "Forcefully wrapping [npc.her] [npc.fingers] around [npc2.namePos] [npc2.cock+], [npc.name] let out [npc.a_moan+] as [npc.she] start frantically stroking up and down its throbbing length."));
					break;
				case SUB_EAGER:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Reaching down between [npc2.namePos] [npc2.legs], [npc.name] eagerly wrap [npc.her] [npc.fingers] around [npc2.her] [npc2.cock+],"
				...
				case SUB_NORMAL:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Reaching down between [npc2.namePos] [npc2.legs], [npc.name] wrap [npc.her] [npc.fingers] around [npc2.her] [npc2.cock+],"
                                    + " letting out [npc.a_moan+] as [npc.she] start stroking up and down its length.",

                            "[npc.Name] drop one of [npc.her] [npc.hands] down between [npc2.namePos] [npc2.legs],"
                                    + " and, taking hold of [npc2.her] [npc2.cock+], [npc.she] start jerking [npc2.herHim] off.",

                            "Teasing [npc.her] [npc.fingers] over [npc2.namePos] [npc2.cock+], [npc.name] let out [npc.a_moan+] as [npc.she] start stroking up and down its throbbing length."));
					break;
				default:
					break;
			}
	...
	public static final SexAction COCK_MASTURBATING_DOM_GENTLE = new SexAction(
		...
		public String getDescription() {
			...
			if(isCharacterPrecumming(Main.sex.getCharacterTargetedForSexAction(this))) {
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                        "[npc.Name] gently slide [npc.her] [npc.hand] up and down around [npc2.namePos] [npc2.penisGirth] cock, spreading [npc2.her] [npc2.precum+] all over [npc2.her] shaft in the process.",

                        "Using [npc2.namePos] [npc2.precum+] as extra lubricant, [npc.name] gently wrap [npc.her] [npc.fingers+] around [npc2.her] [npc2.cock+] и jerk [npc2.herHim] off.",

                        "[npc.Name] let out a reassuring [npc.moan] as [npc.she] gently slide [npc.her] [npc.hand+] up and down the length of [npc2.namePos] [npc2.precum]-dripping [npc2.cock]."));

			} else {
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                        "Gently wrapping [npc.her] [npc.fingers+] around [npc2.namePos] [npc2.cock+], [npc.name] slowly start to slide [npc.her] [npc.hand] up and down [npc2.her] [npc2.penisGirth] shaft.",

                        "[npc.Name] gently wrap [npc.her] [npc.hand] around [npc2.namePos] [npc2.cock+],"
                                + " leaning forwards and inhaling [npc2.her] [npc2.scent+] as [npc.she] gently slide [npc.her] [npc.fingers+] up and down around [npc2.her] [npc2.penisGirth] length.",

                        "Gently pressing [npc.herself] against [npc2.name], [npc.name] let out [npc.a_moan+] as [npc.she] softly slide [npc.her] [npc.hand+] up and down the length of [npc2.namePos] [npc2.cock+]."));
			}
	...
	public static final SexAction COCK_MASTURBATING_DOM_NORMAL = new SexAction(
		...
		public String getDescription() {
			...
			if(isCharacterPrecumming(Main.sex.getCharacterTargetedForSexAction(this))) {
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                        "[npc.Name] eagerly slide [npc.her] [npc.hand] up and down around [npc2.namePos] [npc2.penisGirth] cock, spreading [npc2.her] [npc2.precum+] all over [npc2.her] shaft in the process.",

                        "Using [npc2.namePos] [npc2.precum+] as extra lubricant, [npc.name] enthusiastically wrap [npc.her] [npc.fingers+] around [npc2.her] [npc2.cock+] and eagerly jerk [npc2.herHim] off.",

                        "[npc.Name] let out [npc.a_moan+] as [npc.she] rapidly slide [npc.her] [npc.hand+] up and down the length of [npc2.namePos] [npc2.precum]-dripping [npc2.cock]."));

			} else {
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                        "Eagerly wrapping [npc.her] [npc.fingers+] around [npc2.namePos] [npc2.cock+], [npc.name] rapidly start to slide [npc.her] [npc.hand] up and down [npc2.her] [npc2.penisGirth] shaft.",

                        "[npc.Name] enthusiastically wrap [npc.her] [npc.hand] around [npc2.namePos] [npc2.cock+],"
                                + " leaning forwards and inhaling [npc2.her] [npc2.scent+] as [npc.she] eagerly slide [npc.her] [npc.fingers+] up and down around [npc2.her] [npc2.penisGirth] length.",

                        "Happily pressing [npc.herself] against [npc2.name], [npc.name] let out [npc.a_moan+] as [npc.she] rapidly slide [npc.her] [npc.hand+] up and down the length of [npc2.namePos] [npc2.cock+]."));
			}
	...
	public static final SexAction COCK_MASTURBATING_DOM_ROUGH = new SexAction(
		...
		public String getDescription() {
			...
			if(isCharacterPrecumming(Main.sex.getCharacterTargetedForSexAction(this))) {
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                        "[npc.Name] roughly pump [npc.her] [npc.hand] up and down around [npc2.namePos] [npc2.penisGirth] cock, spreading [npc2.her] [npc2.precum+] all over [npc2.her] shaft in the process.",

                        "Using [npc2.namePos] [npc2.precum+] as extra lubricant, [npc.name] forcefully wrap [npc.her] [npc.fingers+] around [npc2.her] [npc2.cock+] and aggressively jerk [npc2.herHim] off.",

                        "[npc.Name] let out [npc.a_moan+] as [npc.she] roughly pump [npc.her] [npc.hand+] up and down the length of [npc2.namePos] [npc2.precum]-dripping [npc2.cock]."));

			} else {
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                        "Forcefully gripping [npc.her] [npc.fingers+] around [npc2.namePos] [npc2.cock+], [npc.name] start to roughly pump [npc.her] [npc.hand] up and down the length of [npc2.her] [npc2.penisGirth] shaft.",

                        "[npc.Name] aggressively wrap [npc.her] [npc.hand] around [npc2.namePos] [npc2.cock+],"
                                + " leaning forwards and inhaling [npc2.her] [npc2.scent+] as [npc.she] roughly pump [npc.her] [npc.fingers+] up and down around [npc2.her] [npc2.penisGirth] length.",

                        "Roughly grinding [npc.herself] against [npc2.name], [npc.name] let out [npc.a_moan+] as [npc.she] aggressively pump [npc.her] [npc.hand+] up and down the length of [npc2.namePos] [npc2.cock+]."));
			}
	...
	public static final SexAction COCK_MASTURBATING_SUB_NORMAL = new SexAction(
		...
		public String getDescription() {
			...
			if(isCharacterPrecumming(Main.sex.getCharacterTargetedForSexAction(this))) {
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                        "[npc.Name] slide [npc.her] [npc.hand] up and down around [npc2.namePos] [npc2.penisGirth] cock, spreading [npc2.her] [npc2.precum+] all over [npc2.her] shaft in the process.",

                        "Using [npc2.namePos] [npc2.precum+] as extra lubricant, [npc.name] wrap [npc.her] [npc.fingers+] around [npc2.her] [npc2.cock+] и jerk [npc2.herHim] off.",

                        "[npc.Name] let out [npc.a_moan+] as [npc.she] slide [npc.her] [npc.hand+] up and down the length of [npc2.namePos] [npc2.precum]-dripping [npc2.cock]."));

			} else {
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                        "Wrapping [npc.her] [npc.fingers+] around [npc2.namePos] [npc2.cock+], [npc.name] start to slide [npc.her] [npc.hand] up and down [npc2.her] [npc2.penisGirth] shaft.",

                        "[npc.Name] wrap [npc.her] [npc.hand] around [npc2.namePos] [npc2.cock+],"
                                + " leaning forwards and inhaling [npc2.her] [npc2.scent+] as [npc.she] slide [npc.her] [npc.fingers+] up and down around [npc2.her] [npc2.penisGirth] length.",

                        "Pressing [npc.herself] against [npc2.name], [npc.name] let out [npc.a_moan+] as [npc.she] slide [npc.her] [npc.hand+] up and down the length of [npc2.namePos] [npc2.cock+]."));
			}
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                    "[npc.Name] feel tears starting to well up in [npc.namePos] [npc.eyes], and, unable to keep it in any longer,"
                            + " [npc.a_sob+] bursts out from [npc.her] mouth as [npc.she] weakly try to pull [npc.her] [npc.hand] away from [npc2.namePos] [npc2.cock+].",

                    "[npc.A_sob+] bursts out from [npc.namePos] mouth as [npc.she] frantically try to pull [npc.her] [npc.hand] away from [npc2.namePos] [npc2.cock+].",

                    "[npc.Name] [npc.sobsVerb] in distress as [npc.she] frantically try to pull [npc.her] [npc.hand] away from [npc2.namePos] [npc2.cock+]."));
	...
	public static final SexAction COCK_MASTURBATING_STOP = new SexAction(
		...
		public String getDescription() {
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Taking [npc.her] [npc.hand] away from [npc2.namePos] [npc2.cock+], [npc.name] give [npc2.her] [npc2.cockHead] one last rough squeeze as [npc.she] stops giving [npc2.herHim] a handjob.",

                            "[npc.Name] sharply inhale, breathing in [npc2.namePos] [npc2.scent+] before taking [npc.her] [npc.fingers] away from [npc2.her] [npc2.cock+]."));
					break;
				default:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Taking [npc.her] [npc.hand] away from [npc2.namePos] [npc2.cock+], [npc.name] give [npc2.her] [npc2.cockHead] one last stroke as [npc.she] stops giving [npc2.herHim] a handjob.",
	...
	public static final SexAction COCK_MASTURBATED_START = new SexAction(
		...
		public String getDescription() {
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Taking a gentle, but firm, grip on [npc2.namePos] [npc2.hand], [npc.name] slowly guide [npc2.her] [npc2.fingers] around [npc.her] [npc.cock+],"
									+ " letting out a little [npc.moan] before making [npc2.herHim] start giving [npc.herHim] a handjob.",

                            "Taking hold of [npc2.namePos] [npc2.hand], [npc.name] guide [npc2.her] [npc2.fingers] around [npc.her] [npc.cock+], and with a slow, steady pressure,"
                                    + " [npc.she] gently make [npc2.herHim] start giving [npc.herHim] a handjob."));
					break;
				case DOM_NORMAL:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "With a firm grip on [npc2.her] [npc2.hand], [npc.name] eagerly guide [npc2.namePos] [npc2.fingers] around [npc.her] [npc.cock+],"
									+ " letting out [npc.a_moan+] before greedily making [npc2.herHim] start giving [npc.herHim] a handjob.",

                            "Taking hold of [npc2.namePos] [npc2.hand], [npc.name] eagerly guide [npc2.her] [npc2.fingers] around [npc.her] [npc.cock+], and with a determined pressure,"
                                    + " [npc.she] greedily make [npc2.herHim] start giving [npc.herHim] a handjob."));
					break;
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "With a vice-like grip on [npc2.her] [npc2.hand], [npc.name] grind [npc2.namePos] [npc2.fingers] around [npc.her] [npc.cock+],"
									+ " letting out [npc.a_moan+] before roughly forcing [npc2.herHim] to start giving [npc.herHim] a handjob.",

                            "Grabbing [npc2.namePos] [npc2.hand], [npc.name] forcefully push [npc2.namePos] [npc2.fingers] around [npc.her] [npc.cock+], and with a dominant, jerking motion,"
                                    + " [npc.she] roughly force [npc2.herHim] start giving [npc.herHim] a handjob."));
					break;
				case SUB_EAGER:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "With a firm grip on [npc2.her] [npc2.hand], [npc.name] eagerly guide [npc2.namePos] [npc2.fingers] around [npc.her] [npc.cock+],"
                            ...
                            "Taking hold of [npc2.namePos] [npc2.hand], [npc.name] eagerly guide [npc2.namePos] [npc2.fingers] around [npc.her] [npc.cock+], and with a determined pressure,"
                                    + " [npc.she] greedily make [npc2.herHim] start giving [npc.herHim] a handjob."));
					break;
				case SUB_NORMAL:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "With a firm grip on [npc2.her] [npc2.hand], [npc.name] guide [npc2.namePos] [npc2.fingers] around [npc.her] [npc.cock+],"
									+ " letting out [npc.a_moan+] before making [npc2.herHim] start giving [npc.herHim] a handjob.",

                            "Taking hold of [npc2.namePos] [npc2.hand], [npc.name] guide [npc2.namePos] [npc2.fingers] around [npc.her] [npc.cock+], and with a determined pressure,"
                                    + " [npc.she] make [npc2.herHim] start giving [npc.herHim] a handjob."));
					break;
				default:
					break;
			}
			...
			if(!isTargetedCharacterInanimate()) {
				switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(this))) {
					...
					case SUB_RESISTING:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                " [npc2.Name] [npc2.verb(let)] out [npc2.a_sob+] as [npc.name] force [npc2.herHim] to perform a handjob,"
	...
	public static final SexAction COCK_MASTURBATED_DOM_GENTLE = new SexAction(
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                    "Gently pushing [npc.her] [npc.hips] out against [npc2.namePos] [npc2.hand], [npc.name] let out a soft [npc.moan] as [npc2.name] [npc2.verb(continue)] giving [npc.herHim] a handjob.",

                    "With a soft [npc.moan], [npc.name] gently start thrusting [npc.her] [npc.hips] out against [npc2.namePos] [npc2.hand], enjoying the handjob that [npc.sheIs] receiving.",
	...
	public static final SexAction COCK_MASTURBATED_DOM_NORMAL = new SexAction(
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                    "Eagerly pushing [npc.her] [npc.hips] out against [npc2.namePos] [npc2.hand], [npc.name] let out [npc.a_moan+] as [npc2.name] [npc2.verb(continue)] giving [npc.herHim] a handjob.",

                    "With [npc.a_moan+], [npc.name] enthusiastically start thrusting [npc.her] [npc.hips] out against [npc2.namePos] [npc2.hand], enjoying the handjob that [npc.sheIs] receiving.",
	...
	public static final SexAction COCK_MASTURBATED_DOM_ROUGH = new SexAction(
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                    "Violently slamming [npc.her] [npc.hips] out against [npc2.namePos] [npc2.hand], [npc.name] let out [npc.a_moan+] as [npc2.name] [npc2.verb(continue)] giving [npc.herHim] a handjob.",

                    "With [npc.a_moan+], [npc.name] aggressively start thrusting [npc.her] [npc.hips] out against [npc2.namePos] [npc2.hand], enjoying the handjob that [npc.sheIs] receiving.",
	...
	public static final SexAction COCK_MASTURBATED_SUB_NORMAL = new SexAction(
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                    "Pushing [npc.her] [npc.hips] out against [npc2.namePos] [npc2.hand], [npc.name] let out [npc.a_moan+] as [npc2.name] [npc2.verb(continue)] giving [npc.herHim] a handjob.",

                    "With [npc.a_moan+], [npc.name] start thrusting [npc.her] [npc.hips] out against [npc2.namePos] [npc2.hand], enjoying the handjob that [npc.sheIs] receiving.",
	...
	public static final SexAction COCK_MASTURBATED_SUB_RESIST = new SexAction(
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                    "[npc.Name] feel tears starting to well up in [npc.namePos] [npc.eyes], and, unable to keep it in any longer,"
                            + " [npc.a_sob+] bursts out from [npc.her] mouth as [npc.she] weakly try to pull [npc.her] [npc.hips] и [npc.cock] away from [npc2.namePos] [npc2.hand].",

                    "[npc.A_sob+] bursts out from [npc.namePos] mouth as [npc.she] frantically try to pull [npc.her] [npc.cock+] away from [npc2.namePos] [npc2.hand].",

                    "[npc.Name] [npc.sobsVerb] in distress as [npc.she] frantically try to pull [npc.her] [npc.cock+] away from [npc2.namePos] [npc2.hand]."));
	...
	public static final SexAction COCK_MASTURBATED_STOP = new SexAction(
		...
		public String getDescription() {
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Yanking [npc2.namePos] [npc2.fingers] away from [npc.her] [npc.cock+], [npc.name] growl at [npc2.name] as [npc.she] command [npc2.herHim] to stop with [npc2.her] handjob.",

                            "[npc.Name] lean into [npc2.name], inhaling [npc2.her] [npc2.scent] before yanking [npc2.her] [npc2.fingers] away from [npc.her] [npc.cock+]."));
					break;
				default:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Sliding [npc2.namePos] [npc2.fingers] away from [npc.her] [npc.cock+], [npc.name] let out [npc.a_moan+] before telling [npc2.herHim] to stop with [npc2.her] handjob.",

                            "[npc.Name] lean into [npc2.name], inhaling [npc2.her] [npc2.scent] before pushing [npc2.her] [npc2.hand] away from [npc.her] [npc.cock+]."));
					break;
			}
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(this))) {
				...
				default:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            " [npc2.Name] [npc2.verb(let)] out [npc2.a_moan+] as [npc.name] stop [npc2.herHim] from touching [npc.her] [npc.cock+].",
				...
				case SUB_RESISTING:
					return (UtilText.returnStringAtRandom(
							...
							" [npc2.A_sob+] bursts out from between [npc2.namePos] [npc2.lips],"
                                    + " before [npc2.she] [npc2.verb(start)] weakly trying to push [npc.name] away, squirming and protesting as [npc.name] continue to give [npc2.herHim] a handjob.",

							" [npc2.Sobbing] in distress, [npc2.name] [npc2.verb(try)], in vain,"
                                    + " to pull [npc2.her] [npc2.hips] away from [npc.namePos] touch, struggling against [npc.herHim] as [npc.she] continue giving [npc2.herHim] an unwanted handjob."));
				case DOM_GENTLE:
					return (UtilText.returnStringAtRandom(
