...
public class PenisSpinneret {
			...
			if(!getOngoingCharacters(Main.sex.getCharacterTargetedForSexAction(this)).isEmpty()) {
				switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
					case DOM_GENTLE:
						UtilText.nodeContentSB.append(UtilText.parse(Util.newArrayListOfValues(Main.sex.getCharacterPerformingAction(), Main.sex.getCharacterTargetedForSexAction(this), getPrimaryDPPerformer(Main.sex.getCharacterTargetedForSexAction(this))),
								...
								"Not deterred by the fact that [npc3.namePos] [npc3.cock] is already deep in [npc2.namePos] [npc2.spinneret+],"
                                        + " [npc.name] start slowly teasing the [npc.cockTip+] of [npc.her] own [npc.cock+] up against [npc2.her] orifice, threatening to start double-penetrating [npc.herHim] at any moment.",
                                        "With a soft [npc.moan], [npc.name] gently guide the [npc.cockTip+] of [npc.her] [npc.cock] over the exposed parts of [npc2.namePos] spinneret,"
								...
								"Gently sliding the [npc.cockTip+] of [npc.her] [npc.cock] up and down over the exposed parts of [npc2.namePos] [npc2.spinneret+],"
                                        + " [npc.name] let out [npc.a_moan+] as [npc.she] signal that [npc.she] might join [npc3.name] in some double-penetration.")));
						break;
					case DOM_ROUGH:
						UtilText.nodeContentSB.append(UtilText.parse(Util.newArrayListOfValues(Main.sex.getCharacterPerformingAction(), Main.sex.getCharacterTargetedForSexAction(this), getPrimaryDPPerformer(Main.sex.getCharacterTargetedForSexAction(this))),
								UtilText.returnStringAtRandom(
								"Not deterred by the fact that [npc3.namePos] [npc3.cock] is already deep in [npc2.namePos] [npc2.spinneret+],"
                                        + " [npc.name] start roughly grinding the [npc.cockTip+] of [npc.her] own [npc.cock+] up against [npc2.her] web-spinning orifice, threatening to start double-penetrating [npc.herHim] at any moment.",
                                        "With [npc.a_moan+], [npc.name] forcefully rub the [npc.cockTip+] of [npc.her] [npc.cock] over the exposed parts of [npc2.namePos] [npc2.spinneret+],"
										+ " indicating that [npc.she] might join [npc3.name] and start double-penetrating [npc2.her] web-spinning orifice.",
					...
					case SUB_NORMAL:
						UtilText.nodeContentSB.append(UtilText.parse(Util.newArrayListOfValues(Main.sex.getCharacterPerformingAction(), Main.sex.getCharacterTargetedForSexAction(this), getPrimaryDPPerformer(Main.sex.getCharacterTargetedForSexAction(this))),
								UtilText.returnStringAtRandom(
								"Not deterred by the fact that [npc3.namePos] [npc3.cock] is already deep in [npc2.namePos] [npc2.spinneret+],"
                                        + " [npc.name] start grinding the [npc.cockTip+] of [npc.her] own [npc.cock+] up against [npc2.her] web-spinning orifice, threatening to start double-penetrating [npc.herHim] at any moment.",
                                        "With [npc.a_moan+], [npc.name] rub the [npc.cockTip+] of [npc.her] [npc.cock] over the exposed parts of [npc2.namePos] [npc2.spinneret+],"
										+ " indicating that [npc.she] might join [npc3.name] and start double-penetrating [npc2.her] web-spinning orifice.",
					...
					default:
						UtilText.nodeContentSB.append(UtilText.parse(Util.newArrayListOfValues(Main.sex.getCharacterPerformingAction(), Main.sex.getCharacterTargetedForSexAction(this), getPrimaryDPPerformer(Main.sex.getCharacterTargetedForSexAction(this))),
								UtilText.returnStringAtRandom(
								"Not deterred by the fact that [npc3.namePos] [npc3.cock] is already deep in [npc2.namePos] [npc2.spinneret+],"
                                        + " [npc.name] start eagerly grinding the [npc.cockTip+] of [npc.her] own [npc.cock+] up against [npc2.her] web-spinning orifice, threatening to start double-penetrating [npc.herHim] at any moment.",
                                        "With [npc.a_moan+], [npc.name] enthusiastically rub the [npc.cockTip+] of [npc.her] [npc.cock] over the exposed parts of [npc2.namePos] [npc2.spinneret+],"
										+ " indicating that [npc.she] might join [npc3.name] and start double-penetrating [npc2.her] web-spinning orifice.",
				...
				switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
					case DOM_GENTLE:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								"Guiding [npc.her] [npc.cock+] up to [npc2.namePos] [npc2.spinneret+],"
                                        + " [npc.name] start slowly teasing the [npc.cockTip+] up and down over [npc2.her] web-spinning orifice, ready to penetrate [npc2.herHim] at any moment.",
                                "With a soft [npc.moan], [npc.name] guide [npc.her] [npc.cock+] up to [npc2.namePos] [npc2.spinneret+], before starting to gently slide the [npc.cockTip] up and down over [npc2.her] web-spinning orifice.",
					...
					case DOM_ROUGH:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								"Grinding [npc.her] [npc.cock+] up against [npc2.namePos] [npc2.spinneret+],"
                                        + " [npc.name] pull back a little before starting to slide the [npc.cockTip+] up and down over [npc2.her] web-spinning orifice, ready to start fucking [npc2.herHim] at any moment.",
                                "With [npc.a_moan+], [npc.name] line [npc.her] [npc.cock+] up to [npc2.namePos] [npc2.spinneret+],"
					...
					case SUB_NORMAL:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								"Guiding [npc.her] [npc.cock+] up to [npc2.namePos] [npc2.spinneret+],"
                                        + " [npc.name] start sliding the [npc.cockTip+] up and down over [npc2.her] web-spinning orifice, ready to penetrate [npc2.herHim] at any moment.",
                                "With [npc.a_moan+], [npc.name] guide [npc.her] [npc.cock+] up to [npc2.namePos] [npc2.spinneret+], before starting to slide the [npc.cockTip] up and down over [npc2.her] web-spinning orifice.",
					...
					default:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								"Guiding [npc.her] [npc.cock+] up to [npc2.namePos] [npc2.spinneret+],"
                                        + " [npc.name] start eagerly sliding the [npc.cockTip+] up and down over [npc2.her] web-spinning orifice, ready to penetrate [npc2.herHim] at any moment.",
                                "With [npc.a_moan+], [npc.name] guide [npc.her] [npc.cock+] up to [npc2.namePos] [npc2.spinneret+], before starting to eagerly slide the [npc.cockTip] up and down over [npc2.her] web-spinning orifice.",
			...
			if(!getOngoingCharacters(Main.sex.getCharacterPerformingAction()).isEmpty()) {
				switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
					case DOM_GENTLE:
						UtilText.nodeContentSB.append(UtilText.parse(Util.newArrayListOfValues(Main.sex.getCharacterPerformingAction(), Main.sex.getCharacterTargetedForSexAction(this), getPrimaryDPPerformer(Main.sex.getCharacterTargetedForSexAction(this))),
								UtilText.returnStringAtRandom(
                                        "Not satisfied with having just [npc3.namePos] [npc3.cock] penetrating [npc.herHim], [npc.name] take hold of [npc2.namePos] [npc2.cock+],"
								...
								"Wanting more than just [npc3.namePos] [npc3.cock+] stuffed in [npc.her] [npc.spinneret+],"
                                        + " [npc.name] gently take hold of [npc2.namePos] [npc2.cock+], before starting to slide the [npc2.cockTip] up and down over an exposed part of [npc.her] web-spinning orifice.",
								"With [npc3.namePos] [npc3.cock+] still thrusting in and out of [npc.her] [npc.spinneret+],"
                                        + " [npc.name] grab [npc2.namePos] [npc2.cock+], before gently sliding the [npc2.cockTip+] over an exposed part of [npc.her] web-spinning orifice.")));
						break;
					case DOM_ROUGH:
						UtilText.nodeContentSB.append(UtilText.parse(Util.newArrayListOfValues(Main.sex.getCharacterPerformingAction(), Main.sex.getCharacterTargetedForSexAction(this), getPrimaryDPPerformer(Main.sex.getCharacterTargetedForSexAction(this))),
								UtilText.returnStringAtRandom(
                                        "Not satisfied with having just [npc3.namePos] [npc3.cock] penetrating [npc.herHim], [npc.name] roughly grab hold of [npc2.namePos] [npc2.cock+],"
								...
								"Wanting more than just [npc3.namePos] [npc3.cock+] stuffed in [npc.her] [npc.spinneret+],"
                                        + " [npc.name] roughly seize hold of [npc2.namePos] [npc2.cock+], before starting to forcefully rub the [npc2.cockTip] up and down over an exposed part of [npc.her] web-spinning orifice.",
								"With [npc3.namePos] [npc3.cock+] still thrusting in and out of [npc.her] [npc.spinneret+],"
                                        + " [npc.name] forcefully grab [npc2.namePos] [npc2.cock+], before roughly rubbing the [npc2.cockTip+] over an exposed part of [npc.her] web-spinning orifice.")));
						break;
					case SUB_NORMAL:
						UtilText.nodeContentSB.append(UtilText.parse(Util.newArrayListOfValues(Main.sex.getCharacterPerformingAction(), Main.sex.getCharacterTargetedForSexAction(this), getPrimaryDPPerformer(Main.sex.getCharacterTargetedForSexAction(this))),
								UtilText.returnStringAtRandom(
								...
								"Wanting more than just [npc3.namePos] [npc3.cock+] stuffed in [npc.her] [npc.spinneret+],"
                                        + " [npc.name] take hold of [npc2.namePos] [npc2.cock+], before starting to rub the [npc2.cockTip] up and down over an exposed part of [npc.her] web-spinning orifice.",
								"With [npc3.namePos] [npc3.cock+] still thrusting in and out of [npc.her] [npc.spinneret+],"
                                        + " [npc.name] grab [npc2.namePos] [npc2.cock+], before rubbing the [npc2.cockTip+] over an exposed part of [npc.her] web-spinning orifice.")));
						break;
					default:
						UtilText.nodeContentSB.append(UtilText.parse(Util.newArrayListOfValues(Main.sex.getCharacterPerformingAction(), Main.sex.getCharacterTargetedForSexAction(this), getPrimaryDPPerformer(Main.sex.getCharacterTargetedForSexAction(this))),
								UtilText.returnStringAtRandom(
                                        "Not satisfied with having just [npc3.namePos] [npc3.cock] penetrating [npc.herHim], [npc.name] eagerly grab hold of [npc2.namePos] [npc2.cock+],"
								...
								"Wanting more than just [npc3.namePos] [npc3.cock+] stuffed in [npc.her] [npc.spinneret+],"
                                        + " [npc.name] desperately seize hold of [npc2.namePos] [npc2.cock+], before starting to energetically rub the [npc2.cockTip] up and down over an exposed part of [npc.her] web-spinning orifice.",
								"With [npc3.namePos] [npc3.cock+] still thrusting in and out of [npc.her] [npc.spinneret+],"
                                        + " [npc.name] eagerly grab [npc2.namePos] [npc2.cock+], before happily rubbing the [npc2.cockTip+] over an exposed part of [npc.her] web-spinning orifice.")));
						break;
				}
				...
				switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
					case DOM_GENTLE:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                "[npc.Name] grab [npc2.namePos] [npc2.cock+], before guiding it up to [npc.her] [npc.spinneret+]."
                                        + " Slowly pushing the [npc2.cockTip+] up and down over [npc.her] web-spinning orifice, [npc.she] tease [npc2.name] with the promise of penetration at any moment.",
                                "With a soft [npc.moan], [npc.name] grab [npc2.namePos] [npc2.cock+] и guide it up to [npc.her] [npc.spinneret+],"
										+ " before starting to gently slide the [npc2.cockTip] up and down over [npc.her] web-spinning orifice.",
                                "Grabbing [npc2.namePos] [npc2.cock+], [npc.name] gently slide the [npc2.cockTip+] over [npc.her] [npc.spinneret+],"
                                        + " letting out a soft [npc.moan] as [npc.she] tease [npc2.herHim] with the promise of penetration."));
						break;
					case DOM_ROUGH:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                "[npc.Name] grab [npc2.namePos] [npc2.cock+], before yanking it up to [npc.her] [npc.spinneret+]."
                                        + " Roughly forcing the [npc2.cockTip+] up and down over [npc.her] web-spinning orifice, [npc.she] tease [npc2.name] with the promise of penetration at any moment.",
                                "With [npc.a_moan+], [npc.name] grab [npc2.namePos] [npc2.cock+] and yank it up to [npc.her] [npc.spinneret+],"
                                        + " before starting to roughly force the [npc2.cockTip] up and down over [npc.her] web-spinning orifice.",
                                "Grabbing [npc2.namePos] [npc2.cock+], [npc.name] roughly grind the [npc2.cockTip+] over [npc.her] [npc.spinneret+],"
                                        + " letting out [npc.a_moan+] as [npc.she] tease [npc2.herHim] with the promise of penetration."));
						break;
					case SUB_NORMAL:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                "[npc.Name] grab [npc2.namePos] [npc2.cock+], before guiding it up to [npc.her] [npc.spinneret+]."
                                        + " Pushing the [npc2.cockTip+] up and down over [npc.her] web-spinning orifice, [npc.she] tease [npc2.name] with the promise of penetration at any moment.",
                                "With [npc.a_moan+], [npc.name] grab [npc2.namePos] [npc2.cock+] и guide it up to [npc.her] [npc.spinneret+],"
										+ " before starting to slide the [npc2.cockTip] up and down over [npc.her] web-spinning orifice.",
                                "Grabbing [npc2.namePos] [npc2.cock+], [npc.name] slide the [npc2.cockTip+] over [npc.her] [npc.spinneret+],"
                                        + " letting out [npc.a_moan+] as [npc.she] tease [npc2.herHim] with the promise of penetration."));
						break;
					default:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                "[npc.Name] grab [npc2.namePos] [npc2.cock+], before guiding it up to [npc.her] [npc.spinneret+]."
                                        + " Eagerly pushing the [npc2.cockTip+] up and down over [npc.her] web-spinning orifice, [npc.she] tease [npc2.name] with the promise of penetration at any moment.",
                                "With [npc.a_moan+], [npc.name] grab [npc2.namePos] [npc2.cock+] и guide it up to [npc.her] [npc.spinneret+],"
										+ " before starting to eagerly slide the [npc2.cockTip] up and down over [npc.her] web-spinning orifice.",
                                "Grabbing [npc2.namePos] [npc2.cock+], [npc.name] eagerly slide the [npc2.cockTip+] over [npc.her] [npc.spinneret+],"
                                        + " letting out [npc.a_moan+] as [npc.she] tease [npc2.herHim] with the promise of penetration."));
						break;
				}
			}
		...
		public String getDescription() {
			if(PenisSpinneret.getOngoingCharacters(Main.sex.getCharacterPerformingAction()).size()>1) {
				return UtilText.parse(PenisSpinneret.getCharactersForParsing(Main.sex.getCharacterPerformingAction()), UtilText.returnStringAtRandom(
                        "Letting out [npc.a_moan+], [npc.name] concentrate on squeezing the extra internal muscles within [npc.her] [npc.spinneret] down around"
                                + " #IF(npc3.isPlayer())[npc3.namePos] и [npc2.namePos]#ELSE[npc2.namePos] и [npc3.namePos]#ENDIF [npc2.cocks+(true)].",
						(!isTargetedCharacterInanimate()
                                ? "[npc.Name] let out [npc.a_moan+] as [npc.she] focus on controlling the extra muscles lining the insides of [npc.her] [npc.spinneret]."
                                + " Gripping and squeezing them down around #IF(npc3.isPlayer())[npc3.namePos] и [npc2.namePos]#ELSE[npc2.namePos] и [npc3.namePos]#ENDIF [npc2.cocks+(true)], [npc.name] cause the two of "
                        ...
                        "With [npc.a_moan+], [npc.name] focus on controlling the extra muscles deep within [npc.her] [npc.spinneret],"
                                + " gripping them down and massaging #IF(npc3.isPlayer())[npc3.namePos] и [npc2.namePos]#ELSE[npc2.namePos] и [npc3.namePos]#ENDIF [npc2.cock+] as [npc.she] squeal in pleasure."));
				
			} else {
				return UtilText.returnStringAtRandom(
                        "Letting out [npc.a_moan+], [npc.name] concentrate on squeezing the extra internal muscles within [npc.her] [npc.spinneret] down around [npc2.namePos] [npc2.cock+].",
						(!isTargetedCharacterInanimate()
                                ? "[npc.Name] let out [npc.a_moan+] as [npc.she] focus on controlling the extra muscles lining the insides of [npc.her] [npc.spinneret]."
                                + " Gripping and squeezing them down around [npc2.namePos] [npc2.cock+], [npc.name] cause [npc2.herHim] to let out an involuntary cry of pleasure."
							:""),
                        "[npc.Name] find [npc.her] [npc.moans] falling into a steady rhythm as [npc.she] concentrate"
								+ " on squeezing the extra muscles within [npc.her] [npc.spinneret+] down around [npc2.namePos] [npc2.cock+].",
                        "With [npc.a_moan+], [npc.name] focus on controlling the extra muscles deep within [npc.her] [npc.spinneret],"
                                + " gripping them down and massaging [npc2.namePos] [npc2.cock+] as [npc.she] squeal in pleasure.");
			}
		}
	};
				...
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Slowly teasing the [npc.cockTip+] of [npc.her] [npc.cock] over [npc2.namePos] [npc2.spinneret+],"
                                    + " [npc.name] let out a little [npc.moan] before slowly pushing forwards, sinking [npc.her] [npc.cock+] into [npc2.her] web-spinning orifice.",

                            "[npc.Name] position the [npc.cockTip+] of [npc.her] [npc.cock] over [npc2.namePos] [npc2.spinneret+],"
                                    + " and with a slow, steady pressure, [npc.she] gently sink it deep into [npc2.her] web-spinning orifice."));
					break;
				case DOM_NORMAL:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Eagerly teasing the [npc.cockTip+] of [npc.her] [npc.cock] over [npc2.namePos] [npc2.spinneret+],"
                                    + " [npc.name] let out [npc.a_moan+] before thrusting forwards, greedily sinking [npc.her] [npc.cock+] into [npc2.her] web-spinning orifice.",

                            "[npc.Name] position the [npc.cockTip+] of [npc.her] [npc.cock] over [npc2.namePos] [npc2.spinneret+], "
                                    + "and with a determined thrust, [npc.she] eagerly sink it deep into [npc2.her] web-spinning orifice."));
					break;
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Roughly grinding the [npc.cockTip+] of [npc.her] [npc.cock] over [npc2.namePos] [npc2.spinneret+],"
                                    + " [npc.name] let out [npc.a_moan+] before violently slamming forwards, forcing [npc.her] [npc.cock+] deep into [npc2.her] web-spinning orifice.",

                            "[npc.Name] position the [npc.cockTip+] of [npc.her] [npc.cock] over [npc2.namePos] [npc2.spinneret+],"
                                    + " and with a forceful thrust, [npc.she] roughly slam it deep into [npc2.her] web-spinning orifice."));
					break;
				case SUB_EAGER:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Eagerly teasing the [npc.cockTip+] of [npc.her] [npc.cock] over [npc2.namePos] [npc2.spinneret+],"
				...
				case SUB_NORMAL:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Teasing the [npc.cockTip+] of [npc.her] [npc.cock] over [npc2.namePos] [npc2.spinneret+],"
                                    + " [npc.name] let out [npc.a_moan+] before thrusting forwards, sinking [npc.her] [npc.cock+] into [npc2.her] web-spinning orifice.",

                            "[npc.Name] position the [npc.cockTip+] of [npc.her] [npc.cock] over [npc2.namePos] [npc2.spinneret+],"
                                    + " and with a little thrust, [npc.she] sink it deep into [npc2.her] web-spinning orifice."));
					break;
				default:
					break;
			}
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(UtilText.parse(getCharactersForParsing(),
                            "Wanting to join in on the fun, [npc.name] bring the [npc.cockHead+] of [npc.her] [npc.cock] up to [npc2.namePos] [npc2.spinneret+], and the next time [npc3.name] [npc3.verb(pull)] back,"
                                    + " [npc.she] gently push forwards, pushing [npc.her] [npc.cock+] in alongside [npc3.hers] and joining [npc3.herHim] in double-penetrating [npc2.name]."));
					break;
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.parse(getCharactersForParsing(),
                            "Wanting to join in on the fun, [npc.name] bring the [npc.cockHead+] of [npc.her] [npc.cock] up to [npc2.namePos] [npc2.spinneret+], and the next time [npc3.name] [npc3.verb(pull)] back,"
                                    + " [npc.she] roughly thrust forwards, forcing [npc.her] [npc.cock+] in alongside [npc3.hers] and joining [npc3.herHim] in double-penetrating [npc2.name]."));
					break;
				case SUB_NORMAL:
					UtilText.nodeContentSB.append(UtilText.parse(getCharactersForParsing(),
                            "Wanting to join in on the fun, [npc.name] bring the [npc.cockHead+] of [npc.her] [npc.cock] up to [npc2.namePos] [npc2.spinneret+], and the next time [npc3.name] [npc3.verb(pull)] back,"
                                    + " [npc.she] thrust forwards, pushing [npc.her] [npc.cock+] in alongside [npc3.hers] and joining [npc3.herHim] in double-penetrating [npc2.name]."));
					break;
				default: // Dom normal and sub eager:
					UtilText.nodeContentSB.append(UtilText.parse(getCharactersForParsing(),
                            "Wanting to join in on the fun, [npc.name] bring the [npc.cockHead+] of [npc.her] [npc.cock] up to [npc2.namePos] [npc2.spinneret+], and the next time [npc3.name] [npc3.verb(pull)] back,"
                                    + " [npc.she] desperately thrust forwards, ramming [npc.her] [npc.cock+] in alongside [npc3.hers] and joining [npc3.herHim] in double-penetrating [npc2.name]."));
					break;
			}
					...
					case SUB_RESISTING:
						UtilText.nodeContentSB.append(UtilText.parse(getCharactersForParsing(), UtilText.returnStringAtRandom(
								" [npc2.Name] [npc2.verb(let)] out [npc2.a_sob+] as the second [npc.cock] enters [npc2.herHim],"
                                        + " and, with tears running down [npc2.her] [npc2.face], [npc2.she] [npc2.verb(beg)] for [npc.name] и [npc3.name] to pull out.",
		...
		public String getDescription() {
			...
			if(PenisSpinneret.getOngoingCharacters(Main.sex.getCharacterTargetedForSexAction(this)).size()>1) {
				UtilText.nodeContentSB.append(UtilText.parse(PenisSpinneret.getCharactersForParsing(Main.sex.getCharacterTargetedForSexAction(this)), UtilText.returnStringAtRandom(
                        "With [npc.her] [npc.cock+] rubbing up against [npc3.nameHers], [npc.name] gently thrust deep inside of [npc2.namePos] [npc2.spinneret+],"
                                + " letting out a little [npc.moan] with every buck of [npc.her] [npc.hips] as [npc.she] slowly fuck [npc2.herHim].",
                        "Joining [npc3.name] in double-penetrating [npc2.namePos] [npc2.spinneret+], [npc.name] softly thrust [npc.her] [npc.hips] forwards, letting out a little [npc.moan] as [npc.she] gently fuck [npc2.herHim].",
                        "With both [npc.her] и [npc3.namePos] [npc.cocks(true)] stuffed deep in [npc2.namePos] [npc2.spinneret+],"
                                + " [npc.name] gently pump [npc.her] [npc.hips] back and forth, breathing in [npc2.namePos] [npc2.scent] as [npc.she] slowly fuck [npc2.herHim].")));
			} else {
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
						"Gently sinking [npc.her] [npc.cock+] deep into [npc2.namePos] [npc2.spinneret+],"
                                + " [npc.name] start rocking [npc.her] [npc.hips] back and forth, letting out a little [npc.moan] with every thrust as [npc.she] slowly fuck [npc2.name].",
						"Slowly pushing [npc.her] [npc.cock+] into [npc2.namePos] [npc2.spinneret+],"
                                + " [npc.name] softly thrust [npc.her] [npc.hips] forwards, letting out a little [npc.moan] as [npc.she] gently fuck [npc2.herHim].",
                        "Sliding [npc.her] [npc.cock+] into [npc2.namePos] [npc2.spinneret+], [npc.name] let out a little [npc.moan] as [npc.she] start to gently pump [npc.her] [npc.hips] back and forth,"
                                + " breathing in [npc2.namePos] [npc2.scent] as [npc.she] slowly fuck [npc2.herHim]."));
			}
	...
	public static final SexAction PENIS_FUCKING_DOM_NORMAL = new SexAction(
		...
		public String getDescription() {
			...
			if(PenisSpinneret.getOngoingCharacters(Main.sex.getCharacterTargetedForSexAction(this)).size()>1) {
				UtilText.nodeContentSB.append(UtilText.parse(PenisSpinneret.getCharactersForParsing(Main.sex.getCharacterTargetedForSexAction(this)), UtilText.returnStringAtRandom(
                        "With [npc.her] [npc.cock+] rubbing up against [npc3.nameHers], [npc.name] eagerly thrust deep inside of [npc2.namePos] [npc2.spinneret+],"
                                + " letting out [npc.a_moan+] with every energetic buck of [npc.her] [npc.hips] as [npc.she] frantically fuck [npc2.herHim].",
                        "Joining [npc3.name] in double-penetrating [npc2.namePos] [npc2.spinneret+], [npc.name] enthusiastically thrust [npc.her] [npc.hips] forwards, letting out [npc.a_moan+] as [npc.she] eagerly fuck [npc2.herHim].",
                        "With both [npc.her] и [npc3.namePos] [npc.cocks(true)] stuffed deep in [npc2.namePos] [npc2.spinneret+],"
                                + " [npc.name] happily pump [npc.her] [npc.hips] back and forth, breathing in [npc2.namePos] [npc2.scent] as [npc.she] desperately fuck [npc2.herHim].")));
			} else {
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
						"Eagerly sinking [npc.her] [npc.cock+] deep into [npc2.namePos] [npc2.spinneret+],"
                                + " [npc.name] start enthusiastically rocking [npc.her] [npc.hips] back and forth, letting out [npc.a_moan+] with every thrust as [npc.she] happily fuck [npc2.name].",
						"Enthusiastically pushing [npc.her] [npc.cock+] deep into [npc2.namePos] [npc2.spinneret+],"
                                + " [npc.name] frantically thrust [npc.her] [npc.hips] forwards, letting out [npc.a_moan+] as [npc.she] greedily fuck [npc2.herHim].",
                        "Thrusting [npc.her] [npc.cock+] deep into [npc2.namePos] [npc2.spinneret+], [npc.name] let out [npc.a_moan+] as [npc.she] start to eagerly pump [npc.her] [npc.hips] back and forth,"
                                + " breathing in [npc2.namePos] [npc2.scent] as [npc.she] desperately fuck [npc2.herHim]."));
			}
	...
	public static final SexAction PENIS_FUCKING_DOM_ROUGH = new SexAction(
		...
		public String getDescription() {
			...
			if(PenisSpinneret.getOngoingCharacters(Main.sex.getCharacterTargetedForSexAction(this)).size()>1) {
				UtilText.nodeContentSB.append(UtilText.parse(PenisSpinneret.getCharactersForParsing(Main.sex.getCharacterTargetedForSexAction(this)), UtilText.returnStringAtRandom(
                        "With [npc.her] [npc.cock+] rubbing up against [npc3.nameHers], [npc.name] roughly thrust deep inside of [npc2.namePos] [npc2.spinneret+],"
                                + " letting out [npc.a_moan+] with every violent slam of [npc.her] [npc.hips] as [npc.she] forcefully fuck [npc2.herHim].",
                        "Joining [npc3.name] in double-penetrating [npc2.namePos] [npc2.spinneret+], [npc.name] roughly slam [npc.her] [npc.hips] forwards, letting out [npc.a_moan+] as [npc.she] forcefully fuck [npc2.herHim].",
                        "With both [npc.her] и [npc3.namePos] [npc.cocks(true)] stuffed deep in [npc2.namePos] [npc2.spinneret+],"
                                + " [npc.name] violently thrust [npc.her] [npc.hips] back and forth, breathing in [npc2.namePos] [npc2.scent] as [npc.she] aggressively fuck [npc2.herHim].")));
			} else {
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
						"Brutally pounding [npc.her] [npc.cock+] deep into [npc2.namePos] [npc2.spinneret+],"
                                + " [npc.name] start roughly slamming [npc.her] [npc.hips] back and forth, letting out [npc.a_moan+] with every thrust as [npc.she] brutally fuck [npc2.name].",
						"Violently thrusting [npc.her] [npc.cock+] deep into [npc2.namePos] [npc2.spinneret+],"
                                + " [npc.name] start roughly slamming [npc.her] [npc.hips] forwards, letting out [npc.a_moan+] as [npc.she] forcefully fuck [npc2.herHim].",
                        "Forcefully driving [npc.her] [npc.cock+] deep into [npc2.namePos] [npc2.spinneret+], [npc.name] let out [npc.a_moan+] as [npc.she] start to roughly slam [npc.her] [npc.hips] back and forth,"
                                + " breathing in [npc2.namePos] [npc2.scent] as [npc.she] violently fuck [npc2.herHim]."));
			}
	...
	public static final SexAction PENIS_FUCKING_SUB_NORMAL = new SexAction(
		...
		public String getDescription() {
			...
			if(PenisSpinneret.getOngoingCharacters(Main.sex.getCharacterTargetedForSexAction(this)).size()>1) {
				UtilText.nodeContentSB.append(UtilText.parse(PenisSpinneret.getCharactersForParsing(Main.sex.getCharacterTargetedForSexAction(this)), UtilText.returnStringAtRandom(
                        "With [npc.her] [npc.cock+] rubbing up against [npc3.nameHers], [npc.name] thrust deep inside of [npc2.namePos] [npc2.spinneret+],"
                                + " letting out [npc.a_moan+] with every buck of [npc.her] [npc.hips] as [npc.she] happily fuck [npc2.herHim].",
                        "Joining [npc3.name] in double-penetrating [npc2.namePos] [npc2.spinneret+], [npc.name] thrust [npc.her] [npc.hips] forwards, letting out [npc.a_moan+] as [npc.she] fuck [npc2.herHim].",
                        "With both [npc.her] и [npc3.namePos] [npc.cocks(true)] stuffed deep in [npc2.namePos] [npc2.spinneret+],"
                                + " [npc.name] happily pump [npc.her] [npc.hips] back and forth, breathing in [npc2.namePos] [npc2.scent] as [npc.she] fuck [npc2.herHim].")));
			} else {
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
						"Sinking [npc.her] [npc.cock+] deep into [npc2.namePos] [npc2.spinneret+],"
                                + " [npc.name] start rocking [npc.her] [npc.hips] back and forth, letting out [npc.a_moan+] with every thrust as [npc.she] happily fuck [npc2.name].",
						"Pushing [npc.her] [npc.cock+] deep into [npc2.namePos] [npc2.spinneret+],"
                                + " [npc.name] start thrusting [npc.her] [npc.hips] forwards, letting out [npc.a_moan+] as [npc.she] eagerly fuck [npc2.herHim].",
                        "Thrusting [npc.her] [npc.cock+] deep into [npc2.namePos] [npc2.spinneret+], [npc.name] let out [npc.a_moan+] as [npc.she] start to pump [npc.her] [npc.hips] back and forth,"
                                + " breathing in [npc2.namePos] [npc2.scent] as [npc.she] fuck [npc2.herHim]."));
			}
		...
		public String getDescription() {
			...
			if(!Main.sex.getCharacterPerformingAction().isTaur()) {
				switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
					case DOM_GENTLE:
						UtilText.nodeContentSB.append(UtilText.parse(getCharactersForParsing(), UtilText.returnStringAtRandom(
                                "Not satisfied with having just [npc3.name] fucking [npc.her] [npc.spinneret+], [npc.name] gently take hold of [npc2.namePos] [npc2.cock], before slowly guiding it up to [npc.her] web-spinning orifice."
                                        + " Letting out a little [npc.moan], [npc.she] then gently buck [npc.her] [npc.hips] и force [npc2.herHim] to join [npc3.name] in double-penetrating [npc.her] [npc.spinneret+].",
                                "Wanting more than just [npc3.namePos] [npc3.cock] in [npc.her] [npc.spinneret], [npc.name] take hold of [npc2.namePos] [npc2.cock], before gently lining it up to [npc.her] " + spinneretArea + "."
                                        + " Slowly pushing [npc.her] [npc.hips] back, [npc.she] let out a soft [npc.moan] as [npc.she] feel [npc2.namePos] [npc2.cock+] push in alongside [npc3.namePos] into [npc.her] [npc.spinneret+].")));
						break;
					case DOM_ROUGH:
						UtilText.nodeContentSB.append(UtilText.parse(getCharactersForParsing(), UtilText.returnStringAtRandom(
                                "Not satisfied with having just [npc3.name] fucking [npc.her] [npc.spinneret+], [npc.name] roughly grab [npc2.namePos] [npc2.cock], before forcefully moving it up to [npc.her] web-spinning orifice."
                                        + " Letting out [npc.a_moan+], [npc.she] then violently buck [npc.her] [npc.hips] и force [npc2.herHim] to join [npc3.name] in double-penetrating [npc.her] [npc.spinneret+].",
                                "Wanting more than just [npc3.namePos] [npc3.cock] in [npc.her] [npc.spinneret], [npc.name] forcefully grab [npc2.namePos] [npc2.cock], before quickly lining it up to [npc.her] " + spinneretArea + "."
                                        + " Roughly slamming [npc.her] [npc.hips] back, [npc.she] let out [npc.a_moan+] as [npc.she] feel [npc2.namePos] [npc2.cock+] push in alongside [npc3.namePos] into [npc.her] [npc.spinneret+].")));
						break;
					case SUB_NORMAL:
						UtilText.nodeContentSB.append(UtilText.parse(getCharactersForParsing(), UtilText.returnStringAtRandom(
                                "Not satisfied with having just [npc3.name] fucking [npc.her] [npc.spinneret+], [npc.name] grab [npc2.namePos] [npc2.cock], before moving it up to [npc.her] web-spinning orifice."
                                        + " Letting out [npc.a_moan+], [npc.she] then buck [npc.her] [npc.hips] и force [npc2.herHim] to join [npc3.name] in double-penetrating [npc.her] [npc.spinneret+].",
                                "Wanting more than just [npc3.namePos] [npc3.cock] in [npc.her] [npc.spinneret], [npc.name] grab [npc2.namePos] [npc2.cock], before lining it up to [npc.her] " + spinneretArea + "."
                                        + " Bucking [npc.her] [npc.hips] back, [npc.she] let out [npc.a_moan+] as [npc.she] feel [npc2.namePos] [npc2.cock+] push in alongside [npc3.namePos] into [npc.her] [npc.spinneret+].")));
						break;
					default:
						UtilText.nodeContentSB.append(UtilText.parse(getCharactersForParsing(), UtilText.returnStringAtRandom(
                                "Not satisfied with having just [npc3.name] fucking [npc.her] [npc.spinneret+], [npc.name] impatiently grab [npc2.namePos] [npc2.cock], before eagerly moving it up to [npc.her] web-spinning orifice."
                                        + " Letting out [npc.a_moan+], [npc.she] then desperately buck [npc.her] [npc.hips] и force [npc2.herHim] to join [npc3.name] in double-penetrating [npc.her] [npc.spinneret+].",
                                "Wanting more than just [npc3.namePos] [npc3.cock] in [npc.her] [npc.spinneret], [npc.name] greedily grab [npc2.namePos] [npc2.cock], before quickly lining it up to [npc.her] " + spinneretArea + "."
                                        + " Impatiently bucking [npc.her] [npc.hips] back, [npc.she] let out [npc.a_moan+] as [npc.she] feel [npc2.namePos] [npc2.cock+] push in alongside [npc3.namePos] into [npc.her] [npc.spinneret+].")));
						break;
				}
				...
				switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
					case DOM_GENTLE:
						UtilText.nodeContentSB.append(UtilText.parse(getCharactersForParsing(), UtilText.returnStringAtRandom(
                                "Not satisfied with having just [npc3.name] fucking [npc.her] [npc.spinneret+], [npc.name] slowly move [npc.her] [npc.hips] until [npc2.namePos] [npc2.cock+] is pressed up to [npc.her] web-spinning orifice,"
                                        + " and then with a little [npc.moan], [npc.she] gently buck back and force [npc2.herHim] to join [npc3.name] in double-penetrating [npc.her] [npc.spinneret+].",
                                "Wanting to be fucked by more than just [npc3.name], [npc.name] push back against [npc2.namePos] [npc2.cock], making sure to line the [npc2.cockHead] up to [npc.her] " + spinneretArea + " before slowly moving back and forcing [npc2.herHim] to join [npc3.name] in double-penetrating [npc.her] [npc.spinneret+].")));
						break;
					case DOM_ROUGH:
						UtilText.nodeContentSB.append(UtilText.parse(getCharactersForParsing(), UtilText.returnStringAtRandom(
                                "Not satisfied with having just [npc3.name] fucking [npc.her] [npc.spinneret+], [npc.name] forcefully push [npc.her] [npc.hips] back until [npc2.namePos] [npc2.cock+] is pressed up to [npc.her] web-spinning orifice,"
                                        + " and then with [npc.a_moan+], [npc.she] violently slam back and force [npc2.herHim] to join [npc3.name] in double-penetrating [npc.her] [npc.spinneret+].",
                                "Wanting to be fucked by more than just [npc3.name], [npc.name] roughly push back against [npc2.namePos] [npc2.cock], making sure to line the [npc2.cockHead] up to [npc.her] " + spinneretArea + " before dominantly moving back and forcing [npc2.herHim] to join [npc3.name] in double-penetrating [npc.her] [npc.spinneret+].")));
						break;
					case SUB_NORMAL:
						UtilText.nodeContentSB.append(UtilText.parse(getCharactersForParsing(), UtilText.returnStringAtRandom(
                                "Not satisfied with having just [npc3.name] fucking [npc.her] [npc.spinneret+], [npc.name] push [npc.her] [npc.hips] back until [npc2.namePos] [npc2.cock+] is pressed up to [npc.her] web-spinning orifice,"
                                        + " and then with [npc.a_moan+], [npc.she] buck back and force [npc2.herHim] to join [npc3.name] in double-penetrating [npc.her] [npc.spinneret+].",
                                "Wanting to be fucked by more than just [npc3.name], [npc.name] push back against [npc2.namePos] [npc2.cock], making sure to line the [npc2.cockHead] up to [npc.her] " + spinneretArea + " before moving back and forcing [npc2.herHim] to join [npc3.name] in double-penetrating [npc.her] [npc.spinneret+].")));
						break;
					default:
						UtilText.nodeContentSB.append(UtilText.parse(getCharactersForParsing(), UtilText.returnStringAtRandom(
                                "Not satisfied with having just [npc3.name] fucking [npc.her] [npc.spinneret+], [npc.name] eagerly push [npc.her] [npc.hips] back until [npc2.namePos] [npc2.cock+] is pressed up to [npc.her] web-spinning orifice,"
                                        + " and then with [npc.a_moan+], [npc.she] greedily buck back and force [npc2.herHim] to join [npc3.name] in double-penetrating [npc.her] [npc.spinneret+].",
                                "Wanting to be fucked by more than just [npc3.name], [npc.name] desperately push back against [npc2.namePos] [npc2.cock], making sure to line the [npc2.cockHead] up to [npc.her] " + spinneretArea + " before eagerly moving back and forcing [npc2.herHim] to join [npc3.name] in double-penetrating [npc.her] [npc.spinneret+].")));
						break;
				}
			}
			...
			if(!isTargetedCharacterInanimate()) {
				switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(this))) {
					...
					case SUB_RESISTING:
						UtilText.nodeContentSB.append(UtilText.parse(getCharactersForParsing(), UtilText.returnStringAtRandom(
                                " [npc2.Name] [npc2.verb(let)] out [npc2.a_sob+] as [npc.name] force [npc2.her] [npc2.cock] inside of [npc.herHim],"
                                ...
                                " With [npc2.a_sob+], [npc2.name] [npc2.verb(struggle)] against [npc.name] as [npc.she] force [npc2.her] [npc2.cock] deep into [npc.her] [npc.spinneret+].")));
						break;
					default:
						UtilText.nodeContentSB.append(UtilText.parse(getCharactersForParsing(), UtilText.returnStringAtRandom(
								" [npc2.Name] [npc2.verb(let)] out [npc2.a_moan+] as [npc2.she] [npc2.verb(enter)] [npc.herHim],"
		...
		public String getDescription() {
			...
			if(PenisSpinneret.getOngoingCharacters(Main.sex.getCharacterTargetedForSexAction(this)).size()>1) {
				switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(this))) {
					case DOM_GENTLE:
						UtilText.nodeContentSB.append(UtilText.parse(PenisSpinneret.getCharactersForParsing(Main.sex.getCharacterTargetedForSexAction(this)), UtilText.returnStringAtRandom(
                                "[npc.Name] try to pull [npc.her] [npc.cock] out of [npc2.namePos] [npc2.spinneret],"
                                ...
                                "With [npc.a_sob+], [npc.name] try to pull [npc.her] [npc.cock] away from [npc2.name], but [npc2.she] quickly [npc2.verb(grab)] it,"
										+ " before gently forcing it back inside [npc2.her] [npc2.spinneret+] alongside [npc3.nameHers].",
                                "Tears start to well up in [npc.namePos] [npc.eyes], and with [npc.a_sob+], [npc.she] try to pull [npc.her] [npc.cock] away from [npc2.namePos] [npc2.spinneret+],"
				...
				switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(this))) {
					case DOM_GENTLE:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                ...
                                "With [npc.a_sob+], [npc.name] try to pull [npc.her] [npc.cock] away from [npc2.name], but [npc2.she] quickly [npc2.verb(grab)] it, before gently forcing it back inside [npc2.her] [npc2.spinneret+].",
                                "Tears start to well up in [npc.namePos] [npc.eyes], and with [npc.a_sob+], [npc.she] try to pull [npc.her] [npc.cock] away from [npc2.namePos] [npc2.spinneret+],"
										+ " but [npc2.name] quickly [npc2.verb(shift)] position, ignoring [npc.her] protests as [npc2.she] gently [npc2.verb(force)] [npc2.her] [npc2.spinneret+] down onto [npc.her] [npc.cock+]."));
						break;
					case DOM_ROUGH:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                ...
                                "With [npc.a_sob+], [npc.name] try to pull [npc.her] [npc.cock] away from [npc2.name], but [npc2.she] quickly [npc2.verb(grab)] it, before roughly forcing it back inside [npc2.her] [npc2.spinneret+].",
                                "Tears start to well up in [npc.namePos] [npc.eyes], and with [npc.a_sob+], [npc.she] try to pull [npc.her] [npc.cock] away from [npc2.namePos] [npc2.spinneret+],"
										+ " but [npc2.name] quickly [npc2.verb(shift)] position, ignoring [npc.her] protests as [npc2.she] roughly [npc2.verb(force)] [npc2.her] [npc2.spinneret+] down onto [npc.her] [npc.cock+]."));
						break;
					default: // DOM_NORMAL and in case anything goes wrong:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                ...
                                "With [npc.a_sob+], [npc.name] try to pull [npc.her] [npc.cock] away from [npc2.name], but [npc2.she] quickly [npc2.verb(grab)] it, before eagerly forcing it back inside [npc2.her] [npc2.spinneret+].",
                                "Tears start to well up in [npc.namePos] [npc.eyes], and with [npc.a_sob+], [npc.she] try to pull [npc.her] [npc.cock] away from [npc2.namePos] [npc2.spinneret+],"
										+ " but [npc2.name] quickly [npc2.verb(shift)] position, ignoring [npc.her] protests as [npc2.she] [npc2.verb(force)] [npc2.her] [npc2.spinneret+] down onto [npc.her] [npc.cock+]."));
						break;
				}
			...
			if(PenisSpinneret.getOngoingCharacters(Main.sex.getCharacterTargetedForSexAction(this)).size()>1) {
					...
					case DOM_ROUGH:
						UtilText.nodeContentSB.append(UtilText.parse(PenisSpinneret.getCharactersForParsing(Main.sex.getCharacterTargetedForSexAction(this)), UtilText.returnStringAtRandom(
								"Roughly yanking [npc.her] [npc.cock+] out of [npc2.namePos] [npc2.spinneret+],"
                                        + " [npc.name] dominantly slide the [npc.cockTip+] up and down over [npc2.her] web-spinning orifice one last time before pulling back and leaving [npc3.name] to continue fucking [npc2.herHim].",
                                "Thrusting deep inside of [npc2.name] one last time, [npc.name] then yank [npc.her] [npc.cock+] back out of [npc2.her] [npc2.spinneret+], putting an end to the rough double-penetration.")));
						break;
					default:
						UtilText.nodeContentSB.append(UtilText.parse(PenisSpinneret.getCharactersForParsing(Main.sex.getCharacterTargetedForSexAction(this)), UtilText.returnStringAtRandom(
								"Sliding [npc.her] [npc.cock] out of [npc2.namePos] [npc2.spinneret+],"
                                        + " [npc.name] rub the [npc.cockTip] up and down over [npc2.her] web-spinning orifice one last time before pulling back and leaving [npc3.name] to continue fucking [npc2.herHim].",
                                "Pushing deep inside of [npc2.name] one last time, [npc.name] then slide [npc.her] [npc.cock+] back out of [npc2.her] [npc2.spinneret+], putting an end to the double-penetration.")));
						break;
				}
				...
				if(!isTargetedCharacterInanimate()) {
					switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(this))) {
						case SUB_RESISTING:
							UtilText.nodeContentSB.append(UtilText.parse(PenisSpinneret.getCharactersForParsing(Main.sex.getCharacterTargetedForSexAction(this)), UtilText.returnStringAtRandom(
                                    " [npc2.Name] can't [npc2.verb(help)] but [npc2.verb(let)] out [npc2.sob+] as [npc.name] pull out of [npc2.her] [npc2.spinneret],"
						...
						default:
							UtilText.nodeContentSB.append(UtilText.parse(PenisSpinneret.getCharactersForParsing(Main.sex.getCharacterTargetedForSexAction(this)), UtilText.returnStringAtRandom(
                                    " [npc2.Name] [npc2.verb(let)] out [npc2.a_moan+] as [npc.name] pull [npc.her] [npc.cock+] out of [npc2.her] [npc2.spinneret+], eager for more of [npc.her] attention.",
				...
				switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
					case DOM_ROUGH:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								"Roughly yanking [npc.her] [npc.cock+] out of [npc2.namePos] [npc2.spinneret+],"
                                        + " [npc.name] dominantly slide the [npc.cockTip+] up and down over [npc2.her] web-spinning orifice one last time before pulling back.",
                                "Thrusting deep inside of [npc2.name] one last time, [npc.name] then yank [npc.her] [npc.cock+] back out of [npc2.her] [npc2.spinneret+], putting an end to the rough fucking."));
						break;
					default:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                "Sliding [npc.her] [npc.cock] out of [npc2.namePos] [npc2.spinneret+], [npc.name] rub the [npc.cockTip] up and down over [npc2.her] web-spinning orifice one last time before pulling back.",
                                "Pushing deep inside of [npc2.name] one last time, [npc.name] then slide [npc.her] [npc.cock+] back out of [npc2.her] [npc2.spinneret+], putting an end to the fucking."));
						break;
				}
		...
		public String getDescription() {
			...
			if(!Main.sex.getCharacterPerformingAction().isTaur()) {
				switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
					case DOM_GENTLE:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                "Grabbing [npc2.namePos] [npc2.cock], [npc.name] slowly guide it up to [npc.her] " + spinneretArea + ","
                                ...
                                "Grabbing [npc2.namePos] [npc2.cock], [npc.name] line it up to [npc.her] " + spinneretArea + ","
                                        + " before slowly pushing [npc.her] [npc.hips] back and letting out a soft [npc.moan] as [npc.she] penetrate [npc.herself] on [npc2.her] [npc2.cock+]."));
						break;
					case DOM_ROUGH:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                ...
                                "Grabbing [npc2.namePos] [npc2.cock], [npc.name] line it up to [npc.her] " + spinneretArea + ","
                                        + " before eagerly slamming [npc.her] [npc.hips] back and letting out [npc.a_moan+] as [npc.she] penetrate [npc.herself] on [npc2.her] [npc2.cock+]."));
						break;
					case SUB_NORMAL:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                "Grabbing [npc2.namePos] [npc2.cock], [npc.name] guide it up to [npc.her] " + spinneretArea + ","
										+ " letting out [npc.a_moan+] before bucking [npc.her] [npc.hips] and forcing [npc2.herHim] to penetrate [npc.her] [npc.spinneret+].",
                                "Grabbing [npc2.namePos] [npc2.cock], [npc.name] line it up to [npc.her] " + spinneretArea + ","
                                        + " before pushing [npc.her] [npc.hips] back and letting out [npc.a_moan+] as [npc.she] penetrate [npc.herself] on [npc2.her] [npc2.cock+]."));
						break;
					default:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                "Grabbing [npc2.namePos] [npc2.cock], [npc.name] eagerly guide it up to [npc.her] " + spinneretArea + ","
                                ...
                                "Grabbing [npc2.namePos] [npc2.cock], [npc.name] line it up to [npc.her] " + spinneretArea + ","
                                        + " before eagerly thrusting [npc.her] [npc.hips] back and letting out [npc.a_moan+] as [npc.she] penetrate [npc.herself] on [npc2.her] [npc2.cock+]."));
						break;
				}
				...
				switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
					case DOM_GENTLE:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                "[npc.Name] slowly move [npc.her] [npc.hips] until [npc2.namePos] [npc2.cock+] is pressed up against [npc.her] " + spinneretArea + ","
                                        + " and then with a little [npc.moan], [npc.she] gently buck back and force [npc2.herHim] to penetrate [npc.her] [npc.spinneret+].",
                                "Pushing [npc.her] " + spinneretArea + " back against [npc2.namePos] [npc2.cock], [npc.name] line it up over [npc.her] web-spinning orifice,"
                                        + " before slowly moving back and letting out a soft [npc.moan] as [npc.she] force [npc2.herHim] to penetrate [npc.herHim]."));
						break;
					case DOM_ROUGH:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                "[npc.Name] forcefully push [npc.her] [npc.hips] back until [npc2.namePos] [npc2.cock+] is pressed up against [npc.her] " + spinneretArea + ","
                                        + " and then with [npc.a_moan+], [npc.she] violently slam back and force [npc2.herHim] to penetrate [npc.her] [npc.spinneret+].",
                                "Roughly pushing [npc.her] " + spinneretArea + " back against [npc2.namePos] [npc2.cock], [npc.name] line it up over [npc.her] web-spinning orifice,"
                                        + " before dominantly moving back and letting out [npc.a_moan+] as [npc.she] force [npc2.herHim] to penetrate [npc.herHim]."));
						break;
					case SUB_NORMAL:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                "[npc.Name] push [npc.her] [npc.hips] back until [npc2.namePos] [npc2.cock+] is pressed up against [npc.her] " + spinneretArea + ","
                                        + " and then with [npc.a_moan+], [npc.she] buck back and force [npc2.herHim] to penetrate [npc.her] [npc.spinneret+].",
                                "Pushing [npc.her] " + spinneretArea + " back against [npc2.namePos] [npc2.cock], [npc.name] line it up over [npc.her] web-spinning orifice,"
                                        + " before moving back and letting out [npc.a_moan+] as [npc.she] force [npc2.herHim] to penetrate [npc.herHim]."));
						break;
					default:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                "[npc.Name] eagerly push [npc.her] [npc.hips] back until [npc2.namePos] [npc2.cock+] is pressed up against [npc.her] " + spinneretArea + ","
                                        + " and then with [npc.a_moan+], [npc.she] greedily buck back and force [npc2.herHim] to penetrate [npc.her] [npc.spinneret+].",
                                "Desperately pushing [npc.her] " + spinneretArea + " back against [npc2.namePos] [npc2.cock], [npc.name] line it up over [npc.her] web-spinning orifice,"
                                        + " before eagerly moving back and letting out [npc.a_moan+] as [npc.she] force [npc2.herHim] to penetrate [npc.herHim]."));
						break;
				}
			}
		...
		public String getDescription() {
			...
			if(PenisSpinneret.getOngoingCharacters(Main.sex.getCharacterPerformingAction()).size()>1) {
				UtilText.nodeContentSB.append(UtilText.parse(PenisSpinneret.getCharactersForParsing(Main.sex.getCharacterPerformingAction()), UtilText.returnStringAtRandom(
                        "With a gentle thrust of [npc.her] [npc.hips], [npc.name] let out a soft [npc.moan] as [npc.she] help to sink the two [npc2.cocks(true)] penetrating [npc.herHim] ever deeper into [npc.her] [npc.spinneret+].",
                        "With a soft [npc.moan], [npc.name] gently start bucking [npc.her] [npc.hips], forcing #IF(npc3.isPlayer())[npc3.namePos] и [npc2.namePos]#ELSE[npc2.namePos] и [npc3.namePos]#ENDIF [npc2.cocks+(true)] ever deeper into [npc.her] [npc.spinneret+].",
				...
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                        "With a gentle thrust of [npc.her] [npc.hips], [npc.name] let out a soft [npc.moan] as [npc.she] help to sink [npc2.namePos] [npc2.cock+] deep into [npc.her] [npc.spinneret+].",
                        "With a soft [npc.moan], [npc.name] gently start bucking [npc.her] [npc.hips], forcing [npc2.namePos] [npc2.cock+] ever deeper into [npc.her] [npc.spinneret+].",
	...
	public static final SexAction RIDING_PENIS_DOM_NORMAL = new SexAction(
		...
		public String getDescription() {
			...
			if(PenisSpinneret.getOngoingCharacters(Main.sex.getCharacterPerformingAction()).size()>1) {
				UtilText.nodeContentSB.append(UtilText.parse(PenisSpinneret.getCharactersForParsing(Main.sex.getCharacterPerformingAction()), UtilText.returnStringAtRandom(
                        "With an eager bucking of [npc.her] [npc.hips], [npc.name] let out [npc.a_moan+] as [npc.she] help to sink the two [npc2.cocks(true)] penetrating [npc.herHim] ever deeper into [npc.her] [npc.spinneret+].",
                        "With [npc.a_moan+], [npc.name] enthusiastically start bucking [npc.her] [npc.hips], forcing #IF(npc3.isPlayer())[npc3.namePos] и [npc2.namePos]#ELSE[npc2.namePos] и [npc3.namePos]#ENDIF [npc2.cocks+(true)] ever deeper into [npc.her] [npc.spinneret+].",
				...
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                        "With an eager bucking of [npc.her] [npc.hips], [npc.name] let out [npc.a_moan+] as [npc.she] help to sink [npc2.namePos] [npc2.cock+] deep into [npc.her] [npc.spinneret+].",
                        "With [npc.a_moan+], [npc.name] enthusiastically start bucking [npc.her] [npc.hips], forcing [npc2.namePos] [npc2.cock+] ever deeper into [npc.her] [npc.spinneret+].",
	...
	public static final SexAction RIDING_PENIS_DOM_ROUGH = new SexAction(
		...
		public String getDescription() {
			...
			if(PenisSpinneret.getOngoingCharacters(Main.sex.getCharacterPerformingAction()).size()>1) {
				UtilText.nodeContentSB.append(UtilText.parse(PenisSpinneret.getCharactersForParsing(Main.sex.getCharacterPerformingAction()), UtilText.returnStringAtRandom(
                        "With a violent slamming of [npc.her] [npc.hips], [npc.name] let out [npc.a_moan+] as [npc.she] force the two [npc2.cocks(true)] penetrating [npc.herHim] ever deeper into [npc.her] [npc.spinneret+].",
                        "With [npc.a_moan+], [npc.name] roughly start bucking [npc.her] [npc.hips], forcing #IF(npc3.isPlayer())[npc3.namePos] и [npc2.namePos]#ELSE[npc2.namePos] и [npc3.namePos]#ENDIF [npc2.cocks+(true)] ever deeper into [npc.her] [npc.spinneret+].",
				...
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                        "With a violent slam of [npc.her] [npc.hips], [npc.name] let out [npc.a_moan+] as [npc.she] force [npc2.namePos] [npc2.cock+] deep into [npc.her] [npc.spinneret+].",
                        "With [npc.a_moan+], [npc.name] roughly start bucking [npc.her] [npc.hips], forcing [npc2.namePos] [npc2.cock+] ever deeper into [npc.her] [npc.spinneret+].",
	...
	public static final SexAction RIDING_PENIS_SUB_NORMAL = new SexAction(
		...
		public String getDescription() {
			...
			if(PenisSpinneret.getOngoingCharacters(Main.sex.getCharacterPerformingAction()).size()>1) {
				UtilText.nodeContentSB.append(UtilText.parse(PenisSpinneret.getCharactersForParsing(Main.sex.getCharacterPerformingAction()), UtilText.returnStringAtRandom(
                        "With a quick buck of [npc.her] [npc.hips], [npc.name] let out [npc.a_moan+] as [npc.she] force the two [npc2.cocks(true)] penetrating [npc.herHim] ever deeper into [npc.her] [npc.spinneret+].",
                        "With [npc.a_moan+], [npc.name] start bucking [npc.her] [npc.hips], forcing #IF(npc3.isPlayer())[npc3.namePos] и [npc2.namePos]#ELSE[npc2.namePos] и [npc3.namePos]#ENDIF [npc2.cocks+(true)] ever deeper into [npc.her] [npc.spinneret+].",
				...
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                        "With a quick buck of [npc.her] [npc.hips], [npc.name] let out [npc.a_moan+] as [npc.she] help to sink [npc2.namePos] [npc2.cock+] deep into [npc.her] [npc.spinneret+].",
                        "With [npc.a_moan+], [npc.name] start bucking [npc.her] [npc.hips], forcing [npc2.namePos] [npc2.cock+] ever deeper into [npc.her] [npc.spinneret+].",
					...
					case DOM_GENTLE:
						UtilText.nodeContentSB.append(UtilText.parse(PenisSpinneret.getCharactersForParsing(Main.sex.getCharacterPerformingAction()), UtilText.returnStringAtRandom(
                                "[npc.Name] feel tears start to well up in [npc.her] [npc.eyes], and, not being able to hold back any longer, [npc.she] suddenly let out [npc.a_sob+],"
                                        + " before weakly trying to pull both #IF(npc3.isPlayer())[npc3.namePos] и [npc2.namePos]#ELSE[npc2.namePos] и [npc3.namePos]#ENDIF [npc2.cocks(true)] out of [npc.her] [npc.spinneret+].",
                                "[npc.A_sob+] bursts out from [npc.namePos] mouth as [npc.she] frantically try to pull [npc.her] [npc.spinneret] away from the unwanted double-penetration,"
				...
				switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(this))) {
					case DOM_GENTLE:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                ...
                                "[npc.A_sob+] bursts out from [npc.namePos] mouth as [npc.she] frantically try to pull [npc.her] [npc.ass+] away from [npc2.namePos] unwanted penetration,"
		...
		public String getDescription() {
			...
			if(PenisSpinneret.getOngoingCharacters(Main.sex.getCharacterPerformingAction()).size()>1) {
				switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
					case DOM_ROUGH:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                "Yanking [npc2.namePos] [npc2.cock] out of [npc.her] [npc.spinneret+], [npc.name] let out a menacing growl as [npc.she] command [npc2.name] to stop fucking [npc.herHim].",
                                "[npc.Name] lean into [npc2.name], inhaling [npc2.her] [npc2.scent] before yanking [npc2.her] [npc2.cock] out of [npc.her] [npc.spinneret+]."));
						break;
					default:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                "Sliding [npc2.namePos] [npc2.cock] out of [npc.her] [npc.spinneret+], [npc.name] let out [npc.a_moan+] as [npc.she] tell [npc2.name] to stop fucking [npc.herHim].",
                                "[npc.Name] lean into [npc2.name], inhaling [npc2.her] [npc2.scent] before sliding [npc2.her] [npc2.cock] out of [npc.her] [npc.spinneret+]."));
						break;
				}
				...
				if(!isTargetedCharacterInanimate()) {
					switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(this))) {
						...
						default:
							UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                    " [npc2.Name] [npc2.verb(let)] out [npc2.a_moan+] as [npc.name] stop [npc2.herHim] from fucking [npc.her] [npc.spinneret+].",
				...
				switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(action))) {
					case SUB_RESISTING:
						return (UtilText.parse(PenisSpinneret.getCharactersForParsing(Main.sex.getCharacterTargetedForSexAction(action)), UtilText.returnStringAtRandom(
								" Desperately trying, and failing, to pull away from the two [npc.cocks(true)] inside of [npc2.herHim],"
                                        + " [npc2.name] [npc2.verb(let)] out [npc2.a_sob+], tears streaming down [npc2.her] [npc2.face] as [npc2.she] weakly [npc2.verb(beg)] for [npc.name] и [npc3.name] to pull out of [npc2.her] [npc2.spinneret+].",
                                " [npc2.A_sob+] bursts out from between [npc2.namePos] [npc2.lips] as [npc2.she] weakly [npc2.verb(try)] to push [npc.name] и [npc3.name] away,"
								...
								" [npc2.Sobbing] in distress, and with tears running down [npc2.her] [npc2.face],"
                                        + " [npc2.name] weakly [npc2.verb(struggle)] in a vain attempt to dislodge the [npc.cocks(true)] thrusting into [npc2.her] [npc2.spinneret+], pleading and crying for [npc.name] и [npc3.name] to leave [npc2.herHim] alone.")));
					case SUB_NORMAL:
						return (UtilText.parse(PenisSpinneret.getCharactersForParsing(Main.sex.getCharacterTargetedForSexAction(action)), UtilText.returnStringAtRandom(
								...
								" [npc2.A_moan+] bursts out from between [npc2.namePos] [npc2.lips+],"
                                        + " and, thrusting out [npc2.her] [npc2.hips], [npc2.she] [npc2.verb(beg)] for [npc.name] и [npc3.name] to carry on fucking [npc2.herHim].",
					...
					case DOM_GENTLE:
						return (UtilText.parse(PenisSpinneret.getCharactersForParsing(Main.sex.getCharacterTargetedForSexAction(action)), UtilText.returnStringAtRandom(
								...
								" [npc2.A_moan+] drifts out from between [npc2.namePos] [npc2.lips+],"
                                        + " and, slowly bucking [npc2.her] [npc2.hips], [npc2.she] [npc2.verb(implore)] [npc.name] и [npc3.name] to carry on fucking [npc2.herHim].",
					...
					case DOM_ROUGH:
						return (UtilText.parse(PenisSpinneret.getCharactersForParsing(Main.sex.getCharacterTargetedForSexAction(action)), UtilText.returnStringAtRandom(
								...
								" [npc2.A_moan+] bursts out from between [npc2.namePos] [npc2.lips+],"
                                        + " and, roughly thrusting [npc2.her] [npc2.hips], [npc2.she] [npc2.verb(order)] [npc.name] и [npc3.name] to carry on fucking [npc2.herHim].",
					...
					default:
						return (UtilText.parse(PenisSpinneret.getCharactersForParsing(Main.sex.getCharacterTargetedForSexAction(action)), UtilText.returnStringAtRandom(
								...
								" [npc2.A_moan+] bursts out from between [npc2.namePos] [npc2.lips+],"
                                        + " and, energetically thrusting [npc2.her] [npc2.hips], [npc2.she] [npc2.verb(beg)] for [npc.name] и [npc3.name] to carry on fucking [npc2.herHim].",
				...
				switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(action))) {
					case SUB_RESISTING:
						return UtilText.parse(PenisSpinneret.getCharactersForParsing(Main.sex.getCharacterPerformingAction()), UtilText.returnStringAtRandom(
								...
								" [npc2.A_sob+] bursts out from between [npc2.namePos] [npc2.lips] as [npc2.she] weakly [npc2.verb(try)] to push [npc.name] away,"
                                        + " squirming and protesting as [npc.name] continue to force both [npc2.her] и [npc3.namePos] [npc2.cock+] deep into [npc.her] [npc.spinneret+].",
					...
					case SUB_RESISTING:
						return (UtilText.returnStringAtRandom(
								" Failing to pull [npc2.her] [npc2.cock] away from [npc.namePos] [npc.spinneret],"
										+ " [npc2.name] [npc2.verb(let)] out [npc2.a_sob+] as [npc2.she] weakly [npc2.verb(try)] to struggle free.",
								" [npc2.A_sob+] bursts out from between [npc2.namePos] [npc2.lips] as [npc2.she] weakly [npc2.verb(try)] to push [npc.name] away,"
                                        + " squirming and protesting as [npc.name] continue to force [npc2.her] [npc2.cock+] deep into [npc.her] [npc.spinneret+].",
								" [npc2.Sobbing] in distress, [npc2.name] [npc2.verb(try)], in vain, to pull [npc2.her] [npc2.cock] away from [npc.namePos] [npc.spinneret+]."));
					case DOM_GENTLE:
						return (UtilText.returnStringAtRandom(
								" [npc2.Name] gently [npc2.verb(slide)] [npc2.her] [npc2.cock+] deep into [npc.namePos] [npc.spinneret+],"
