...
public class FootMouth {
			...
			if(Main.sex.getCharacterPerformingAction().isAbleToAccessCoverableArea(CoverableArea.FEET, false)) {
				if(Main.sex.getCharacterTargetedForSexAction(this).getLegType().getFootType().equals(FootType.HOOFS)) {
					...
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "[npc.Eagerly(bringing)] [npc.her] head down to [npc2.namePos] hard hoofs, [npc.name] press [npc.her] [npc.lips+] against them and start passionately kissing and licking them.",
                            "[npc.Name] drop [npc.her] head down to [npc2.namePos] [npc2.feet], before eagerly pressing [npc.her] [npc.lips+] against [npc2.namePos] hard hoofs and starting to [npc.gently] kiss and lick them."));
					
				} else if(Main.sex.getCharacterTargetedForSexAction(this).getLegType().getFootType().equals(FootType.TALONS)) {
					foundFootType = true;
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "[npc.Eagerly(bringing)] [npc.her] head down to [npc2.namePos] bird-like feet, [npc.name] press [npc.her] [npc.lips+] against [npc2.her] talons and start passionately kissing and licking them.",
                            "[npc.Name] drop [npc.her] head down to [npc2.namePos] bird-like feet, before eagerly pressing [npc.her] [npc.lips+] against [npc2.namePos] talons and starting to [npc.gently] kiss and lick them."));
					
				} else if(Main.sex.getCharacterTargetedForSexAction(this).getLegType().getFootType().equals(FootType.TENTACLE)) {
					foundFootType = true;
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "[npc.Eagerly(bringing)] [npc.her] head down to [npc2.namePos] tentacles, [npc.name] press [npc.her] [npc.lips+] against them and start passionately kissing and licking them.",
                            "[npc.Name] drop [npc.her] head down to [npc2.namePos] tentacles, before eagerly pressing [npc.her] [npc.lips+] against them and starting to [npc.gently] kiss and lick them."));
					
				}
			}
			if(!foundFootType) {
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                        "[npc.Eagerly(bringing)] [npc.her] head down to [npc2.namePos] [npc2.feet+], [npc.name] press [npc.her] [npc.lips+] against them and start passionately kissing and licking them.",
                        "[npc.Name] drop [npc.her] head down to [npc2.namePos] [npc2.feet+], before eagerly pressing [npc.her] [npc.lips+] against them and starting to [npc.gently] kiss and lick them."));
			}
					...
					case SUB_RESISTING:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							" [npc2.Name] [npc2.verb(let)] out [npc2.a_sob+] as [npc.name] [npc.do] this, and with tears running down [npc2.her] [npc2.face], [npc2.she] desperately [npc2.verb(beg)] for [npc.herHim] to stop.",
                                " With [npc2.a_sob+], [npc2.name] [npc2.verb(try)] to pull away from [npc.name], but, being unable to do so, all [npc2.she] can do is sob as [npc.name] continue worshipping [npc2.her] [npc2.feet]."));
						break;
					default:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                " [npc2.Name] [npc2.verb(let)] out [npc2.a_moan+] as [npc.name] start worshipping [npc2.her] [npc2.feet],"
	...
	public static final SexAction FOOT_ORAL_GIVING_DOM_GENTLE = new SexAction(
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                    "After planting a series of gentle kisses on [npc2.namePos] [npc2.feet], [npc.name] proceed to start lovingly licking them, letting out a series of soft [npc.moans] in the process.",
                    "Gently kissing and licking [npc2.namePos] [npc2.toes+], [npc.name] let out a little [npc.moan] as [npc.she] lovingly worship [npc2.namePos] [npc2.feet(true)].",
                    "[npc.Name] let out a little [npc.moan] as [npc.she] press [npc.her] [npc.lips+] against [npc2.namePos] [npc2.feet], before starting to lovingly kiss and lick them."));
	...
	public static final SexAction FOOT_ORAL_GIVING_DOM_NORMAL = new SexAction(
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                    "After planting a series of passionate kisses on [npc2.namePos] [npc2.feet], [npc.name] proceed to start enthusiastically licking them, letting out a series of [npc.moans+] in the process.",
                    "Passionately kissing and licking [npc2.namePos] [npc2.toes+], [npc.name] let out [npc.a_moan+] as [npc.she] happily worship [npc2.namePos] [npc2.feet(true)].",
                    "[npc.Name] let out [npc.a_moan+] as [npc.she] press [npc.her] [npc.lips+] against [npc2.namePos] [npc2.feet], before starting to eagerly kiss and lick them."));
	...
	public static final SexAction FOOT_ORAL_GIVING_DOM_ROUGH = new SexAction(
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                    "After planting a series of forceful kisses on [npc2.namePos] [npc2.feet], [npc.name] proceed to start roughly licking them, letting out a series of [npc.moans+] in the process.",
                    "Roughly kissing and licking [npc2.namePos] [npc2.toes+], [npc.name] let out [npc.a_moan+] as [npc.she] dominantly worship [npc2.namePos] [npc2.feet(true)].",
                    "[npc.Name] let out [npc.a_moan+] as [npc.she] press [npc.her] [npc.lips+] against [npc2.namePos] [npc2.feet], before starting to forcefully kiss and lick them."));
	...
	public static final SexAction FOOT_ORAL_GIVING_SUB_NORMAL = new SexAction(
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                    "After planting a series of kisses on [npc2.namePos] [npc2.feet], [npc.name] proceed to start licking them, letting out a series of [npc.moans+] in the process.",
                    "Kissing and licking [npc2.namePos] [npc2.toes+], [npc.name] let out [npc.a_moan+] as [npc.she] worship [npc2.namePos] [npc2.feet(true)].",
                    "[npc.Name] let out [npc.a_moan+] as [npc.she] press [npc.her] [npc.lips+] against [npc2.namePos] [npc2.feet], before starting to kiss and lick them."));
	...
	public static final SexAction FOOT_ORAL_GIVING_SUB_RESIST = new SexAction(
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                    "[npc.Name] desperately try, and fail, to pull [npc.her] [npc.face+] away from [npc2.namePos] [npc2.feet+], letting out [npc.a_sob+] in the process.",
                    ...
                    "[npc.Sobbing] in distress, [npc.name] weakly struggle against [npc2.name] as [npc.she] plead for [npc2.herHim] to take [npc2.her] [npc2.feet] away from [npc.her] [npc.face]."));
	...
	public static final SexAction FOOT_ORAL_GIVING_STOP = new SexAction(
		...
		public String getDescription() {
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "After planting one last, rough kiss on [npc2.namePos] [npc2.feet+], [npc.name] lift [npc.her] head and bring an end to [npc.her] worshipping.",
				...
				default:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "After planting one last kiss on [npc2.namePos] [npc2.feet+], [npc.name] lift [npc.her] head and bring an end to [npc.her] worshipping.",
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(this))) {
				...
				default:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            " [npc2.Name] [npc2.verb(let)] out [npc2.a_moan+] as [npc.name] pull back, eager for more of [npc.her] attention.",
		...
		public String getDescription() {
			...
			if(Main.sex.getCharacterPerformingAction().isAbleToAccessCoverableArea(CoverableArea.FEET, false)) {
				if(Main.sex.getCharacterPerformingAction().getLegType().getFootType().equals(FootType.HOOFS)) {
					foundFootType = true;
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "With [npc.a_moan+], [npc.name] [npc.eagerly] push [npc2.namePos] head down to [npc.her] hard hoofs, before getting [npc2.herHim] to kiss them and start orally worshipping [npc.her] [npc.feet+].",
                            "Pushing [npc2.namePos] head down to [npc.her] hard hoofs, [npc.name] can't help but [npc.moanVerb+] as [npc.she] make [npc2.herHim] kiss and orally worship [npc.her] [npc.feet+]."));
					
				} else if(Main.sex.getCharacterPerformingAction().getLegType().getFootType().equals(FootType.TALONS)) {
					foundFootType = true;
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "With [npc.a_moan+], [npc.name] [npc.eagerly] push [npc2.namePos] head down to [npc.her] bird-like feet, before getting [npc2.herHim] to kiss [npc.her] talons and start orally worshipping [npc.her] [npc.feet+].",
                            "Pushing [npc2.namePos] head down to [npc.her] bird-like feet, [npc.name] can't help but [npc.moanVerb+] as [npc.she] make [npc2.herHim] kiss [npc.her] talons and orally worship [npc.her] [npc.feet+]."));
					
				} else if(Main.sex.getCharacterPerformingAction().getLegType().getFootType().equals(FootType.TENTACLE)) {
					foundFootType = true;
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "With [npc.a_moan+], [npc.name] [npc.eagerly] push [npc2.namePos] head down to [npc.her] tentacles, before getting [npc2.herHim] to kiss and start orally worshipping them.",
                            "Pushing [npc2.namePos] head down to [npc.her] tentacles, [npc.name] can't help but [npc.moanVerb+] as [npc.she] make [npc2.herHim] kiss and orally worship them."));
				}
			}
			if(!foundFootType) {
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                        "With [npc.a_moan+], [npc.name] [npc.eagerly] push [npc2.namePos] head down to [npc.her] [npc.feet], before getting [npc2.herHim] to kiss them and start orally worshipping them.",
                        "Pushing [npc2.namePos] head down to [npc.her] [npc.feet], [npc.name] can't help but [npc.moanVerb+] as [npc.she] make [npc2.herHim] kiss and orally worship them."));
			}
			...
			if(!isTargetedCharacterInanimate()) {
				switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(this))) {
					case SUB_RESISTING:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                " [npc2.Name] [npc2.verb(let)] out [npc2.a_sob+] as [npc.name] [npc.eagerly] push [npc.her] [npc.feet] against [npc2.her] mouth, and desperately [npc2.verb(try)] to pull away.",
                                " With [npc2.a_sob+], [npc2.name] [npc2.verb(struggle)] against [npc.name] as [npc.she] [npc.eagerly] press [npc.her] [npc.feet+] against [npc2.her] mouth."));
						break;
					default:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
	...
	private static String getTargetedCharacterReceivingResponse(SexAction action) {
		if(!action.isTargetedCharacterInanimate()) {
			switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(action))) {
				...
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            " [npc2.Name] [npc.eagerly] [npc2.verb(lick)] и [npc2.verb(suck)] on [npc.namePos] [npc.toes+], letting out [npc2.a_moan+] as [npc2.she] [npc2.eagerly] [npc2.verb(worship)] [npc.her] [npc.feet+].",
	...
	public static final SexAction FOOT_ORAL_RECEIVING_DOM_GENTLE = new SexAction(
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                    "Gently pushing [npc.her] [npc.feet+] into [npc2.namePos] [npc2.face], [npc.name] let out a soft [npc.moan] as [npc.she] [npc.has] them orally worshipped.",
                    "With a soft [npc.moan], [npc.name] gently push [npc.her] [npc.feet+] against [npc2.namePos] [npc2.lips+], giving [npc2.herHim] no option but to continue worshipping them.",
	...
	public static final SexAction FOOT_ORAL_RECEIVING_DOM_NORMAL = new SexAction(
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                    "[npc.Eagerly] pushing [npc.her] [npc.feet+] into [npc2.namePos] [npc2.face], [npc.name] let out [npc.a_moan+] as [npc.she] [npc.has] them orally worshipped.",
                    "With [npc.a_moan+], [npc.name] [npc.eagerly] push [npc.her] [npc.feet+] against [npc2.namePos] [npc2.lips+], giving [npc2.herHim] no option but to continue worshipping them.",
	...
	public static final SexAction FOOT_ORAL_RECEIVING_SUB_NORMAL = new SexAction(
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                    "Pushing [npc.her] [npc.feet+] into [npc2.namePos] [npc2.face], [npc.name] let out [npc.a_moan+] as [npc.she] [npc.has] them orally worshipped.",
                    "With [npc.a_moan+], [npc.name] push [npc.her] [npc.feet+] against [npc2.namePos] [npc2.lips+], giving [npc2.herHim] no option but to continue worshipping them.",
	...
	public static final SexAction FOOT_ORAL_RECEIVING_SUB_RESIST = new SexAction(
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                    "[npc.Name] desperately try, and fail, to pull [npc.her] [npc.feet] away from [npc2.namePos] [npc2.face], letting out [npc.a_sob+] in the process.",
                    ...
                    "[npc.Sobbing] in distress, [npc.name] weakly struggle against [npc2.name] as [npc.she] plead for [npc2.herHim] to take [npc2.her] mouth away from [npc.her] [npc.feet]."));
	...
	public static final SexAction FOOT_ORAL_RECEIVING_STOP = new SexAction(
		...
		public String getDescription() {
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "After roughly pushing [npc.her] [npc.feet+] into [npc2.namePos] face one last time, [npc.name] pull them away and put an end to [npc2.her] oral worshipping.",
                            "[npc.Name] grind [npc.her] [npc.feet+] into [npc2.namePos] face one last time, before letting out an amused [npc.moan] and suddenly pulling them away from [npc2.her] mouth."));
					break;
				default:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "After [npc.eagerly] pushing [npc.her] [npc.feet+] into [npc2.namePos] face one last time, [npc.name] pull them away and put an end to [npc2.her] oral worshipping.",
                            "[npc.Name] push [npc.her] [npc.feet+] into [npc2.namePos] face one last time, before letting out [npc.a_moan+] and firmly pulling them away from [npc2.her] mouth."));
					break;
			}
