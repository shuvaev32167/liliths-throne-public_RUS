...
public class TailMouth {
				...
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Slowly teasing the [npc.tailTip+] of [npc.her] [npc.tail(true)] over [npc2.namePos] [npc2.lips+],"
                                    + " [npc.name] let out a little [npc.moan] before slowly pushing forwards, sinking [npc.her] [npc.tail+(true)] down [npc2.her] throat.",
                            "[npc.Name] position the [npc.tailTip+] of [npc.her] [npc.tail(true)] between [npc2.namePos] [npc2.lips+],"
                                    + " and with a slow, steady pressure, [npc.she] gently sink it deep down [npc2.her] throat."));
					break;
				case DOM_NORMAL:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Eagerly teasing the [npc.tailTip+] of [npc.her] [npc.tail(true)] over [npc2.namePos] [npc2.lips+],"
                                    + " [npc.name] let out [npc.a_moan+] before thrusting forwards, greedily sinking [npc.her] [npc.tail+(true)] into [npc2.her] throat.",
                            "[npc.Name] position the [npc.tailTip+] of [npc.her] [npc.tail(true)] between [npc2.namePos] [npc2.lips+], "
                                    + "and with a determined thrust, [npc.she] eagerly sink it deep down [npc2.her] throat."));
					break;
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Roughly grinding the [npc.tailTip+] of [npc.her] [npc.tail(true)] over [npc2.namePos] [npc2.lips+],"
                                    + " [npc.name] let out [npc.a_moan+] before violently slamming forwards, forcing [npc.her] [npc.tail+(true)] deep into [npc2.her] throat.",
                            "[npc.Name] position the [npc.tailTip+] of [npc.her] [npc.tail(true)] between [npc2.namePos] [npc2.lips+],"
                                    + " and with a forceful thrust, [npc.she] roughly slam it deep down [npc2.her] throat."));
					break;
				case SUB_EAGER:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Eagerly teasing the [npc.tailTip+] of [npc.her] [npc.tail(true)] over [npc2.namePos] [npc2.lips+],"
				...
				case SUB_NORMAL:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Teasing the [npc.tailTip+] of [npc.her] [npc.tail(true)] over [npc2.namePos] [npc2.lips+],"
                                    + " [npc.name] let out [npc.a_moan+] before thrusting forwards, sinking [npc.her] [npc.tail+(true)] into [npc2.her] throat.",
                            "[npc.Name] position the [npc.tailTip+] of [npc.her] [npc.tail(true)] between [npc2.namePos] [npc2.lips+],"
                                    + " and with a little thrust, [npc.she] sink it deep down [npc2.her] throat."));
					break;
				case SUB_RESISTING:
					break;
			}
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
					"Softly pushing [npc.her] [npc.tail+(true)] deep down [npc2.namePos] throat,"
                            + " [npc.name] start sliding it in and out, letting out a little [npc.moan] with every one of [npc.her] gentle thrusts.",
					"Slowly pushing [npc.her] [npc.tail+(true)] down [npc2.namePos] throat,"
                            + " [npc.name] softly [npc2.verb(thrust)] it in and out, letting out a little [npc.moan] as [npc.she] gently receive oral from [npc2.herHim].",
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
					"Eagerly sinking [npc.her] [npc.tail+(true)] deep into [npc2.namePos] throat,"
                            + " [npc.name] start enthusiastically pumping it in and out, letting out [npc.a_moan+] with each one of [npc.her] energetic thrusts.",
					"Enthusiastically pushing [npc.her] [npc.tail+(true)] down [npc2.namePos] throat,"
                            + " [npc.name] enthusiastically [npc2.verb(thrust)] it in and out, letting out [npc.a_moan+] as [npc.she] greedily receive oral from [npc2.herHim].",
					"Thrusting [npc.her] [npc.tail+(true)] deep down [npc2.namePos] throat,"
                            + " [npc.name] let out [npc.a_moan+] as [npc.she] start to eagerly pump it in and out, breathing in [npc2.namePos] [npc2.scent] as [npc.she] desperately tail-fuck [npc2.her] face."));
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
					"Roughly slamming [npc.her] [npc.tail+(true)] deep into [npc2.namePos] throat,"
                            + " [npc.name] start roughly pumping it in and out, letting out [npc.a_moan+] with each one of [npc.her] brutal thrusts.",
					"Violently thrusting [npc.her] [npc.tail+(true)] down [npc2.namePos] throat,"
                            + " [npc.name] roughly [npc2.verb(thrust)] it in and out, letting out [npc.a_moan+] as [npc.she] forcefully receive oral from [npc2.herHim].",
					"Forcefully driving [npc.her] [npc.tail+(true)] deep down [npc2.namePos] throat,"
                            + " [npc.name] let out [npc.a_moan+] as [npc.she] start to roughly slam it in and out, breathing in [npc2.namePos] [npc2.scent] as [npc.she] violently tail-fuck [npc2.her] face."));
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
					"Sinking [npc.her] [npc.tail+(true)] deep into [npc2.namePos] throat,"
                            + " [npc.name] start pumping it in and out, letting out [npc.a_moan+] with each one of [npc.her] thrusts.",
					"Pushing [npc.her] [npc.tail+(true)] down [npc2.namePos] throat,"
                            + " [npc.name] [npc2.verb(thrust)] it in and out, letting out [npc.a_moan+] as [npc.she] receive oral from [npc2.herHim].",
					"Thrusting [npc.her] [npc.tail+(true)] deep down [npc2.namePos] throat,"
                            + " [npc.name] let out [npc.a_moan+] as [npc.she] start to pump it in and out, breathing in [npc2.namePos] [npc2.scent] as [npc.she] tail-fuck [npc2.her] face."));
	...
	public static final SexAction TAIL_THROAT_FUCK_SUB_RESIST = new SexAction(
		...
		public String getDescription() {
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(this))) {
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "[npc.Name] try to pull [npc.her] [npc.tail(true)] out of [npc2.namePos] mouth,"
                            ...
                            "With [npc.a_sob+], [npc.name] try to pull [npc.her] [npc.tail(true)] away from [npc2.name],"
									+ " but [npc2.she] quickly [npc2.verb(grab)] it and gently [npc2.verb(force)] it back down [npc2.her] throat.",
                            "Tears start to well up in [npc.namePos] [npc.eyes], and with [npc.a_sob+], [npc.she] try to pull [npc.her] [npc.tail(true)] away from [npc2.namePos] [npc2.lips+],"
		...
		public String getDescription() {
				...
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Roughly yanking [npc.her] [npc.tail+(true)] out of [npc2.namePos] mouth,"
                                    + " [npc.name] dominantly slide the [npc.tailTip+] up and down over [npc2.her] [npc2.lips+] one last time before pulling back.",
                            "Thrusting deep down [npc2.name] throat one last time, [npc.name] then yank [npc.her] [npc.tail+(true)] back out of [npc2.her] mouth, putting an end to the rough face-fucking."));
					break;
				default:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Sliding [npc.her] [npc.tail(true)] out of [npc2.namePos] mouth,"
                                    + " [npc.name] rub the [npc.tailTip] up and down over [npc2.her] [npc2.lips+] one last time before pulling back.",
                            "Pushing deep down [npc2.name] throat one last time, [npc.name] then slide [npc.her] [npc.tail+(true)] back out of [npc2.her] mouth, putting an end to the face-fucking."));
					break;
			}
			...
			if(!isTargetedCharacterInanimate()) {
				switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(this))) {
					case SUB_RESISTING:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                " [npc2.Name] can't [npc2.verb(help)] but [npc2.verb(let)] out [npc2.sob+] as [npc.name] pull out of [npc2.her] throat,"
					...
					default:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                " [npc2.Name] [npc2.verb(let)] out [npc2.a_moan+] as [npc.name] pull [npc.her] [npc.tail+(true)] out of [npc2.her] throat, eager for more of [npc.her] attention.",
	...
	public static final SexAction USING_TAIL_START = new SexAction(
		...
		public String getDescription() {
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Grabbing [npc2.namePos] [npc2.tail(true)], [npc.name] slowly guide it up to [npc.her] [npc.lips+],"
									+ " letting out a little [npc.moan] before opening wide and gently taking it deep down [npc.her] throat.",
                            "Grabbing [npc2.namePos] [npc2.tail(true)], [npc.name] line it up to [npc.her] parted [npc.lips],"
									+ " before slowly moving [npc.her] head forwards and gently taking it deep down [npc.her] throat."));
					break;
				case DOM_NORMAL:
				case SUB_EAGER:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Grabbing [npc2.namePos] [npc2.tail(true)], [npc.name] eagerly guide it up to [npc.her] [npc.lips+],"
									+ " letting out [npc.a_moan+] before opening wide and greedily taking it deep down [npc.her] throat.",
                            "Grabbing [npc2.namePos] [npc2.tail(true)], [npc.name] impatiently line it up to [npc.her] parted [npc.lips],"
									+ " before quickly bobbing [npc.her] head forwards and eagerly taking it deep down [npc.her] throat."));
					break;
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Grabbing [npc2.namePos] [npc2.tail(true)], [npc.name] roughly yank it up to [npc.her] [npc.lips+],"
									+ " letting out [npc.a_moan+] before opening wide and forcefully taking it deep down [npc.her] throat.",
                            "Grabbing [npc2.namePos] [npc2.tail(true)], [npc.name] violently yank it up to [npc.her] parted [npc.lips],"
									+ " before quickly bobbing [npc.her] head forwards and roughly forcing it deep down [npc.her] throat."));
					break;
				case SUB_NORMAL:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Grabbing [npc2.namePos] [npc2.tail(true)], [npc.name] guide it up to [npc.her] [npc.lips+],"
				...
				switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(this))) {
					...
					case SUB_RESISTING:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                ...
                                " With [npc2.a_sob+], [npc2.name] [npc2.verb(struggle)] against [npc.name] as [npc.she] force [npc2.her] [npc2.tail(true)] deep into [npc.her] throat."));
						break;
				}
			}
	...
	public static final SexAction SUCKING_TAIL_DOM_GENTLE = new SexAction(
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                    "Gently pushing [npc.her] head forwards, [npc.name] let out a soft [npc.moan] as [npc.she] help to sink [npc2.namePos] [npc2.tail+(true)] deep down [npc.her] throat.",
                    "With a soft [npc.moan], [npc.name] gently start pushing [npc.her] head forwards, forcing [npc2.namePos] [npc2.tail+(true)] ever deeper down [npc.her] throat.",
					"Slowly pushing [npc.her] head forwards,"
                            + " a muffled [npc.moan] escapes from between [npc.namePos] [npc.lips+] as [npc.she] force [npc2.namePos] [npc2.tail+(true)] deep down [npc.her] throat."));
	...
	public static final SexAction SUCKING_TAIL_DOM_NORMAL = new SexAction(
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                    "Eagerly pushing [npc.her] head forwards, [npc.name] let out [npc.a_moan+] as [npc.she] help to sink [npc2.namePos] [npc2.tail+(true)] deep down [npc.her] throat.",
                    "With [npc.a_moan+], [npc.name] enthusiastically start pushing [npc.her] head forwards, forcing [npc2.namePos] [npc2.tail+(true)] ever deeper down [npc.her] throat.",
					"Energetically pushing [npc.her] head forwards,"
                            + " [npc.a_moan+] escapes from between [npc.namePos] [npc.lips+] as [npc.she] happily force [npc2.namePos] [npc2.tail+(true)] deep down [npc.her] throat."));
	...
	public static final SexAction SUCKING_TAIL_DOM_ROUGH = new SexAction(
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                    "Violently slamming [npc.her] head forwards, [npc.name] let out [npc.a_moan+] as [npc.she] force [npc2.namePos] [npc2.tail+(true)] deep down [npc.her] throat.",
                    "With [npc.a_moan+], [npc.name] start roughly pushing [npc.her] head forwards, forcing [npc2.namePos] [npc2.tail+(true)] ever deeper down [npc.her] throat.",
					"Forcefully pushing [npc.her] head forwards,"
                            + " [npc.a_moan+] escapes from between [npc.namePos] [npc.lips+] as [npc.she] violently force [npc2.namePos] [npc2.tail+(true)] deep down [npc.her] throat."));
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(this))) {
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            ...
                            "[npc.A_sob+] bursts out from [npc.namePos] mouth as [npc.she] frantically try to pull [npc.her] head away from [npc2.namePos] unwanted penetration,"
	...
	public static final SexAction FUCKED_STOP = new SexAction(
		...
		public String getDescription() {
			...
			switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Yanking [npc2.namePos] [npc2.tail(true)] out of [npc.her] throat, [npc.name] let out a menacing growl to remind [npc2.name] that [npc.sheIs] the one in charge.",
                            "[npc.Name] lean into [npc2.name], taking a moment to inhale [npc2.her] [npc2.scent] before yanking [npc2.her] [npc2.tail(true)] out of [npc.her] throat."));
					break;
				default:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Sliding [npc2.namePos] [npc2.tail(true)] out of [npc.her] throat, [npc.name] let out [npc.a_moan+] to let [npc2.name] know that [npc.she] enjoyed the experience.",
                            "[npc.Name] lean into [npc2.name], taking a moment to inhale [npc2.her] [npc2.scent] before sliding [npc2.her] [npc2.tail(true)] out of [npc.her] throat."));
					break;
			}
			...
			if(!isTargetedCharacterInanimate()) {
				switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(this))) {
					...
					default:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                " [npc2.Name] [npc2.verb(let)] out [npc2.a_moan+] as [npc.name] stop [npc2.herHim] from tail-fucking [npc.her] throat.",
	...
	public static final SexAction THROAT_CONTROL = new SexAction(
		...
		public String getDescription() {
			return UtilText.returnStringAtRandom(
                    "Letting out [npc.a_moan+], [npc.name] concentrate on squeezing the extra internal muscles within [npc.her] throat down around [npc2.namePos] [npc2.tail+(true)].",
					(!isTargetedCharacterInanimate()
                            ? "[npc.Name] let out [npc.a_moan+] as [npc.she] focus on controlling the extra muscles lining the insides of [npc.her] throat."
                    ...
                    "With [npc.a_moan+], [npc.name] focus on controlling the extra muscles deep within [npc.her] throat,"
				...
				case SUB_RESISTING:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							...
							" [npc2.A_sob+] bursts out from between [npc2.namePos] [npc2.lips] as [npc2.she] weakly [npc2.verb(try)] to push [npc.name] away,"
                                    + " squirming and protesting as [npc.name] continue to force [npc2.her] [npc2.tail+(true)] deep into [npc.her] throat.",
