...
public class TongueMouth {
			...
			if(Main.sex.getSexPositionSlot(Main.sex.getCharacterPerformingAction()).hasTag(SexSlotTag.COWGIRL)
				...
				if (Main.sex.getAllOngoingSexAreas(Main.sex.getCharacterPerformingAction(), SexAreaOrifice.ANUS).contains(SexAreaPenetration.PENIS)) {
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "[npc.Name] sink down onto [npc2.namePos] [npc2.penis], letting out [npc.a_moan+] as [npc.her] [npc.asshole+] grips down around [npc2.her] [npc2.penisGirth] [npc2.penis+]."
                                    + " As [npc.her] [npc.moan] trails off, [npc.name] lean down and grab [npc2.namePos] head in both hands,"
									+ " before pressing [npc.her] [npc.lips+] against [npc2.hers] and delivering a passionate kiss.",

                            "With [npc.a_moan+], [npc.name] slide down onto [npc2.namePos] [npc2.penis+], before leaning down and pressing [npc.herself] against [npc2.her] [npc2.breasts]."
                                    + " Breathing in [npc2.namePos] [npc2.scent+], [npc.name] press [npc.her] [npc.lips+] against [npc2.hers] и start to passionately kiss [npc2.herHim].",

                            "[npc.Name] let [npc2.namePos] [npc2.penis+] slide even deeper into [npc.her] [npc.asshole+] as [npc.she] lean down and pull [npc2.herHim] into a desperate kiss.",

                            "Dropping down, [npc.name] let out [npc.a_moan+] as [npc.she] bury [npc2.namePos] [npc2.penis+] in [npc.her] [npc.asshole+],"
					...
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "[npc.Name] sink down onto [npc2.namePos] [npc2.penis], letting out [npc.a_moan+] as [npc.her] [npc.vagina+] grips down around [npc2.her] [npc2.penisGirth] [npc2.penis+]."
                                    + " As [npc.her] [npc.moan] trails off, [npc.name] lean down and grab [npc2.namePos] head in both hands,"
									+ " before pressing [npc.her] [npc.lips+] against [npc2.hers] and delivering a passionate kiss.",
                            ...
                            "[npc.Name] let [npc2.namePos] [npc2.penis+] [npc2.verb(slide)] even deeper into [npc.her] [npc.vagina+] as [npc.she] lean down and pull [npc2.herHim] into a desperate kiss.",

                            "Dropping down, [npc.name] let out [npc.a_moan+] as [npc.she] bury [npc2.namePos] [npc2.penis+] in [npc.her] [npc.vagina+],"
							+ " before leaning down and pressing [npc.her] [npc.lips+] against [npc2.hers]."));
					
				} else {
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "[npc.Name] lean down, pressing [npc.her] [npc.lips+] against [npc2.namePos] mouth as [npc.she] deliver a passionate kiss.",

                            "With a grin, [npc.name] lean down into [npc2.namePos] [npc2.breasts], breathing in [npc2.her] [npc2.scent] as [npc.she] press [npc.her] [npc.lips+] against [npc2.hers].",

                            "Leaning down, [npc.name] let out [npc.a_moan+] as [npc.she] press [npc.her] [npc.lips+] against [npc2.namePos] и start to eagerly kiss [npc2.herHim]."));
				}
				...
				if(!isTargetedCharacterInanimate()) {
					switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(this))) {
						...
						case SUB_RESISTING:
							UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                    " [npc2.Name] [npc2.verb(try)] to pull away, [npc2.sobbing] and squirming in discomfort as [npc.name] force [npc.herself] on [npc2.herHim].",

                                    " [npc2.NamePos] [npc2.sob+] is muffled into [npc.namePos] mouth as [npc2.she] [npc2.verb(try)] to pull away, squirming in discomfort as [npc.name] force [npc.herself] on [npc2.herHim].",
								
								" With [npc2.a_sob+], [npc2.name] [npc2.verb(try)], in vain, to pull away from [npc.name],"
                                        + " protesting and squirming in discomfort as [npc.name] force [npc.her] [npc.tongue] past [npc2.her] reluctant [npc2.lips]."));
							break;
						default:
							UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								" [npc2.Name] happily [npc2.verb(push)] [npc2.her] [npc2.tongue] deep into [npc.namePos] mouth,"
                                        + " eagerly pressing [npc2.her] [npc2.lips+] back against [npc.hers] и [npc2.moaning] in delight as [npc2.she] greedily [npc2.verb(return)] [npc.her] display of affection.",
				...
				switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
					case DOM_GENTLE:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                "Reaching up to take hold of [npc2.namePos] chin, [npc.name] tilt [npc2.her] head to one side as [npc.she] lean forwards,"
                                        + " pressing [npc.her] [npc.lips+] against [npc2.hers] as [npc.she] pull [npc2.herHim] into a gentle kiss.",

                                "[npc.Name] lean forwards, pressing into [npc2.namePos] back and breathing in [npc2.her] [npc2.scent+]."
                                        + " Reaching up, [npc.she] turn [npc2.namePos] head to one side and gently press [npc.her] [npc.lips+] against [npc2.hers].",

                                "[npc.Name] lean into [npc2.namePos] back, turning [npc2.her] head slightly to one side before gently pulling [npc2.herHim] into a soft kiss."));
						break;
					case DOM_ROUGH:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                "Reaching up to roughly grab [npc2.namePos] chin, [npc.name] yank [npc2.her] head to one side,"
                                        + " before grinding [npc.her] [npc.lips+] against [npc2.hers] as [npc.she] pull [npc2.herHim] into a forceful kiss.",

                                "[npc.Name] lean forwards, pressing into [npc2.namePos] back and breathing in [npc2.her] [npc2.scent+]."
                                        + " Reaching up, [npc.she] roughly yank [npc2.namePos] head to one side before forcefully press [npc.her] [npc.lips+] against [npc2.hers].",

                                "[npc.Name] lean into [npc2.namePos] back, yanking [npc2.her] head to one side before roughly forcing [npc.her] [npc.tongue+] down [npc2.her] throat."));
						break;
					default:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                "Reaching up to take hold of [npc2.her] chin, [npc.name] lean forwards,"
                                        + " eagerly pressing [npc.her] [npc.lips+] against [npc2.hers] as [npc.she] pull [npc2.herHim] into a passionate kiss.",

                                "[npc.Name] lean forwards, pressing into [npc2.namePos] back and breathing in [npc2.her] [npc2.scent+]."
                                        + " Reaching up, [npc.she] turn [npc2.namePos] head to one side and passionately press [npc.her] [npc.lips+] against [npc2.hers].",

                                "[npc.Name] lean into [npc2.namePos] back, turning [npc2.her] head slightly to one side before eagerly pulling [npc2.herHim] into a passionate kiss."));
						break;
				}
				if(!isTargetedCharacterInanimate()) {
					switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(this))) {
				...
				switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
					case DOM_GENTLE:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                "Gazing into [npc2.namePos] [npc2.eyes], [npc.name] lean forwards, pressing [npc.her] [npc.lips+] against [npc2.hers] as [npc.she] pull [npc2.herHim] into a gentle kiss.",

                                "[npc.Name] lean into [npc2.name], breathing in [npc2.her] [npc2.scent+] as [npc.she] gently press [npc.her] [npc.lips+] against [npc2.hers].",

                                "[npc.Name] lean in against [npc2.namePos] [npc2.breasts+], tilting [npc.her] head slightly to one side before gently pulling [npc2.herHim] into a loving kiss."));
						break;
					case DOM_NORMAL:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                "Gazing into [npc2.namePos] [npc2.eyes], [npc.name] lean forwards, pressing [npc.her] [npc.lips+] against [npc2.hers] as [npc.she] pull [npc2.herHim] into a passionate kiss.",

                                "[npc.Name] lean into [npc2.name], breathing in [npc2.her] [npc2.scent+] as [npc.she] eagerly press [npc.her] [npc.lips+] against [npc2.hers].",

                                "[npc.Name] lean in against [npc2.namePos] [npc2.breasts+], tilting [npc.her] head slightly to one side before eagerly pulling [npc2.herHim] into a passionate kiss."));
						break;
					case DOM_ROUGH:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                "Gazing into [npc2.namePos] [npc2.eyes], [npc.name] lean forwards, roughly pressing [npc.her] [npc.lips+] against [npc2.hers] as [npc.she] pull [npc2.herHim] into a forceful kiss.",

                                "[npc.Name] lean into [npc2.name], breathing in [npc2.her] [npc2.scent+] as [npc.she] roughly grind [npc.her] [npc.lips+] against [npc2.hers].",

                                "[npc.Name] lean in against [npc2.namePos] [npc2.breasts+], tilting [npc.her] head to one side before violently pulling [npc2.herHim] into a rough kiss."));
						break;
					case SUB_EAGER:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                "Gazing into [npc2.namePos] [npc2.eyes], [npc.name] lean forwards, eagerly pressing [npc.her] [npc.lips+] against [npc2.hers] and delivering a passionate kiss.",

                                "[npc.Name] lean into [npc2.name], breathing in [npc2.her] [npc2.scent+] as [npc.she] eagerly press [npc.her] [npc.lips+] against [npc2.hers].",

                                "[npc.Name] lean in against [npc2.namePos] [npc2.breasts+], tilting [npc.her] head slightly to one side before planting a desperate, passionate kiss on [npc2.her] [npc2.lips+]."));
						break;
					case SUB_NORMAL:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                "Gazing into [npc2.namePos] [npc2.eyes], [npc.name] lean forwards, before pressing [npc.her] [npc.lips+] against [npc2.hers] and delivering a passionate kiss.",

                                "[npc.Name] lean into [npc2.name], breathing in [npc2.her] [npc2.scent+] as [npc.she] happily press [npc.her] [npc.lips+] against [npc2.hers].",

                                "[npc.Name] lean in against [npc2.namePos] [npc2.breasts+], tilting [npc.her] head slightly to one side before planting a wet kiss on [npc2.her] [npc2.lips+]."));
						break;
					default:
						break;
				}
				...
				if(!isTargetedCharacterInanimate()) {
					switch(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(this))) {
						...
						case SUB_EAGER:
							UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								" [npc2.Name] happily [npc2.verb(push)] [npc2.her] [npc2.tongue] deep into [npc.namePos] mouth,"
                                        + " eagerly pressing [npc2.her] [npc2.lips+] against [npc.hers] и [npc2.moaning] in delight as [npc2.she] greedily [npc2.verb(return)] [npc.her] display of affection.",
	...
	public static final SexAction KISS_DOM_GENTLE = new SexAction(
		...
		public String getDescription() {
			...
			if(Main.sex.getSexPositionSlot(Main.sex.getCharacterTargetedForSexAction(this)).hasTag(SexSlotTag.FACE_TO_WALL)
				...
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                        "Still leaning into [npc2.namePos] back, [npc.name] gently press [npc.her] [npc.lips+] against [npc2.nameHers], before planting a series of soft kisses on [npc2.her] mouth.",

                        "[npc.Name] gently lean into [npc2.namePos] back, breathing in [npc2.her] [npc2.scent] as [npc.she] plant a series of soft kisses on [npc2.her] [npc2.lips+].",

                        "[npc.Name] slowly press into [npc2.namePos] back, gently pinning [npc2.herHim] against the wall as [npc.she] lean in over [npc2.her] shoulder to gently kiss [npc2.her] [npc2.lips+]."));

			} else {

				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                        "Gently pressing [npc.her] [npc.lips+] against [npc2.nameHers], [npc.name] plant a series of soft kisses on [npc2.her] mouth.",

                        "[npc.Name] gently lean in against [npc2.name], breathing in [npc2.her] [npc2.scent+] as [npc.she] plant a series of soft kisses on [npc2.her] [npc2.lips+].",

                        "[npc.Name] gently press against [npc2.namePos] [npc2.breasts+], before tilting [npc.her] head slightly to one side as [npc.she] softly kiss [npc2.her] [npc2.lips+]."));
	...
	public static final SexAction KISS_DOM_NORMAL = new SexAction(
		...
		public String getDescription() {
			...
			if(Main.sex.getSexPositionSlot(Main.sex.getCharacterTargetedForSexAction(this)).hasTag(SexSlotTag.FACE_TO_WALL)
				...
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                        "Still leaning into [npc2.namePos] back, [npc.name] eagerly press [npc.her] [npc.lips+] against [npc2.nameHers], before planting a series of passionate kisses on [npc2.her] mouth.",

                        "[npc.Name] eagerly lean into [npc2.namePos] back, breathing in [npc2.her] [npc2.scent] as [npc.she] plant a series of passionate kisses on [npc2.her] [npc2.lips+].",

                        "[npc.Name] eagerly press into [npc2.namePos] back, pinning [npc2.herHim] against the wall as [npc.she] lean in over [npc2.her] shoulder to passionately kiss [npc2.her] [npc2.lips+]."));

			} else {

				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                        "Eagerly pressing [npc.her] [npc.lips+] against [npc2.nameHers], [npc.name] plant a series of passionate kisses on [npc2.her] mouth.",

                        "[npc.Name] eagerly lean in against [npc2.name], breathing in [npc2.her] [npc2.scent+] as [npc.she] plant a series of soft kisses on [npc2.her] [npc2.lips+].",

                        "[npc.Name] eagerly press against [npc2.namePos] [npc2.breasts+], before tilting [npc.her] head slightly to one side as [npc.she] passionately kiss [npc2.her] [npc2.lips+]."));
	...
	public static final SexAction KISS_DOM_ROUGH = new SexAction(
		...
		public String getDescription() {
			...
			if(Main.sex.getSexPositionSlot(Main.sex.getCharacterTargetedForSexAction(this)).hasTag(SexSlotTag.FACE_TO_WALL)
				...
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                        "Violently grinding into [npc2.namePos] back, [npc.name] forcefully press [npc.her] [npc.lips+] against [npc2.nameHers], before greedily thrusting [npc.her] [npc.tongue] deep down [npc2.her] throat.",

                        "[npc.Name] roughly press into [npc2.namePos] back, breathing in [npc2.her] [npc2.scent] as [npc.she] plant a series of passionate kisses on [npc2.her] [npc2.lips+].",

                        "[npc.Name] roughly press into [npc2.namePos] back,"
                                + " forcefully pinning [npc2.herHim] against the wall as [npc.she] lean in over [npc2.her] shoulder to thrust [npc.her] [npc.tongue+] deep down [npc2.her] throat."));

			} else {

				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                        "Forcefully pressing [npc.her] [npc.lips+] against [npc2.nameHers], [npc.name] greedily thrust [npc.her] [npc.tongue] deep down [npc2.her] throat.",

                        "[npc.Name] roughly grind against [npc2.name], breathing in [npc2.her] [npc2.scent+] as [npc.she] greedily tongue-fuck [npc2.her] mouth.",

                        "[npc.Name] roughly press against [npc2.namePos] [npc2.breasts+], before thrusting [npc.her] [npc.tongue] deep down [npc2.her] throat."));
	...
	public static final SexAction KISS_SUB_NORMAL = new SexAction(
		...
		public String getDescription() {
			...
			if(Main.sex.getSexPositionSlot(Main.sex.getCharacterTargetedForSexAction(this)).hasTag(SexSlotTag.FACE_TO_WALL)
				...
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                        "Still leaning into [npc2.namePos] back, [npc.name] press [npc.her] [npc.lips+] against [npc2.nameHers], before planting a series of passionate kisses on [npc2.her] mouth.",

                        "[npc.Name] lean into [npc2.namePos] back, breathing in [npc2.her] [npc2.scent] as [npc.she] plant a series of passionate kisses on [npc2.her] [npc2.lips+].",

                        "[npc.Name] press into [npc2.namePos] back, pinning [npc2.herHim] against the wall as [npc.she] lean in over [npc2.her] shoulder to passionately kiss [npc2.her] [npc2.lips+]."));

			} else {

				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                        "Pressing [npc.her] [npc.lips+] against [npc2.nameHers], [npc.name] plant a series of passionate kisses on [npc2.her] mouth.",

                        "[npc.Name] lean in against [npc2.name], breathing in [npc2.her] [npc2.scent+] as [npc.she] plant a series of soft kisses on [npc2.her] [npc2.lips+].",

                        "[npc.Name] press against [npc2.namePos] [npc2.breasts+], before tilting [npc.her] head slightly to one side as [npc.she] passionately kiss [npc2.her] [npc2.lips+]."));
	...
	public static final SexAction KISS_SUB_RESIST = new SexAction(
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                    "Feeling tears welling up in [npc.her] eyes, [npc.name] let out [npc.a_sob+], trying to push back against [npc2.name] in response to [npc2.her] unwanted kisses.",

                    "With [npc2.namePos] [npc2.scent+] overwhelming [npc.her] senses, [npc.name] let out a muffled [npc.sob],"
                    ...
                    "[npc.Name] desperately try to push [npc2.name] away, [npc.sobbing] in distress as [npc2.she] [npc2.verb(continue)] kissing and grinding up against [npc.herHim]."));
				...
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
						"Pulling back, [npc.name] roughly pushes [npc2.name] away from [npc.herHim] as [npc.she] puts an end to [npc.her] kiss.",
                            ...
                            "[npc.Name] suddenly, and roughly, push [npc2.name] away from [npc.herHim], bringing an end to [npc.her] kiss.",

                            "[npc.Name] pull back from [npc2.name], before roughly pushing [npc2.herHim] away from [npc.herHim] and breaking off [npc.her] kiss."));
					break;
				default:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                            "Gazing into [npc2.namePos] [npc2.eyes], [npc.name] grin as [npc.she] pull back, putting an end to [npc.her] kiss.",

                            "[npc.Name] suddenly pull back, bringing an end to [npc.her] kiss.",

                            "[npc.Name] pull back from [npc2.name], taking [npc.her] [npc.lips+] away from [npc2.hers] as [npc.she] breaks off [npc.her] kiss."));
					break;
			}
					...
					case SUB_RESISTING:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							" [npc2.Name] [npc2.verb(breathe)] a small sigh of relief, before quickly continuing to [npc2.sob] and struggle against [npc.name] as [npc2.she] [npc2.verb(try)] to break free from [npc.her] grasp.",
                                ...
                                " With [npc2.a_sob+], [npc2.name] [npc2.verb(try)], in vain, to [npc2.verb(push)] [npc.name] even further away, protesting and squirming in discomfort as [npc.she] hold [npc2.herHim] firmly in place."));
						break;
					default:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                                " [npc2.Name] [npc2.verb(let)] out a little whine as [npc.name] pull back, signalling [npc2.her] desperate need for more attention.",
				...
				case SUB_RESISTING:
					return(UtilText.returnStringAtRandom(
						" [npc2.Name] [npc2.verb(let)] out [npc2.a_sob+] in response, trying [npc2.her] hardest to [npc2.verb(push)] [npc.name] away as [npc2.she] [npc2.verb(writhe)] about in discomfort.",
                            ...
                            " With [npc2.a_sob+], [npc2.name] [npc2.verb(try)] to [npc2.verb(push)] [npc.name] away, struggling in vain as [npc.she] continue to plant gentle kisses on [npc2.her] unwilling [npc2.lips].",

                            " [npc2.Name] desperately [npc2.verb(try)] to pull away, struggling and pushing back as [npc.name] continue to molest [npc2.herHim],"
