...
public class SadisticActions {
		...
		public String getDescription() {
			...
			if (Main.sex.getAllOngoingSexAreas(Main.sex.getCharacterTargetedForSexAction(this), SexAreaOrifice.VAGINA).contains(SexAreaPenetration.PENIS)) {
				if(!Main.sex.getCharacterTargetedForSexAction(this).hasTail()) {
                    tailSpecial1 = "Hilting [npc.her] [npc.cock+] deep inside [npc2.namePos] [npc2.pussy+], [npc.name] reach down and roughly grope [npc2.her] [npc2.ass+],"
							+ " before starting to deliver a series of stinging slaps to [npc2.her] exposed cheeks.";
				} else {
                    tailSpecial1 = "Hilting [npc.her] [npc.cock+] deep inside [npc2.namePos] [npc2.pussy+], [npc.name] roughly grab the base of [npc2.her] [npc2.tail+] и yank upwards,"
				...
				if(!Main.sex.getCharacterTargetedForSexAction(this).hasTail()) {
                    tailSpecial2 = "Still ploughing away at [npc2.her] [npc2.pussy+], [npc.name] growl down that [npc.sheIs] going to put [npc2.name] in [npc2.her] place,"
							+ " before starting to make good on [npc.her] threat by aggressively slapping [npc2.her] exposed ass cheeks.";
				} else {
                    tailSpecial2 = "Still ploughing away at [npc2.her] [npc2.pussy+], [npc.name] grab the base of [npc2.namePos] [npc2.tail+] in one [npc.hand],"
				...
				return UtilText.returnStringAtRandom(
							tailSpecial1,
							tailSpecial2,
                        "Hilting [npc.her] [npc.cock+] deep inside [npc2.namePos] [npc2.pussy], [npc.name] use one [npc.hand] to hold [npc2.herHim] still,"
							...
							isTargetedCharacterInanimate()?null
                                    : "[npc2.Name] [npc2.verb(let)] out [npc2.a_moan+] as [npc.name] start slapping [npc2.her] [npc2.ass+] in time with [npc.her] powerful thrusts into [npc2.her] [npc2.pussy+].",
							isTargetedCharacterInanimate()?null
                                    : "While [npc.name] continue pounding away at [npc2.namePos] [npc2.pussy+], [npc.she] reach down and start to roughly slap [npc2.her] [npc2.ass+],"
                                    + " growling in glee as [npc2.she] [npc2.verb(squirm)] и [npc2.verb(squeal)] under [npc.her] stinging blows.");
				...
				if(!Main.sex.getCharacterTargetedForSexAction(this).hasTail()) {
                    tailSpecial1 = "Hilting [npc.her] [npc.cock+] deep inside [npc2.namePos] [npc2.asshole+], [npc.name] reach down and roughly grope [npc2.her] [npc2.ass+],"
							+ " before starting to deliver a series of stinging slaps to [npc2.her] exposed cheeks.";
				} else {
                    tailSpecial1 = "Hilting [npc.her] [npc.cock+] deep inside [npc2.namePos] [npc2.asshole+], [npc.name] roughly grab the base of [npc2.her] [npc2.tail+] и yank upwards,"
										+ " raising [npc2.her] [npc2.ass+] up high in the air before starting to deliver a series of stinging slaps to [npc2.her] exposed cheeks.";
				}
				if(!Main.sex.getCharacterTargetedForSexAction(this).hasTail()) {
                    tailSpecial2 = "Still ploughing away at [npc2.her] [npc2.asshole+], [npc.name] growl down that [npc.sheIs] going to put [npc2.name] in [npc2.her] place,"
							+ " before starting to make good on [npc.her] threat by aggressively slapping [npc2.her] exposed ass cheeks.";
				} else {
                    tailSpecial2 = "Still ploughing away at [npc2.her] [npc2.asshole+], [npc.name] grab the base of [npc2.namePos] [npc2.tail+] in one [npc.hand],"
										+ " roughly yanking [npc2.her] [npc2.ass+] up high in the air before starting to aggressively slap [npc2.her] exposed cheeks.";
				}
				...
				return UtilText.returnStringAtRandom(
							tailSpecial1,
							tailSpecial2,
                        "Hilting [npc.her] [npc.cock+] deep inside [npc2.namePos] [npc2.asshole], [npc.name] use one [npc.hand] to hold [npc2.herHim] still,"
								+ " while using [npc.her] other to deliver a series of stinging slaps to [npc2.her] exposed ass cheeks.",
							isTargetedCharacterInanimate()?null
                                    : "[npc2.Name] [npc2.verb(let)] out [npc2.a_moan+] as [npc.name] start slapping [npc2.her] [npc2.ass+] in time with [npc.her] powerful thrusts into [npc2.her] [npc2.asshole+].",
							isTargetedCharacterInanimate()?null
                                    : "While [npc.name] continue pounding away at [npc2.namePos] [npc2.asshole+], [npc.she] reach down and start to roughly slap [npc2.her] [npc2.ass+],"
                                    + " growling in glee as [npc2.she] [npc2.verb(squirm)] и [npc2.verb(squeal)] under [npc.her] stinging blows.");

			} else {
				if(!Main.sex.getCharacterTargetedForSexAction(this).hasTail()) {
                    tailSpecial1 = "Growling down into [npc2.namePos] [npc2.ear+], [npc.name] reach down and grab [npc2.her] waist, using one hand to hold [npc2.herHim] still,"
										+ " while using [npc.her] other to deliver a series of stinging slaps to [npc2.her] [npc2.ass+].";
				} else {
                    tailSpecial1 = "Growling down into [npc2.namePos] [npc2.ear], [npc.name] roughly grab the base of [npc2.her] [npc2.tail+] и yank upwards,"
								+ " raising [npc2.her] [npc2.ass+] up high in the air before starting to deliver a series of stinging slaps to [npc2.her] exposed cheeks.";
				}
				if(!Main.sex.getCharacterTargetedForSexAction(this).hasTail()) {
                    tailSpecial2 = "[npc.Name] reach down and grab [npc2.namePos] waist with one hand,"
                            + " holding [npc2.herHim] firmly in [npc.her] grip as [npc.she] start to aggressively slap [npc2.her] exposed cheeks.";
				} else {
					tailSpecial2 = isTargetedCharacterInanimate()?null
                            : "[npc.Name] reach down and grab the base of [npc2.namePos] [npc2.tail+], causing [npc2.herHim] to let out a surprised yelp as [npc.she] roughly yank upwards,"
                            + " forcing [npc2.herHim] to push [npc2.her] [npc2.ass+] up high in the air as [npc.name] start to aggressively slap [npc2.her] exposed cheeks.";
				}
				...
				return UtilText.returnStringAtRandom(
							...
							tailSpecial2,
							isTargetedCharacterInanimate()?null
                                    : "[npc2.Name] [npc2.verb(let)] out [npc2.a_moan+] as [npc.name] start roughly slapping [npc2.her] [npc2.ass+],"
                                    + " and [npc.name] find [npc.herself] grinning in glee as [npc.she] watch [npc2.herHim] squirm and cry out beneath [npc.her] stinging blows.",
							isTargetedCharacterInanimate()?null
                                    : "[npc2.Name] [npc2.verb(let)] out a startled wail as [npc.name] start to roughly slap [npc2.her] [npc2.ass+],"
                                    + " and [npc.name] quickly find [npc.herself] grinning in glee as [npc.she] watch [npc2.herHim] squirm and wail beneath [npc.her] relentless blows.",
							isTargetedCharacterInanimate()?null
                                    : "[npc.Name] growl down that [npc.sheIs] going to put [npc2.name] in [npc2.her] place, before starting to aggressively slap [npc2.her] [npc2.ass+],"
	...
	public static final SexAction SPANK_ASS = new SexAction(
		...
		public String getDescription() {
			...
			if (Main.sex.getAllOngoingSexAreas(Main.sex.getCharacterTargetedForSexAction(this), SexAreaOrifice.VAGINA).contains(SexAreaPenetration.PENIS)) {
				if(!Main.sex.getCharacterTargetedForSexAction(this).hasTail()) {
                    tailSpecial1 = "Hilting [npc.her] [npc.cock+] deep inside [npc2.namePos] [npc2.pussy+], [npc.name] reach down and playfully grope [npc2.her] [npc2.ass+],"
							+ " before starting to deliver a series of firm spanks to [npc2.her] exposed cheeks.";
				} else {
                    tailSpecial1 = "Hilting [npc.her] [npc.cock+] deep inside [npc2.namePos] [npc2.pussy+], [npc.name] playfully grab the base of [npc2.her] [npc2.tail+] и pull upwards,"
				...
				return UtilText.returnStringAtRandom(
                        ...
                        "Hilting [npc.her] [npc.cock+] deep inside [npc2.namePos] [npc2.pussy], [npc.name] use one [npc.hand] to hold [npc2.herHim] still,"
							...
							isTargetedCharacterInanimate()?null
                                    : "[npc2.Name] [npc2.verb(let)] out [npc2.a_moan+] as [npc.name] start playfully spanking [npc2.her] [npc2.ass+] in time with [npc.her] thrusts into [npc2.her] [npc2.pussy+].",
							isTargetedCharacterInanimate()?null
                                    : "While [npc.name] continue pounding away at [npc2.namePos] [npc2.pussy+], [npc.she] reach down and start to playfully slap [npc2.her] [npc2.ass+],"
                                    + " which causes [npc2.herHim] to [npc2.verb(squirm)] и [npc2.verb(squeal)] in response.");

			} else if (Main.sex.getAllOngoingSexAreas(Main.sex.getCharacterTargetedForSexAction(this), SexAreaOrifice.ANUS).contains(SexAreaPenetration.PENIS)) {
				if(!Main.sex.getCharacterTargetedForSexAction(this).hasTail()) {
                    tailSpecial1 = "Hilting [npc.her] [npc.cock+] deep inside [npc2.namePos] [npc2.asshole+], [npc.name] reach down and playfully grope [npc2.her] [npc2.ass+],"
							+ " before starting to deliver a series of firm spanks to [npc2.her] exposed cheeks.";
				} else {
                    tailSpecial1 = "Hilting [npc.her] [npc.cock+] deep inside [npc2.namePos] [npc2.asshole+], [npc.name] playfully grab the base of [npc2.her] [npc2.tail+] и pull upwards,"
									+ " raising [npc2.her] [npc2.ass+] up high in the air before starting to deliver a series of firm spanks to [npc2.her] exposed cheeks.";
				}
				if(!Main.sex.getCharacterTargetedForSexAction(this).hasTail()) {
				...
				return UtilText.returnStringAtRandom(
                        ...
                        "Hilting [npc.her] [npc.cock+] deep inside [npc2.namePos] [npc2.asshole], [npc.name] use one [npc.hand] to hold [npc2.herHim] still,"
								+ " while using [npc.her] other to deliver a series of firm spanks to [npc2.her] exposed ass cheeks.",
							isTargetedCharacterInanimate()?null
                                    : "[npc2.Name] [npc2.verb(let)] out [npc2.a_moan+] as [npc.name] start playfully spanking [npc2.her] [npc2.ass+] in time with [npc.her] thrusts into [npc2.her] [npc2.asshole+].",
							isTargetedCharacterInanimate()?null
                                    : "While [npc.name] continue pounding away at [npc2.namePos] [npc2.asshole+], [npc.she] reach down and start to playfully slap [npc2.her] [npc2.ass+],"
                                    + " which causes [npc2.herHim] to [npc2.verb(squirm)] и [npc2.verb(squeal)] in response.");

			} else {
				if(!Main.sex.getCharacterTargetedForSexAction(this).hasTail()) {
                    tailSpecial1 = "Letting out [npc.a_moan+], [npc.name] reach down and grab [npc2.namePos] waist, using one [npc.hand(true)] to hold [npc2.herHim] still,"
										+ " while using [npc.her] other to deliver a series of firm spanks to [npc2.her] [npc2.ass+].";
				} else {
                    tailSpecial1 = "Letting out [npc.a_moan+], [npc.name] playfully grab the base of [npc2.her] [npc2.tail+] и pull upwards,"
								+ " raising [npc2.her] [npc2.ass+] up high in the air before starting to deliver a series of firm spanks to [npc2.her] exposed cheeks.";
				}
				if(!Main.sex.getCharacterTargetedForSexAction(this).hasTail()) {
                    tailSpecial2 = "[npc.Name] reach down and grab [npc2.namePos] waist with one hand,"
                            + " holding [npc2.herHim] firmly in [npc.her] grip as [npc.she] start to playfully slap [npc2.her] exposed cheeks.";
				} else {
					tailSpecial2 = isTargetedCharacterInanimate()?null
                            : "[npc.Name] reach down and grab the base of [npc2.namePos] [npc2.tail+], causing [npc2.herHim] to let out a surprised yelp as [npc.she] playfully pull upwards,"
                            + " forcing [npc2.herHim] to push [npc2.her] [npc2.ass+] up high in the air as [npc.name] start to firmly spank [npc2.her] exposed cheeks.";
				}

				return UtilText.returnStringAtRandom(
							tailSpecial1,
							tailSpecial2,
                        "[npc.Name] use one [npc.hand] to hold [npc2.name] still, while using [npc.her] other to deliver a series of firm spanks to [npc2.her] exposed ass cheeks.",
							isTargetedCharacterInanimate()?null
                                    : "[npc2.Name] [npc2.verb(let)] out [npc2.a_moan+] as [npc.name] start playfully spanking [npc2.her] [npc2.ass+].",
							isTargetedCharacterInanimate()?null
                                    : "[npc.Name] reach down and start to playfully spank [npc2.her] [npc2.ass+], which causes [npc2.herHim] to [npc2.verb(squirm)] и [npc2.verb(squeal)] in response.");
			}
		}
	};
	...
	public static final SexAction SLAP_FACE = new SexAction(
		...
		public String getDescription() {
			...
			sb.append(UtilText.returnStringAtRandom(
                    "Wanting to put [npc2.name] in [npc2.her] place, [npc.name] lift [npc.her] [npc.hand], before swinging down to deliver a sharp, stinging slap to [npc2.her] face.",
                    "Lifting [npc.her] [npc.hand], [npc.name] swing down, delivering a sharp slap to [npc2.namePos] face in order to put [npc2.herHim] in [npc2.her] place.",
                    "Seeking to remind [npc2.name] who's in charge, [npc.name] raise [npc.her] [npc.hand], before swiping down and delivering a sharp slap to [npc2.her] face."));
				...
				if(Main.sex.getCharacterTargetedForSexAction(this).getFetishDesire(Fetish.FETISH_MASOCHIST).isPositive() && Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(this))!=SexPace.SUB_RESISTING) {
					...
					if(Main.sex.getCharacterTargetedForSexAction(this).isFeminine()) {
						sb.append(UtilText.returnStringAtRandom(
                                ...
                                " The pained squeal which immediately escapes from [npc2.namePos] mouth is exactly what [npc.name] [npc.was] looking for, and [npc.she] can't help but grin as [npc.she] see tears well up in"
						...
						sb.append(UtilText.returnStringAtRandom(
								" A protesting shout escapes from [npc2.namePos] mouth at the moment of contact,"
										+ (Main.sex.getCharacterPerformingAction().isPlayer()
												?" which is precisely the reaction you were looking for."
												:" and from the wicked grin that settles on [npc.namePos] face, this was just the reaction [npc.she] [npc.was] looking for."),
                                " The pained exclamation which immediately escapes from [npc2.namePos] mouth is exactly what [npc.name] [npc.was] looking for, and [npc.she] can't help but grin as [npc.she] see the shocked look in"
										+ (Main.sex.getCharacterTargetedForSexAction(this).isPlayer()
												?" your [npc2.eyes+]."
												:" [npc.her] submissive bitch's [npc2.eyes+]."),
	...
	public static final SexAction SPIT_FACE = new SexAction(
		...
		public String getDescription() {
			...
			sb.append(UtilText.returnStringAtRandom(
                    "Wanting to show [npc2.name] that [npc2.sheIs] a worthless bitch, [npc.name] lean in towards [npc2.herHim], before spitting on [npc2.her] face.",
                    "Leaning in towards [npc2.name], [npc.name] purse [npc.her] [npc.lips+], before spitting directly on [npc2.her] face.",
                    "Seeking to remind [npc2.name] of how worthless [npc2.sheIsFull], [npc.name] lean in towards [npc2.herHim], before pursing [npc.her] [npc.lips+] and spitting directly on [npc2.her] face."));
						...
						sb.append(UtilText.returnStringAtRandom(
								" A disgusted cry escapes from [npc2.namePos] mouth as the ball of saliva splatters onto [npc2.her] cheek,"
										+ (Main.sex.getCharacterPerformingAction().isPlayer()
												?" which is precisely the reaction you were looking for."
												:" and from the wicked grin that settles on [npc.namePos] face, this was just the reaction [npc.she] [npc.was] looking for."),
                                " The horrified protestations which [npc2.name] immediately [npc2.verb(make)] is exactly what [npc.name] [npc.was] looking for, and [npc.she] can't help but grin as [npc.she] see tears well up in"
										+ (Main.sex.getCharacterTargetedForSexAction(this).isPlayer()
												?" your [npc2.eyes+]."
												:" [npc.her] submissive bitch's [npc2.eyes+]."),
								" After letting out a shocked cry, tears start to well up in [npc2.namePos] [npc2.eyes], letting [npc.name] know that [npc.her] abuse is having the exact effect [npc.she] [npc.was] looking for."));
						...
						sb.append(UtilText.returnStringAtRandom(
								" A disgusted cry escapes from [npc2.namePos] mouth as the ball of saliva splatters onto [npc2.her] cheek,"
										+ (Main.sex.getCharacterPerformingAction().isPlayer()
												?" which is precisely the reaction you were looking for."
												:" and from the wicked grin that settles on [npc.namePos] face, this was just the reaction [npc.she] [npc.was] looking for."),
                                " The horrified protestations which [npc2.name] immediately [npc2.verb(make)] is exactly what [npc.name] [npc.was] looking for, and [npc.she] can't help but grin as [npc.she] see the shocked look in"
										+ (Main.sex.getCharacterTargetedForSexAction(this).isPlayer()
												?" your [npc2.eyes+]."
												:" [npc.her] submissive bitch's [npc2.eyes+]."),
								" [npc2.Name] immediately [npc2.verb(let)] out a shocked cry, revealing to [npc.name] that [npc.her] abuse is having the exact effect [npc.she] [npc.was] looking for."));	
	...
	public static final SexAction CHOKE = new SexAction(
		...
		public String getDescription() {
			...
			if(Main.sex.getOngoingCharactersUsingAreas(Main.sex.getCharacterTargetedForSexAction(this), SexAreaOrifice.VAGINA, SexAreaPenetration.PENIS).contains(Main.sex.getCharacterPerformingAction())) {
				sb.append(UtilText.returnStringAtRandom(
                        "Continuing to ram [npc.her] [npc.cock+] in and out of [npc2.namePos] [npc2.pussy+], [npc.name] reach up to grab [npc2.her] neck, before squeezing down and choking [npc2.herHim].",
                        "[npc.Name] reach up to grab [npc2.namePos] neck, and, while still forcefully pounding [npc2.her] [npc2.pussy+], [npc.she] roughly squeeze down in order to choke [npc2.herHim].",
                        "Slamming [npc.her] [npc.cock+] deep into [npc2.namePos] [npc2.pussy+], [npc.name] reach up and grab [npc2.her] neck,"
                                + " squeezing down and choking [npc2.herHim] as [npc.she] pull back and continue roughly fucking [npc2.herHim]."));
				...
				sb.append(UtilText.returnStringAtRandom(
                        "Continuing to ram [npc.her] [npc.cock+] in and out of [npc2.namePos] [npc2.asshole+], [npc.name] reach up to grab [npc2.her] neck, before squeezing down and choking [npc2.herHim].",
                        "[npc.Name] reach up to grab [npc2.namePos] neck, and, while still forcefully pounding [npc2.her] [npc2.asshole+], [npc.she] roughly squeeze down in order to choke [npc2.herHim].",
                        "Slamming [npc.her] [npc.cock+] deep into [npc2.namePos] [npc2.asshole+], [npc.name] reach up and grab [npc2.her] neck,"
                                + " squeezing down and choking [npc2.herHim] as [npc.she] pull back and continue roughly fucking [npc2.herHim]."));
				
			} else {
				sb.append(UtilText.returnStringAtRandom(
                        "With a sadistic grin on [npc.her] face, [npc.name] reach up to grab [npc2.name] by [npc2.her] neck, before squeezing down and choking [npc2.herHim].",
                        "[npc.Name] reach up to grab [npc2.namePos] neck, and, letting out a sadistic laugh, [npc.she] roughly squeeze down in order to choke [npc2.herHim].",
                        "With a cruel laugh, [npc.name] reach up and grab [npc2.name] by [npc2.her] neck, before sadistically squeezing down and choking [npc2.herHim]."));
			}
						...
						sb.append(UtilText.returnStringAtRandom(
								" A series of gargled spluttering noises escape from [npc2.namePos] mouth,"
										+ (Main.sex.getCharacterPerformingAction().isPlayer()
												?" which is precisely the reaction you were looking for."
												:" and from the wicked grin that settles on [npc.namePos] face, this was just the reaction [npc.she] [npc.was] looking for."),
                                " The distressed, gargled cries which [npc2.name] [npc2.verb(start)] to make are exactly what [npc.name] [npc.was] looking for, and [npc.she] can't help but grin as [npc.she] see tears well up in"
										+ (Main.sex.getCharacterTargetedForSexAction(this).isPlayer()
												?" your [npc2.eyes+]."
												:" [npc.her] submissive bitch's [npc2.eyes+]."),
						...
						sb.append(UtilText.returnStringAtRandom(
								" A series of gargled spluttering noises escape from [npc2.namePos] mouth,"
										+ (Main.sex.getCharacterPerformingAction().isPlayer()
												?" which is precisely the reaction you were looking for."
												:" and from the wicked grin that settles on [npc.namePos] face, this was just the reaction [npc.she] [npc.was] looking for."),
                                " The distressed, gargled cries which [npc2.name] immediately [npc2.verb(make)] is exactly what [npc.name] [npc.was] looking for, and [npc.she] can't help but grin as [npc.she] see the shocked look in"
										+ (Main.sex.getCharacterTargetedForSexAction(this).isPlayer()
												?" your [npc2.eyes+]."
												:" [npc.her] submissive bitch's [npc2.eyes+]."),
	...
	public static final SexAction SLAP_PUSSY = new SexAction(
		...
		public String getDescription() {
			...
			sb.append(UtilText.returnStringAtRandom(
                    "[npc.Name] tease [npc.her] [npc.fingers+] over [npc2.namePos] [npc2.pussy+], before suddenly delivering a series of sharp, painful slaps to [npc2.her] feminine sex.",
                    "Dropping [npc.her] [npc.hand] down to [npc2.namePos] groin, [npc.name] start roughly slapping [npc2.her] [npc2.pussy+].",
                    "Reaching down to [npc2.namePos] groin, [npc.name] forcefully grope [npc2.herHim] for a moment, before suddenly delivering a series of sharp slaps to [npc2.her] [npc2.pussy+]."));
			...
			if(!isTargetedCharacterInanimate()) {
				if(Main.sex.getCharacterTargetedForSexAction(this).getFetishDesire(Fetish.FETISH_MASOCHIST).isPositive() && Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(this))!=SexPace.SUB_RESISTING) {
					...
					if(Main.sex.getCharacterTargetedForSexAction(this).isFeminine()) {
						sb.append(UtilText.returnStringAtRandom(
                                " A protesting yelp escapes from [npc2.namePos] mouth, and [npc2.she] [npc2.verb(squirm)] и [npc2.verb(squeal)] in discomfort as [npc2.her] [npc2.pussy] is continuously slapped.",
                                ...
                                " After letting out a shocked cry, tears well up in [npc2.namePos] [npc2.eyes] as [npc2.she] [npc2.verb(struggle)] и [npc2.verb(cry)] for [npc.name] to stop slapping [npc2.her] [npc2.pussy]."));
						
					} else {
						sb.append(UtilText.returnStringAtRandom(
                                " A protesting growl escapes from [npc2.namePos] mouth, and [npc2.she] [npc2.verb(squirm)] и [npc2.verb(grunt)] in discomfort as [npc2.her] [npc2.pussy] is continuously slapped.",
                                ...
                                " After letting out a shocked cry, [npc2.name] [npc2.verb(struggle)] и [npc2.verb(shout)] for [npc.name] to leave [npc2.her] [npc2.pussy] alone."));
					}
				}
			}
	...
	public static final SexAction PINCH_CLIT = new SexAction(
		...
		public String getDescription() {
			...
			sb.append(UtilText.returnStringAtRandom(
                    "[npc.NamePos] [npc.fingers+] home in on [npc2.namePos] [npc2.pussy+], and without warning [npc.she] start to painfully pinch and cruelly flick [npc2.her] [npc2.clit+].",
                    "After dominantly pushing [npc.her] [npc.hand] into [npc2.namePos] groin, [npc.name] suddenly pinch [npc2.her] [npc2.clit+] hard, before forcefully flicking it several times in quick succession.",
                    "Reaching down to [npc2.namePos] groin, [npc.name] give [npc2.her] [npc2.clit+] a few rough flicks, before painfully pinching and tugging at it."));
			...
			if(!isTargetedCharacterInanimate()) {
				if(Main.sex.getCharacterTargetedForSexAction(this).getFetishDesire(Fetish.FETISH_MASOCHIST).isPositive() && Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(this))!=SexPace.SUB_RESISTING) {
					...
					if(Main.sex.getCharacterTargetedForSexAction(this).isFeminine()) {
						sb.append(UtilText.returnStringAtRandom(
                                " A protesting cry bursts out from [npc2.namePos] mouth, and [npc2.she] [npc2.verb(squirm)] и [npc2.verb(squeal)] in pain as [npc2.her] [npc2.clit] is roughly abused.",
                                ...
                                " After letting out a shocked cry, tears well up in [npc2.namePos] [npc2.eyes] as [npc2.she] [npc2.verb(struggle)] и [npc2.verb(cry)] for [npc.name] to stop punishing [npc2.her] [npc2.clit]."));
						
					} else {
						sb.append(UtilText.returnStringAtRandom(
                                " A protesting growl escapes from [npc2.namePos] mouth, and [npc2.she] [npc2.verb(squirm)] и [npc2.verb(grunt)] in discomfort as [npc2.her] [npc2.clit] is roughly abused.",
                                ...
                                " After letting out a shocked cry, [npc2.name] [npc2.verb(struggle)] и [npc2.verb(shout)] for [npc.name] to leave [npc2.her] [npc2.clit] alone."));
					}
				}
			}
	...
	public static final SexAction SLAP_COCK = new SexAction(
		...
		public String getDescription() {
			...
			if(Main.sex.getCharacterTargetedForSexAction(this).isInternalTesticles()) {
				sb.append(UtilText.returnStringAtRandom(
                        "[npc.Name] tease [npc.her] [npc.fingers+] over [npc2.namePos] [npc2.cock+], before suddenly delivering a series of sharp, painful slaps to it.",
                        "Dropping [npc.her] [npc.hand] down to [npc2.namePos] groin, [npc.name] start roughly slapping [npc2.her] [npc2.cock+].",
                        "Reaching down to [npc2.namePos] groin, [npc.name] forcefully grope [npc2.her] [npc2.cock+] for a moment, before suddenly delivering a series of sharp slaps to it."));
				
			} else {
				sb.append(UtilText.returnStringAtRandom(
                        "[npc.Name] tease [npc.her] [npc.fingers+] over [npc2.namePos] [npc2.balls+], before suddenly delivering a series of sharp, painful slaps to [npc2.her] [npc2.cock+].",
                        "Dropping [npc.her] [npc.hand] down to [npc2.namePos] groin, [npc.name] start roughly slapping [npc2.her] [npc2.cock+].",
                        "Reaching down to [npc2.namePos] groin, [npc.name] forcefully grope [npc2.her] [npc2.balls+] for a moment, before suddenly delivering a series of sharp slaps to [npc2.her] [npc2.cock+]."));
			}
			...
			if(!isTargetedCharacterInanimate()) {
				if(Main.sex.getCharacterTargetedForSexAction(this).getFetishDesire(Fetish.FETISH_MASOCHIST).isPositive() && Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(this))!=SexPace.SUB_RESISTING) {
					...
					if(Main.sex.getCharacterTargetedForSexAction(this).isFeminine()) {
						sb.append(UtilText.returnStringAtRandom(
                                " A protesting yelp escapes from [npc2.namePos] mouth, and [npc2.she] [npc2.verb(squirm)] и [npc2.verb(squeal)] in discomfort as [npc2.her] [npc2.cock] is continuously slapped.",
                                ...
                                " After letting out a shocked cry, tears well up in [npc2.namePos] [npc2.eyes] as [npc2.she] [npc2.verb(struggle)] и [npc2.verb(cry)] for [npc.name] to stop slapping [npc2.her] [npc2.cock]."));
						
					} else {
						sb.append(UtilText.returnStringAtRandom(
                                " A protesting growl escapes from [npc2.namePos] mouth, and [npc2.she] [npc2.verb(squirm)] и [npc2.verb(grunt)] in discomfort as [npc2.her] [npc2.cock] is continuously slapped.",
                                ...
                                " After letting out a shocked cry, [npc2.name] [npc2.verb(struggle)] и [npc2.verb(shout)] for [npc.name] to leave [npc2.her] [npc2.cock] alone."));
					}
				}
			}
