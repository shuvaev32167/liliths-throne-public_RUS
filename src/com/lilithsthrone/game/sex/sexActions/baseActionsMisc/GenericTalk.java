			...
			if(Main.sex.getCharacterPerformingAction().isSpeechMuffled()) {
				sb.append(
						UtilText.returnStringAtRandom(
                                ...
                                "Due to [npc.her] mouth currently being blocked, [npc.nameIsFull] not able to speak, and instead [npc.verb(decide)] to let out a soft, whimsical sigh to let [npc2.name] know that [npc.she] love [npc2.herHim].",
			...
			if(Main.sex.getCharacterPerformingAction().isSpeechMuffled()) {
				sb.append(
						UtilText.returnStringAtRandom(
                                ...
                                "Due to [npc.her] mouth currently being blocked, [npc.nameIsFull] not able to speak, and instead [npc.verb(decide)] to let out a loving moan to let [npc2.name] know that [npc.she] love [npc2.herHim] too.",
