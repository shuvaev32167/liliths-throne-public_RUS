...
public class Cowgirl {
	...
	public static String getTongueMouthDescription() {
		...
		if (Main.sex.getAllOngoingSexAreas(Main.sex.getCharacterPerformingAction(), SexAreaOrifice.ANUS).contains(SexAreaPenetration.PENIS)) {
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                    "[npc.Name] sink down onto [npc2.namePos] [npc2.penis+], letting out [npc.a_moan+] [npc.she] lean down and grab [npc2.namePos] head in both hands, before pulling [npc2.name] up into a passionate kiss.",
                    "With [npc.a_moan+], [npc.name] slide down onto [npc2.namePos] [npc2.penis+], leaning down into [npc2.namePos] [npc2.breasts] and breathing in [npc2.namePos] [npc2.scent] before pressing [npc.her] [npc.lips+] against [npc2.namePos]s.",
                    "[npc.Name] let [npc2.namePos] [npc2.penis+] slide even deeper into [npc.her] [npc.asshole+] as [npc.she] lean down and pulls [npc2.name] into a desperate kiss.",
                    "Leaning down, [npc.name] let out [npc.a_moan+] as [npc.she] buries [npc.herself] on [npc2.namePos] [npc2.penis+], before leaning forwards and pressing [npc.her] [npc.lips+] against [npc2.namePos]s."));
			...
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                    "[npc.Name] sink down onto [npc2.namePos] [npc2.penis+], letting out a happy squeal as [npc.she] feel [npc2.name] sink deep inside [npc.her] [npc.pussy+]."
                            + " Bottoming out on [npc2.namePos] [npc2.cock], [npc.she] lean down and grab [npc2.namePos] head in both hands, before pulling [npc2.name] up into a passionate kiss.",
                    "With [npc.a_moan+], [npc.name] slide down onto [npc2.namePos] [npc2.penis+], leaning down into [npc2.namePos] [npc2.breasts] and breathing in [npc2.namePos] [npc2.scent] before pressing [npc.her] [npc.lips+] against [npc2.namePos]s.",
                    "[npc.Name] let [npc2.namePos] [npc2.penis+] slide even deeper into [npc.her] [npc.pussy+] as [npc.she] lean down and pulls [npc2.name] into a desperate kiss.",
                    "Leaning down, [npc.name] let out [npc.a_moan+] as [npc.she] buries [npc.herself] on [npc2.namePos] [npc2.penis+], before leaning forwards and pressing [npc.her] [npc.lips+] against [npc2.namePos]s."));
			
		} else {
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                    "[npc.Name] lean down, grabbing [npc2.namePos] head in both hands and pulling [npc2.name] up into a passionate kiss.",
                    "With a grin, [npc.name] lean down into [npc2.namePos] [npc2.breasts], breathing in [npc2.namePos] [npc2.scent] before pressing [npc.her] [npc.lips+] against [npc2.namePos]s.",
                    "Leaning down, [npc.name] let out [npc.a_moan+] as [npc.she] presses [npc.her] [npc.lips+] against [npc2.namePos]s and starts to eagerly kiss [npc2.name]."));
		}

		switch(Main.sex.getSexPace(Main.game.getPlayer())) {
			case SUB_EAGER:
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                        " [npc2.Name] happily push [npc2.namePos] [npc2.tongue] deep into [npc.her] mouth, eagerly pressing [npc2.namePos] [npc2.lips+] back against [npc.hers] и [npc2.moaning] in delight as [npc2.name] greedily return [npc.her] display of affection.",
	...
	public static String getStartingVaginalPenetrationDescription() {
		...
		switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
			case DOM_GENTLE:
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
						"[npc.Name] reaches down to take hold of [npc2.namePos] [npc2.cock+], before shuffling around to get into a good position."
                                + " After taking a moment to tease the [npc2.cockHead+] between [npc.her] outer labia, [npc.she] let out a little [npc.moan] as [npc.she] slowly drops down and penetrates [npc.her] [npc.pussy+] on [npc2.namePos] [npc2.cock+].",
			...
			case DOM_NORMAL:
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
						"[npc.Name] reaches down to take a firm hold of [npc2.namePos] [npc2.cock+], before shuffling around to get into a good position."
                                + " After taking a moment to tease the [npc2.cockHead+] between [npc.her] outer labia, [npc.she] let out [npc.a_moan+] as [npc.she] eagerly drops down and penetrates [npc.her] [npc.pussy+] on [npc2.namePos] [npc2.cock+].",
			...
			case DOM_ROUGH:
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                        "[npc.Name] reaches down and roughly grab [npc2.namePos] [npc2.cock+], before shuffling around to get into a good position."
                                + " After taking a moment to tease the [npc2.cockHead+] between [npc.her] outer labia, [npc.she] let out [npc.a_moan+] as [npc.she] forcefully drops down and penetrates [npc.her] [npc.pussy+] on [npc2.namePos] [npc2.cock+].",
	...
	public static String getRidingCockGentle() {
		return UtilText.returnStringAtRandom(
                "Using [npc.her] legs, [npc.name] slowly lift [npc.herself] up and down, sliding [npc2.namePos] [npc2.penis+] in and out of [npc.her] [npc.pussy+] as [npc.she] [npc.moansVerb+] out loud.",
                "Leaning forwards, [npc.name] uses [npc.her] [npc.hands] to support some of [npc.her] weight as [npc.she] slowly slide up and down on [npc2.namePos] [npc2.penis+]."
                        + " As [npc.she] lower [npc.her] [npc.face+] towards [npc2.name], [npc.she] gets a waft of [npc2.namePos] [npc2.scent], and [npc.she] bites [npc.her] [npc.lip] as [npc.she] breathes in the intoxicating aroma.",
                ...
                "[npc.Name] slowly lift [npc.herself] up before sliding back down, letting out a soft [npc.moan] as [npc.she] spears [npc.her] [npc.pussy+] on [npc2.namePos] [npc2.penis+].");
	}
	
	public static String getRidingCockNormal() {
		return UtilText.returnStringAtRandom(
                "Using [npc.her] legs, [npc.name] lift [npc.herself] up and down, sliding [npc2.namePos] [npc2.penis+] in and out of [npc.her] [npc.pussy+] as [npc.she] [npc.moansVerb+] out loud.",
                "Leaning forwards, [npc.name] uses [npc.her] [npc.hands] to support some of [npc.her] weight as [npc.she] eagerly slide up and down on [npc2.namePos] [npc2.penis+]."
                        + " As [npc.she] lower [npc.her] [npc.face+] towards [npc2.name], [npc.she] gets a waft of [npc2.namePos] [npc2.scent], and [npc.she] bites [npc.her] [npc.lip] as [npc.she] breathes in the intoxicating aroma.",
                ...
                "[npc.Name] lift [npc.herself] up before greedily sliding back down, letting out [npc.a_moan+] as [npc.she] spears [npc.her] [npc.pussy+] on [npc2.namePos] [npc2.penis+].");
	}
	...
	public static String getStoppingVaginalPenetrationDescription() {
		...
		switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
			case DOM_ROUGH:
                UtilText.nodeContentSB.append("Reaching down, [npc.name] roughly grab the base of [npc2.namePos] [npc2.cock], before lifting [npc.herself] up and allowing [npc2.namePos] [npc2.cock+] to slide out of [npc.her] [npc.pussy+].");
				break;
			default:
	...
	public static String getStartingAnalPenetrationDescription() {
		...
		switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
			case DOM_GENTLE:
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
						"[npc.Name] reaches down to take hold of [npc2.namePos] [npc2.cock+], before shuffling around to get into a good position."
                                + " After taking a moment to tease the [npc2.cockHead+] over [npc.her] [npc.asshole+], [npc.she] let out a little [npc.moan] as [npc.she] slowly drops down and penetrates [npc.her] [npc.ass+] on [npc2.namePos] [npc2.cock+].",
			...
			case DOM_NORMAL:
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
						"[npc.Name] reaches down to take a firm hold of [npc2.namePos] [npc2.cock+], before shuffling around to get into a good position."
                                + " After taking a moment to tease the [npc2.cockHead+] over [npc.her] [npc.asshole+], [npc.she] let out [npc.a_moan+] as [npc.she] eagerly drops down and penetrates [npc.her] [npc.ass+] on [npc2.namePos] [npc2.cock+].",
			...
			case DOM_ROUGH:
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                        "[npc.Name] reaches down and roughly grab [npc2.namePos] [npc2.cock+], before shuffling around to get into a good position."
                                + " After taking a moment to tease the [npc2.cockHead+] over [npc.her] [npc.asshole+], [npc.she] let out [npc.a_moan+] as [npc.she] forcefully drops down and penetrates [npc.her] [npc.ass+] on [npc2.namePos] [npc2.cock+].",
	...
	public static String getRidingCockAnallyGentle() {
		return UtilText.returnStringAtRandom(
                "Using [npc.her] legs, [npc.name] slowly lift [npc.herself] up and down, sliding [npc2.namePos] [npc2.penis+] in and out of [npc.her] [npc.asshole+] as [npc.she] [npc.moansVerb+] out loud.",
                "Leaning forwards, [npc.name] uses [npc.her] [npc.hands] to support some of [npc.her] weight as [npc.she] slowly slide up and down on [npc2.namePos] [npc2.penis+]."
                        + " As [npc.she] lower [npc.her] [npc.face+] towards [npc2.name], [npc.she] gets a waft of [npc2.namePos] [npc2.scent], and [npc.she] bites [npc.her] [npc.lip] as [npc.she] breathes in the intoxicating aroma.",
				"Lowering [npc.her] [npc.hands] to [npc.her] knees, [npc.name] uses [npc.her] [npc.legs] to slowly slide [npc.herself] up and down, letting out soft [npc.moans] as [npc.she] impales [npc.herself] on [npc2.namePos] [npc2.cock+].",
                "[npc.Name] slowly lift [npc.herself] up before sliding back down, letting out a soft [npc.moan] as [npc.she] spears [npc.her] [npc.asshole+] on [npc2.namePos] [npc2.penis+].");
	}
	
	public static String getRidingCockAnallyNormal() {
		return UtilText.returnStringAtRandom(
                "Using [npc.her] legs, [npc.name] lift [npc.herself] up and down, sliding [npc2.namePos] [npc2.penis+] in and out of [npc.her] [npc.asshole+] as [npc.she] [npc.moansVerb+] out loud.",
                "Leaning forwards, [npc.name] uses [npc.her] [npc.hands] to support some of [npc.her] weight as [npc.she] eagerly slide up and down on [npc2.namePos] [npc2.penis+]."
                        + " As [npc.she] lower [npc.her] [npc.face+] towards [npc2.name], [npc.she] gets a waft of [npc2.namePos] [npc2.scent], and [npc.she] bites [npc.her] [npc.lip] as [npc.she] breathes in the intoxicating aroma.",
				"Lowering [npc.her] [npc.hands] to [npc.her] knees, [npc.name] uses [npc.her] [npc.legs] to enthusiastically slide [npc.herself] up and down, letting out [npc.moans+] as [npc.she] impales [npc.herself] on [npc2.namePos] [npc2.cock+].",
                "[npc.Name] lift [npc.herself] up before greedily sliding back down, letting out [npc.a_moan+] as [npc.she] spears [npc.her] [npc.asshole+] on [npc2.namePos] [npc2.penis+].");
	}
	...
	public static String getStoppingAnalPenetrationDescription() {
		...
		switch(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) {
			case DOM_ROUGH:
                UtilText.nodeContentSB.append("Reaching back beneath [npc.herHim], [npc.name] roughly grab the base of [npc2.namePos] [npc2.cock], before lifting [npc.herself] up and allowing [npc2.namePos] [npc2.cock+] to slide out of [npc.her] [npc.asshole+].");
				break;
			default:
