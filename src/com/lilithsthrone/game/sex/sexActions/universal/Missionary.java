		...
		public String getDescription() {
			...
			if(vaginalSex) {
				return UtilText.parse(Main.sex.getCharacterPerformingAction(), Main.sex.getTargetedPartner(Main.sex.getCharacterPerformingAction()),
						UtilText.returnStringAtRandom(
                                "[npc.Name] bite [npc.her] [npc.lip] и let out [npc.moan+],"
						...
						"Pulling [npc.her] [npc.feet] back and to each side,"
                                + " [npc.name] help [npc2.name] to thrust [npc2.her] [npc2.cock+] deep into [npc.her] [npc.pussy+] by [npc.spreadingHerLegs].",
			...
			if(analSex) {
				return UtilText.parse(Main.sex.getCharacterPerformingAction(), Main.sex.getTargetedPartner(Main.sex.getCharacterPerformingAction()),
						UtilText.returnStringAtRandom(
                                "[npc.Name] bite [npc.her] [npc.lip] и let out [npc.moan+],"
                                        + " before raising [npc.her] [npc.ass+] и [npc.spreadingHerLegs] in order to help sink [npc2.namePos] [npc2.cock+] deeper into [npc.her] [npc.asshole+].",
                                "[npc.Name] [npc.spreadsHerLegs] и raise [npc.her] [npc.ass+] for [npc2.name], helping [npc2.herHim] to thrust [npc2.her] [npc2.cock+] deep into [npc.her] [npc.asshole+].",
						"Pulling [npc.her] [npc.feet] back and to each side,"
                                + " [npc.name] help [npc2.name] to thrust [npc2.her] [npc2.cock+] deep into [npc.her] [npc.asshole+] by raising [npc.her] [npc.ass] и [npc.spreadingHerLegs].",
                                "[npc.Name] [npc.spreadsHerLegs] и raise [npc.her] [npc.ass+],"
								+ " looking up at [npc2.name] and biting [npc.her] [npc.lip] as [npc2.she] [npc2.verb(continue)] fucking [npc.her] [npc.asshole+]."));
			}
			
			return UtilText.parse(Main.sex.getCharacterPerformingAction(), Main.sex.getTargetedPartner(Main.sex.getCharacterPerformingAction()),
					UtilText.returnStringAtRandom(
                            "Looking up at [npc2.name], [npc.name] bite [npc.her] [npc.lip] и let out [npc.moan+], before [npc.spreadingHerLegs] and submissively presenting [npc.herself], ready to be penetrated.",
					...
					"Pulling [npc.her] [npc.feet] back and to each side, [npc.name] [npc.spreadsHerLegs], enticing [npc2.name] to penetrate [npc.herHim].",
                            "[npc.Name] [npc.spreadsHerLegs], looking up at [npc2.name] and biting [npc.her] [npc.lip] as [npc.she] entice [npc2.herHim] to penetrate [npc.herHim]."));
		}
	};
