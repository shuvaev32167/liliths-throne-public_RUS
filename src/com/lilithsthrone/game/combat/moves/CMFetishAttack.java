...
public class CMFetishAttack {
        ...
        public String getPrediction(int turnIndex, GameCharacter source, GameCharacter target, List<GameCharacter> enemies, List<GameCharacter> allies) {
            ...
            return UtilText.parse(source, target,
            		(isCrit?"[style.colourExcellent(Critical)]: ":"")
                            + "[npc.Name] offer [npc2.name] the use of [npc.her] ass, dealing " + getFormattedDamage(damageType, getDamage(source, target, isCrit), target, false, isTargetAtMaximumLust(target)) + " damage."
        ...
        public String perform(int turnIndex, GameCharacter source, GameCharacter target, List<GameCharacter> enemies, List<GameCharacter> allies) {
            ...
            return formatAttackOutcome(source, target,
					(UtilText.returnStringAtRandom(
                            "[npc.Name] turn around, presenting [npc.her] [npc.ass+] to [npc2.name] before giving it a slap and [npc.moaning], "
                            ...
                            "[npc.Name] turn around, squeezing and groping [npc.her] [npc.ass+] as [npc.she] [npc.moansVerb], "
								+ (target.getAppearsAsGender().isFeminine()
									?"[npc.speech(Why don't you come and have a go?)]"
									:"[npc.speech(My asshole needs cock!)]"),
                            "[npc.Name] turn around, using both hands to grope and spread apart [npc.her] ass cheeks as [npc.she] [npc.moansVerb], "
								+ (target.getAppearsAsGender().isFeminine()
									?"[npc.speech(Come and play!)]"
									:"[npc.speech(Please, I want your cock in my ass!)]"),
                            "[npc.Name] turn around, spreading apart [npc.her] ass cheeks with both hands as [npc.she] [npc.moansVerb], "
								+ (target.getAppearsAsGender().isFeminine()
    ...
    public static AbstractCombatMove TEASE_ANAL_GIVING = new AbstractCombatMove(CombatMoveCategory.SPECIAL,
        ...
        public String getPrediction(int turnIndex, GameCharacter source, GameCharacter target, List<GameCharacter> enemies, List<GameCharacter> allies) {
            ...
            return UtilText.parse(source, target,
            		(isCrit?"[style.colourExcellent(Critical)]: ":"")
                            + "[npc.Name] tell [npc2.name] that [npc.sheIs] going to use [npc2.her] ass, dealing " + getFormattedDamage(damageType, getDamage(source, target, isCrit), target, false, isTargetAtMaximumLust(target)) + " damage."
            			+ (target.getFetishDesire(oppositeFetish).isNegative()?" [style.italicsMinorBad(Damage is reduced to 1 as [npc2.name] [npc2.verb(dislike)] the "+oppositeFetish.getName(source)+" fetish!)]":""));
        }
        ...
        public String perform(int turnIndex, GameCharacter source, GameCharacter target, List<GameCharacter> enemies, List<GameCharacter> allies) {
            ...
            return formatAttackOutcome(source, target,
            		(UtilText.returnStringAtRandom(
                            "[npc.Name] grin at [npc2.name], before moving [npc.her] gaze down to [npc2.her] [npc2.ass+] и [npc.moaning],"
    							+" [npc.speech(Your ass looks like it needs a good fuck!)]",
                            "[npc.Name] hungrily stare at [npc2.namePos] [npc2.ass+], [npc.moaning],"
    							+" [npc.speech(I'm going to fuck that ass so hard!)]",
                            "Gazing lustfully at [npc2.namePos] [npc2.ass+], [npc.name] let out [npc.a_moan+],"
    ...
    public static AbstractCombatMove TEASE_VAGINAL_RECEIVING = new AbstractCombatMove(CombatMoveCategory.SPECIAL,
        ...
        public String getPrediction(int turnIndex, GameCharacter source, GameCharacter target, List<GameCharacter> enemies, List<GameCharacter> allies) {
            ...
            return UtilText.parse(source, target,
            		(isCrit?"[style.colourExcellent(Critical)]: ":"")
                            + "[npc.Name] offer [npc2.name] the use of [npc.her] pussy, dealing " + getFormattedDamage(damageType, getDamage(source, target, isCrit), target, false, isTargetAtMaximumLust(target)) + " damage."
            			+ (target.getFetishDesire(oppositeFetish).isNegative()?" [style.italicsMinorBad(Damage is reduced to 1 as [npc2.name] [npc2.verb(dislike)] the "+oppositeFetish.getName(source)+" fetish!)]":""));
        }
        ...
        public String perform(int turnIndex, GameCharacter source, GameCharacter target, List<GameCharacter> enemies, List<GameCharacter> allies) {
            ...
            return formatAttackOutcome(source, target,
            		(UtilText.returnStringAtRandom(
                            "[npc.Name] slide [npc.her] [npc.hands] down between [npc.her] [npc.legs] и [npc.moansVerb], "
								+ "[npc.speech(My pussy's aching for your touch!)]",
                            "[npc.Name] slip one [npc.hand] down between [npc.her] [npc.legs] и [npc.moansVerb], "
								+ "[npc.speech(Come fuck my pussy!)]",
                            "[npc.Name] thrust [npc.her] [npc.hips+] out a little and [npc.moansVerb], "
								+ "[npc.speech(I'm getting wet already! Come fuck my little pussy!)]",
                            "[npc.Name] wink at [npc2.name] и [npc.moansVerb], "
    ...
    public static AbstractCombatMove TEASE_VAGINAL_GIVING = new AbstractCombatMove(CombatMoveCategory.SPECIAL,
        ...
        public String getPrediction(int turnIndex, GameCharacter source, GameCharacter target, List<GameCharacter> enemies, List<GameCharacter> allies) {
            ...
            return UtilText.parse(source, target,
	            		(isCrit?"[style.colourExcellent(Critical)]: ":"")
                                + "[npc.Name] tell [npc2.name] that [npc.sheIs] going to use [npc2.her] pussy, dealing " + getFormattedDamage(damageType, getDamage(source, target, isCrit), target, false, isTargetAtMaximumLust(target)) + " damage."
	            			+ (!target.hasVagina()
        ...
        public String perform(int turnIndex, GameCharacter source, GameCharacter target, List<GameCharacter> enemies, List<GameCharacter> allies) {
            ...
            return formatAttackOutcome(source, target,
            		(UtilText.returnStringAtRandom(
                            "[npc.Name] grin at [npc2.name], before moving [npc.her] gaze down to between [npc2.her] [npc2.legs] и [npc.moaning],"
							+" [npc.speech(Your pussy looks like it needs a good fuck!)]",
                            "[npc.Name] hungrily stare between [npc2.namePos] [npc2.legs], [npc.moaning],"
							+" [npc.speech(I'm going to fuck that pussy so hard!)]",
                            "Gazing lustfully between [npc2.namePos] [npc2.legs], [npc.name] let out [npc.a_moan+],"
    ...
    public static AbstractCombatMove TEASE_INCEST = new AbstractCombatMove(CombatMoveCategory.SPECIAL,
        ...
        public String getPrediction(int turnIndex, GameCharacter source, GameCharacter target, List<GameCharacter> enemies, List<GameCharacter> allies) {
            ...
            if(target.isRelatedTo(source)) {
	            return UtilText.parse(source, target,
	            		(isCrit?"[style.colourExcellent(Critical)]: ":"")
                                + "[npc.Name] tell [npc2.name] that [npc.sheIs] going to have incestuous sex with [npc2.herHim], dealing "
	            				+ getFormattedDamage(damageType, getDamage(source, target, isCrit), target, false, isTargetAtMaximumLust(target)) + " damage."
	            			+ (target.getFetishDesire(oppositeFetish).isNegative()?" [style.italicsMinorBad(Damage is reduced to 1 as [npc2.name] [npc2.verb(dislike)] the "+oppositeFetish.getName(source)+" fetish!)]":""));
            } else {
	            return UtilText.parse(source, target,
	            		(isCrit?"[style.colourExcellent(Critical)]: ":"")
                                + "[npc.Name] tell [npc2.name] that [npc.she] love having incestuous sex, dealing "
	            				+ getFormattedDamage(damageType, getDamage(source, target, isCrit), target, false, isTargetAtMaximumLust(target)) + " damage."
        ...
        public String perform(int turnIndex, GameCharacter source, GameCharacter target, List<GameCharacter> enemies, List<GameCharacter> allies) {
            ...
            if(target.isRelatedTo(source)) {
                ...
                return formatAttackOutcome(source, target,
                		(UtilText.returnStringAtRandom(
                                "[npc1.Name] grin at [npc2.name], before thrusting [npc1.her] [npc1.hips] forwards and calling out, "
        								+ "[npc1.speech("+dialogue+")]",
                                "Running [npc1.her] [npc1.hands] down over [npc1.her] groin, [npc1.name] call out to [npc2.name], "
        								+ "[npc1.speech("+dialogue+")]",
                                "[npc1.Name] let out an eager groan as [npc1.she] thrust [npc1.her] [npc1.hips] at [npc2.name], "
    ...
    public static AbstractCombatMove TEASE_CUM_STUD = new AbstractCombatMove(CombatMoveCategory.SPECIAL,
        ...
        public String getPrediction(int turnIndex, GameCharacter source, GameCharacter target, List<GameCharacter> enemies, List<GameCharacter> allies) {
            ...
            return UtilText.parse(source, target,
            			(isCrit?"[style.colourExcellent(Critical)]: ":"")
                                + "[npc.Name] tell [npc2.name] that [npc.sheIs] going to give [npc2.herHim] a taste of [npc.her] cum, dealing "
            					+ getFormattedDamage(damageType, getDamage(source, target, isCrit), target, false, isTargetAtMaximumLust(target)) + " damage."
            				+ (target.getFetishDesire(oppositeFetish).isNegative()?" [style.italicsMinorBad(Damage is reduced to 1 as [npc2.name] [npc2.verb(dislike)] the "+oppositeFetish.getName(source)+" fetish!)]":""));
        }
        ...
        public String perform(int turnIndex, GameCharacter source, GameCharacter target, List<GameCharacter> enemies, List<GameCharacter> allies) {
            ...
            return formatAttackOutcome(source, target,
            		(UtilText.returnStringAtRandom(
                            "[npc.Name] grin at [npc2.name], before thrusting [npc.her] [npc.hips] and calling out, "
    								+ "[npc.speech(I can't wait to fill you with my [npc.cum]!)]",
                            "Running [npc.her] [npc.hands] down over [npc.her] groin, [npc.name] call out to [npc2.name], "
    								+ "[npc.speech(I bet you can't wait to taste my [npc.cum]!)]",
                            "[npc.Name] let out an eager groan as [npc.she] thrust [npc.her] [npc.hips] at [npc2.name], "
    ...
    public static AbstractCombatMove TEASE_CUM_ADDICT = new AbstractCombatMove(CombatMoveCategory.SPECIAL,
        ...
        public String getPrediction(int turnIndex, GameCharacter source, GameCharacter target, List<GameCharacter> enemies, List<GameCharacter> allies) {
            ...
            return UtilText.parse(source, target,
            			(isCrit?"[style.colourExcellent(Critical)]: ":"")
                                + "[npc.Name] tell [npc2.name] that [npc.she] want [npc2.her] cum, dealing "
            					+ getFormattedDamage(damageType, getDamage(source, target, isCrit), target, false, isTargetAtMaximumLust(target)) + " damage."
        ...
        public String perform(int turnIndex, GameCharacter source, GameCharacter target, List<GameCharacter> enemies, List<GameCharacter> allies) {
            ...
            return formatAttackOutcome(source, target,
            		(UtilText.returnStringAtRandom(
                            "[npc.Name] let out [npc.a_moan+] as [npc.she] reveal [npc.her] cum-lust, "
    								+ "[npc.speech(Aah! I need cum! I haven't had a meal in ages!)]",
                            "First letting out a hungry whine, [npc.name] plead, "
    								+ "[npc.speech(Mmm! I need cum!)]",
                            "[npc.Name] let out a pathetic whine as [npc.she] beg, "
    								+ "[npc.speech(I'm so hungry! I need your cum!)]",
                            "[npc.Name] let out a pathetic whine as [npc.she] beg for a meal, "
    ...
    public static AbstractCombatMove TEASE_PENIS_RECEIVING = new AbstractCombatMove(CombatMoveCategory.SPECIAL,
        ...
        public String getPrediction(int turnIndex, GameCharacter source, GameCharacter target, List<GameCharacter> enemies, List<GameCharacter> allies) {
            ...
            return UtilText.parse(source, target,
            			(isCrit?"[style.colourExcellent(Critical)]: ":"")
                                + "[npc.Name] beg for [npc2.namePos] cock, dealing "
            					+ getFormattedDamage(damageType, getDamage(source, target, isCrit), target, false, isTargetAtMaximumLust(target)) + " damage."
            				+ (!target.hasPenisIgnoreDildo()
            						?" [style.italicsMinorBad(Damage is reduced to 1 as [npc2.name] does not have a penis!)]"
            						:(target.getFetishDesire(oppositeFetish).isNegative()
        ...
        public String perform(int turnIndex, GameCharacter source, GameCharacter target, List<GameCharacter> enemies, List<GameCharacter> allies) {
            ...
            return formatAttackOutcome(source, target,
            		(UtilText.returnStringAtRandom(
                            "[npc.Name] stare down between [npc2.namePos] [npc2.legs] as [npc.she] [npc.moanVerb], [npc.speech(I'll be getting a taste of your [npc2.cock] soon enough!)]",
                            "[npc.Name] hungrily gaze down between [npc2.namePos] [npc2.legs] и [npc.moanVerb], [npc.speech(I want to feel your cock throbbing inside of me!)]",
                            "[npc.Name] grin at [npc2.name], licking [npc.her] [npc.lips+] and flicking [npc.her] gaze down to rest on [npc2.namePos] crotch as [npc.she] [npc.moanVerb], [npc.speech(I'll take good care of your cock!)]"))
            			+dealtDamage.getKey(),
            		"[npc2.Name] took " + getFormattedDamage(damageType, dealtDamage.getValue(), target, true, maxLust) + " damage!",
            		(isCrit
            			?"[npc2.NameIsFull] incredibly turned on, and [npc2.verb(take)] triple damage!"
    ...
    public static AbstractCombatMove TEASE_PENIS_GIVING = new AbstractCombatMove(CombatMoveCategory.SPECIAL,
        ...
        public String getPrediction(int turnIndex, GameCharacter source, GameCharacter target, List<GameCharacter> enemies, List<GameCharacter> allies) {
            ...
            return UtilText.parse(source, target,
	            		(isCrit?"[style.colourExcellent(Critical)]: ":"")
                                + "[npc.Name] tell [npc2.name] that [npc.sheIs] going to give [npc2.herHim] a taste of [npc.her] [npc.cock+], dealing "
	            				+ getFormattedDamage(damageType, getDamage(source, target, isCrit), target, false, isTargetAtMaximumLust(target)) + " damage."
            				+ (target.getFetishDesire(oppositeFetish).isNegative()?" [style.italicsMinorBad(Damage is reduced to 1 as [npc2.name] [npc2.verb(dislike)] the "+oppositeFetish.getName(source)+" fetish!)]":""));
        }
        ...
        public String perform(int turnIndex, GameCharacter source, GameCharacter target, List<GameCharacter> enemies, List<GameCharacter> allies) {
            ...
            return formatAttackOutcome(source, target,
            		(UtilText.returnStringAtRandom(
                            "[npc.Name] slide [npc.a_hand] down between [npc.her] [npc.legs], before grabbing [npc.her] crotch and [npc.moaning] at [npc2.name], [npc.speech(I can't wait to stuff my cock inside you!)]",
                            "[npc.Name] thrust [npc.her] [npc.hips+] forward and [npc.moanVerb] at [npc2.name], [npc.speech(Come get a taste of my cock!)]",
                            "[npc.Name] grin at [npc2.name] as [npc.she] [npc.moanVerb], [npc.speech(You're going to love the feeling of my cock!)]")) + dealtDamage.getKey(),
            		"[npc2.Name] took " + getFormattedDamage(damageType, dealtDamage.getValue(), target, true, maxLust) + " damage!",
            		(isCrit
            			?"[npc2.NameIsFull] incredibly turned on, and [npc2.verb(take)] triple damage!"
            			:null),
    ...
    public static AbstractCombatMove TEASE_LEG_RECEIVING = new AbstractCombatMove(CombatMoveCategory.SPECIAL,
        ...
        public String getPrediction(int turnIndex, GameCharacter source, GameCharacter target, List<GameCharacter> enemies, List<GameCharacter> allies) {
            ...
            return UtilText.parse(source, target,
            		(isCrit?"[style.colourExcellent(Critical)]: ":"")
                            + "[npc.Name] offer [npc2.name] the use of [npc.her] legs, dealing " + getFormattedDamage(damageType, getDamage(source, target, isCrit), target, false, isTargetAtMaximumLust(target)) + " damage."
            			+ (target.getFetishDesire(oppositeFetish).isNegative()?" [style.italicsMinorBad(Damage is reduced to 1 as [npc2.name] [npc2.verb(dislike)] the "+oppositeFetish.getName(source)+" fetish!)]":""));
        }
        ...
        public String perform(int turnIndex, GameCharacter source, GameCharacter target, List<GameCharacter> enemies, List<GameCharacter> allies) {
            ...
            return formatAttackOutcome(source, target,
            		(UtilText.returnStringAtRandom(
                            ...
                            "[npc.Name] slip one [npc.hand] down to stroke [npc.her] [npc.legs] и [npc.moansVerb], "
								+ "[npc.speech(Come fuck my thighs!)]",
                            "[npc.Name] lift one of [npc.her] [npc.legs+] и [npc.moansVerb], "
    ...
    public static AbstractCombatMove TEASE_LEG_GIVING = new AbstractCombatMove(CombatMoveCategory.SPECIAL,
        ...
        public String getPrediction(int turnIndex, GameCharacter source, GameCharacter target, List<GameCharacter> enemies, List<GameCharacter> allies) {
            ...
            return UtilText.parse(source, target,
	            		(isCrit?"[style.colourExcellent(Critical)]: ":"")
                                + "[npc.Name] tell [npc2.name] that [npc.sheIs] going to use [npc2.her] [npc2.legs],"
        ...
        public String perform(int turnIndex, GameCharacter source, GameCharacter target, List<GameCharacter> enemies, List<GameCharacter> allies) {
            ...
            return formatAttackOutcome(source, target,
            		(UtilText.returnStringAtRandom(
                            "[npc.Name] grin at [npc2.name], before moving [npc.her] gaze down to [npc2.her] [npc2.legs] и [npc.moaning],"
							+" [npc.speech(Your thighs look like they need a good fuck!)]",
                            "[npc.Name] hungrily stare at [npc2.namePos] [npc2.legs], [npc.moaning],"
							+" [npc.speech(I'm going to fuck those legs so hard!)]",
                            "Gazing lustfully at [npc2.namePos] [npc2.legs], [npc.name] let out [npc.a_moan+],"
	...
	public static AbstractCombatMove TEASE_FOOT_RECEIVING = new AbstractCombatMove(CombatMoveCategory.SPECIAL,
        ...
        public String getPrediction(int turnIndex, GameCharacter source, GameCharacter target, List<GameCharacter> enemies, List<GameCharacter> allies) {
            ...
            return UtilText.parse(source, target,
            			(isCrit?"[style.colourExcellent(Critical)]: ":"")
                                + "[npc.Name] beg for [npc2.name] to use [npc2.her] feet, dealing "
            					+ getFormattedDamage(damageType, getDamage(source, target, isCrit), target, false, isTargetAtMaximumLust(target)) + " damage."
            				+ (target.getFetishDesire(oppositeFetish).isNegative()?" [style.italicsMinorBad(Damage is reduced to 1 as [npc2.name] [npc2.verb(dislike)] the "+oppositeFetish.getName(source)+" fetish!)]":""));
        }
        ...
        public String perform(int turnIndex, GameCharacter source, GameCharacter target, List<GameCharacter> enemies, List<GameCharacter> allies) {
            ...
            return formatAttackOutcome(source, target,
            		(UtilText.returnStringAtRandom(
                            "[npc.Name] gaze hungrily down at [npc2.namePos] [npc2.feet] as [npc.she] [npc.moanVerb], [npc.speech(I can't wait to feel your [npc2.feet] all over me!)]",
                            "[npc.Name] bite [npc.her] [npc.lip] as [npc.she] gaze down at [npc2.namePos] [npc2.feet]. [npc.speech(Let me worship your [npc2.feet]!)]",
                            "[npc.Name] grin at [npc2.name], licking [npc.her] [npc.lips+] and flicking [npc.her] gaze down to rest on [npc2.namePos] [npc2.feet] as [npc.she] [npc.moanVerb],"
    ...
    public static AbstractCombatMove TEASE_FOOT_GIVING = new AbstractCombatMove(CombatMoveCategory.SPECIAL,
        ...
        public String getPrediction(int turnIndex, GameCharacter source, GameCharacter target, List<GameCharacter> enemies, List<GameCharacter> allies) {
            ...
            return UtilText.parse(source, target,
	            		(isCrit?"[style.colourExcellent(Critical)]: ":"")
                                + "[npc.Name] tell [npc2.name] that [npc.sheIs] going to use [npc.her] [npc.feet] on [npc2.herHim], dealing "
            					+ getFormattedDamage(damageType, getDamage(source, target, isCrit), target, false, isTargetAtMaximumLust(target)) + " damage."
            				+ (target.getFetishDesire(oppositeFetish).isNegative()?" [style.italicsMinorBad(Damage is reduced to 1 as [npc2.name] [npc2.verb(dislike)] the "+oppositeFetish.getName(source)+" fetish!)]":""));
        }
        ...
        public String perform(int turnIndex, GameCharacter source, GameCharacter target, List<GameCharacter> enemies, List<GameCharacter> allies) {
            ...
            return formatAttackOutcome(source, target,
            		(UtilText.returnStringAtRandom(
                            "[npc.Name] lift one of [npc.her] [npc.legs], before pointing [npc.her] [npc.foot] at [npc2.name]. [npc.speech(Get down on your knees and kiss my [npc.feet]!)]",
                            "[npc.Name] thrust one of [npc.her] [npc.feet+] forwards and [npc.moanVerb] at [npc2.name], [npc.speech(You'll be licking my toes soon enough!)]",
                            "[npc.Name] grin at [npc2.name] as [npc.she] [npc.moanVerb], [npc.speech(Crawl over here and kiss my feet!)]")) + dealtDamage.getKey(),
            		"[npc2.Name] took " + getFormattedDamage(damageType, dealtDamage.getValue(), target, true, maxLust) + " damage!",
            		(isCrit
            			?"[npc2.NameIsFull] incredibly turned on, and [npc2.verb(take)] triple damage!"
            			:null),
	...
	public static AbstractCombatMove TEASE_ARMPIT_RECEIVING = new AbstractCombatMove(CombatMoveCategory.SPECIAL,
        ...
        public String getPrediction(int turnIndex, GameCharacter source, GameCharacter target, List<GameCharacter> enemies, List<GameCharacter> allies) {
            ...
            return UtilText.parse(source, target,
            			(isCrit?"[style.colourExcellent(Critical)]: ":"")
                                + "[npc.Name] beg for [npc2.name] to use [npc2.her] armpits, dealing "
            					+ getFormattedDamage(damageType, getDamage(source, target, isCrit), target, false, isTargetAtMaximumLust(target)) + " damage."
            				+ (target.getFetishDesire(oppositeFetish).isNegative()?" [style.italicsMinorBad(Damage is reduced to 1 as [npc2.name] [npc2.verb(dislike)] the "+oppositeFetish.getName(source)+" fetish!)]":""));
        }
        ...
        public String perform(int turnIndex, GameCharacter source, GameCharacter target, List<GameCharacter> enemies, List<GameCharacter> allies) {
            ...
            return formatAttackOutcome(source, target,
            		(UtilText.returnStringAtRandom(
                            "[npc.Name] lift [npc.her] [npc.arms] и [npc.moanVerb], [npc.speech(I can't wait for you to be using my armpits!)]",
                            "[npc.Name] bite [npc.her] [npc.lip] as [npc.she] lift [npc.her] [npc.arm] и show off [npc.her] [npc.armpits+], [npc.speech(You're going to love my armpits!)]",
                            "[npc.Name] grin at [npc2.name], licking [npc.her] [npc.lips+] and lifting [npc.her] [npc.arm] to show off [npc.her] [npc.armpit+] as [npc.she] [npc.moanVerb],"
    ...
    public static AbstractCombatMove TEASE_ARMPIT_GIVING = new AbstractCombatMove(CombatMoveCategory.SPECIAL,
        ...
        public String getPrediction(int turnIndex, GameCharacter source, GameCharacter target, List<GameCharacter> enemies, List<GameCharacter> allies) {
            ...
            return UtilText.parse(source, target,
	            		(isCrit?"[style.colourExcellent(Critical)]: ":"")
                                + "[npc.Name] tell [npc2.name] that [npc.sheIs] going to use [npc.her] [npc.armpits] on [npc2.herHim], dealing "
            					+ getFormattedDamage(damageType, getDamage(source, target, isCrit), target, false, isTargetAtMaximumLust(target)) + " damage."
            				+ (target.getFetishDesire(oppositeFetish).isNegative()?" [style.italicsMinorBad(Damage is reduced to 1 as [npc2.name] [npc2.verb(dislike)] the "+oppositeFetish.getName(source)+" fetish!)]":""));
        }
        ...
        public String perform(int turnIndex, GameCharacter source, GameCharacter target, List<GameCharacter> enemies, List<GameCharacter> allies) {
            ...
            return formatAttackOutcome(source, target,
            		(UtilText.returnStringAtRandom(
                            "[npc.Name] grin at [npc2.name], before moving [npc.her] gaze down to [npc2.her] [npc2.arms] и [npc.moaning],"
    								+" [npc.speech(Your armpits look like they need a good fuck!)]",
                            "[npc.Name] hungrily stare at [npc2.namePos] [npc2.armpits], [npc.moaning],"
								+" [npc.speech(I'm going to use your pits!)]",
                            "Gazing lustfully at [npc2.namePos] [npc2.arms], [npc.name] let out [npc.a_moan+],"
    ...
    public static AbstractCombatMove TEASE_ORAL_RECEIVING = new AbstractCombatMove(CombatMoveCategory.SPECIAL,
        ...
        public String getPrediction(int turnIndex, GameCharacter source, GameCharacter target, List<GameCharacter> enemies, List<GameCharacter> allies) {
            ...
            return UtilText.parse(source, target,
            			(isCrit?"[style.colourExcellent(Critical)]: ":"")
                                + "[npc.Name] beg for [npc2.name] to perform oral on [npc.herHim], dealing "
                    			+ getFormattedDamage(damageType, getDamage(source, target, isCrit), target, false, isTargetAtMaximumLust(target)) + " damage."
            				+ (target.getFetishDesire(oppositeFetish).isNegative()?" [style.italicsMinorBad(Damage is reduced to 1 as [npc2.name] [npc2.verb(dislike)] the "+oppositeFetish.getName(source)+" fetish!)]":""));
        }
        ...
        public String perform(int turnIndex, GameCharacter source, GameCharacter target, List<GameCharacter> enemies, List<GameCharacter> allies) {
            ...
            return formatAttackOutcome(source, target,
            		(UtilText.returnStringAtRandom(
                            "[npc.Name] grin at [npc2.name], gazing at [npc2.her] [npc2.lips+] as [npc.she] [npc.moansVerb],"
    							+" [npc.speech(I can't wait to put your [npc2.lips] to use!)]",
                            "[npc.Name] hungrily stare at [npc2.namePos] [npc2.lips+], [npc.moaning],"
    							+" [npc.speech(Your tongue belongs between my [npc.legs]!)]",
                            "Gazing lustfully at [npc2.namePos] [npc2.lips+], [npc.name] let out [npc.a_moan+],"
    ...
    public static AbstractCombatMove TEASE_ORAL_GIVING = new AbstractCombatMove(CombatMoveCategory.SPECIAL,
        ...
        public String getPrediction(int turnIndex, GameCharacter source, GameCharacter target, List<GameCharacter> enemies, List<GameCharacter> allies) {
            ...
            return UtilText.parse(source, target,
            			(isCrit?"[style.colourExcellent(Critical)]: ":"")
                                + "[npc.Name] tell [npc2.name] that [npc.sheIs] going to perform oral on [npc2.herHim], dealing "
            					+ getFormattedDamage(damageType, getDamage(source, target, isCrit), target, false, isTargetAtMaximumLust(target)) + " damage."
            				+ (target.getFetishDesire(oppositeFetish).isNegative()?" [style.italicsMinorBad(Damage is reduced to 1 as [npc2.name] [npc2.verb(dislike)] the "+oppositeFetish.getName(source)+" fetish!)]":""));
        }
        ...
        public String perform(int turnIndex, GameCharacter source, GameCharacter target, List<GameCharacter> enemies, List<GameCharacter> allies) {
            ...
            return formatAttackOutcome(source, target,
            		(UtilText.returnStringAtRandom(
                            "[npc.Name] open [npc.her] mouth, sticking out [npc.her] [npc.tongue] and making a suggestive gesture with one of [npc.her] [npc.hands], "
    								+ (target.getAppearsAsGender().isFeminine()
    ...
    public static AbstractCombatMove TEASE_BREASTS_OTHERS = new AbstractCombatMove(CombatMoveCategory.SPECIAL,
        ...
        public String getPrediction(int turnIndex, GameCharacter source, GameCharacter target, List<GameCharacter> enemies, List<GameCharacter> allies) {
            ...
            return UtilText.parse(source, target,
            			(isCrit?"[style.colourExcellent(Critical)]: ":"")
                                + "[npc.Name] beg to have a feel of [npc2.namePos] [npc2.breasts+], dealing "
            					+ getFormattedDamage(damageType, getDamage(source, target, isCrit), target, false, isTargetAtMaximumLust(target)) + " damage."
            				+ (!target.hasBreasts()
        ...
        public String perform(int turnIndex, GameCharacter source, GameCharacter target, List<GameCharacter> enemies, List<GameCharacter> allies) {
            ...
            if(target.hasBreasts()) {
				attackText = UtilText.parse(source, target,
						(UtilText.returnStringAtRandom(
                                "[npc.Name] grin at [npc2.name], gazing at [npc2.her] [npc2.breasts+] as [npc.she] [npc.moansVerb],"
							+" [npc.speech(I can't wait to get my [npc.hands] on your [npc2.breasts]!)]",
                                "[npc.Name] hungrily stare at [npc2.namePos] [npc2.breasts+], [npc.moaning],"
							+" [npc.speech(I'm going to have fun playing with those!)]",
                                "Gazing lustfully at [npc2.namePos] [npc2.breasts+], [npc.name] let out [npc.a_moan+],"
								+" [npc.speech(I'm going to have fun with those [npc2.breasts+] of yours!)]")));
				
			} else {
				attackText = UtilText.parse(source, target,
						(UtilText.returnStringAtRandom(
                                "Gazing at [npc2.namePos] chest, [npc.name] let out an annoyed huff,"
									+ " [npc.speech(I wish you had a nice pair of tits that I could use!)]",
                                "[npc.Name] pout at [npc2.namePos] [npc2.breasts+], before whining,"
    ...
    public static AbstractCombatMove TEASE_BREASTS = new AbstractCombatMove(CombatMoveCategory.SPECIAL,
        ...
        public String getPrediction(int turnIndex, GameCharacter source, GameCharacter target, List<GameCharacter> enemies, List<GameCharacter> allies) {
            ...
            return UtilText.parse(source, target,
            			(isCrit?"[style.colourExcellent(Critical)]: ":"")
                                + "[npc.Name] tease [npc2.name] with the promise of getting to have a feel of [npc.her] tits, dealing "
            					+ getFormattedDamage(damageType, getDamage(source, target, isCrit), target, false, isTargetAtMaximumLust(target)) + " damage."
            				+ (target.getFetishDesire(oppositeFetish).isNegative()?" [style.italicsMinorBad(Damage is reduced to 1 as [npc2.name] [npc2.verb(dislike)] the "+oppositeFetish.getName(source)+" fetish!)]":""));
        }
        ...
        public String perform(int turnIndex, GameCharacter source, GameCharacter target, List<GameCharacter> enemies, List<GameCharacter> allies) {
            ...
            return formatAttackOutcome(source, target,
            		(UtilText.returnStringAtRandom(
                            "Pushing [npc.her] [npc.breasts+] together, [npc.name] lean forwards and wink at [npc2.name], "
    								+ (target.getAppearsAsGender().isFeminine()
                            ...
                            "Running [npc.her] [npc.hands] suggestively over [npc.her] [npc.breasts+], [npc.name] bite [npc.her] lip before pouting at [npc2.name], "
    								+ (target.getAppearsAsGender().isFeminine()
    ...
    public static AbstractCombatMove TEASE_LACTATION_OTHERS = new AbstractCombatMove(CombatMoveCategory.SPECIAL,
        ...
        public String getPrediction(int turnIndex, GameCharacter source, GameCharacter target, List<GameCharacter> enemies, List<GameCharacter> allies) {
            ...
            return UtilText.parse(source, target,
            			(isCrit?"[style.colourExcellent(Critical)]: ":"")
                                + "[npc.Name] beg to milk [npc2.namePos] [npc2.breasts+], dealing "
            					+ getFormattedDamage(damageType, getDamage(source, target, isCrit), target, false, isTargetAtMaximumLust(target)) + " damage."
        ...
        public String perform(int turnIndex, GameCharacter source, GameCharacter target, List<GameCharacter> enemies, List<GameCharacter> allies) {
            ...
            if(target.hasBreasts()) {
				...
				attackText = UtilText.parse(source, target,
						(UtilText.returnStringAtRandom(
                                "[npc.Name] grin at [npc2.name], gazing at [npc2.her] [npc2.crotchBoobs+] as [npc.she] [npc.moansVerb],"
								+" [npc.speech(I'm going to have fun milking your udders!)]",
                                "[npc.Name] hungrily stare at [npc2.namePos] [npc2.crotchBoobs+], [npc.moaning],"
								+" [npc.speech(I can't wait to give you a good milking!)]",
                                "Gazing lustfully at [npc2.namePos] [npc2.crotchBoobs+], [npc.name] let out [npc.a_moan+],"
									+" [npc.speech(I'm going to have fun milking those [npc2.breasts+] of yours!)]")));
    ...
    public static AbstractCombatMove TEASE_LACTATION = new AbstractCombatMove(CombatMoveCategory.SPECIAL,
        ...
        public String getPrediction(int turnIndex, GameCharacter source, GameCharacter target, List<GameCharacter> enemies, List<GameCharacter> allies) {
            ...
            return UtilText.parse(source, target,
            			(isCrit?"[style.colourExcellent(Critical)]: ":"")
                                + "[npc.Name] tell [npc2.name] that [npc.sheIs] going to get [npc2.herHim] to milk [npc.her] tits, dealing "
            					+ getFormattedDamage(damageType, getDamage(source, target, isCrit), target, false, isTargetAtMaximumLust(target)) + " damage."
            				+ (target.getFetishDesire(oppositeFetish).isNegative()
            						?" [style.italicsMinorBad(Damage is reduced to 1 as [npc2.name] [npc2.verb(dislike)] the "+oppositeFetish.getName(source)+" fetish!)]"
        ...
        public String perform(int turnIndex, GameCharacter source, GameCharacter target, List<GameCharacter> enemies, List<GameCharacter> allies) {
            ...
            if(source.hasBreasts()) {
                return formatAttackOutcome(source, target,
                		(UtilText.returnStringAtRandom(
                                "Pushing [npc.her] [npc.breasts+] together, [npc.name] pout at [npc2.name], "
        								+ "[npc.speech(My breasts are so sore! Please, I need milking!)]",
                                "Pushing [npc.her] [npc.breasts+] together, [npc.name] let out a whine as [npc.she] bat [npc.her] eyelids at [npc2.name], "
                ...
                return formatAttackOutcome(source, target,
                		(UtilText.returnStringAtRandom(
                                "Presenting [npc.her] [npc.crotchBoobs+] to [npc2.name], [npc.name] pout и whine, "
        								+ "[npc.speech(My teats are so sore! Please, I need milking!)]",
                                "Presenting [npc.her] [npc.crotchBoobs+] to [npc2.name], [npc.name] bat [npc.her] eyelids and whine, "
        								+ "[npc.speech(I'm so full of milk! I need help!)]",
        						(source.isTaur()
        							?null
                                        : "Running [npc.her] [npc.hands] suggestively over [npc.her] [npc.breasts+], [npc.name] bite [npc.her] lip before pouting at [npc2.name], "
    ...
    public static AbstractCombatMove TEASE_FERTILITY = new AbstractCombatMove(CombatMoveCategory.SPECIAL,
        ...
        public String getPrediction(int turnIndex, GameCharacter source, GameCharacter target, List<GameCharacter> enemies, List<GameCharacter> allies) {
            ...
            return UtilText.parse(source, target,
            			(isCrit?"[style.colourExcellent(Critical)]: ":"")
                                + "[npc.Name] tell [npc2.name] how fertile [npc.sheIsFull], dealing "
            					+ getFormattedDamage(damageType, getDamage(source, target, isCrit), target, false, isTargetAtMaximumLust(target)) + " damage."
            				+ (target.getFetishDesire(oppositeFetish).isNegative()?" [style.italicsMinorBad(Damage is reduced to 1 as [npc2.name] [npc2.verb(dislike)] the "+oppositeFetish.getName(source)+" fetish!)]":""));
        }
        ...
        public String perform(int turnIndex, GameCharacter source, GameCharacter target, List<GameCharacter> enemies, List<GameCharacter> allies) {
            ...
            if(source.isVisiblyPregnant()) {
				attackText = UtilText.parse(source, target,
						(UtilText.returnStringAtRandom(
                                "Running [npc.her] [npc.hands] over [npc.her] pregnant belly, [npc.name] wink at [npc2.name], "
								+ (target.getAppearsAsGender().isFeminine()
									?"[npc.speech(Let me tell you the best ways to get knocked up!)]"
									:"[npc.speech(Ever wanted to fuck a pregnant [npc.girl]?)]"),
                                "[npc.Name] pushes out [npc.her] pregnant belly and giggle at [npc2.name], "
								+ (target.getAppearsAsGender().isFeminine()
                                ...
                                "Sliding [npc.her] [npc.hands] over [npc.her] pregnant bump, [npc.name] pout at [npc2.name], "
								+ (target.getAppearsAsGender().isFeminine()
									?"[npc.speech(Come have a feel!)]"
									:"[npc.speech(Pregnant [npc.girls] are the best fucks around!)]"),
                                "Posturing so as to draw attention to [npc.her] pregnant bump, [npc.name] bite [npc.her] lip at [npc2.name], "
								+ (target.getAppearsAsGender().isFeminine()
				...
				attackText = UtilText.parse(source, target,
						(UtilText.returnStringAtRandom(
                                "Rubbing [npc.her] [npc.hands] over [npc.her] flat stomach, [npc.name] bite [npc.her] [npc.lip] at [npc2.name], "
								+ (target.getAppearsAsGender().isFeminine()
									?"[npc.speech(Aww... I wish I were pregnant so bad!)]"
									:"[npc.speech(I need to get pregnant so bad! Come fill me your cum already!)]"),
                                "Sliding [npc.her] [npc.hands] over [npc.her] flat stomach, [npc.name] pout at [npc2.name], "
								+ (target.getAppearsAsGender().isFeminine()
    ...
    public static AbstractCombatMove TEASE_VIRILITY = new AbstractCombatMove(CombatMoveCategory.SPECIAL,
        ...
        public String getPrediction(int turnIndex, GameCharacter source, GameCharacter target, List<GameCharacter> enemies, List<GameCharacter> allies) {
            ...
            return UtilText.parse(source, target,
            			(isCrit?"[style.colourExcellent(Critical)]: ":"")
                                + "[npc.Name] tell [npc2.name] that [npc.sheIs] going to breed [npc2.herHim], dealing "
            					+ getFormattedDamage(damageType, getDamage(source, target, isCrit), target, false, isTargetAtMaximumLust(target)) + " damage."
            				+ (target.getFetishDesire(oppositeFetish).isNegative()?" [style.italicsMinorBad(Damage is reduced to 1 as [npc2.name] [npc2.verb(dislike)] the "+oppositeFetish.getName(source)+" fetish!)]":""));
        }
        ...
        public String perform(int turnIndex, GameCharacter source, GameCharacter target, List<GameCharacter> enemies, List<GameCharacter> allies) {
			...
			if(target.isVisiblyPregnant()) {
				attackText = UtilText.parse(source, target,
						(UtilText.returnStringAtRandom(
                                "Reaching down to grab [npc.her] crotch, [npc.name] wink at [npc2.name], "
								+ "[npc.speech(Shame you're already pregnant... But that won't stop me from filling your pussy with my [npc.cum+]!)]",
                                "Running [npc.her] [npc.hands] down over [npc.her] crotch, [npc.name] wink at [npc2.name], "
								+ "[npc.speech(You may already be pregnant, but that won't stop me from giving you a nice creampie!)]",
                                "Sliding [npc.her] [npc.hands] down to draw attention to [npc.her] crotch, [npc.name] grin at [npc2.name], "
								+ "[npc.speech(Don't think that being pregnant will stop me from filling your cunt with my [npc.cum+]!)]",
                                "Reaching down to grab [npc.her] crotch, [npc.name] grin at [npc2.name], "
    ...
    public static AbstractCombatMove TEASE_DOMINANT = new AbstractCombatMove(CombatMoveCategory.SPECIAL,
        ...
        public String getPrediction(int turnIndex, GameCharacter source, GameCharacter target, List<GameCharacter> enemies, List<GameCharacter> allies) {
            ...
            return UtilText.parse(source, target,
            			(isCrit?"[style.colourExcellent(Critical)]: ":"")
                                + "[npc.Name] tell [npc2.name] that [npc.sheIs] going to dominate [npc2.herHim], dealing "
            					+ getFormattedDamage(damageType, getDamage(source, target, isCrit), target, false, isTargetAtMaximumLust(target)) + " damage."
            				+ (target.getFetishDesire(oppositeFetish).isNegative()?" [style.italicsMinorBad(Damage is reduced to 1 as [npc2.name] [npc2.verb(dislike)] the "+oppositeFetish.getName(source)+" fetish!)]":""));
        }
        ...
        public String perform(int turnIndex, GameCharacter source, GameCharacter target, List<GameCharacter> enemies, List<GameCharacter> allies) {
            ...
            String sb = UtilText.returnStringAtRandom(
                    "Grinning lustfully at [npc2.name], [npc.name] growl, ",
                    "With an evil grin on [npc.her] face, [npc.name] growl at [npc2.name], ",
                    "Glaring imposingly at [npc2.name], [npc.name] growl, ",
                    "[npc.Name] let out a menacing growl as [npc.she] stare lustfully at [npc2.name], ") +
                    UtilText.returnStringAtRandom(
    ...
    public static AbstractCombatMove TEASE_SUBMISSIVE = new AbstractCombatMove(CombatMoveCategory.SPECIAL,
        ...
        public String getPrediction(int turnIndex, GameCharacter source, GameCharacter target, List<GameCharacter> enemies, List<GameCharacter> allies) {
            ...
            return UtilText.parse(source, target,
            			(isCrit?"[style.colourExcellent(Critical)]: ":"")
                                + "[npc.Name] tell [npc2.name] how [npc.she] love to be dominated, dealing "
            					+ getFormattedDamage(damageType, getDamage(source, target, isCrit), target, false, isTargetAtMaximumLust(target)) + " damage."
            				+ (target.getFetishDesire(oppositeFetish).isNegative()?" [style.italicsMinorBad(Damage is reduced to 1 as [npc2.name] [npc2.verb(dislike)] the "+oppositeFetish.getName(source)+" fetish!)]":""));
        }
        ...
        public String perform(int turnIndex, GameCharacter source, GameCharacter target, List<GameCharacter> enemies, List<GameCharacter> allies) {
            ...
            return formatAttackOutcome(source, target,
            		(UtilText.returnStringAtRandom(
                            "[npc.Name] tilt [npc.her] head down in a sign of submission, before looking up with big, innocent eyes, "
    								+ "[npc.speech(I'll be a good [npc.girl]! I promise!)]",
                            "[npc.Name] bite [npc.her] [npc.lip] и shuffle [npc.her] [npc.feet] as [npc.she] [npc.do] [npc.her] best to look as weak as possible, "
    								+ "[npc.speech(I'll do anything you want!)]",
                            "[npc.Name] shuffle [npc.her] [npc.feet] и make [npc.herself] as small as possible, before lustfully gazing up at [npc2.name], "
    								+ (target.getAppearsAsGender().isFeminine()
    									?"[npc.speech(Please! Treat me like your little bitch!)]"
    									:"[npc.speech(Please! Make me your little fuck-toy!)]"),
                            "[npc.Name] put on [npc.her] most innocent look as [npc.she] gaze lustfully into [npc2.namePos] [npc2.eyes], "
    								+ (target.getAppearsAsGender().isFeminine()
