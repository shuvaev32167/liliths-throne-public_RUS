...
public class SlimeGuardIce extends NPC {
	...
	public SlimeGuardIce(boolean isImported) {
        super(isImported, new NameTriplet("Кристалл"), "Триггс",
...
//		this.setEyeShadow(new Covering(BodyCoveringType.MAKEUP_EYE_SHADOW, PresetColour.COVERING_PURPLE));
	...
	public Response endCombat(boolean applyEffects, boolean victory) {
		if (victory) {
            return new Response("Victorious", "[slimeFire.Name] и [slimeIce.name] are defeated!", SlimeQueensLair.SLIME_GUARDS_COMBAT_PLAYER_VICTORY) {
				@Override
				public void effects() {
            ...
            return new Response("Defeated", "[slimeFire.Name] и [slimeIce.name] have defeated you!", SlimeQueensLair.SLIME_GUARDS_COMBAT_PLAYER_DEFEAT);
		}
	}
