...
public class Bunny extends NPC {
	...
	public Bunny(boolean isImported) {
        super(isImported, new NameTriplet("Банни"), "Хазенкамп",
		...
		if(!user.equals(target)) { // Item is not being self-used:
			...
			return new Value<>(false,
					UtilText.parse(user, target,
						"<p>"
                                + "[npc.Name] take out " + UtilText.generateSingularDeterminer(itemName) + " " + itemName + " from [npc.her] inventory and try to give it to [npc2.name],"
