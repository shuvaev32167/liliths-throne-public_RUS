...
public enum Quest {
	...
	MAIN_3_E_THEMISCYRA_ATTACK(QuestType.MAIN, 1, 250) {
		...
		@Override
		public String getDescription() {
            return "Отделившись от Мераксис, ты [pc.genderBasedWord(объединился, объединилась)] с амазонкой кородевушкой по имени Аурокарис."
...
//					+ " You could either offer yourself, or, if you own any slaves, offer one of those to Arthur instead.";
	...
	VENGAR_ONE(QuestType.SIDE, 1, 5) {
		...
		@Override
		public String getCompletedDescription() {
            return "Ты [npc.genderBasedWord(обнаружил, обнаружила)] Венгара, сидящего на троне в главном зале, и, подойдя к нему, получили выбор: либо присоединиться к его банде, либо сразиться с его телохранителями крысодевушками.";
		}
	},
