...
public abstract class AbstractHairType implements BodyPartTypeInterface {
	...
	public AbstractHairType(AbstractBodyCoveringType skinType,
							...
							boolean defaultPlural) {
		this(skinType, race, transformationName, name, namePlural, descriptorsMasculine, descriptorsFeminine,
				hairTransformationDescription, hairBodyDescription, tags);
