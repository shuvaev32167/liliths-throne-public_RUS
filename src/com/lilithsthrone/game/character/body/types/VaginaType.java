...
public class VaginaType {
	...
	public static AbstractVaginaType HUMAN = new AbstractVaginaType(BodyCoveringType.VAGINA,
			...
			Util.newArrayListOfValues(""),
			Util.newArrayListOfValues(""),
            "[npc.She] let out a squeal of excitement as a wave of pleasure runs up through [npc.her] groin, which increases in intensity as [npc.she] feel [npc.her] slit uncontrollably shifting and contracting."
                    + " Within moments, the feeling starts to fade away, and with a surprised gasp, [npc.she] discover that [npc.her] pussy [npc.has] shaped itself into a regular human vagina."
                    + " A warm, tingling feeling spreads up through [npc.her] lower abdomen, and as the transformation comes to an end, [npc.she] realise that [npc.her] internal reproductive organs have also transformed into those of a human."
			...
			Race.NONE,
			false,
            "[npc.She] moans and squirms about as [npc.she] feel [npc.her] pussy suddenly tighten and squeeze shut, and with a desperate cry, a strange pressure washes through [npc.her] lower abdomen."
                    + " Thankfully, the feeling fades almost as quickly as it came, and when the discomfort subsides, [npc.she] gasp as [npc.she] suddenly realise that [npc.her] vagina [npc.has] totally vanished!"
					...
					if(!owner.isVaginaVirgin()) {
						return UtilText.parse(owner,
								"<p style='text-align:center;'>"
									...
									+ "<br/><i>"
                                        + "As the reality of losing [npc.her] worthless cunt sinks in, [npc.name] start to think of [npc.herself] as something more than a dirty slut."
										+ " After all, if [npc.she] [npc.do]n't have a pussy, it's technically not possible for [npc.herHim] to have lost [npc.her] virginity!"
                                        + " Letting out a deep sigh, [npc.she] manage to convince [npc.herself] that [npc.she] no longer [npc.has] to worry about being a broken virgin."
									+ "<br/>"
						...
						return UtilText.parse(owner,
								"<p style='text-align:center;'>"
									...
									+ "<br/><i>"
                                        + "As the reality of losing [npc.her] vagina sinks in, [npc.name] start to feel a rising panic in the back of [npc.her] mind."
									+ " After all, if [npc.she] [npc.do]n't have a pussy, [npc.she] can't be considered a pure virgin!"
									+ "</i><br/>"
                                        + "Until [npc.name] can regain [npc.her] lost vagina, [npc.she] will [style.boldBad(no longer be considered a pure virgin)]!"
								+ "</p>");
					}
				}
			}
	...
	public static AbstractVaginaType ANGEL = new AbstractVaginaType(BodyCoveringType.VAGINA,
            ...
            "[npc.She] let out a squeal of excitement as a wave of pleasure runs up through [npc.her] groin, which increases in intensity as [npc.she] feel [npc.her] slit uncontrollably shifting and contracting."
                    + " Within moments, the feeling starts to fade away, and with a surprised gasp, [npc.she] discover that [npc.her] pussy [npc.has] shaped itself into an absolutely perfect-looking angelic vagina."
                    + " A warm, tingling feeling spreads up through [npc.her] lower abdomen, and as the transformation comes to an end, [npc.she] realise that [npc.her] internal reproductive organs have also transformed into those of an angel."
	...
	public static AbstractVaginaType DEMON_COMMON = new AbstractVaginaType(BodyCoveringType.VAGINA,
            ...
            "[npc.She] let out a squeal of excitement as a wave of pleasure runs up through [npc.her] groin, which increases in intensity as [npc.she] feel [npc.her] slit uncontrollably shifting and contracting."
                    ...
                    + " and [npc.she] let out a lewd moan as [npc.she] feel a new set of muscles forming all along the inner-walls of [npc.her] pussy."
                    + " With an experimental squeeze, [npc.she] quickly discover that [npc.she] [npc.has] an incredible amount of control over [npc.her] pussy's new muscles."
					+ " With one last shiver of pleasure, [npc.her] pussy reshapes its exterior into an absolutely perfect-looking vagina."
				+ "</p>"
				+ "<p>"
                    + "Just as [npc.she] start think that the transformation [npc.has] come to an end, [npc.her] pussy's new muscles involuntarily clench down,"
                    ...
                    + " and [npc.her] squeal turns into a satisfied moan as [npc.she] imagine them pumping their hot, virile seed deep into [npc.her] demonic womb."
                    ...
                    + " [npc.she] feel [npc.her] female reproductive organs finishing their transformation."
					+ "<br/>"
	...
	public static AbstractVaginaType DOG_MORPH = new AbstractVaginaType(BodyCoveringType.VAGINA,
            ...
            "[npc.She] let out a squeal of excitement as a wave of pleasure runs up through [npc.her] groin, which increases in intensity as [npc.she] feel [npc.her] slit uncontrollably shifting and contracting."
                    + " Within moments, the feeling fades away, and [npc.she] discover that [npc.her] pussy [npc.has] reformed and puffed up into a distinctly dog-like form."
				+ "</p>"
				+ "<p>"
                    + "Just as [npc.she] start think that the transformation [npc.has] come to an end, [npc.her] pussy involuntarily clenches down,"
						+ " and a desperate squeal escapes from between [npc.her] [npc.lips+] as a warm, tingling feeling spreads up through [npc.her] lower abdomen."
					+ " Images of red, knotted dog-cocks slamming deep into [npc.her] new pussy flash before [npc.her] eyes,"
                    + " and [npc.her] squeal turns into a satisfied moan as [npc.she] imagine them pumping their potent seed deep into [npc.her] canine womb."
					+ " Just as quickly as they came, the images fade from [npc.her] mind, and as one last wave of tingling pleasure washes through [npc.her] body,"
                    + " [npc.she] feel [npc.her] female reproductive organs finishing their transformation."
...
//	};
	public static AbstractVaginaType WOLF_MORPH = new AbstractVaginaType(BodyCoveringType.VAGINA,
			...
			Util.newArrayListOfValues("hot"),
            "[npc.She] let out a squeal of excitement as a wave of pleasure runs up through [npc.her] groin, which increases in intensity as [npc.she] feel [npc.her] slit uncontrollably shifting and contracting."
                    + " Within moments, the feeling fades away, and [npc.she] discover that [npc.her] pussy [npc.has] reformed and puffed up into a distinctly wolf-like form."
				+ "</p>"
				+ "<p>"
                    + "Just as [npc.she] start think that the transformation [npc.has] come to an end, [npc.her] pussy involuntarily clenches down,"
						+ " and a desperate squeal escapes from between [npc.her] [npc.lips+] as a warm, tingling feeling spreads up through [npc.her] lower abdomen."
					+ " Images of red, knotted wolf-cocks slamming deep into [npc.her] new pussy flash before [npc.her] eyes,"
                    + " and [npc.her] squeal turns into a satisfied moan as [npc.she] imagine them pumping their potent seed deep into [npc.her] lupine womb."
					+ " Just as quickly as they came, the images fade from [npc.her] mind, and as one last wave of tingling pleasure washes through [npc.her] body,"
                    + " [npc.she] feel [npc.her] female reproductive organs finishing their transformation."
	...
	public static AbstractVaginaType FOX_MORPH = new AbstractVaginaType(BodyCoveringType.VAGINA,
			...
			Util.newArrayListOfValues("hot"),
            "[npc.She] let out a squeal of excitement as a wave of pleasure runs up through [npc.her] groin, which increases in intensity as [npc.she] feel [npc.her] slit uncontrollably shifting and contracting."
                    + " Within moments, the feeling fades away, and [npc.she] discover that [npc.her] pussy [npc.has] reformed and puffed up into a distinctly fox-like form."
				+ "</p>"
				+ "<p>"
                    + "Just as [npc.she] start think that the transformation [npc.has] come to an end, [npc.her] pussy involuntarily clenches down,"
						+ " and a desperate squeal escapes from between [npc.her] [npc.lips+] as a warm, tingling feeling spreads up through [npc.her] lower abdomen."
					+ " Images of red, knotted fox-cocks slamming deep into [npc.her] new pussy flash before [npc.her] eyes,"
                    + " and [npc.her] squeal turns into a satisfied moan as [npc.she] imagine them pumping their potent seed deep into [npc.her] vulpine womb."
					+ " Just as quickly as they came, the images fade from [npc.her] mind, and as one last wave of tingling pleasure washes through [npc.her] body,"
                    + " [npc.she] feel [npc.her] female reproductive organs finishing their transformation."
	...
	public static AbstractVaginaType CAT_MORPH = new AbstractVaginaType(BodyCoveringType.VAGINA,
			...
			Util.newArrayListOfValues("hot"),
            "[npc.She] let out a squeal of excitement as a wave of pleasure runs up through [npc.her] groin, which increases in intensity as [npc.she] feel [npc.her] slit uncontrollably shifting and contracting."
                    + " Within moments, the feeling fades away, and [npc.she] discover that [npc.her] pussy [npc.has] reformed into a distinctly cat-like form."
				+ "</p>"
				+ "<p>"
                    + "Just as [npc.she] start think that the transformation [npc.has] come to an end, [npc.her] pussy involuntarily clenches down,"
						+ " and a desperate squeal escapes from between [npc.her] [npc.lips+] as a warm, tingling feeling spreads up through [npc.her] lower abdomen."
					+ " Images of barbed cat-cocks slamming deep into [npc.her] new pussy flash before [npc.her] eyes,"
                    + " and [npc.her] squeal turns into a satisfied moan as [npc.she] imagine them pumping their potent seed deep into [npc.her] feline womb."
					+ " Just as quickly as they came, the images fade from [npc.her] mind, and as one last wave of tingling pleasure washes through [npc.her] body,"
                    + " [npc.she] feel [npc.her] female reproductive organs finishing their transformation."
	...
	public static AbstractVaginaType SQUIRREL_MORPH = new AbstractVaginaType(BodyCoveringType.VAGINA,
			...
			Util.newArrayListOfValues("hot"),
            "[npc.She] let out a squeal of excitement as a wave of pleasure runs up through [npc.her] groin, which increases in intensity as [npc.she] feel [npc.her] slit uncontrollably shifting and contracting."
                    + " Within moments, the feeling fades away, and [npc.she] discover that [npc.her] pussy [npc.has] reformed into a distinctly squirrel-like form."
				+ "</p>"
				+ "<p>"
                    + "Just as [npc.she] start think that the transformation [npc.has] come to an end, [npc.her] pussy involuntarily clenches down,"
						+ " and a desperate squeal escapes from between [npc.her] [npc.lips+] as a warm, tingling feeling spreads up through [npc.her] lower abdomen."
					+ " Images of massive squirrel-cocks slamming deep into [npc.her] new pussy flash before [npc.her] eyes,"
                    + " and [npc.her] squeal turns into a satisfied moan as [npc.she] imagine them pumping their potent seed deep into [npc.her] new womb."
					+ " Just as quickly as they came, the images fade from [npc.her] mind, and as one last wave of tingling pleasure washes through [npc.her] body,"
                    + " [npc.she] feel [npc.her] female reproductive organs finishing their transformation."
	...
	public static AbstractVaginaType RAT_MORPH = new AbstractVaginaType(BodyCoveringType.VAGINA,
			...
			Util.newArrayListOfValues("hot"),
            "[npc.She] let out a squeal of excitement as a wave of pleasure runs up through [npc.her] groin, which increases in intensity as [npc.she] feel [npc.her] slit uncontrollably shifting and contracting."
                    + " Within moments, the feeling fades away, and [npc.she] discover that [npc.her] pussy [npc.has] reformed into a distinctly rat-like form."
				+ "</p>"
				+ "<p>"
                    + "Just as [npc.she] start think that the transformation [npc.has] come to an end, [npc.her] pussy involuntarily clenches down,"
						+ " and a desperate squeal escapes from between [npc.her] [npc.lips+] as a warm, tingling feeling spreads up through [npc.her] lower abdomen."
					+ " Images of throbbing rat-cocks slamming deep into [npc.her] new pussy flash before [npc.her] eyes,"
                    + " and [npc.her] squeal turns into a satisfied moan as [npc.she] imagine them pumping their potent seed deep into [npc.her] rodent womb."
					+ " Just as quickly as they came, the images fade from [npc.her] mind, and as one last wave of tingling pleasure washes through [npc.her] body,"
                    + " [npc.she] feel [npc.her] female reproductive organs finishing their transformation."
	...
	public static AbstractVaginaType RABBIT_MORPH = new AbstractVaginaType(BodyCoveringType.VAGINA,
			...
			Util.newArrayListOfValues("hot"),
            "[npc.She] let out a squeal of excitement as a wave of pleasure runs up through [npc.her] groin, which increases in intensity as [npc.she] feel [npc.her] slit uncontrollably shifting and contracting."
                    + " Within moments, the feeling fades away, and [npc.she] discover that [npc.her] pussy [npc.has] reformed into a distinctly rabbit-like form."
				+ "</p>"
				+ "<p>"
                    + "Just as [npc.she] start think that the transformation [npc.has] come to an end, [npc.her] pussy involuntarily clenches down,"
						+ " and a desperate squeal escapes from between [npc.her] [npc.lips+] as a warm, tingling feeling spreads up through [npc.her] lower abdomen."
					+ " Images of thick rabbit-cocks slamming deep into [npc.her] new pussy flash before [npc.her] eyes,"
                    + " and [npc.her] squeal turns into a satisfied moan as [npc.she] imagine them pumping their virile seed deep into [npc.her] new womb."
					+ " Just as quickly as they came, the images fade from [npc.her] mind, and as one last wave of tingling pleasure washes through [npc.her] body,"
                    + " [npc.she] feel [npc.her] female reproductive organs finishing their transformation."
	...
	public static AbstractVaginaType BAT_MORPH = new AbstractVaginaType(BodyCoveringType.VAGINA,
			...
			Util.newArrayListOfValues("hot"),
            "[npc.She] let out a squeal of excitement as a wave of pleasure runs up through [npc.her] groin, which increases in intensity as [npc.she] feel [npc.her] slit uncontrollably shifting and contracting."
                    + " Within moments, the feeling fades away, and [npc.she] discover that [npc.her] pussy [npc.has] reformed into a distinctly bat-like form."
				+ "</p>"
				+ "<p>"
                    + "Just as [npc.she] start think that the transformation [npc.has] come to an end, [npc.her] pussy involuntarily clenches down,"
						+ " and a desperate squeal escapes from between [npc.her] [npc.lips+] as a warm, tingling feeling spreads up through [npc.her] lower abdomen."
					+ " Images of throbbing bat-cocks slamming deep into [npc.her] new pussy flash before [npc.her] eyes,"
                    + " and [npc.her] squeal turns into a satisfied moan as [npc.she] imagine them pumping their hot seed deep into [npc.her] new womb."
					+ " Just as quickly as they came, the images fade from [npc.her] mind, and as one last wave of tingling pleasure washes through [npc.her] body,"
                    + " [npc.she] feel [npc.her] female reproductive organs finishing their transformation."
	...
	public static AbstractVaginaType ALLIGATOR_MORPH = new AbstractVaginaType(BodyCoveringType.VAGINA,
			...
			Util.newArrayListOfValues("hot"),
            "[npc.She] let out a squeal of excitement as a wave of pleasure runs up through [npc.her] groin, which increases in intensity as [npc.she] feel [npc.her] slit uncontrollably shifting and contracting."
                    + " Within moments, the feeling fades away, and [npc.she] discover that [npc.her] pussy [npc.has] reformed into a distinctly alligator-like form."
				+ "</p>"
				+ "<p>"
                    + "Just as [npc.she] start think that the transformation [npc.has] come to an end, [npc.her] pussy involuntarily clenches down,"
						+ " and a desperate squeal escapes from between [npc.her] [npc.lips+] as a warm, tingling feeling spreads up through [npc.her] lower abdomen."
	...
	public static AbstractVaginaType COW_MORPH = new AbstractVaginaType(BodyCoveringType.VAGINA,
			...
			Util.newArrayListOfValues("hot"),
            "[npc.She] let out a squeal of excitement as a wave of pleasure runs up through [npc.her] groin, which increases in intensity as [npc.she] feel [npc.her] slit uncontrollably shifting and contracting."
                    + " Within moments, the feeling fades away, and [npc.she] discover that [npc.her] pussy [npc.has] reformed into a distinctly cow-like form."
				+ "</p>"
				+ "<p>"
                    + "Just as [npc.she] start think that the transformation [npc.has] come to an end, [npc.her] pussy involuntarily clenches down,"
						+ " and a desperate squeal escapes from between [npc.her] [npc.lips+] as a warm, tingling feeling spreads up through [npc.her] lower abdomen."
	...
	public static AbstractVaginaType HORSE_MORPH = new AbstractVaginaType(BodyCoveringType.VAGINA,
            ...
            "[npc.She] let out a squeal of excitement as a wave of pleasure runs up through [npc.her] groin, which increases in intensity as [npc.she] feel [npc.her] slit uncontrollably shifting and contracting."
                    ...
                    + " and [npc.she] let out a lewd moan as [npc.she] feel a new set of muscles forming all along the inner-walls of [npc.her] pussy."
                    + " With an experimental squeeze, [npc.she] quickly discover that [npc.she] [npc.has] an incredible amount of control over [npc.her] pussy's new muscles."
                    + " Within moments, the feeling fades away, and [npc.she] discover that [npc.her] pussy [npc.has] reformed itself and puffed up into a distinctly horse-like form."
				+ "</p>"
				+ "<p>"
                    + "Just as [npc.she] start think that the transformation [npc.has] come to an end, [npc.her] pussy involuntarily clenches down,"
						+ " and a desperate squeal escapes from between [npc.her] [npc.lips+] as a warm, tingling feeling spreads up through [npc.her] lower abdomen."
	...
	public static AbstractVaginaType REINDEER_MORPH = new AbstractVaginaType(BodyCoveringType.VAGINA,
			...
			Util.newArrayListOfValues("hot"),
            "[npc.She] let out a squeal of excitement as a wave of pleasure runs up through [npc.her] groin, which increases in intensity as [npc.she] feel [npc.her] slit uncontrollably shifting and contracting."
                    + " Within moments, the feeling fades away, and [npc.she] discover that [npc.her] pussy [npc.has] reformed itself and puffed up into a distinctly reindeer-like form."
				+ "</p>"
				+ "<p>"
                    + "Just as [npc.she] start think that the transformation [npc.has] come to an end, [npc.her] pussy involuntarily clenches down,"
						+ " and a desperate squeal escapes from between [npc.her] [npc.lips+] as a warm, tingling feeling spreads up through [npc.her] lower abdomen."
	...
	public static AbstractVaginaType HARPY = new AbstractVaginaType(BodyCoveringType.VAGINA,
			...
			Util.newArrayListOfValues("hot"),
            "[npc.She] let out a squeal of excitement as a wave of pleasure runs up through [npc.her] groin, which increases in intensity as [npc.she] feel [npc.her] slit uncontrollably shifting and contracting."
                    + " Within moments, the feeling fades away, and [npc.she] discover that [npc.her] pussy [npc.has] reformed itself into a distinctly bird-like form."
				+ "</p>"
				+ "<p>"
                    + "Just as [npc.she] start think that the transformation [npc.has] come to an end, [npc.her] pussy involuntarily clenches down,"
						+ " and a desperate squeal escapes from between [npc.her] [npc.lips+] as a warm, tingling feeling spreads up through [npc.her] lower abdomen."
					+ " Images of throbbing bird-cocks slamming deep into [npc.her] new pussy flash before [npc.her] eyes,"
                    + " and [npc.her] squeal turns into a satisfied moan as [npc.she] imagine them pumping their hot seed deep into [npc.her] avian womb."
					+ " Just as quickly as they came, the images fade from [npc.her] mind, and as one last wave of tingling pleasure washes through [npc.her] body,"
                    + " [npc.she] feel [npc.her] female reproductive organs finishing their transformation."
