...
public enum HairLength {
	/** Bald */
	ZERO_BALD("лысые", 0, 1, PresetColour.GENERIC_SIZE_ONE, false),
	/** Very short */
	ONE_VERY_SHORT("очень короткие", 1, 8, PresetColour.GENERIC_SIZE_TWO, false),
	/** Short */
	TWO_SHORT("короткие", 8, 15, PresetColour.GENERIC_SIZE_THREE, true),
	/** above the shoulders */
	THREE_SHOULDER_LENGTH("по плечи", 15, 30, PresetColour.GENERIC_SIZE_FOUR, true),
	/** Reaching down to mid-back */
	FOUR_MID_BACK("длинные", 30, 60, PresetColour.GENERIC_SIZE_FIVE, true),
	/** Reaching down to just above the ass */
	FIVE_ABOVE_ASS("очень длинные", 60, 100, PresetColour.GENERIC_SIZE_SIX, true),
	/** Reaching down to below the ass */
	SIX_BELOW_ASS("невероятно длинные", 100, 180, PresetColour.GENERIC_SIZE_SEVEN, true),
