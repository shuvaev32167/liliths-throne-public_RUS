...
public enum CumProduction {
	...
	FOUR_LARGE("много", "большое количество", 16, 30, 5, Wetness.FOUR_SLIMY, PresetColour.GENERIC_SIZE_FIVE, 0),
	
	/** This is a very large amount of cum. (About a quarter of a can of coke.)*/
	FIVE_HUGE("гигантское", "гигантское количество", 30, 100, 0, Wetness.FIVE_SLOPPY, PresetColour.GENERIC_SIZE_SIX, 1),
	
	/** This and SEVEN_MONSTROUS are a bit ridiculous, and should only be used as part of "extreme proportion" content. */
	SIX_EXTREME("экстремальное", "экстремальное количество", 100, 1000, 0, Wetness.SIX_SOPPING_WET, PresetColour.GENERIC_SIZE_SEVEN, 3),
