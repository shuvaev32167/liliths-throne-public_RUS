...
public class PlaceUpgrade {
	...
	public static final AbstractPlaceUpgrade LILAYA_SPA_BAR = new AbstractPlaceUpgrade(false,
			...
			"Ты [pc.genderBasedWord(построил, построила)] бар в зоне бассейна спа-салона, где всегда будет в наличии широкий выбор алкогольных и безалкогольных напитков."
					+ " Однако затраты на охлаждение и пополнение запасов означают, что содержание такого оборудования обходится недешево...",
			"",
			15_000,
			5_000,
			500,
