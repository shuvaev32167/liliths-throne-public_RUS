        ...
        UtilText.COMMANDS_LIST.add(new ParserCommand(
            ...
            public String parse(List<GameCharacter> specialNPCs, String command, String arguments, String target, GameCharacter character) {
                ...
                return Optional.ofNullable(arguments)
                        ...
                        .map(word -> {
                            if (Boolean.TRUE.equals(isCapitalise.getAsBoolean())) {
        ...
        UtilText.COMMANDS_LIST.add(new ParserCommand(
            ...
            public String parse(List<GameCharacter> specialNPCs, String command, String arguments, String target, GameCharacter character) {
                ...
                return Optional.ofNullable(arguments)
                        ...
                        .map(string -> Morpher.replaceBetweenHtmlTags(string,
                                        (string1) -> MORPHER.morphGender(string1, convertGender(gender), Numeration.SINGLE)
                                )
                        )
                        .map(word -> {
                            if (Boolean.TRUE.equals(isCapitalise.getAsBoolean())) {
        ...
        UtilText.COMMANDS_LIST.add(new ParserCommand(
            ...
            public String parse(List<GameCharacter> specialNPCs, String command, String arguments, String target, GameCharacter character) {
                ...
                return Optional.ofNullable(arguments)
                        ...
                        .map(word -> {
                            if (Boolean.TRUE.equals(Boolean.TRUE.equals(isCapitalise.getAsBoolean()))) {
                                return Util.capitaliseSentence(word);
                            } else {
                                return word;
                            }
